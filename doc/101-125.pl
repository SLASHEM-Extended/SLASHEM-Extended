...
my $moncount  = 35; # How many monsters to do per page-load.
...
for (1 .. $moncount) {
  ...
  my $lvl = (int rand 26) + 100;
  my $mov = (50 > rand 100) ? (12 + int rand rand rand 60) : (20 - int rand rand 19);
  my $ac  = (int rand 51) - 40;
  my $mr  = int rand 100;
  if (50 > rand 100) {
    $mr   = (int rand 50) + 51;
  }
