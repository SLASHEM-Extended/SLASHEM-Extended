...
\DefineString{h1}{}
\DefineString{h2}{\%}
\DefineString{vr}{{\it SLASH'EM\/} 0.0.6}
\DefineString{f0}{\UseString{vr}}
\DefineString{f1}{}
\DefineString{f2}{October 7, 2000}
%.mt
\title{\LARGE A Guide to the Mazes of Menace:\\
\Large Guidebook for {\it SLASH'EM\/} 0.0.6}
...
another object of the same type (``{\tt polypiling}'') or the form of your own
...
tile sets can be slected for initial display (using the tiles option) or
...
The Amiga port of {\it NetHack\/} was resurrected for 3.3.1 by {\it Janne Salmijarvi}.
%.pg

The Atari port of {\it NetHack\/} was resurrected for 3.3.1 by {\it Christian ``{\tt Marvin}''}
Bressler.
%.pg
