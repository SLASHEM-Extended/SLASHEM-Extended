...
the same conditions as the `{\tt G}' command does. For ports with mouse 
...
{\it Alex Kompel\/} contributed a new graphical interface for the Windows port..pg
