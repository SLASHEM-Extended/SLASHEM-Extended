...
playerextrinsicsickres()
{
	...
	if ( (uarmc && uarmc->oartifact == ART_EVERY_CONDITION_SUIT) || (uarmg && uarmg->oartifact == ART_HOBART_THE_GOLDEN) || (uarmg && uarmg->oartifact == ART_GASTER_FIL) || (uarmc && uarmc->oartifact == ART_KWULL_GONG) || (uimplant && uimplant->oartifact == ART_VIRAL_CORE_OF_ISKAR_THE_PA) || (powerfulimplants() && uimplant && uimplant->oartifact == ART_GENDEREQUALNESS) ) return TRUE;
...
playerextrinsicdeathres()
{
	...
	if ( (uarms && uarms->oartifact == ART_ANTINSTANT_DEATH) || (uamul && uamul->oartifact == ART_MYSTER_DEEP_) || (uarm && uarm->oartifact == ART_UMBRANOX) || (uarmc && uarmc->oartifact == ART_ADILA_S_PINNACLE) || (uarm && uarm->oartifact == ART_ALEIT_GIVESITNOT) || (uarm && uarm->oartifact == ART_STALWART_COSTUME) || (uamul && uamul->oartifact == ART_PERMANENTLY_BLACK) || (uwep && uwep->oartifact == ART_KALI_S_ORBIT) || (uarmf && uarmf->oartifact == ART_AMY_S_MISPURCHASE) || (uarmc && uarmc->oartifact == ART_BLACKER_QUIVER) || (uarmf && uarmf->oartifact == ART_DARKFLECT) ) return TRUE;
...
playerextrinsicdiscountaction()
{
	...
	if ( (uarmg && uarmg->oartifact == ART_INTERMINTER) || (powerfulimplants() && uimplant && uimplant->oartifact == ART_DIDI_S_LEG_PAINTING) ) return TRUE;
...
playerextrinsicfreeaction()
{
	...
	if ( (powerfulimplants() && uimplant && uimplant->oartifact == ART_DIDI_S_LEG_PAINTING) ) return TRUE;
...
playerextrinsicshockres()
{
	...
	if ( (uwep && uwep->oartifact == ART_ELEMENTAL_STAFF) || (uarmf && uarmf->oartifact == ART_SARAH_S_REPLACEMENT) || autismringcheck(ART_RING_OF_STEEL_DRAGON) || (uwep && uwep->oartifact == ART_JADE_TALON) || (uarmu && uarmu->oartifact == ART_EVERY_EVENTUALITY) || autismringcheck(ART_RED_YELLOW_ORANGE) || (ublindf && ublindf->oartifact == ART_TOTALLY_THE_SPECTRUM) || (uarmf && uarmf->oartifact == ART_DORIKA_S_COLORBLOCK) || (uimplant && uimplant->oartifact == ART_FULLPOWER) || (uarm && uarm->oartifact == ART_EFHECK) ) return TRUE;
...
playerextrinsicspeed()
{
	...
	if ( (uchain && uchain->oartifact == ART_JORMUNGANDR_S_COIL) || (uimplant && uimplant->oartifact == ART_GIULY_AH) || (uarm && uarm->oartifact == ART_MOTA_ROLA) || u.tempveryfastspeed ) return TRUE;
