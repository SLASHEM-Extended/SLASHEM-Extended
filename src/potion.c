...
playerextrinsicaggravatemon()
{
	...
	if ( (uarmf && uarmf->oartifact == ART_KUUGRUU__KUUGRUU_) || (uarmf && uarmf->oartifact == ART_INGRID_S_IRONHOOF_BOOTS) || (uarmc && uarmc->oartifact == ART_LILIANE_S_GLAMOUR_VEIL) ) return TRUE;
...
playerextrinsicdiscountaction()
{
	...
	if ( (uarmg && uarmg->oartifact == ART_INTERMINTER) || (uarmc && uarmc->oartifact == ART_GERMAN_CHANCELLOR_SAYS_) || (powerfulimplants() && uimplant && uimplant->oartifact == ART_DIDI_S_LEG_PAINTING) || (uarmf && uarmf->oartifact == ART_OFFZEEH_BRUN) ) return TRUE;
...
playerextrinsicsleepres()
{
	...
	if ( (uarmf && uarmf->oartifact == ART_KARIN_S_SHARP_EDGE) || (ublindf && ublindf->oartifact == ART_LEANDRA_S_WORD) || (uarmf && uarmf->oartifact == ART_SOLVEJG_S_SQUEEZE_IN) || (uarmf && uarmf->oartifact == ART_JESSICA_S_RAINBOW) ) return TRUE;
...
playerextrinsicfreeaction()
{
	...
	if ( (uarmf && uarmf->oartifact == ART_ROUGHGRAVEL_MASTER) || (powerfulimplants() && uimplant && uimplant->oartifact == ART_DIDI_S_LEG_PAINTING) || (uarmc && uarmc->oartifact == ART_GERMAN_CHANCELLOR_SAYS_) || (uarmf && uarmf->oartifact == ART_JANET_S_DETACHMENT) || (ublindf && ublindf->oartifact == ART_HEADHORN) || (uarmf && uarmf->oartifact == ART_RINGFIGHTER_S_GUARD) || (uarmf && uarmf->oartifact == ART_ERIK_S_MARCHING_BOOTS) ) return TRUE;
