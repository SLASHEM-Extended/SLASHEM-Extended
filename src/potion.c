...
playerextrinsicdrainres()
{
	...
	if ( (uarmf && uarmf->oartifact == ART_ALMIS_MANICIA) || (powerfulimplants() && uimplant && uimplant->oartifact == ART_BLOODPUMP_OF_HARKON_BLOODR) ) return TRUE;
