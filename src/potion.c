...
playerextrinsicmysteryres()
{
	...
	if ( (uarmc && uarmc->oartifact == ART_SUPATECT) || (uarmc && uarmc->oartifact == ART_FELL_GARB) ) return TRUE;
...
playerextrinsicmagicalbreath()
{
	...
	if ( (uarmc && uarmc->oartifact == ART_MANTLE_OF_THE_MANTA_RAY) || (uarmc && uarmc->oartifact == ART_OUT_OF_THE_RAIN) || (uwep && uwep->oartifact == ART_TEZCATLIPOCA_S_BUBBLESTORM) ) return TRUE; 
...
playerextrinsicfireres()
{
	...
	if ( (uwep && uwep->oartifact == ART_ELEMENTAL_STAFF) || (uwep && uwep->oartifact == ART_JADE_TALON) || (uarmu && uarmu->oartifact == ART_CRIMSON_PLATE) || (uwep && uwep->oartifact == ART_DICHOTOMY) || (uarm && uarm->oartifact == ART_EFHECK) || (uarmu && uarmu->oartifact == ART_EVERY_EVENTUALITY) || autismringcheck(ART_RED_YELLOW_ORANGE) || (ublindf && ublindf->oartifact == ART_TOTALLY_THE_SPECTRUM) || (uarmc && uarmc->oartifact == ART_DELLEN) ) return TRUE;
