...
playerextrinsicaggravatemon()
{
	...
	if ( (uarmf && uarmf->oartifact == ART_KUUGRUU__KUUGRUU_) ) return TRUE;
...
playerextrinsicsickres()
{
	...
	if ( (uarmc && uarmc->oartifact == ART_EVERY_CONDITION_SUIT) || (uarmg && uarmg->oartifact == ART_HOBART_THE_GOLDEN) || (uarmg && uarmg->oartifact == ART_GASTER_FIL) || (uarmc && uarmc->oartifact == ART_KWULL_GONG) || (uarmc && uarmc->oartifact == ART_GERMAN_CHANCELLOR_SAYS_) || (uimplant && uimplant->oartifact == ART_VIRAL_CORE_OF_ISKAR_THE_PA) || (uarmf && uarmf->oartifact == ART_FUNGUS_ERADICATION) || (powerfulimplants() && uimplant && uimplant->oartifact == ART_GENDEREQUALNESS) ) return TRUE;
...
playerextrinsicfearres()
{
	...
	if ( (uarmf && uarmf->oartifact == ART_DON_T_RUN_IN_FEAR) ) return TRUE;
...
playerextrinsicsleepres()
{
	...
	if ( (uarmf && uarmf->oartifact == ART_KARIN_S_SHARP_EDGE) || (uarmf && uarmf->oartifact == ART_SOLVEJG_S_SQUEEZE_IN) || (uarmf && uarmf->oartifact == ART_JESSICA_S_RAINBOW) ) return TRUE;
...
playerextrinsicstoneres()
{
	...
	if (autismringcheck(ART_FIRMBLOCK) || (uarmf && uarmf->oartifact == ART_PORYSTONE) || (uarmf && uarmf->oartifact == ART_ANASTASIA_S_PLAYTIME) ) return TRUE;
...
playerextrinsicfreeaction()
{
	...
	if ( (uarmf && uarmf->oartifact == ART_ROUGHGRAVEL_MASTER) || (powerfulimplants() && uimplant && uimplant->oartifact == ART_DIDI_S_LEG_PAINTING) || (uarmc && uarmc->oartifact == ART_GERMAN_CHANCELLOR_SAYS_) || (uarmf && uarmf->oartifact == ART_JANET_S_DETACHMENT) || (ublindf && ublindf->oartifact == ART_HEADHORN) || (uarmf && uarmf->oartifact == ART_RINGFIGHTER_S_GUARD) ) return TRUE;
...
playerextrinsicspeed()
{
	...
	if ( (uchain && uchain->oartifact == ART_JORMUNGANDR_S_COIL) || (uimplant && uimplant->oartifact == ART_GIULY_AH) || (uarm && uarm->oartifact == ART_MOTA_ROLA) || u.tempveryfastspeed || (uarmc && uarmc->oartifact == ART_HUNTING_TIME_HINT) || (uarmf && uarmf->oartifact == ART_ADHS_DIAGNOSIS) || bmwride(ART_MARLOWE_S_CAMEL) ) return TRUE;
