...
playerextrinsicsickres()
{
	...
	if ( (uarmc && uarmc->oartifact == ART_EVERY_CONDITION_SUIT) || (uarmg && uarmg->oartifact == ART_GASTER_FIL) || (uarmc && uarmc->oartifact == ART_KWULL_GONG) ) return TRUE;
...
playerextrinsicmysteryres()
{
	...
	if ( (uarmc && uarmc->oartifact == ART_SUPATECT) || (uarmf && uarmf->oartifact == ART_GNOME_QUEEN_S_SLIPPERS) || (uarmh && uarmh->oartifact == ART_PURPLE_ORC) || (uarmc && uarmc->oartifact == ART_FELL_GARB) ) return TRUE;
...
playerextrinsicpsires()
{
	...
	if ( (uamul && uamul->oartifact == ART_PRECIOUS_UNOBTAINABLE_PROP) || (uarm && uarm->oartifact == ART_MINDMEND) || autismringcheck(ART_KONDRE) || (uamul && uamul->oartifact == ART_ISRA_S_ANGLE) || (uwep && uwep->oartifact == ART_CHAINS_OF_THE_ABYSS) || (uarmh && uarmh->oartifact == ART_PSYSTRYKE) || (uarm && uarm->oartifact == ART_ULTRAVIOLET_RAINBOW) ) return TRUE;
...
playerextrinsicsleepres()
{
	...
	if ( (uarmc && uarmc->oartifact == ART_CLOAK_OF_THE_UNHELD_ONE) || (uarmc && uarmc->oartifact == ART_CLOAK_OF_THE_UNHELD_POTATO) || (uarmc && uarmc->oartifact == ART_STRIPED_SHIRT_OF_THE_FALSE) || (uarmh && uarmh->oartifact == ART_CROWN_OF_THE_PERCIPIENT) || (uarmf && uarmf->oartifact == ART_SYLVIE_S_YAWN) || (uarmc && uarmc->oartifact == ART_RUFFLED_SHIRT_OF_THE_ARIST) || (uarmc && uarmc->oartifact == ART_NUTKNU_KOLAS) || (uarmh && uarmh->oartifact == ART_ENSNARED_MIND) || autismringcheck(ART_BUT_YOU_MUST) || (uarmf && uarmf->oartifact == ART_DAPHNE_S_BOREDOM) || autismringcheck(ART_IT_S_NOT_BEDTIME_YET) || autismringcheck(ART_GRISHUH) || (ublindf && ublindf->oartifact == ART_TOTALLY_THE_SPECTRUM) || (uarmc && uarmc->oartifact == ART_WAKESTAY) || (uarms && uarms->oartifact == ART_KAVYA_S_HASPLE) || (uarmu && uarmu->oartifact == ART_SETH_S_ERROR) || (uwep && uwep->oartifact == ART_MECHINEFELL) || (uchain && uchain->oartifact == ART_MECHINEFELL) ) return TRUE;
...
playerextrinsicfireres()
{
	...
	if ( (uwep && uwep->oartifact == ART_ELEMENTAL_STAFF) || (uwep && uwep->oartifact == ART_JADE_TALON) || (uarmu && uarmu->oartifact == ART_CRIMSON_PLATE) || (uwep && uwep->oartifact == ART_DICHOTOMY) || (uarm && uarm->oartifact == ART_EFHECK) || (uarmu && uarmu->oartifact == ART_EVERY_EVENTUALITY) || autismringcheck(ART_RED_YELLOW_ORANGE) || (ublindf && ublindf->oartifact == ART_TOTALLY_THE_SPECTRUM) || (uarmh && uarmh->oartifact == ART_SPRING_BREEZE) || (uarmc && uarmc->oartifact == ART_DELLEN) ) return TRUE;
...
playerextrinsiccoldres()
{
	...
	if ( (uarm && uarm->oartifact == ART_VERY_HOT_IN_HERE) || u.cryopancaketurns || (uwep && uwep->oartifact == ART_JADE_TALON) || (uwep && uwep->oartifact == ART_ELEMENTAL_STAFF) || (uarmc && uarmc->oartifact == ART_NUTKNU_KOLAS) || (uarmc && uarmc->oartifact == ART_FLEECY_CORN) || (uarmf && uarmf->oartifact == ART_SARAH_S_REPLACEMENT) || (uarmu && uarmu->oartifact == ART_EVERY_EVENTUALITY) || (uwep && uwep->oartifact == ART_DICHOTOMY) || (ublindf && ublindf->oartifact == ART_TOTALLY_THE_SPECTRUM) || (uarmh && uarmh->oartifact == ART_SPRING_BREEZE) || (uarm && uarm->oartifact == ART_EFHECK) ) return TRUE;
...
playerextrinsicpoisonres()
{
	...
	if (autismringcheck(ART_FOLL_DECK) || (uwep && uwep->oartifact == ART_MECHINEFELL) || (uchain && uchain->oartifact == ART_MECHINEFELL) || (uball && uball->oartifact == ART_HIGH_AFFIX) || (uarm && uarm->oartifact == ART_EFHECK) ) return TRUE;
