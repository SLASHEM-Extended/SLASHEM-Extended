...
playerextrinsicsickres()
{
	...
	if ( (uarmc && uarmc->oartifact == ART_EVERY_CONDITION_SUIT) || (uarmg && uarmg->oartifact == ART_HOBART_THE_GOLDEN) || (uarmg && uarmg->oartifact == ART_GASTER_FIL) || (uarmc && uarmc->oartifact == ART_KWULL_GONG) || (uarmc && uarmc->oartifact == ART_GERMAN_CHANCELLOR_SAYS_) || (uimplant && uimplant->oartifact == ART_VIRAL_CORE_OF_ISKAR_THE_PA) || (powerfulimplants() && uimplant && uimplant->oartifact == ART_GENDEREQUALNESS) ) return TRUE;
...
playerextrinsicdeathres()
{
	...
	if ( (uarms && uarms->oartifact == ART_ANTINSTANT_DEATH) || (uamul && uamul->oartifact == ART_MYSTER_DEEP_) || (uarm && uarm->oartifact == ART_UMBRANOX) || (uarmc && uarmc->oartifact == ART_ADILA_S_PINNACLE) || (uarm && uarm->oartifact == ART_ALEIT_GIVESITNOT) || (uarm && uarm->oartifact == ART_STALWART_COSTUME) || (uamul && uamul->oartifact == ART_PERMANENTLY_BLACK) || (uwep && uwep->oartifact == ART_KALI_S_ORBIT) || (uarmf && uarmf->oartifact == ART_AMY_S_MISPURCHASE) || (uarmc && uarmc->oartifact == ART_BLACKER_QUIVER) || (uarmc && uarmc->oartifact == ART_ORNA_S_DOUBLE) || (uarmf && uarmf->oartifact == ART_DARKFLECT) ) return TRUE;
...
playerextrinsicdiscountaction()
{
	...
	if ( (uarmg && uarmg->oartifact == ART_INTERMINTER) || (uarmc && uarmc->oartifact == ART_GERMAN_CHANCELLOR_SAYS_) || (powerfulimplants() && uimplant && uimplant->oartifact == ART_DIDI_S_LEG_PAINTING) ) return TRUE;
...
playerextrinsicstoneres()
{
	...
	if (autismringcheck(ART_FIRMBLOCK) || (uarmf && uarmf->oartifact == ART_ANASTASIA_S_PLAYTIME) ) return TRUE;
...
playerextrinsicfreeaction()
{
	...
	if ( (powerfulimplants() && uimplant && uimplant->oartifact == ART_DIDI_S_LEG_PAINTING) || (uarmc && uarmc->oartifact == ART_GERMAN_CHANCELLOR_SAYS_) ) return TRUE;
...
playerextrinsicspeed()
{
	...
	if ( (uchain && uchain->oartifact == ART_JORMUNGANDR_S_COIL) || (uimplant && uimplant->oartifact == ART_GIULY_AH) || (uarm && uarm->oartifact == ART_MOTA_ROLA) || u.tempveryfastspeed || bmwride(ART_MARLOWE_S_CAMEL) ) return TRUE;
