...
playerwearshighheels()
{
	...
	if ((uarmf->otyp == NADJA_BUCKLED_LADY_SHOES) || (uarmf->otyp == ELENA_COMBAT_BOOTS) || (uarmf->otyp == THAI_COMBAT_BOOTS) || (uarmf->otyp == SHOCK_ISOLATED_HEELS) || (uarmf->otyp == MELTEM_COMBAT_BOOTS) || (uarmf->otyp == KATRIN_COMBAT_BOOTS) || (uarmf->otyp == STILETTO_SANDALS) || (uarmf->otyp == NATALJE_BLOCK_HEEL_SANDALS) || (uarmf->otyp == HIGH_STILETTOS) || (uarmf->otyp == HIGH_HEELED_SKIERS) || (uarmf->otyp == UNFAIR_STILETTOS) || (uarmf->otyp == COVETED_BOOTS) || (uarmf->otyp == SKY_HIGH_HEELS) || (uarmf->otyp == RED_SPELL_HEELS) || (uarmf->otyp == FIRE_BRIGADE_HEELS) || (uarmf->otyp == DESTRUCTIVE_HEELS) || (uarmf->otyp == OMEGA_HEELS) || (uarmf->otyp == LONG_POINTY_HEELS) || (uarmf->otyp == VIOLET_BEAUTY_HEELS) || (uarmf->otyp == AUTOSCOOTER_HEELS) || (uarmf->otyp == SINFUL_HEELS) || (uarmf->otyp == KILLER_HEELS) || (uarmf->otyp == HIGH_SCORING_HEELS) || (uarmf->otyp == KRISTIN_COMBAT_BOOTS) || (uarmf->otyp == RUEA_COMBAT_BOOTS)) return TRUE;
...
playerextrinsicaggravatemon()
{
	...
	if ( autismringcheck(ART_FYRYONI) || (uarmf && uarmf->oartifact == ART_JOHANETTA_S_TITLE) ) return TRUE;
...
playerextrinsicdisintres()
{
	...
	if ( (uarmf && uarmf->oartifact == ART_SOFTWOOD) ) return TRUE;
...
playerextrinsicfreeaction()
{
	...
	if ( (uwep && uwep->oartifact == ART_HEAVY_CROSSBOW_OF_ETERNITY) || (uamul && uamul->oartifact == ART_AMULET_OF_INGWE) || (uarm && uarm->oartifact == ART_VENGEANCE_OF_ETERNITY) ) return TRUE;
