...
playerextrinsicmysteryres()
{
	...
	if ( (uarmc && uarmc->oartifact == ART_SUPATECT) || (uarmf && uarmf->oartifact == ART_GNOME_QUEEN_S_SLIPPERS) || (uarmh && uarmh->oartifact == ART_PURPLE_ORC) || (uarmc && uarmc->oartifact == ART_FELL_GARB) || (uarmf && uarmf->oartifact == ART_DORIKA_S_COLORBLOCK) ) return TRUE;
