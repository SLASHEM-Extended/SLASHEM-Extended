...
playerextrinsicdeathres()
{
	...
	if ( (uarms && uarms->oartifact == ART_ANTINSTANT_DEATH) ) return TRUE;
...
playerextrinsicpsires()
{
	...
	if ( (uamul && uamul->oartifact == ART_PRECIOUS_UNOBTAINABLE_PROP) ) return TRUE;
...
playerextrinsicfreeaction()
{
	...
	if ( (uwep && uwep->oartifact == ART_HEAVY_CROSSBOW_OF_ETERNITY) || (uamul && uamul->oartifact == ART_AMULET_OF_INGWE) || (uarm && uarm->oartifact == ART_THEY_SMOKED_POT_) || (uarm && uarm->oartifact == ART_VENGEANCE_OF_ETERNITY) || (uwep && uwep->oartifact == ART_AMALGAMATED_SKIES) || (uwep && uwep->oartifact == ART_ABSURD_OVERPOWEREDNESS) || autismringcheck(ART_BUT_YOU_MUST) || autismringcheck(ART_RING_OF_STEEL_DRAGON) || (uwep && uwep->oartifact == ART_PURE_BLACK_DIABLO) || (uwep && uwep->oartifact == ART_MARC_S_WRONG_SPELL) ) return TRUE;
...
playerextrinsicfireres()
{
	...
	if ( (uwep && uwep->oartifact == ART_ELEMENTAL_STAFF) || (uwep && uwep->oartifact == ART_JADE_TALON) || (uarmu && uarmu->oartifact == ART_CRIMSON_PLATE) ) return TRUE;
...
playerextrinsiccoldres()
{
	...
	if ( (uarm && uarm->oartifact == ART_VERY_HOT_IN_HERE) || (uwep && uwep->oartifact == ART_JADE_TALON) || (uwep && uwep->oartifact == ART_ELEMENTAL_STAFF) || (uarmc && uarmc->oartifact == ART_NUTKNU_KOLAS) || (uarmf && uarmf->oartifact == ART_SARAH_S_REPLACEMENT) ) return TRUE;
