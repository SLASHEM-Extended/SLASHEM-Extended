...
#ifdef SHOW_WEIGHT
	{"invweight", &flags.invweight, FALSE},
#else
	{"invweight", (boolean *)0, FALSE},
#endif
/*WAC the keep savefile option...*/
#ifdef KEEP_SAVE
	{"keep_savefile", &flags.keep_savefile, FALSE},
#else
	{"keep_savefile", (boolean *)0, FALSE},
#endif
	...
	{"mail", (boolean *)0, TRUE},
#endif
	{"menu_on_esc", &flags.menu_on_esc, TRUE},
#ifdef NEWS
...
#ifdef SHOW_DMG
	{"showdmg", &flags.showdmg, FALSE},
#else
	{"showdmg", (boolean *)0, FALSE},
#endif
#ifdef SHOW_WEIGHT
	{"showweight", &flags.showweight, FALSE},
#else
	{"showweight", (boolean *)0, FALSE},
#endif
