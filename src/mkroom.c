...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(20)) {u.specialtensionmonster = rnd(288);
				if (!rn2(4)) u.specialtensionmonsterB = rnd(288);
			}
			break;
	    case DRAGONLAIR:
