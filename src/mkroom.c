...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(10)) {u.specialtensionmonster = rnd(371); /* monstercolor function! */
				if (!rn2(4)) u.specialtensionmonsterB = rnd(371);
			}
			break;
	    case DRAGONLAIR:
...
illusionmon()
{
	...
	switch (rnd(29)) {
		...
		case 29:
			return specialtensmon(370); break; /* AD_ILLU */
		default:
			return specialtensmon(288); break; /* AD_SPC2 */
	}
