...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(10)) {u.specialtensionmonster = rnd(338);
				if (!rn2(4)) u.specialtensionmonsterB = rnd(338);
			}
			break;
	    case DRAGONLAIR:
