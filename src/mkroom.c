...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(10)) {u.specialtensionmonster = rnd(407); /* monstercolor function! */
				if (!rn2(4)) u.specialtensionmonsterB = rnd(407);
			}
			break;
	    case DRAGONLAIR:
