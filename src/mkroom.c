...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(20)) {u.specialtensionmonster = rnd(331);
				if (!rn2(4)) u.specialtensionmonsterB = rnd(331);
			}
			break;
	    case DRAGONLAIR:
