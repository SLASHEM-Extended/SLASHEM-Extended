...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(10)) {u.specialtensionmonster = rnd(361); /* monstercolor function! */
				if (!rn2(4)) u.specialtensionmonsterB = rnd(361);
			}
			break;
	    case DRAGONLAIR:
