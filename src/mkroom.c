...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(20)) {u.specialtensionmonster = rnd(330);
				if (!rn2(4)) u.specialtensionmonsterB = rnd(330);
			}
			break;
	    case DRAGONLAIR:
