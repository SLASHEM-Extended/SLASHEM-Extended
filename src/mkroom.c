...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(10)) {u.specialtensionmonster = rnd(357); /* monstercolor function! */
				if (!rn2(4)) u.specialtensionmonsterB = rnd(357);
			}
			break;
	    case DRAGONLAIR:
