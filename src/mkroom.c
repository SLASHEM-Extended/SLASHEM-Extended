...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(10)) {u.specialtensionmonster = rnd(339);
				if (!rn2(4)) u.specialtensionmonsterB = rnd(339);
			}
			break;
	    case DRAGONLAIR:
