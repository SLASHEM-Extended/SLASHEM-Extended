...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(10)) {u.specialtensionmonster = rnd(372); /* monstercolor function! */
				if (!rn2(4)) u.specialtensionmonsterB = rnd(372);
			}
			break;
	    case DRAGONLAIR:
