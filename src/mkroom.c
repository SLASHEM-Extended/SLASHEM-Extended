...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(10)) {u.specialtensionmonster = rnd(346); /* monstercolor function! */
				if (!rn2(4)) u.specialtensionmonsterB = rnd(346);
			}
			break;
	    case DRAGONLAIR:
