...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(20)) {u.specialtensionmonster = rnd(332);
				if (!rn2(4)) u.specialtensionmonsterB = rnd(332);
			}
			break;
	    case DRAGONLAIR:
