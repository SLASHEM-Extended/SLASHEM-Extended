...
struct mkroom *sroom;
{
	...
	switch(type) {
		...
		case TENSHALL:
			...
			if (!rn2(20)) {u.specialtensionmonster = rnd(298);
				if (!rn2(4)) u.specialtensionmonsterB = rnd(298);
			}
			break;
	    case DRAGONLAIR:
