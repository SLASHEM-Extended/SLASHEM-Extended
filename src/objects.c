...
CLOAK("dwarvish cloak", "hooded cloak",
		0, 0,	0,	   28, 0, 4, 50, 10, 2, CLOTH, HI_CLOTH),
...
GEM("worthless piece of orange glass", "orange", 176, 0, 0, 6, 6, 6, 5, GLASS, CLR_ORANGE),
GEM("worthless piece of yellow glass", "yellow", 176, 0, 0, 6, 6, 6, 5, GLASS, CLR_YELLOW),
GEM("worthless piece of black glass",  "black",  176, 0, 0, 6, 6, 6, 5, GLASS, CLR_BLACK),
