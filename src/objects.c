...
ARMOR("chain mail", (char *)0,
	1, 0, 0, 0,	340, 5, 120,  75,  4, 1, ARM_SUIT, IRON, HI_METAL),
...
AMULET("amulet versus poison",    "pyramidal",  POISON_RES, 499, GEMSTONE,	CLR_BRIGHT_CYAN),
...
SPELL("identify",        "bronze",      P_DIVINATION_SPELL, 140,  8, 5, 1, NODIR,     HI_COPPER),
...
WAND("healing",        "bamboo",   240, 500, 1, IMMEDIATE, WOOD,     CLR_YELLOW),
