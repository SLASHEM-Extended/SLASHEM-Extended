...
CLOAK("heavy status cloak", "phantom cloak",
		0, 1,	STATUS_FAILURE,  1, 0, 4, 50,  2, 3, WAX, CLR_GRAY),
...
CLOAK("yellow spell cloak", "petrified cloak",
		0, 1,	YELLOW_SPELLS,  1, 0, 4, 50,  0, 3, MINERAL, CLR_BLACK),
CLOAK("vulnerability cloak", "flax cloak",
		0, 1,	REPEATING_VULNERABILITY,  1, 0, 4, 50,  8, 3, PAPER, CLR_WHITE),
CLOAK("cloak of inventorylessness", "glass cloak",
		0, 1,	INVENTORY_LOST,  1, 0, 4, 50,  -5, 3, GLASS, CLR_CYAN),
...
HELM("helm of lose identification", "conical hat", 
		0, 1, UNIDENTIFY,		1, 1, 20,  50, 7, 3, CLOTH, CLR_BRIGHT_BLUE),
...
HELM("blacky helmet", "middle-earth helmet", 
		0, 1, BLACK_NG_WALLS,	1, 1, 20,  50, 0, 3, METAL, CLR_GREEN),
...
HELM("out of memory helmet", "masked helmet", 
		0, 1, MEMORY_LOST,	1, 1, 20,  50, 0, 3, LEATHER, CLR_WHITE),
...
GLOVES("unwieldy gloves", "graffiti gloves",
		0, 1,  FREE_HAND_LOST,	1, 1, 4, 50,  5, 3, LIQUID, CLR_BRIGHT_GREEN),
...
GLOVES("undroppable gloves", "concrete gloves",
		0, 1,  DROP_BUG,	1, 1, 4, 50,  7, 3, MINERAL, CLR_GRAY),
GLOVES("gloves of missing information", "nondescript gloves",
		0, 1,  UNINFORMATION,	1, 1, 4, 50,  4, 3, WOOD, CLR_WHITE),
...
BOOTS("sentient high-heeled shoes", "irregular boots",
		0, 1,  SENTIENT_HIGH_HEELS,  1, 2, 8, 50,  2, 3, WAX, CLR_BRIGHT_CYAN),
...
BOOTS("gridbug conduct boots", "chess boots",
		0, 1,  BISHOP_GRIDBUG,  1, 2, 8, 50,  1, 3, MINERAL, CLR_WHITE),
BOOTS("stairwell stomping boots", "plateau boots",
		0, 1,  STAIRSTRAP,  1, 2, 8, 50,  3, 3, METAL, CLR_BLACK),
