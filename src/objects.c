...
WEAPON("spear", (char *)0,
	1, 1, 0, 129, 12,  3,  6,  8, 0, P,   P_SPEAR, IRON, HI_METAL),
...
ARMOR("plate mail", (char *)0,
	1, 0, 1, 0,	210, 5, 200, 600,  0, 2, ARM_SUIT, IRON, HI_METAL),
#ifdef JEDI
...
ARMOR("chain mail", (char *)0,
	1, 0, 0, 0,	360, 5, 120,  75,  4, 1, ARM_SUIT, IRON, HI_METAL),
...
HELM("orcish helm", "iron skull cap",
		0, 0, 0,			18, 1, 12,  10, 9, 0, IRON, CLR_BLACK),
