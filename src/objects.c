...
ARMOR("plate mail", (char *)0,
	1, 0, 1, 0,	180, 5, 200, 600,  0, 2, ARM_SUIT, IRON, HI_METAL),
...
ARMOR("scale mail", (char *)0,
	1, 0, 0, 0,	285, 5, 100,  45,  5, 0, ARM_SUIT, IRON, HI_METAL),
ARMOR("studded leather armor", (char *)0,
	1, 0, 0, 0,	344, 3, 80,  15,  7, 1, ARM_SUIT, LEATHER, HI_LEATHER),
ARMOR("ring mail", (char *)0,
	1, 0, 0, 0,	305, 5, 100, 100,  6, 0, ARM_SUIT, IRON, HI_METAL),
ARMOR("orcish ring mail", "crude ring mail",
	0, 0, 0, 0,	100, 5, 100,  80,  7, 1, ARM_SUIT, IRON, CLR_BLACK),
ARMOR("leather armor", (char *)0,
	1, 0, 0, 0,	320, 3, 60,   5,  8, 0, ARM_SUIT, LEATHER, HI_LEATHER),
...
RING("teleportation", TELEPORT, "silver",   300, 161, 1, 0, 3, SILVER, HI_SILVER),
...
RING("polymorph", POLYMORPH, "ivory",       300, 160, 1, 0, 4, BONE, CLR_WHITE),
...
AMULET("amulet of change",        "square",     0,          543,	IRON,	CLR_BLACK),
...
AMULET("amulet of restful sleep", "triangular", SLEEPING,   491, GEMSTONE,	CLR_MAGENTA),
...
AMULET("amulet versus poison",    "pyramidal",  POISON_RES, 484, GEMSTONE,	CLR_BRIGHT_CYAN),
...
GEM("worthless piece of white glass", "white",   171, 0, 0, 6, 6, 6, 5, GLASS, CLR_WHITE),
GEM("worthless piece of blue glass", "blue",     171, 0, 0, 6, 6, 6, 5, GLASS, CLR_BRIGHT_BLUE),
GEM("worthless piece of red glass", "red",       172, 0, 0, 6, 6, 6, 5, GLASS, CLR_RED),
GEM("worthless piece of yellowish brown glass", "yellowish brown",
												 172, 0, 0, 6, 6, 6, 5, GLASS, CLR_BROWN),
GEM("worthless piece of orange glass", "orange", 172, 0, 0, 6, 6, 6, 5, GLASS, CLR_ORANGE),
GEM("worthless piece of yellow glass", "yellow", 172, 0, 0, 6, 6, 6, 5, GLASS, CLR_YELLOW),
GEM("worthless piece of black glass",  "black",  172, 0, 0, 6, 6, 6, 5, GLASS, CLR_BLACK),
GEM("worthless piece of pink glass",  "pink",  171, 0, 0, 6, 6, 6, 5, GLASS, CLR_BRIGHT_MAGENTA),
GEM("worthless piece of cyan glass",  "cyan",  171, 0, 0, 6, 6, 6, 5, GLASS, CLR_CYAN),
GEM("worthless piece of teal glass",  "teal",  171, 0, 0, 6, 6, 6, 5, GLASS, CLR_BRIGHT_CYAN),
GEM("worthless piece of green glass", "green",   171, 0, 0, 6, 6, 6, 5, GLASS, CLR_GREEN),
GEM("worthless piece of radiant glass", "radiant",   171, 0, 0, 6, 6, 6, 5, GLASS, CLR_BRIGHT_GREEN),
GEM("worthless piece of violet glass", "violet", 171, 0, 0, 6, 6, 6, 5, GLASS, CLR_MAGENTA),
