...
ARMOR("chain mail", (char *)0,
	1, 0, 0, 0,	320, 5, 120,  75,  4, 1, ARM_SUIT, IRON, HI_METAL),
...
AMULET("amulet of restful sleep", "triangular", SLEEPING,   487, GEMSTONE,	CLR_MAGENTA),
