...
CLOAK("dwarvish cloak", "hooded cloak",
		0, 0,	0,	   40, 0, 4, 50, 10, 2, CLOTH, HI_CLOTH),
...
HELM("helmet", "plumed helmet",
		0, 0, 0,		   40, 1, 20,  50, 9, 0, IRON, HI_METAL),
HELM("helm of brilliance", "etched helmet",
		0, 1, 0,			30, 1, 20,  50, 9, 0, IRON, CLR_GREEN),
HELM("helm of opposite alignment", "crested helmet",
		0, 1, 0,			25, 1, 20,  50, 9, 0, IRON, HI_METAL),
...
GLOVES("leather gloves", "old gloves",
		0, 0,  0,			75, 1, 4,  50,  9, 0, LEATHER, HI_LEATHER),
...
BOOTS("low boots", "walking shoes",
		0, 0,  0,	  90, 2, 4,  8,  9, 0, LEATHER, HI_LEATHER),
...
RING("adornment", ADORNED, "wooden",        300, 115, 1, 1, 2, WOOD, HI_WOOD),
...
POTION("booze", "brown",                0, 0,          150, 300, CLR_BROWN),
POTION("fruit juice", "dark",           0, 0,          175, 300, CLR_BLACK),
...
POTION("object detection", "smoky",     1, 0,          190, 300, CLR_GRAY),
...
/* Attack */
SCROLL("create monster",        "LEP GEX VEN ZEA",      P_ATTACK_SPELL, 1, 125, 300, CLR_RED),
...
/* Healing spells */
SPELL("stone to flesh",	 "thick",       P_HEALING_SPELL, 75,  1, 3, 1, IMMEDIATE, HI_PAPER),
SPELL("healing",         "white",       P_HEALING_SPELL, 125,  2, 1, 1, IMMEDIATE, CLR_WHITE),
SPELL("cure blindness",  "yellow",      P_HEALING_SPELL, 100,  2, 2, 1, IMMEDIATE, CLR_YELLOW),
SPELL("cure sickness",   "indigo",      P_HEALING_SPELL, 100,  3, 3, 1, NODIR,     CLR_BRIGHT_BLUE),
SPELL("cure hallucination", "glowing",  P_HEALING_SPELL, 75,  3, 3, 1, NODIR,     CLR_YELLOW),
SPELL("cure confusion",   "moldy",      P_HEALING_SPELL, 75,  3, 3, 1, NODIR,     CLR_BROWN),
SPELL("cure stun",   "fat",      	    P_HEALING_SPELL, 75,  3, 3, 1, NODIR,     CLR_BRIGHT_MAGENTA),
SPELL("extra healing",   "plaid",       P_HEALING_SPELL, 75,  5, 3, 1, IMMEDIATE, CLR_GREEN),
...
SPELL("remove curse",    "wrinkled",    P_PROTECTION_SPELL, 125,  5, 5, 1, NODIR,     HI_PAPER),
...
SPELL("invisibility",    "dark brown",  P_BODY_SPELL, 50,  5, 4, 1, NODIR,     CLR_BROWN),
...
/* Matter spells */
SPELL("knock",           "pink",        P_MATTER_SPELL, 125,  1, 1, 1, IMMEDIATE, CLR_BRIGHT_MAGENTA),
...
SPELL("wizard lock",     "dark green",  P_MATTER_SPELL, 125,  3, 2, 1, IMMEDIATE, CLR_GREEN),
...
SPELL("repair armor",	 "pergament",   P_MATTER_SPELL, 25,  6, 3, 1, IMMEDIATE, HI_PAPER),
...
WAND("light",          "glass",    175, 500, 1, NODIR,     GLASS,    HI_GLASS),
...
WAND("opening",        "zinc",     125, 500, 1, IMMEDIATE, METAL,    HI_METAL),
...
WAND("speed monster",  "brass",   175, 500, 1, IMMEDIATE, COPPER,   HI_COPPER),
WAND("haste monster",  "royal",    25, 500, 1, IMMEDIATE, GOLD,   CLR_ORANGE),
WAND("striking",       "ebony",   300, 500, 1, IMMEDIATE, WOOD,     HI_WOOD),
WAND("undead turning", "copper",  225, 500, 1, IMMEDIATE, COPPER,   HI_COPPER),
WAND("draining",       "ceramic", 125, 500, 1, IMMEDIATE, MINERAL,  HI_MINERAL),
...
WAND("polymorph",      "silver",   225, 500, 1, IMMEDIATE, SILVER,   HI_SILVER),
...
ROCK("loadstone", "gray",	0, 60, 1200,  60, 40, 40, 1, 1200, 6, MINERAL, CLR_GRAY),
