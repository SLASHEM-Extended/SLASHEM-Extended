...
/* Axes */
WEAPON("axe", (char *)0,
	1, 0, 0, 170, 24,  8,  8,  4, 0, S,   P_AXE, IRON, HI_METAL),
...
WEAPON("long sword", (char *)0,
	1, 0, 0, 200, 16, 15,  8, 12, 0, S,   P_LONG_SWORD, IRON, HI_METAL),
...
WEAPON("two-handed sword", (char *)0,
	1, 0, 1, 122,60, 50, 18,  9, 0, S,   P_TWO_HANDED_SWORD, IRON, HI_METAL),
	/* +2d6 large */
...
WEAPON("war hammer", (char *)0,
	1, 0, 0, 110, 20,  5,  7,  7, 0, B,   P_HAMMER, IRON, HI_METAL),
	/* +1 small */
...
WEAPON("quarterstaff", "staff",
	0, 0, 1, 58, 16,  5,  9,  9, 0, B,   P_QUARTERSTAFF, WOOD, HI_WOOD),
...
WEAPON("spear", (char *)0,
	1, 1, 0, 121, 12,  3,  6,  8, 0, P,   P_SPEAR, IRON, HI_METAL),
WEAPON("droven spear", "long obsidian spear",
	0, 1, 1,  1, 12,  3, 12, 12, 2, P,   P_SPEAR, GLASS, CLR_BLACK),
...
WEAPON("trident", (char *)0,
	1, 0, 0,  59, 10,  5,  6,  4, 1, P,   P_TRIDENT, IRON, HI_METAL),
	/* +1 small, +2d4 large */
...
WEAPON("droven lance", "obsidian lance",
	0, 0, 1,  1,100, 10, 15, 15, 2, P,   P_LANCE, GLASS, CLR_BLACK),
...
GUN("crossbow", (char *)0,				0, 1, 195, 20, 40, 12, -1, 1, WP_GENERIC, WOOD, P_CROSSBOW, HI_WOOD),
...
/* (also weptoool spoon) */
WEAPON("dart", (char *)0,
	1, 1, 0, 260,  0,  4,  5,  2, 0, P,   -P_DART, IRON, HI_METAL),
WEAPON("spike", (char *)0,
...
ARMOR("Hawaiian shirt", (char *)0,
	1, 0, 0, 0,	29, 0,	 2,   3, 10, 0, ARM_SHIRT, CLOTH, CLR_MAGENTA),
...
ARMOR("splint mail", (char *)0,
	1, 0, 1, 0,	330, 5, 160,  80,  2, 1, ARM_SUIT, IRON, HI_METAL),
ARMOR("banded mail", (char *)0,
	1, 0, 1, 0,	330, 5, 160,  90,  3, 0, ARM_SUIT, IRON, HI_METAL),
...
ARMOR("chain mail", (char *)0,
	1, 0, 0, 0,	359, 5, 120,  75,  4, 1, ARM_SUIT, IRON, HI_METAL),
...
CLOAK("orcish cloak", "coarse mantelet",
		0, 0,	0,	   28, 0, 4, 40, 10, 2, CLOTH, CLR_BLACK),
CLOAK("dwarvish cloak", "hooded cloak",
		0, 0,	0,	   27, 0, 4, 50, 10, 2, CLOTH, HI_CLOTH),
...
HELM("helm of lose identification", "conical hat", 
		0, 1, UNIDENTIFY,		1, 1, 20,  50, 7, 5, CLOTH, CLR_BRIGHT_BLUE),
...
HELM("helmet", "plumed helmet",
		0, 0, 0,		   24, 1, 20,  50, 9, 0, IRON, HI_METAL),
...
SHIELD("small shield", (char *)0,
		1, 0, 0, 0,	     25, 0, 12,	3,  6, 0, WOOD, HI_WOOD),
...
BOOTS("low boots", "walking shoes",
		0, 0,  0,	  78, 2, 4,  8,  9, 0, LEATHER, HI_LEATHER),
...
BOOTS("high boots", "jackboots",
		0, 0,  0,	  52, 2, 8, 12,  8, 0, LEATHER, HI_LEATHER),
...
AMULET("amulet of strangulation", "oval",       STRANGLED, 445, PLASTIC,	CLR_BRIGHT_MAGENTA),
...
SCROLL("identify",              "KERNOD WEL",           P_DIVINATION_SPELL, 1, 940, 300, CLR_GREEN),
...
WAND("light",          "glass",    145, 500, 1, NODIR,     GLASS,    HI_GLASS),
...
GEM("jade", "green",                   10,/*326*/ 0,  300, 15, 15, 15,  6, GEMSTONE, CLR_GREEN),
GEM("worthless piece of white glass", "white",   173, 0, 0, 6, 6, 6, 5, GLASS, CLR_WHITE),
GEM("worthless piece of blue glass", "blue",     173, 0, 0, 6, 6, 6, 5, GLASS, CLR_BRIGHT_BLUE),
GEM("worthless piece of red glass", "red",       173, 0, 0, 6, 6, 6, 5, GLASS, CLR_RED),
GEM("worthless piece of yellowish brown glass", "yellowish brown",
												 174, 0, 0, 6, 6, 6, 5, GLASS, CLR_BROWN),
GEM("worthless piece of orange glass", "orange", 173, 0, 0, 6, 6, 6, 5, GLASS, CLR_ORANGE),
GEM("worthless piece of yellow glass", "yellow", 173, 0, 0, 6, 6, 6, 5, GLASS, CLR_YELLOW),
...
GEM("worthless piece of green glass", "green",   172, 0, 0, 6, 6, 6, 5, GLASS, CLR_GREEN),
GEM("worthless piece of radiant glass", "radiant",   173, 0, 0, 6, 6, 6, 5, GLASS, CLR_BRIGHT_GREEN),
GEM("worthless piece of violet glass", "violet", 173, 0, 0, 6, 6, 6, 5, GLASS, CLR_MAGENTA),
