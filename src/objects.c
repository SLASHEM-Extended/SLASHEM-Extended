...
BOW("bow", (char *)0,			1, 1, 23, 12, 60, 0, WOOD, P_BOW, HI_WOOD),
...
BOW("droven bow", "spider-legged bow",	1, 0, 1, 12, 60, 5, GLASS, P_BOW, CLR_BLACK),
PROJECTILE("orcish arrow", "crude arrow",
	0, 15, 0, 2, 6, 6, 0, IRON, -P_BOW, CLR_BLACK),
PROJECTILE("arrow", (char *)0,
	1, 47, 0, 2, 7, 7, 0, IRON, -P_BOW, HI_METAL),
...
PROJECTILE("droven arrow", "obsidian arrow",
	0, 1, 0, 6, 15, 15, 3, GLASS, -P_BOW, CLR_BLACK),
...
GUN("heavy machine gun", (char *)0,1,  1, 1, 200, 2000, 14,  8, 0, WP_BULLET, IRON, P_FIREARM, HI_METAL),
GUN("rifle", (char *)0,		   1,  1, 1,  12,  150, 25, -1,  5, WP_BULLET, IRON, P_FIREARM, HI_METAL),
GUN("assault rifle", (char *)0,	   1,  0, 1,  16, 1000, 12,  5, 2, WP_BULLET, IRON, P_FIREARM, HI_METAL),
GUN("sniper rifle", (char *)0,	   1,  1, 1,  20, 4000, 35, -3,  8, WP_BULLET, IRON, P_FIREARM, HI_METAL),
...
GUN("crossbow", (char *)0,				0, 1, 40, 20, 40, 12, -1, 1, WP_GENERIC, WOOD, P_CROSSBOW, HI_WOOD),
GUN("droven crossbow", "spider-legged crossbow", 0, 0, 5, 30, 120, 12, -1, 5, WP_GENERIC, GLASS, P_CROSSBOW, CLR_BLACK), 
PROJECTILE("crossbow bolt", (char *)0,
	1, 37, 0, 2, 14, 14, 1, IRON, -P_CROSSBOW, HI_METAL),
PROJECTILE("droven bolt", "obsidian bolt",
	0, 1, 1, 2, 24, 24, 2, GLASS, -P_CROSSBOW, CLR_BLACK), 
...
ARMOR("banded mail", (char *)0,
	1, 0, 1, 0,	66, 5, 160,  90,  4, 0, ARM_SUIT, IRON, HI_METAL),
...
ARMOR("leather armor", (char *)0,
	1, 0, 0, 0,	73, 3, 60,   5,  8, 0, ARM_SUIT, LEATHER, HI_LEATHER),
...
CLOAK("orcish cloak", "coarse mantelet",
		0, 0,	0,	    5, 0, 4, 40, 10, 2, CLOTH, CLR_BLACK),
...
CLOAK("cloak of confusion", "ripped cloak",
		0, 1,	CONFUSION,  1, 0, 4, 50,  6, 3, LEATHER, CLR_BLACK),
...
HELM("helmet", "plumed helmet",
		0, 0, 0,		   7, 1, 20,  50, 9, 0, IRON, HI_METAL),
...
HELM("helm of discovery", "viking helmet", 
		0, 1, SEARCHING,	1, 1, 20,  50, 9, 0, IRON, HI_METAL),
...
SHIELD("flame shield", "dark red shield",
		0, 1, 0, FIRE_RES,	 1, 0, 20, 300, 8, 0, IRON, CLR_RED),
SHIELD("ice shield", "dark blue shield",
		0, 1, 0, COLD_RES,	 1, 0, 20, 300, 8, 0, IRON, CLR_BRIGHT_BLUE),
SHIELD("lightning shield", "dull yellow shield",
		0, 1, 0, SHOCK_RES,	 1, 0, 20, 300, 8, 0, IRON, CLR_YELLOW),
SHIELD("venom shield", "dark green shield",
		0, 1, 0, POISON_RES,	 1, 0, 20, 300, 8, 0, IRON, CLR_GREEN),
SHIELD("shield of light", "shiny shield",
		0, 1, 0, INFRAVISION,	 1, 0, 20, 300, 8, 0, IRON, CLR_YELLOW),
SHIELD("shield of mobility", "slippery shield",
		0, 1, 0, FREE_ACTION, 1, 0, 20, 300, 9, 0, IRON, HI_METAL),
...
BOOTS("high boots", "jackboots",
		0, 0,  0,	  12, 2, 8, 12,  8, 0, LEATHER, HI_LEATHER),
...
BOOTS("boots of molasses", "thigh boots",
		0, 1,  FROZEN,	  1, 2, 8, 50, 9, 0, LEATHER, CLR_BLACK),
...
BOOTS("elven boots", "mud boots",
		0, 1,  STEALTH,   12, 2, 8,  50,  9, 0, LEATHER, HI_LEATHER),
BOOTS("kicking boots", "steel boots",
		0, 1,  0,         12, 2, 8,  50,  9, 0, IRON, CLR_BROWN),
...
BOOTS("levitation boots", "snow boots",
		0, 1,  LEVITATION,12, 2, 8, 50,  9, 0, LEATHER, HI_LEATHER),
...
RING("numbness",  NUMBED,  "constricting", 300,  5, 1, 0, 1, METAL, CLR_CYAN),
RING("mood",       0,          "ridged",    300, 23, 1, 0, 8, IRON, HI_METAL),
...
RING("fear resistance", FEAR_RES, "branching",  300, 5, 1, 0, 1, WOOD, CLR_GREEN),
RING("gain constitution", 0,   "opal",      300, 28, 1, 1, 7, MINERAL,  HI_MINERAL),
...
AMULET("amulet versus poison",    "pyramidal",  POISON_RES, 100, GEMSTONE,	CLR_BRIGHT_CYAN),
...
AMULET("amulet of power",			 "bloody",		ENERGY_REGENERATION,  5, FLESH, CLR_RED),
...
TOOL("switcher", (char *)0, 1, 0, 1, 0,  1,  0,  2000, METAL, CLR_BRIGHT_GREEN),
...
FOOD("lemon",               10, 1,  0, 0, VEGGY, 200, CLR_YELLOW),
...
FOOD("fortune cookie",      65, 1,  0, 0, VEGGY,  40, CLR_YELLOW),
FOOD("pancake",             13, 2,  0, 0, VEGGY, 200, CLR_YELLOW),
FOOD("tortilla",             1, 2,  0, 0, VEGGY,  80, CLR_WHITE),
/* special "food" by Amy */
FOOD("ugh memory to create inventory window",             1, 1,  0, 0, VEGGY,  0, CLR_WHITE),
...
POTION("fruit juice", "dark",           0, 0,          35, 300, CLR_BLACK),
POTION("see invisible", "magenta",      1, SEE_INVIS,  33, 300, CLR_MAGENTA),
POTION("sickness", "fizzy",             0, 0,          25, 300, CLR_CYAN),
POTION("sleeping",  "effervescent",     1, 0,          20, 300, CLR_GRAY),
POTION("clairvoyance","luminescent",    1, 0,          20, 300, CLR_WHITE),
POTION("confusion", "orange",           1, CONFUSION,  30, 300, CLR_ORANGE),
POTION("hallucination", "sky blue",     1, HALLUC,     25, 300, CLR_CYAN),
...
POTION("ice", "ice-cold",  		    1, 0,           5, 300, CLR_BRIGHT_CYAN),
POTION("fire", "simmering",  		    1, 0,           5, 300, CLR_ORANGE),
POTION("fear", "bewitched",  		    1, 0,           5, 300, CLR_MAGENTA),
POTION("stunning", "viscous",     	    1, 0,           5, 300, CLR_RED),
POTION("numbness", "flowing",		    1, 0,           5, 300, CLR_ORANGE),
POTION("invisibility", "brilliant blue",1, INVIS,      35, 300, CLR_BRIGHT_BLUE),
...
POTION("salt water",	"polka-dot",    0, 0,		  5, 300, CLR_RED),
...
/* Attack */
SCROLL("create monster",        "LEP GEX VEN ZEA",      P_ATTACK_SPELL, 1,  25, 300, CLR_RED),
...
/* Divination */
SCROLL("light",                 "VERR YED HORRE",       P_DIVINATION_SPELL, 1,  15, 300, CLR_BLACK),
...
SCROLL("amnesia",               "DUAM XNAHT",           P_NONE, 1,  5, 300, CLR_BRIGHT_BLUE),
SCROLL("bad effect",               "LITTLE STRAWBERRY ME BABY",           P_NONE, 1,  5, 300, CLR_ORANGE),
...
SCROLL("trap disarming",               "CHRISTIAN GREY KILLED ALL HIS SUBS",    P_NONE, 1,   5, 300, CLR_BRIGHT_MAGENTA),
...
SPELL("detect monsters", "leather",     P_DIVINATION_SPELL, 15,  5, 4, 1, NODIR,     HI_LEATHER),
...
SPELL("godmode",        "heavenly",   P_PROTECTION_SPELL, 5,  10, 8, 1, NODIR,     CLR_BRIGHT_CYAN),
...
SPELL("magic missile",   "vellum",      P_ATTACK_SPELL, 40,  4, 3, 1, RAY,       HI_PAPER),
...
SPELL("sleep",           "mottled",     P_ENCHANTMENT_SPELL, 35,  3, 2, 1, RAY,  HI_PAPER),
...
WAND("secret door detection", "balsa",
                                   15, 500, 1, NODIR,     WOOD,     HI_WOOD),
WAND("trap disarming", "elysium",
                                    5, 500, 1, NODIR,     GOLD,     CLR_YELLOW),
...
WAND("create monster", "maple",    25, 500, 1, NODIR,     WOOD,     HI_WOOD),
WAND("bad effect", "pebble",     5, 500, 1, NODIR,     MINERAL,     CLR_ORANGE),
...
GEM("diamond", "white",                1,  0, 4000, 15, 10, GEMSTONE, CLR_WHITE),
GEM("ruby", "red",                     2,  0, 3500, 15,  9, GEMSTONE, CLR_RED),
GEM("jacinth", "orange",               2,  0, 3250, 15,  9, GEMSTONE, CLR_ORANGE),
GEM("sapphire", "blue",                2,  0, 3000, 15,  9, GEMSTONE, CLR_BRIGHT_BLUE),
GEM("black opal", "black",             2,  0, 2500, 15,  8, GEMSTONE, CLR_BLACK),
GEM("emerald", "green",                2,  0, 2500, 15,  8, GEMSTONE, CLR_GREEN),
GEM("turquoise", "green",              2,  0, 2000, 15,  6, GEMSTONE, CLR_GREEN),
GEM("citrine", "yellow",               3,  0, 1500, 15,  6, GEMSTONE, CLR_YELLOW),
GEM("aquamarine", "green",             3,  0, 1500, 15,  8, GEMSTONE, CLR_GREEN),
GEM("amber", "yellowish brown",        3,  0, 1000, 15,  2, GEMSTONE, CLR_BROWN),
GEM("topaz", "yellowish brown",        4,  0,  900, 15,  8, GEMSTONE, CLR_BROWN),
GEM("jet", "black",                    4,  0,  850, 15,  7, GEMSTONE, CLR_BLACK),
GEM("opal", "white",                   4,  0,  800, 15,  6, GEMSTONE, CLR_WHITE),
GEM("chrysoberyl", "yellow",           4,  0,  700, 15,  5, GEMSTONE, CLR_YELLOW),
GEM("garnet", "red",                   4,  0,  700, 15,  7, GEMSTONE, CLR_RED),
GEM("amethyst", "violet",              5,  0,  600, 15,  7, GEMSTONE, CLR_MAGENTA),
GEM("jasper", "red",                   5,  0,  500, 15,  7, GEMSTONE, CLR_RED),
GEM("fluorite", "violet",              5,  0,  400, 15,  4, GEMSTONE, CLR_MAGENTA),
GEM("obsidian", "black",               5,  0,  200, 15,  6, GEMSTONE, CLR_BLACK),
GEM("agate", "orange",                 5,  0,  200, 15,  6, GEMSTONE, CLR_ORANGE),
GEM("jade", "green",                   5,  0,  300, 15,  6, GEMSTONE, CLR_GREEN),
GEM("worthless piece of white glass", "white",   53, 0, 0, 6, 5, GLASS, CLR_WHITE),
GEM("worthless piece of blue glass", "blue",     53, 0, 0, 6, 5, GLASS, CLR_BRIGHT_BLUE),
GEM("worthless piece of red glass", "red",       53, 0, 0, 6, 5, GLASS, CLR_RED),
GEM("worthless piece of yellowish brown glass", "yellowish brown",
												 56, 0, 0, 6, 5, GLASS, CLR_BROWN),
GEM("worthless piece of orange glass", "orange", 53, 0, 0, 6, 5, GLASS, CLR_ORANGE),
GEM("worthless piece of yellow glass", "yellow", 53, 0, 0, 6, 5, GLASS, CLR_YELLOW),
GEM("worthless piece of black glass",  "black",  53, 0, 0, 6, 5, GLASS, CLR_BLACK),
GEM("worthless piece of green glass", "green",   53, 0, 0, 6, 5, GLASS, CLR_GREEN),
GEM("worthless piece of violet glass", "violet", 53, 0, 0, 6, 5, GLASS, CLR_MAGENTA),
...
ROCK("salt chunk", "gray",    0,  5,  0, 60, 17, 17, 0, 10, 2, MINERAL, CLR_GRAY),
ROCK("whetstone", "gray",	0,  2,  0, 60, 15, 15, 1, 10, 7, MINERAL, CLR_GRAY),
ROCK("flint", "gray",		0, 10,  0, 60, 20, 20, 0, 10, 7, MINERAL, CLR_GRAY),
ROCK("rock", (char *)0,		1,400,  0,  0, 10, 10, 0, 10, 7, MINERAL, CLR_GRAY),
#undef GEM
#undef ROCK
