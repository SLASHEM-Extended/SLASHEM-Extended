...
WEAPON("two-handed sword", (char *)0,
	1, 0, 1, 124,60, 50, 18,  9, 0, S,   P_TWO_HANDED_SWORD, IRON, HI_METAL),
	/* +2d6 large */
...
WEAPON("silver mace", (char *)0,
	...
	/* STEPHEN WHITE'S NEW CODE */
WEAPON("mace", (char *)0,
	1, 0, 0, 160, 12,  5,  6,  7, 0, B,   P_MACE, IRON, HI_METAL),
	/* +1 small */
...
WEAPON("spear", (char *)0,
	1, 1, 0, 126, 12,  3,  6,  8, 0, P,   P_SPEAR, IRON, HI_METAL),
...
ARMOR("leather armor", (char *)0,
	1, 0, 0, 0,	332, 3, 60,   5,  8, 0, ARM_SUIT, LEATHER, HI_LEATHER),
...
CLOAK("leather cloak", (char *)0,
		1, 0,	0,	   33, 0, 7, 40,  9, 1, LEATHER, CLR_BROWN),
...
HELM("helmet", "plumed helmet",
		0, 0, 0,		   28, 1, 20,  50, 9, 0, IRON, HI_METAL),
...
GLOVES("leather gloves", "old gloves",
		0, 0,  0,			50, 1, 4,  50,  9, 0, LEATHER, HI_LEATHER),
...
SHIELD("large shield", (char *)0,
		1, 0, 1, 0,	     25, 0,40, 10,  5, 2, IRON, HI_METAL),
...
BOOTS("low boots", "walking shoes",
		0, 0,  0,	  79, 2, 4,  8,  9, 0, LEATHER, HI_LEATHER),
...
AMULET("amulet of restful sleep", "triangular", SLEEPING,   498, GEMSTONE,	CLR_MAGENTA),
...
SCROLL("identify",              "KERNOD WEL",           P_DIVINATION_SPELL, 1, 950, 300, CLR_GREEN),
...
GEM("wonder stone", "violet",         1,/*2*/  0, 5000, 62, 62, 15, 13, GEMSTONE, CLR_MAGENTA),
GEM("diamond", "white",                2,/*4*/  0, 4000, 52, 52, 15, 10, GEMSTONE, CLR_WHITE),
GEM("cirmocline", "pink",              2,/*6*/  0, 4000, 52, 52, 15, 11, GEMSTONE, CLR_BRIGHT_MAGENTA),
GEM("ruby", "red",                     3,  0, 3500, 47, 47, 15,  9, GEMSTONE, CLR_RED),
GEM("jacinth", "orange",               3,  0, 3250, 44, 44, 15,  9, GEMSTONE, CLR_ORANGE),
GEM("sapphire", "blue",                3,/*15*/  0, 3000, 42, 42, 15,  9, GEMSTONE, CLR_BRIGHT_BLUE),
...
GEM("orthoclase", "yellow",            4,/*39*/  0, 2000, 32, 32, 15,  6, GEMSTONE, CLR_YELLOW),
...
GEM("sodalith", "blue",                5,/*79*/  0, 1000, 22, 22, 15,  6, GEMSTONE, CLR_BRIGHT_BLUE),
...
GEM("malachite", "green",              6,/*127*/  0,  800, 20, 20, 15,  4, GEMSTONE, CLR_GREEN),
...
GEM("garnet", "red",                   7,/*155*/  0,  700, 19, 19, 15,  7, GEMSTONE, CLR_RED),
...
GEM("prehnite", "radiant",             8,/*219*/  0,  500, 17, 17, 15,  6, GEMSTONE, CLR_BRIGHT_GREEN),
...
GEM("obsidian", "black",               9,/*255*/  0,  200, 14, 14, 15,  6, GEMSTONE, CLR_BLACK),
...
GEM("jade", "green",                   10,/*325*/ 0,  300, 15, 15, 15,  6, GEMSTONE, CLR_GREEN),
GEM("worthless piece of white glass", "white",   174, 0, 0, 6, 6, 6, 5, GLASS, CLR_WHITE),
GEM("worthless piece of blue glass", "blue",     174, 0, 0, 6, 6, 6, 5, GLASS, CLR_BRIGHT_BLUE),
GEM("worthless piece of red glass", "red",       174, 0, 0, 6, 6, 6, 5, GLASS, CLR_RED),
GEM("worthless piece of yellowish brown glass", "yellowish brown",
												 174, 0, 0, 6, 6, 6, 5, GLASS, CLR_BROWN),
GEM("worthless piece of orange glass", "orange", 174, 0, 0, 6, 6, 6, 5, GLASS, CLR_ORANGE),
GEM("worthless piece of yellow glass", "yellow", 174, 0, 0, 6, 6, 6, 5, GLASS, CLR_YELLOW),
GEM("worthless piece of black glass",  "black",  174, 0, 0, 6, 6, 6, 5, GLASS, CLR_BLACK),
GEM("worthless piece of pink glass",  "pink",  173, 0, 0, 6, 6, 6, 5, GLASS, CLR_BRIGHT_MAGENTA),
GEM("worthless piece of cyan glass",  "cyan",  173, 0, 0, 6, 6, 6, 5, GLASS, CLR_CYAN),
GEM("worthless piece of teal glass",  "teal",  173, 0, 0, 6, 6, 6, 5, GLASS, CLR_BRIGHT_CYAN),
GEM("worthless piece of green glass", "green",   173, 0, 0, 6, 6, 6, 5, GLASS, CLR_GREEN),
