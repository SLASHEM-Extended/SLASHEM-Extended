...
PROJECTILE("arrow", (char *)0,
	1, 200, 0, 2, 10, 10, 0, IRON, -P_BOW, HI_METAL),
...
BULLET("antimatter bullet", (char *)0,
	1,  5,   0,  35, 24, 36, 1, WP_BULLET,   P, MITHRIL, -P_FIREARM, CLR_BLACK),
...
/* (also weptoool spoon) */
WEAPON("dart", (char *)0,
	1, 1, 0, 258,  0,  4,  5,  2, 0, P,   -P_DART, IRON, HI_METAL),
WEAPON("spike", (char *)0,
	1, 1, 0,  5,  0,  4,  5,  2, 0, P,   -P_DART, BONE, CLR_WHITE),
WEAPON("dart of disintegration", (char *)0,
	1, 1, 0, 1,  0,  4,  5,  2, 0, P,   -P_DART, MITHRIL, CLR_BLACK),
...
ARMOR("kyrt shirt", (char *)0,
	1, 0, 0, 0,	1, 0,	 2,  200, 10, 0, ARM_SHIRT, CLOTH, CLR_ORANGE),
...
ARMOR("chain mail", (char *)0,
	1, 0, 0, 0,	296, 5, 120,  75,  4, 1, ARM_SUIT, IRON, HI_METAL),
...
ARMOR("scale mail", (char *)0,
	1, 0, 0, 0,	265, 5, 100,  45,  5, 0, ARM_SUIT, IRON, HI_METAL),
ARMOR("studded leather armor", (char *)0,
	1, 0, 0, 0,	284, 3, 80,  15,  7, 1, ARM_SUIT, LEATHER, HI_LEATHER),
ARMOR("ring mail", (char *)0,
	1, 0, 0, 0,	270, 5, 100, 100,  6, 0, ARM_SUIT, IRON, HI_METAL),
ARMOR("orcish ring mail", "crude ring mail",
	0, 0, 0, 0,	100, 5, 100,  80,  7, 1, ARM_SUIT, IRON, CLR_BLACK),
ARMOR("leather armor", (char *)0,
	1, 0, 0, 0,	272, 3, 60,   5,  8, 0, ARM_SUIT, LEATHER, HI_LEATHER),
...
CLOAK("cloak of leech", "energizer cloak",
		0, 1,	MANALEECH,  5, 0, 4, 50,  9, 3, 0, CLR_BRIGHT_BLUE),
...
CLOAK("nasty cloak", "chilling cloak",
		0, 1, 0,  5, 0, 4, 50,  3, 5, LIQUID, CLR_BRIGHT_CYAN),
CLOAK("special cloak", "electrostatic cloak",
		0, 1, 0,  5, 0, 4, 50,  9, 1, CLOTH, CLR_YELLOW),
CLOAK("plain cloak", "homicidal cloak",
		0, 1, 0,  5, 0, 4, 50,  9, 1, MINERAL, CLR_BLACK),
CLOAK("archaic cloak", "greek cloak",
		0, 1, 0,  5, 0, 4, 50,  9, 1, CLOTH, CLR_BRIGHT_BLUE),
...
HELM("unwanted helmet", "bug-tracking helmet",
		0, 1, 0,	5, 1, 20,  50, 4, 4, IRON, CLR_RED),
HELM("wonder helmet", "weeping helmet",
		0, 1, 0,	5, 1, 20,  50, 9, 1, LIQUID, CLR_BRIGHT_BLUE),
HELM("pointed helmet", "narrow helmet",
		0, 1, 0,	5, 1, 20,  50, 9, 1, COPPER, CLR_ORANGE),
HELM("bog-standard helmet", "celtic helmet",
		0, 1, 0,	5, 1, 20,  50, 9, 1, METAL, CLR_GRAY),
...
GLOVES("gauntlets of leech", "fingerless gloves",
		0, 0,  MANALEECH,       5, 1,  4, 50,  9, 0, LEATHER, CLR_BROWN),
...
GLOVES("evil gloves", "fatal gloves",
		0, 1,  0,	5, 1, 4, 50,  2, 6, SILVER, CLR_BLACK),
GLOVES("arcane gauntlets", "runic gloves",
		0, 1,  0,	5, 1, 4, 50,  9, 1, LEATHER, CLR_ORANGE),
GLOVES("placeholder gloves", "spanish gloves",
		0, 1,  0,	5, 1, 4, 50,  9, 1, CLOTH, CLR_RED),
GLOVES("protective gloves", "english gloves",
		0, 1,  0,	5, 1, 4, 50,  9, 1, LEATHER, CLR_BLACK),
...
BOOTS("unfair stilettos", "beautiful heels",
		0, 1,  0,  5, 2, 8, 50,  0, 9, WOOD, CLR_CYAN),
BOOTS("sky-high heels", "roman sandals",
		0, 1,  0,  5, 2, 8, 50,  9, 1, LEATHER, CLR_BROWN),
BOOTS("prehistoric boots", "castlevania boots",
		0, 1,  0,  5, 2, 8, 50,  9, 1, METAL, CLR_RED),
BOOTS("synthetic sandals", "korean sandals",
		0, 1,  0,  5, 2, 8, 50,  9, 1, CLOTH, CLR_MAGENTA),
...
RING("invisibility", INVIS,    "wire",      300, 150, 1, 0, 5, IRON, HI_METAL),
...
RING("restration", STUN_RES,   "enamel", 300, 1, 1, 0, 6, IRON,     CLR_WHITE),
RING("heavy attack", 0,        "grindstone", 300, 1, 1, 1, 8, MINERAL,  HI_MINERAL), /* increase accuracy and damage */
...
RING("leech", MANALEECH, "andalusite", 300, 5, 1, 0, 7, MINERAL, CLR_CYAN),
RING("danger", 0, "finger-smashing", 300, 5, 1, 0, 2, PLATINUM, CLR_BLACK),

RING("polymorph", POLYMORPH, "ivory",       300, 145, 1, 0, 4, BONE, CLR_WHITE),
...
AMULET("amulet of change",        "square",     0,          513,	IRON,	CLR_BLACK),
...
AMULET("amulet of leech",			 "hard metal",		MANALEECH,  5, METAL, CLR_GRAY),
AMULET("amulet of danger",			 "doomed",		0,  5, DRAGON_HIDE, CLR_BLACK),
...
TOOL("magic whistle", "whistle",0, 0, 1, 0, 120,  0,  10, METAL, HI_METAL),
TOOL("dark magic whistle", "whistle",0, 0, 1, 0, 5,  0,  10, METAL, HI_METAL),
...
SCROLL("identify",              "KERNOD WEL",           P_DIVINATION_SPELL, 1, 791, 300, CLR_GREEN),
SCROLL("secure identify",       "LARGE ALARM ALL PERSONNEL EVACUATE THE AREA IMMEDIATELY", P_DIVINATION_SPELL, 1, 25, 300, CLR_RED),
...
SCROLL("enchant armor",         "ZELGO MER",            P_ENCHANTMENT_SPELL,  1,  300, 300, CLR_GREEN),
SCROLL("armor specialization",  "YOU HAVE TO TAKE A CRAP AND THERE IS NO TOILET NEARBY", P_ENCHANTMENT_SPELL,  1,  5, 300, CLR_BROWN),
...
SPELL("cure stun",   "fat",      	    P_HEALING_SPELL, 69,  3, 3, 1, NODIR,     CLR_BRIGHT_MAGENTA),
...
SPELL("fixing",    "complete",          P_HEALING_SPELL,  1, 30, 8, 1, NODIR,     CLR_BRIGHT_CYAN),
/* Divination spells */
...
SPELL("teleport away",   "gold",        P_BODY_SPELL, 70,  6, 6, 1, IMMEDIATE, HI_GOLD),
...
/* Matter spells */
SPELL("knock",           "pink",        P_MATTER_SPELL, 115,  1, 1, 1, IMMEDIATE, CLR_BRIGHT_MAGENTA),
...
SPELL("wizard lock",     "dark green",  P_MATTER_SPELL, 115,  3, 2, 1, IMMEDIATE, CLR_GREEN),
...
SPELL("gravity beam",   "heavy",        P_ATTACK_SPELL, 5, 35, 7, 1, IMMEDIATE, CLR_GRAY),
SPELL("dream eater",   "dreamy",   P_ENCHANTMENT_SPELL, 5, 35, 7, 1, IMMEDIATE, CLR_BLACK),
SPELL("bubblebeam",   "encased",        P_MATTER_SPELL, 5, 35, 7, 1, IMMEDIATE, CLR_CYAN),
SPELL("good night",   "nightly",        P_ATTACK_SPELL, 5, 20, 6, 1, IMMEDIATE, CLR_BLACK),
SPELL("inferno",   "enveloped",         P_MATTER_SPELL, 5, 35, 7, 1, RAY,       CLR_RED),
SPELL("ice beam",   "chilly",           P_MATTER_SPELL, 5, 45, 8, 1, RAY,       CLR_BRIGHT_CYAN),
SPELL("thunder",   "sparking",          P_MATTER_SPELL, 5, 45, 8, 1, RAY,       CLR_YELLOW),
SPELL("sludge",   "litter",             P_MATTER_SPELL, 5, 45, 8, 1, RAY,       CLR_BRIGHT_GREEN),
SPELL("toxic",   "wasteful",            P_ATTACK_SPELL, 5, 45, 8, 1, RAY,       CLR_MAGENTA),
SPELL("nether beam",   "underworld",      P_BODY_SPELL, 1, 45, 8, 1, RAY,       CLR_MAGENTA),
SPELL("aurora beam",   "swirling",      P_MATTER_SPELL, 5, 45, 8, 1, RAY,       CLR_BRIGHT_MAGENTA),
SPELL("chloroform", "impregnated", P_ENCHANTMENT_SPELL, 5, 35, 7, 1, RAY,       CLR_CYAN),

/* Ray type spells are all here.  Kludge for zap.c */
SPELL("magic missile",   "vellum",      P_ATTACK_SPELL, 195, 4, 3, 1, RAY,       HI_PAPER),
SPELL("fireball",        "ragged",      P_MATTER_SPELL, 60,  6, 4, 1, RAY,       HI_PAPER),
SPELL("cone of cold",    "dog eared",   P_MATTER_SPELL, 70,  8, 5, 1, RAY,       HI_PAPER),
...
SPELL("lightning",       "rainbow",     P_MATTER_SPELL, 45,  7, 4, 1, RAY,       HI_PAPER),
SPELL("poison blast",    "tattered",    P_ATTACK_SPELL, 45,  7, 4, 1, RAY,       HI_PAPER),
SPELL("acid stream",     "colorful",    P_MATTER_SPELL, 45,  7, 4, 1, RAY,       HI_PAPER),
SPELL("solar beam",     "mirroring",    P_MATTER_SPELL, 20,  10, 6, 1, RAY,       CLR_BRIGHT_CYAN),
SPELL("psybeam",         "psionic",     P_BODY_SPELL,    4,  10, 6, 1, RAY,       CLR_MAGENTA),
...
WAND("locking",        "aluminum", 110, 500, 1, IMMEDIATE, METAL,    HI_METAL),
...
WAND("opening",        "zinc",     110, 500, 1, IMMEDIATE, METAL,    HI_METAL),
...
WAND("poison",         "cornered", 15, 500, 1, RAY,       IRON,     HI_METAL),
...
WAND("gravity beam",  "lacquered",   5, 500, 1, IMMEDIATE,       SILVER,     CLR_GRAY),
WAND("dream eater",  "tapered",   5, 500, 1, IMMEDIATE,       WOOD,     CLR_BROWN),
WAND("bubblebeam",  "biblic",   5, 500, 1, IMMEDIATE,       PAPER,     CLR_BRIGHT_GREEN),
WAND("good night",  "wish parser",   5, 500, 1, IMMEDIATE,       BONE,     CLR_BRIGHT_CYAN),
WAND("inferno",  "subsurface",   5, 500, 1, RAY,       GOLD,     CLR_ORANGE),
WAND("ice beam",  "nebulous",   5, 500, 1, RAY,       WAX,     CLR_BLACK),
WAND("thunder",  "rollover",   5, 500, 1, RAY,       VEGGY,     CLR_BRIGHT_GREEN),
WAND("sludge",  "fallthrough",   5, 500, 1, RAY,       CLOTH,     CLR_BROWN),
WAND("toxic",  "holed",   5, 500, 1, RAY,       WOOD,     CLR_BROWN),
WAND("nether beam",  "crashbug",   1, 500, 1, RAY,       GLASS,     CLR_RED),
WAND("aurora beam",  "alarming",   5, 500, 1, RAY,       GEMSTONE,     CLR_RED),
WAND("chloroform",  "blackthorn",   5, 500, 1, RAY,       WOOD,     CLR_BLACK),
...
WAND("fire",           "hexagonal",120, 500, 1, RAY,       IRON,     HI_METAL),
WAND("cold",           "short",    145, 500, 1, RAY,       IRON,     HI_METAL),
WAND("sleep",          "runed",    235, 500, 1, RAY,       IRON,     HI_METAL),
WAND("death",          "long",      25, 500, 1, RAY,       IRON,     HI_METAL),
WAND("lightning",      "curved",   95, 500, 1, RAY,       IRON,     HI_METAL),
WAND("fireball",       "octagonal", 25, 500, 1, RAY,       IRON,     HI_METAL),
WAND("acid",		"measured",	20, 500, 1, RAY,       METAL,	 HI_METAL),
WAND("solar beam",	"beaming",	20, 500, 1, RAY,       METAL,	 CLR_BRIGHT_CYAN),
WAND("psybeam",		"avada kedavra",	4, 500, 1, RAY,  WOOD,	 CLR_MAGENTA),
