...
ARMOR("bronze plate mail", (char *)0,
	1, 0, 1, 0,	135, 5, 200, 400,  1, 0, ARM_SUIT, COPPER, HI_COPPER),
#else
ARMOR("bronze plate mail", (char *)0,
...
GLOVES("gloves of safeguard", "orange gloves",
		0, 0,  SWIMMING,	   1, 1, 4, 50,  9, 0, PLASTIC, CLR_ORANGE),
GLOVES("gloves of plugsuit", "tightly fitting gloves",
...
GLOVES("gloves of missing information", "nondescript gloves",
		0, 1,  UNINFORMATION,	1, 1, 4, 50,  4, 6, WOOD, CLR_WHITE),
GLOVES("gloves of trap creation", "spiky gloves",
...
AMULET("amulet of restful sleep", "triangular", SLEEPING,   493, GEMSTONE,	CLR_MAGENTA),
...
/* Attack spells */
SPELL("force bolt",      "red",         P_ATTACK_SPELL, 125, 2, 1, 1, IMMEDIATE, CLR_RED),
...
WAND("striking",       "ebony",   270, 500, 1, IMMEDIATE, WOOD,     HI_WOOD),
...
WAND("magic missile",  "steel",   240, 500, 1, RAY,       IRON,     HI_METAL),
