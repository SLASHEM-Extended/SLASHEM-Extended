...
STATIC_OVL struct Jitem Soviet_items[] = {
	...
	{ RIFLE_BULLET, "todo" },
	{ SNIPER_BULLET, "todo" },
	{ ASSAULT_RIFLE_BULLET, "todo" },
	{ ANTIMATTER_SMG_BULLET, "todo" },
	{ ANTIMATTER_MG_BULLET, "todo" },
	{ ANTIMATTER_RIFLE_BULLET, "todo" },
	{ ANTIMATTER_SNIPER_BULLET, "todo" },
	{ ANTIMATTER_ASSAULT_RIFLE_BULLE, "todo" },
