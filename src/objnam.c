...
int prop;
{
	switch (prop) {
		...
		case FEMTRAP_SABINE:
			return "Sabine's curse";
		case FEMTRAP_JANET:
			return "Janet's curse";
		case FEMTRAP_TANJA:
...
STATIC_OVL struct Jitem Soviet_items[] = {
	...
	{ REGULAR_GLOVES, "kozhanyye perchatki" },
	...
	{ CATAPULT, "katapul'ta" },
	{ SILVER_PISTOL_BULLET, "serebryanaya pulya" },
	...
	{ NEMEAN_LION_HIDE, "nemeyskogo lev spryatat'" },
	...
	{ ANTIMATTER_PISTOL_BULLET, "antiveshchestvo pulya" },
	...
	{ LEAD_PISTOL_BULLET, "svintsovaya pulya" },
	...
	{ BONE_ARROW, "kostyanaya strela" },
	{ BONE_DAGGER, "kostyanoy kinzhal" },
	{ WRAITHBLADE, "prizrachnyy klinok" },
	{ TECPATL, "tekpatl'" },
	{ ANCUS, "ankus" },
	{ ATGEIR, "atgeyr" },
	{ KHOPESH, "yegipetskiy serpovidnyy mech" },
	{ MACUAHUITL, "makuauitl'" },
	{ ATLATL, "instrument dlya kamennoy prashchi" },
	{ ICHCAHUIPILLI, "ichkauipilli" },
	{ TINSEL_LONGSWORD, "mishura" },
	{ TREESTAFF, "derevoposokh" },
	{ GARBOWHIP, "gorbyl'" },
	{ ORGANOSHIELD, "organoshchit" },
	{ HEAVY_TINSEL_BALL, "tyazhelyy mishurnyy shar" },
	{ AMBER_BALL, "yantarnyy shar" },
	{ TINSEL_CHAIN, "mishura tsep'" },
	{ AMBER_CHAIN, "yantarnaya tsepochka" },
	{ GROM_AXE, "grom topor" },
	{ HONOR_KATANA, "chest' yaponskiy mech" },
	{ DIMENSIONAL_SHARD, "razmernyy oskolok" },
	{ CIRCULAR_SAW, "tsirkulyarnaya pila" },
	{ AMBUSH_QATAR, "zasada katar" },
	{ PHEONIX_STAFF, "feniks posokh" },
	{ DIVINE_DART, "bozhestvennyy drotik" },
	{ JUMPING_FLAMER, "prygayushchiy ognemet" },
	{ SECRET_SOUND_WHIP, "sekretnyy zvukovoy knut" },
	{ OLD_MAIL, "staraya pochta" },
	{ CANDY_BRA, "konfetnyy byustgal'ter" },
	{ BULL_SHIELD, "bychiy shchit" },
	{ LEAD_BOX, "svintsovaya korobka" },
	{ NANO_CHEST, "nano sunduk" },
	{ DISPERSION_BOX, "dispersionnaya korobka" },
	{ HANDYBAG, "sumochka" },
	{ DEATH_HORN, "rog smerti" },
	{ BLACK_LIGHTSABER, "chernyy svetovoy mech" },
	{ ORANGE_LIGHTSABER, "oranzhevyy svetovoy mech" },
	{ AMBER_FRAGMENT, "oskolok yantarya" },
	{ HEAVY_LASER_BALL, "tyazhelyy lazernyy shar" },
	{ LASER_CHAIN, "lazernaya tsep'" },
	{ SPRAY_BOX, "raspylitel'" },
	{ CONTROVERSY_CODE, "kod protivorechiya" },
	{ LASER_TIN_OPENER, "lazernyy konservnyy nozh" },
	{ POWERFIST, "silovoy kulak" },
	{ LASERFIST, "lazernyy kulak" },
	{ SCR_COURSE_TRAVELING, "kurs puteshestviya" },
	{ CYAN_DOUBLE_LIGHTSABER, "goluboy dvoynoy svetovoy mech" },
	{ KLIUSLING, "klyuremen'" },
	{ METEOR_ARROW, "meteornaya strela" },
	{ METEOR_FRAGMENT, "fragment meteora" },
	{ DARK_DRAGON_SCALE_MAIL, "kol'chuga iz cheshui temnogo drakona" },
	{ DARK_DRAGON_SCALES, "cheshuya temnogo drakona" },
	{ DARK_DRAGON_SCALE_SHIELD, "shchit iz cheshui temnogo drakona" },
	{ RAINBOW_LIGHTSABER, "raduzhnyy svetovoy mech" },

	{ ANNEMARIE_PLATFORM_SANDALS, "Annemarie bosonozhki na platforme" },
	{ JIL_VELCRO_SHOES, "Jil obuv' na lipuchke" },
	{ JANA_SNEAKERS, "Jana krossovki" },
	{ KATRIN_COMBAT_BOOTS, "Katrin boyevyye sapogi" },
	{ GUDRUN_WEDGE_SANDALS, "Gudrun bosonozhki na tanketke" },
	{ ELLA_WEDGE_SANDALS, "Ella bosonozhki na tanketke" },
	{ MANUELA_COMBAT_BOOTS, "Manuela boyevyye sapogi" },
	{ JENNIFER_COMBAT_BOOTS, "Jennifer boyevyye sapogi" },
	{ PATRICIA_STEEL_CAPPED_SANDALS, "Patricia sandalii s metallicheskimi vstavkami" },
	{ ANTJE_SNEAKERS, "Antje krossovki" },
	{ ANTJE_COMBAT_BOOTS, "Antje boyevyye sapogi" },
	{ KERSTIN_COMBAT_BOOTS, "Kerstin boyevyye sapogi" },
	{ KERSTIN_WOODEN_SANDALS, "Kerstin derevyannyye sandalii" },
	{ KERSTIN_SNEAKERS, "Kerstin krossovki" },
	{ LAURA_WINTER_BOOTS, "Laura sapogi zimniye" },
	{ LARISSA_PLATFORM_BOOTS, "Larissa sapogi na platforme" },
	{ NORA_COMBAT_BOOTS, "Nora boyevyye sapogi" },
	{ NATALIA_WEDGE_SANDALS, "Natalia bosonozhki na tanketke" },
	{ SUSANNE_COMBAT_BOOTS, "Susanne boyevyye sapogi" },
	{ LISA_COMBAT_BOOTS, "Lisa boyevyye sapogi" },
	{ BRIDGHITTE_SKI_HEELS, "Bridghitte lyzhnyye kabluki" },
	{ JULIA_COMBAT_BOOTS, "Julia boyevyye sapogi" },
	{ NICOLE_COMBAT_BOOTS, "Nicole boyevyye sapogi" },
	{ RITA_STILETTOS, "Rita tufli na shpil'ke" },
	{ JANINA_LADY_PUMPS, "Janina ledi nasosy" },
	{ ROSA_GIRL_SHOES, "Rosa obuv' dlya devochek" },
	{ KSENIA_PLATFORM_SANDALS, "Ksenia bosonozhki na platforme" },
	{ LYDIA_LADY_PUMPS, "Lydia ledi nasosy" },
	{ CONNY_COMBAT_BOOTS, "Conny boyevyye sapogi" },
	{ KATIA_COMBAT_BOOTS, "Katia boyevyye sapogi" },
	{ MARIYA_COMBAT_BOOTS, "Mariya boyevyye sapogi" },
	{ ELISE_HIPPIE_HEELS, "Elise kabluki khippi" },
	{ RONJA_COMBAT_BOOTS, "Ronja boyevyye sapogi" },
	{ ARIANE_COMBAT_BOOTS, "Ariane boyevyye sapogi" },
	{ JOHANNA_COMBAT_BOOTS, "Johanna boyevyye sapogi" },
	{ INGE_COMBAT_BOOTS, "Inge boyevyye sapogi" },

	{ SMG_BULLET, "pulya pistolet-pulemet" },
	{ MG_BULLET, "pulemet pulya" },
	{ RIFLE_BULLET, "vintovochnaya pulya" },
	{ SNIPER_BULLET, "snayperskaya pulya" },
	{ ASSAULT_RIFLE_BULLET, "pulya shturmovoy vintovki" },
	{ ANTIMATTER_SMG_BULLET, "pulya iz antiveshchestva pistolet-pulemet" },
	{ ANTIMATTER_MG_BULLET, "pulya iz antiveshchestva pulemet" },
	{ ANTIMATTER_RIFLE_BULLET, "vintovochnaya pulya iz antiveshchestva" },
	{ ANTIMATTER_SNIPER_BULLET, "snayperskaya pulya iz antiveshchestva" },
	{ ANTIMATTER_ASSAULT_RIFLE_BULLE, "pulya shturmovoy vintovki iz antiveshchestva" },
	{ AUTO_SHOTGUN_SHELL, "patron dlya avtomaticheskogo drobovika" },
	{ RAYGUN_BOLT, "luchevoy prikruchen" },
	{ RADIO, "radiopriyemnik" },
	{ LEAD_SMG_BULLET, "svintsovaya pulya pistolet-pulemet" },
	{ LEAD_MG_BULLET, "svintsovaya pulya pulemet" },
	{ LEAD_RIFLE_BULLET, "svintsovaya vintovochnaya pulya" },
	{ LEAD_SNIPER_BULLET, "svintsovaya snayperskaya pulya" },
	{ LEAD_ASSAULT_RIFLE_BULLET, "svintsovaya shturmovoy vintovki pulya" },
	{ AUTO_LEAD_SHOT, "avtomaticheskiy svintsovyy vystrel" },
	{ COPPER_RIFLE_BULLET, "mednaya vintovochnaya pulya" },
	{ PLATINUM_SNIPER_BULLET, "platinovaya snayperskaya pulya" },
	{ CHROME_PELLET, "khrom granuly" },
	{ GRIM_SHIELD, "mrachnyy shchit" },
	{ CLOAK_OF_PAIN_SENSE, "plashch chuvstva boli" },
	{ ONE_EATING_SIGN, "odin znak yedy" },

	{ BRASS_KNUCKLES, "kastet" },
	{ SUPER_KNUCKLES, "lishniy chelovek kostyashki" },
	{ ULTRA_KNUCKLES, "ul'tra sustavy" },
	{ ELITE_KNUCKLES, "elitnyye kostyashki" },
	{ BUGXPLORE_HELMET, "shlem issledovaniya zhukov" },
	{ YAWNING_VISOR, "ziyayushchiy kozyrek" },
	{ AMULET_OF_TRAP_WARPING, "amulet of deformatsiya lovushki" },
	{ AMULET_OF_HI_LEVEL_CASTING, "amulet of kasting vysokogo urovnya" },
	{ RIN_INCESSANT_FARTING, "neprekrashchayushchiysya perdezh" },
	{ RIN_LAMITY, "khromota" },
	{ RIN_WALLFARTING, "perdezh v stenu" },
	{ ROBE_OF_DESTINY, "odezhda sud'by" },
	{ TEZ_SHIELD, "atstekskiy bog shchit" },
	{ KILLER_SPAWN_BOOTS, "sapogi ubiytsy" },
	{ GIANT_EXPLORER_STONE, "gigantskiy kamen' issledovatelya" },
	{ TRAPWARP_STONE, "kamen'-lovushka" },
	{ YAWM_STONE, "ryskayushchiy kamen'" },
	{ CHAOSCRADLE_STONE, "kolybel' khaosa" },
	{ TEZ_STONE, "atstekskiy bog kamen'" },
	{ BOSSGOD_STONE, "kamen' boga-bossa" },
	{ UBERGOD_STONE, "verkhovnyy bog kamen'" },
	{ TOO_GOOD_GO_STONE, "slishkom khoroshiy kamen'" },
	{ KILLER_ROOM_STONE, "kamen' komnaty ubiytsy" },
	{ FUNWALL_STONE, "veselaya stena kamen'" },
	{ CLOAK_OF_INVERSION, "plashch inversii" },
	{ CLOAK_OF_WINCING, "plashch morshchas'" },
	{ BOOTS_OF_INVERSION, "sapogi inversii" },
	{ INVERSION_SHIELD, "inversionnyy shchit" },
	{ WINCING_GRIMACE, "morshchas' grimasa" },
	{ RIN_WINCING, "morshchas'" },

	{ RUTH_SNEAKERS, "Ruth krossovki" },
	{ MAGDALENA_COMBAT_BOOTS, "Magdalena boyevyye sapogi" },
	{ MARLEEN_COMBAT_BOOTS, "Marleen boyevyye sapogi" },
	{ KLARA_PLATFORM_SANDALS, "Klara bosonozhki na platforme" },
	{ FRIEDERIKE_DANCING_SHOES, "Friederike tantseval'naya obuv'" },
	{ NAOMI_STILETTOS, "Naomi tufli na shpil'ke" },
	{ UTE_PLATFORM_SANDALS, "Ute bosonozhki na platforme" },
	{ JASIEEN_WEDGE_SANDALS, "Jasieen bosonozhki na tanketke" },
	{ YASAMAN_LEATHER_BOOTS, "Yasaman kozhanyye botinki" },
	{ MAY_BRITT_SANDALS, "May-Britt sandalii" },

	{ REALLY_BAD_HELM, "ochen' plokhoy shlem" },
	{ COVID____COATED_CLOAK, "plashch s pokrytiyem covid-19" },
	{ RIN_ARTIFACT_BLASTING, "vzryv artefaktov" },
	{ REALLY_BAD_STONE, "ochen' plokhoy kamen'" },
	{ COVID_STONE, "kovid kamen'" },
	{ BLAST_STONE, "vzryvnoy kamen'" },

	{ HONEYCOMB, "soty" },
	{ NASTYCURSE_STONE, "protivnyy proklyatyy kamen'" },
	{ SPI_IMAGE_MOOSE_SHIELD, "zerkal'noye otrazheniye losinyy shchit" },
	{ SHOVEL, "lopata" },

	{ NADINE_STILETTO_SANDALS, "Nadine bosonozhki na shpil'ke" },
	{ LUISA_HUGGING_BOOTS, "Luisa obnimayushchiye sapogi" },
	{ IRINA_WEDGE_SANDALS, "Irina bosonozhki na tanketke" },
	{ LISELOTTE_HUGGING_BOOTS, "Liselotte obnimayushchiye sapogi" },
	{ GRETA_HUGGING_BOOTS, "Greta obnimayushchiye sapogi" },
	{ JANE_HUGGING_BOOTS, "Jane obnimayushchiye sapogi" },
	{ SUE_LYN_WINTER_BOOTS, "Sue Lyn zimnyaya obuv'" },
	{ CHARLOTTE_HUGGING_BOOTS, "Charlotte obnimayushchiye sapogi" },
	{ HANNAH_CUDDLE_BOOTS, "Hannah obnimat'sya sapogi" },
	{ LITTLE_MARIE_HUGGING_BOOTS, "Little Marie obnimayushchiye sapogi" },

	{ DEFUSING_BOX, "korobka razryadki" },
	{ CLOAK_OF_DEFUSING, "plashch obezvrezhivaniya" },
	{ GAUNTLETS_OF_DEFUSING, "rukavitsy obezvrezhivaniya" },
	{ AMULET_OF_DEFUSING, "amulet of obezvrezhivaniya" },

	{ PARRY_DAGGER, "pariruyushchiy kinzhal" },
	{ PARRY_SWORD, "pariruyushchiy mech" },
	{ PISTOL_PAIR, "pistoletnaya para" },
	{ FIVE_SEVEN_BULLET, "pulya pyat'-sem'" },
	{ LEAD_FIVE_SEVEN_BULLET, "svintsovaya pulya pyat'-sem'" },
	{ SHADOW_FIVE_SEVEN_BULLET, "ten' pyat'-sem' pulya" },
	{ ANTIMATTER_FIVE_SEVEN_BULLET, "pulya iz antiveshchestva pyat'-sem'" },
	{ RAPID_DART, "bystryy drotik" },
	{ NINJA_STAR, "zvezda nindzya" },
	{ FLAMETHROWER, "ognemet" },
	{ HEAVY_SPEAR, "tyazheloye kop'ye" },
	{ SUPERHEAVY_SPEAR, "sverkhtyazheloye kop'ye" },
	{ WAN_STONE_TO_FLESH, "kamen' k ploti" },
	{ WAN_LAVA, "zhidkaya zola" },
	{ RIN_IMPACT, "vliyaniye" },
	{ RIN_REVERSE_REGENERATION, "obratnaya regeneratsiya" },
	{ ROBE_OF_PUGILISM, "khalat kulachnogo boya" },
	{ ROBE_OF_FOCUSSING, "khalat fokusirovki" },
	{ SHIELD_PATE_GLASSES, "ochki s pashtetom" },
	{ INFUSION, "vlivaniye" },
	{ BEAUTY_PACK, "kosmetichka" },
	{ BLESSER, "blagoslovlyayushchiy" },
	{ SCR_EXTRA_SKILL_POINT, "dopolnitel'noye ochko navyka" },
	{ SCR_PROOF_ACCESSORY, "dokazatel'stvo aksessuar" },
	{ SCR_PROOF_TOOL, "instrument dokazatel'stva" },
	{ SCR_NAME, "imya" },
	{ AMULET_VERSUS_NAGGING, "amulet protiv nyt'ya" },
	{ AMULET_OF_SYMBIOTE_SAVING, "amulet of spaseniye simbiota" },
	{ POT_CURE_AIDS, "lechebnyye sredstva" },
	{ SPE_COMBAT_COMMAND, "boyevoye komandovaniye" },
	{ SPE_DEFUSING, "obezvrezhivaniye" },
	{ LIGHTTORCH, "fakel" },
	{ LASER_FLYAXE, "lazernyy topor" },
	{ PINK_LIGHTSWORD, "rozovyy svetovoy mech" },
	{ PINK_DOUBLE_LIGHTSWORD, "rozovyy dvoynoy svetovoy mech" },
	{ RAD_X, "rad-kh" },
	{ RADAWAY, "siyayushchiy" },
	{ SPE_RESIST_STUN, "soprotivlyat'sya oglusheniyu" },
	{ SPE_RESIST_CONFUSION, "soprotivlyat'sya putanitse" },
	{ SPE_RESIST_CONTAMINATION, "soprotivlyat'sya zagryazneniyu" },

	{ STONE_OF_COMPLETE_FUCKUP, "kamen' polnogo pizdetsa" },
	{ REAL_LIE_STONE, "nastoyashchiy kamen' lzhi" },
	{ ESCAPE_PAST_STONE, "pobeg mimo kamnya" },
	{ PETHATE_STONE, "pegatskiy kamen'" },
	{ PET_LASHOUT_STONE, "kamen' dlya zashchity ot domashnikh zhivotnykh" },
	{ PETSTARVE_STONE, "pitomets golodayet kamen'" },
	{ PETSCREW_STONE, "samorez kamen'" },
	{ TECH_LOSS_STONE, "tekhnicheskiy kamen' poteri" },
	{ PROOFLOSS_STONE, "kamen' dlya proverki ubytka" },
	{ UN_INVIS_STONE, "ne nevidimyy kamen'" },
	{ DETECTATION_STONE, "kamen' obnaruzheniya" },
	{ ETERNAL_LIAR_BOOTS, "sapogi vechnogo lzhetsa" },
	{ UNDETECTION_GLOVES, "nezametnyye perchatki" },
	{ PETHATE_CLOAK, "plashch iz petata" },
	{ PET_LASHOUT_CLOAK, "plashch dlya domashnikh zhivotnykh" },
	{ PETSTARVE_CLOAK, "plashch golodayushchego pitomtsa" },
	{ PETSCREW_CLOAK, "plashch s petlyami" },
	{ NON_PROOF_CLOAK, "nepronitsayemyy plashch" },
	{ TECH_LOSS_HELMET, "tekhnicheskiy shlem poteri" },
	{ AMULET_OF_ESCAPE_PROBLEM, "amulet of problema pobega" },
	{ RIN_VISIBLE_BECOMING, "vidimoye stanovleniye" },

	{ OPTION_STONE, "variant kamen'" },
	{ MISCOLOR_STONE, "nepravil'nyy tsvet kamen'" },
	{ ONE_RAINBOW_STONE, "odin raduzhnyy kamen'" },
	{ COLORSHIFT_STONE, "tsvetnoy kamen'" },
	{ TOP_LINE_STONE, "kamen' verkhney linii" },
	{ CAPS_STONE, "shapki kamen'" },
	{ UN_KNOWLEDGE_STONE, "kamen' neznaniya" },
	{ DARKHANCE_STONE, "temnyy kamen'" },
	{ DSCHUEUEUET_STONE, "strannyy zvuk kamen'" },
	{ NOPESKILL_STONE, "kamen' nea navyk" },
	{ DARK_HAND_GLOVES, "temnyye perchatki" },
	{ GAUNTLETS_OF_RAINBOW_MOUD, "rukavitsy raduzhnoy gryazi" },
	{ THROUGH_THE_FLOOR_BOOTS, "cherez pol sapogi" },
	{ OPTIONAL_HELMET, "dopolnitel'nyy shlem" },
	{ TOP_HELMET, "verkhniy shlem" },
	{ ABCDE_HELMET, "abkde shlem" },
	{ COLOR_CHANGING_CONE, "konus, menyayushchiy tsvet" },
	{ CLOAK_OF_NULLIFICATION, "plashch annulirovaniya" },
	{ AMULET_OF_MISCOLORATION, "amulet of obestsvechivaniye" },
	{ AMULET_OF_LOST_KNOWLEDGE, "amulet of poteryannoye znaniye" },
	{ AMULET_OF_SEVERE_FUCKUP, "amulet of ser'yeznyy pizdets" },

	{ CASINO_CHIP, "fishka kazino" },

	{ AMULET_OF_BURDEN, "amulet of gruz" },
	{ CLOAK_OF_BURDEN, "plashch bremeni" },
	{ CLOAK_OF_VACUUM, "plashch vakuuma" },
	{ VACUUM_HELMET, "vakuumnyy shlem" },
	{ VACUUM_STAFF, "vakuumnyy personal" },

	{ CLOAK_OF_RESISTANCE_PIERCING, "plashch soprotivleniya pirsing" },
	{ GAUNTLETS_OF_ELEMENTAL_POWER, "rukavitsy stikhiynoy sily" },
	{ RIN_PIERCING, "pirsing" },
	{ ROBE_OF_MAGIC_POWER, "odeyaniye magicheskoy sily" },

	{ MYSTERY_DRAGON_SCALE_MAIL, "zagadochnaya kol'chuga iz cheshui drakona" },
	{ MYSTERY_DRAGON_SCALES, "zagadochnaya cheshuya drakona" },
	{ MYSTERY_DRAGON_SCALE_SHIELD, "tainstvennyy shchit iz cheshui drakona" },
	{ AMULET_OF_FUCKING, "amulet of chertovski" },
	{ AMULET_OF_MYSTERY_RESISTANCE, "amulet of taynoye soprotivleniye" },
	{ CLOAK_OF_FUCKING, "plashch trakha" },
	{ GAUNTLETS_OF_FORTUNE, "rukavitsy udachi" },
	{ GAUNTLETS_OF_MYSTERY_RESISTANC, "rukavitsy tainstvennogo soprotivleniya" },
	{ CLOAK_OF_MAGIC_FIND, "plashch volshebnoy nakhodki" },
	{ COMBINATION_CLOAK, "kombinirovannyy plashch" },
	{ CLOAK_OF_LOWER_MYSTERY, "plashch nizshey tayny" },
	{ CLOAK_OF_MYSTERY, "plashch tayny" },
	{ CLOAK_OF_ARMOR_MYSTERY, "tayna dospekhov plashcha" },
	{ RIN_MAGIC_FIND, "volshebnaya nakhodka" },
	{ RIN_MYSTERY_RESISTANCE, "taynoye soprotivleniye" },
	{ MYSTERIOUS_PICK, "zagadochnyy vybor" },
	{ MAGISWORD, "magicheskiy mech" },
	{ HELM_OF_MYSTERY_RES, "taynyy shlem" },
	{ MYSTERIOUS_BOOTS, "zagadochnyye sapogi" },
	{ MYSTERY_SHIELD, "tainstvennyy shchit" },
	{ ROBE_OF_SPELL_BOOSTING, "mantiya usileniya zaklinaniy" },
	{ CLOAK_OF_SPELL_BOOSTING, "plashch usileniya zaklinaniy" },
	{ CASTSHIRT, "gipsovaya rubashka" },
	{ GAUNTLETS_OF_SPELL_POWER, "rukavitsy sily zaklinaniy" },
	{ AMULET_OF_SPELLCASTING, "amulet of koldovstvo" },
	{ CASTER_STAFF, "personal zaklinatelya" },
	{ AMULET_OF_MONSTER_SAVING, "amulet of spaseniye monstra" },
	{ AMULET_OF_THIRD_CHANCE, "amulet of tretiy shans" },
	{ FLEURE, "tsveteniye" },
	{ BROKEN_BOOTS, "slomannyye botinki" },
	{ RIPPED_CLOAK, "rvanyy plashch" },
	{ RUSTED_MAIL, "rzhavaya pochta" },
	{ RUSTED_GAUNTLETS, "rzhavyye rukavitsy" },
	{ BROKEN_SHIELD, "slomannyy shchit" },
	{ BROKEN_HELMET, "slomannyy shlem" },
	{ CRUMBLED_SHIRT, "raskroshennaya rubashka" },
	{ OVER_SHOES, "poverkh obuvi" },
	{ TANJA_SNEAKERS, "Tanja krossovki" },
	{ SONJA_SNEAKERS, "Sonja krossovki" },
	{ RHEA_LADY_PUMPS, "Rhea ledi tufli na vysokom kabluke" },
	{ LARA_COMBAT_BOOTS, "Lara boyevyye botinki" },
	{ BROKEN_SWORD, "slomannyy mech" },
	{ COPPER_PLATE_MAIL, "mednaya plastinchataya kol'chuga" },
	{ GOLDEN_SHIELD, "zolotoy shchit" },
	{ TANK_SADDLE, "sedlo tanka" },
	{ BARDING, "instrument dlya sedlaniya loshadi" },
	{ MESH_SADDLE, "setchatoye sedlo" },
	{ ADAMANT_LEASH, "nepreklonnyy povodok" },
	{ SPE_LOOT_IMPROVEMENT, "uluchsheniye dobychi" },
	{ SPE_MYSTERY_PROTECTION, "tayna zashchity" },
	{ TONFA, "udarnaya palka byka" },
	{ UNWIELDY_PICK, "gromozdkiy vybor" },
	{ FAR_EAST_ARROW, "dal'nevostochnaya strelka" },
	{ TOP_BOX, "verkhniy yashchik" },
	{ TITAN_SACK, "titanovyy meshok" },
	{ JUNK_METAL, "musornyy metall" },
	{ COBALT_CHUNK, "kusok kobal'ta" },
	{ BRONZE_NUGGET, "bronzovyy samorodok" },
	{ STEEL_SLUG, "stal'naya pulya" },
	{ SATURNITE_FIST, "saturnitovyy kulak" },
	{ JEONTU_GEOM, "chontu geometriya" },
	{ DIM_LANTERN, "tusklyy fonar'" },
	{ JACK_KNIFE, "skladnoy nozh" },
	{ REPLICA_UNICORN_HORN, "kopiya roga yedinoroga" },
	{ TITANIUM_HORN, "titanovyy rog" },
	{ HEAVY_MESH_BALL, "tyazhelyy setchatyy myach" },
	{ HEAVY_FIRMAMENT_BALL, "tyazhelyy shar nebesnogo svoda" },
	{ HEAVY_SINNUM_BALL, "tyazhelyy shar iz sinnuma" },
	{ HEAVY_CORAL_BALL, "tyazhelyy korallovyy shar" },
	{ HEAVY_CHITIN_BALL, "tyazhelyy khitinovyy shar" },
	{ HEAVY_BRONZE_BALL, "tyazhelyy bronzovyy shar" },
	{ HEAVY_TITANIUM_BALL, "tyazhelyy titanovyy shar" },
	{ HEAVY_STEEL_BALL, "tyazhelyy stal'noy shar" },
	{ HEAVY_MERCURIAL_BALL, "tyazhelyy rtutnyy shar" },
	{ HEAVY_BAMBOO_BALL, "tyazhelyy bambukovyy myach" },
	{ HEAVY_ALU_BALL, "tyazhelyy alyuminiyevyy shar" },
	{ HEAVY_COBALT_BALL, "tyazhelyy kobal'tovyy shar" },
	{ GREEN_STEEL_BALL, "zelenyy stal'noy shar" },
	{ MESH_CHAIN, "setchataya tsep'" },
	{ FIRMAMENT_CHAIN, "tsep' nebosvoda" },
	{ SINNUM_SCOURGE, "zhest' bich" },
	{ CORAL_NUNCHIAKU, "korallovyy nuntsiaku" },
	{ CHITIN_CHAIN, "khitinovaya tsep'" },
	{ BRONZE_CHAIN, "bronzovaya tsepochka" },
	{ TITANIUM_SCOURGE, "titanovaya bich" },
	{ STEEL_NUNCHIAKU, "stal'nyye nuntsiaku" },
	{ MERCURIAL_CHAIN, "rtutnaya tsep'" },
	{ BAMBOO_CHAIN, "bambukovaya tsep'" },
	{ ALU_SCOURGE, "alu bich" },
	{ COBALT_NUNCHIAKU, "kobal'tovyye nuntsiaku" },
	{ GREEN_STEEL_CHAIN, "zelenaya stal'naya tsep'" },
	{ FATMAN, "tolstyak" },
	{ MINI_NUKE, "mini yadernoye oruzhiye" },
	{ SHUTTER_SHIELD, "shchitok zatvora" },
	{ CLOAK_OF_SHUTDOWN, "maskirovka otklyucheniya" },
	{ RIN_SHUTDOWN, "neispravnost'" },
	{ GAUNTLETS_OF_AUTOMATIC_SHUTDOW, "rukavitsy avtomaticheskogo otklyucheniya" },
	{ AMULET_OF_AUTOMATIC_SHUTDOWN, "amulet of avtomaticheskoye otklyucheniye" },
	{ RIN_NASTINESS_RESISTANCE, "soprotivleniye gadosti" },
	{ RIN_INDIGESTION, "rasstroystvo zheludka" },
	{ LIGHT_MAIL, "legkaya pochta" },
	{ LOOT_CHEST, "sunduk s dobychey" },
	{ ROUND_MAIL, "kruglaya pochta" },
	{ PINCER_STAFF, "kleshnevyy posokh" },
	{ UNDERWATER_TRIDENT, "podvodnyy trezubets" },
	{ SET_OF_CROW_TALONS, "nabor voron'ikh kogtey" },
	{ BLADE_OF_PITY, "lezviye zhalosti" },
	{ PARAZONIUM, "parazoniy" },
	{ BRONZE_DAGGER, "bronzovyy kinzhal" },
	{ FANG_OF_APEP, "klyk obez'yany" },
	{ STEEL_KNIFE, "stal'noy nozh" },
	{ CONSECRATED_KNIFE, "osvyashchennyy nozh" },
	{ DISKOS, "grecheskiy krug" },
	{ QUATTUORST_AXE, "chetyrekhkratnyy topor" },
	{ MIRRORBLADE, "zerkal'nyy klinok" },
	{ BLADE_OF_MERCY, "klinok miloserdiya" },
	{ BLADE_OF_GRACE, "klinok blagodati" },
	{ GLADIUS, "mech iz rima" },
	{ ISAMUSEI, "isamusey" },
	{ KACHISEI, "kachisey" },
	{ ZANBATO, "yaponskoye smeshannoye oruzhiye" },
	{ UNNATURAL_SWORD, "neyestestvennyy mech" },
	{ DOUBLE_FORCE_BLADE, "lezviye dvoynoy sily" },
	{ COBALT_STAFF, "kobal'tovyy posokh" },
	{ BAMBOO_STAFF, "bambukovyy posokh" },
	{ BREAKER_STAFF, "personal vyklyuchatelya" },
	{ FEATHER_STAFF, "pero posokh" },
	{ FORCE_WHIP, "sila knuta" },
	{ CHITIN_WHIP, "khitinovyy knut" },
	{ FORMICAN_WHIP, "formikanskiy knut" },
	{ CLAWED_HAND, "kogtistaya ruka" },
	{ BESTIAL_CLAW, "zverinyy kogot'" },
	{ MEASURER_QATAR, "zamershchik katar" },
	{ QUHAB, "kukhab" },
	{ SUWAYYAH, "suvayya" },
	{ BREAKING_WHEEL, "lomayushcheyesya koleso" },
	{ CARCOSAN_STING, "karkozanovoye zhalo" },
	{ LEAD_UNLOADER, "svintsovyy razgruzchik" },
	{ STORM_RIFLE, "avtomaticheskaya vintovka" },
	{ CARCOSAN_BOLT, "karkozan vkhod" },
	{ BRONZE_SMG_BULLET, "bronzovaya pulya pistolet-pulemet" },
	{ HOLLOW_POINT_MG_BULLET, "pulya mg s polym nakonechnikom" },
	{ LOWRATE_ASSAULT_RIFLE_BULLET, "pulya dlya shturmovoy vintovki nizkogo kachestva" },
	{ COATED_AUTO_SHELL, "avto obolochka s pokrytiyem" },
	{ LIGHT_ARROW, "svetovaya strelka" },
	{ FALCHION, "fal'shion" },
	{ MOUNTAIN_SWORD, "gornyy mech" },
	{ ORCISH_SCIMITAR, "orochiy yatagan" },
	{ STINGING_SWORD, "zhalyashchiy mech" },
	{ ORCISH_LONG_SWORD, "orkskiy dlinnyy mech" },
	{ FLOWING_SWORD, "struyashchiysya mech" },
	{ ULTRA_SWORD, "ul'tra mech" },
	{ HEAVY_MACE, "tyazhelaya bulava" },
	{ EXECUTIONER_S_MACE, "bulava palacha" },
	{ TINMACE, "zhest'" },
	{ ORCISH_MORNING_STAR, "oroch'ya utrennyaya zvezda" },
	{ TURNING_STAR, "vrashchayushchayasya zvezda" },
	{ HEAVY_WAR_HAMMER, "tyazhelyy boyevoy molot" },
	{ SEXY_MARY_JANE, "seksual'naya meri dzheyn" },
	{ KITTEN_HEEL_PUMP, "tufli-lodochki na kabluke kotenka" },
	{ TRIPLE_HEADED_FLAIL, "trekhglavyy tsep" },
	{ SPIKED_CHAIN, "shipovannaya tsep'" },
	{ FOOTBOW, "smychok" },
	{ MASTER_KNUCKLES, "vladelets naklz" },
	{ SHELL_CLUB, "snaryadnyy klub" },
	{ CUDGEL, "bit' palkoy" },
	{ LIGHT_CLUB, "legkiy klub" },
	{ STEEL_CLUB, "stal'naya dubinka" },
	{ HEAVENLY_BALL, "nebesnyy shar" },
	{ DRAMA_ORB, "dramaticheskiy shar" },
	{ MARKET_GRINDER, "rynochnaya myasorubka" },
	{ GRAND_GRINDER, "velikaya drobilka" },
	{ SHICKSTAKE, "zarabotok" },
	{ PATINA_BAR, "chern' polosa" },
	{ LOCHABER_AXE, "topor lochabera" },
	{ TOP_POLE, "verkhniy stolb" },
	{ SVAERDSTAV, "svayerdstav" },
	{ STANGOEKSE, "stangoyekse" },
	{ COBALT_SPEAR, "kobal'tovoye kop'ye" },
	{ CHEAP_SPEAR, "deshevoye kop'ye" },
	{ PUNCTURING_JAVELIN, "prokalyvayushcheye kop'ye" },
	{ UNDERWORLD_JAVELIN, "kop'ye prestupnogo mira" },
	{ TRANSPARENCE_THROWER, "metatel' prozrachnosti" },
	{ AIRSTRIKE_PIKE, "aviaudar shchuka" },
	{ BAGGY_SLING, "meshkovatyy remen'" },
	{ LIGHT_CROSSBOW, "legkiy arbalet" },
	{ SPIKY_BOLT, "ostrokonechnyy vkhod" },
	{ HARDENED_BOLT, "zakalennyy vkhod" },
	{ LOWLY_DART, "skromnyy drotik" },
	{ WOOD_DART, "derevyannyy drotik" },
	{ LIGHT_STAR, "svetlaya zvezda" },
	{ ALU_BOOMERANG, "alu bumerang" },
	{ SUNLIGHT_MAGGOT, "solnechnyy svet lichinka" },
	{ TOQUE, "kolpak" },
	{ HARMONIUM_HELM, "fisgarmoniya shlem" },
	{ PONTIFF_S_CROWN, "korona pontifika" },
	{ FACELESS_HELM, "bez litsa shlem" },
	{ HELM_OF_MADNESS, "shlem bezumiya" },
	{ LANTERN_PLATE_MAIL, "fonar' plastinchataya kol'chuga" },
	{ HIGH_ELVEN_PLATE, "plastina vysshikh el'fov" },
	{ IMPERIAL_ELVEN_ARMOR, "imperatorskiye el'fiyskiye dospekhi" },
	{ HARMONIUM_PLATE, "tarelka fisgarmonii" },
	{ HARMONIUM_SCALE_MAIL, "kol'chuga v masshtabe garmoshki" },
	{ EILISTRAN_ARMOR, "eylistranskaya bronya" },
	{ THROWAWAY_ARMOR, "odnorazovaya bronya" },
	{ MESH_ARMOR, "setchataya bronya" },
	{ CUIRASS_ARMOR, "kirasa dospekhi" },
	{ HELLFORGED_PLATE_MAIL, "adskaya latnaya kol'chuga" },
	{ WAISTCLOTH, "poyas" },
	{ REINFORCED_SHIRT, "usilennaya rubashka" },
	{ SMOKY_VIOLET_FACELESS_ROBE, "dymchato-fioletovyy bezlikiy khalat" },
	{ BUCKLER, "bakler" },
	{ LIGHT_SHIELD, "legkiy shchit" },
	{ RESONANT_SHIELD, "rezonansnyy shchit" },
	{ CRINGE_SHIELD, "s''yezhivat'sya shchit" },
	{ BRONZE_SHIELD, "bronzovyy shchit" },
	{ SHELL_SHIELD, "pantsirnyy shchit" },
	{ SUPER_SHIELD, "superskiy shchit" },
	{ TOWER_SHIELD, "bashennyy shchit" },
	{ HARMONIUM_GAUNTLETS, "rukavitsy fisgarmonii" },
	{ ORCISH_BOOTS, "oroch'i sapogi" },
	{ HARMONIUM_BOOTS, "sapogi-garmoshka" },
	{ WIND_AND_FIRE_WHEELS, "vetrovyye i ognennyye kolesa" },
	{ AMULET_OF_NAUSEA, "amulet of toshnota" },
	{ SUPERPOWER_GAUNTLETS, "sverkhmoshchnyye rukavitsy" },
	{ GAUNTLETS_OF_PHYSICAL_SUSTENAN, "rukavitsy fizicheskoy podderzhki" },
	{ GAUNTLETS_OF_FISTFIGHTING, "rukavitsy kulachnogo boya" },
	{ HELM_OF_HOLDING, "rul' kholdinga" },
	{ ANTIMINDFLAY_HELMET, "shlem protiv napadeniya razuma" },
	{ GOOD_ESP_HELMET, "khoroshiy esp shlem" },
	{ SPEED_HOLDING_BOOTS, "botinki dlya uderzhaniya skorosti" },
	{ RIN_UPPER_ADORNMENT, "verkhneye ukrasheniye" },
	{ AMULET_OF_CLEAR_MIND, "amulet of yasnyy um" },
	{ POT_REFLECTION, "otrazheniye" },
	{ SPE_MAGIC_BOLT, "volshebnyy vkhod" },
	{ SPE_LIGHT_AREA, "svetlaya zona" },
	{ KITE_SHIELD, "vozdushnyy zmey shchit" },
	{ SCR_RETURN, "vozvrashchat'sya" },
	{ SPE_RETURN, "vozvrashchat'sya" },
	{ DISINFECTANT_GLOVES, "dezinfitsiruyushchiye perchatki" },
	{ HYPERSONIC_GLOVES, "giperzvukovyye perchatki" },
	{ HEEL_WISE_SHOES, "tufli na kabluke" },
	{ EPVI_STONE, "kamen' khimicheskaya kompaniya" },
	{ EPVI_SLIPPERS, "tapochki khimicheskaya kompaniya" },
	{ SABRINA_PLATFORM_BOOTS, "botinki Sabrina na platforme" },
	{ AEFDE_STONE, "efde kamen'" },
	{ FISHINGHAIL_MET, "vstretil rybolovnyy grad" },
	{ SPE_MEDIUM_HEALING, "sredneye istseleniye" },
	{ SPE_STRONG_HEALING, "sil'noye istseleniye" },
	{ SPE_SUPER_HEALING, "superskiy istseleniye" },
	{ SPE_HEALING_RAIN, "tselebnyy dozhd'" },
	{ SPE_TELEPORT_SELF, "teleportirovat'sya sam" },
	{ WAN_MEDIUM_HEALING, "sredneye istseleniye" },
	{ WAN_STRONG_HEALING, "sil'noye istseleniyeistseleniye" },
	{ WAN_SUPER_HEALING, "superskiy istseleniyeistseleniye" },
	{ WAN_TELEPORT_SELF, "teleportirovat'sya sam" },
	{ ACID_SYRINGE, "kislotnyy shprits" },
	{ NIGHT_VISION_GOGGLES, "ochki nochnogo videniya" },
	{ COMPLETE_BLOCKAGE_SHIELD, "polnaya blokirovka shchita" },
	{ EGGKICK_SHOES, "obuv' dlya yaits" },
	{ POT_BOOST, "sposobstvovat' rostu" },
	{ SPE_DEFENSIVE_FIREBALL, "zashchitnyy ognennyy shar" },
	{ SPE_ULTRA_P, "ul'tra pistolet" },
	{ SPE_FORCIBLE_MOVE, "nasil'stvennyy khod" },
	{ MEAN_BURDEN_STONE, "sredniy obremenitel'nyy kamen'" },
	{ CARRCAP_STONE, "karkapskiy kamen'" },
	{ UMENG_STONE, "kamen' umen" },
	{ AMULET_OF_TOTAL_BURDEN, "amulet of obshchaya nagruzka" },
	{ TOO_HEAVY_PLATE, "slishkom tyazhelaya tarelka" },
	{ UMENG_CLOAK, "umen plashch" },
	{ GAUNTLETS_OF_TRUE_AIM, "rukavitsy istinnoy tseli" },
	{ GAUNTLETS_OF_ARMORING, "rukavitsy broni" },
	{ BLACK_HENBANE, "chernaya belena" },
	{ DIGESTION_CAKE, "pishchevareniye tort" },
	{ HELMET_OF_SAVING, "shlem spaseniya" },
	{ TEACHING_STAFF, "prepodavatel'skiy sostav" },
	{ CANE, "trostnik" },
	{ SATANIC_ARMOR, "sataninskaya bronya" },
	{ UPPERWEAVER_S_ROBE, "khalat verkhovogo tkacha" },
	{ SHOCK_ISOLATED_HEELS, "shok izolirovannyye kabluki" },
	{ FLEECLE_SHOES, "flisovaya obuv'" },
	{ POT_GREASE, "smazka" },
	{ AMULET_OF_PHYSICAL_BOOST, "amulet of fizicheskiy impul's" },
	{ AMULET_OF_MENTAL_BOOST, "amulet of umstvennyy impul's" },
	{ AMULET_OF_THE_MATRIX, "amulet of matritsa" },
	{ DARK_LIGHTSABER, "temnyy svetovoy mech" },
	{ JEDI_ROBE, "dzhedayskiy khalat" },
	{ RANDOM_JACKET, "sluchaynaya kurtka" },
	{ COMMANDER_HEELS, "komandirskiye kabluki" },
	{ GAUNTLETS_OF_PARALYSIS_ANNOUNC, "anons rukavits paralicha" },
	{ VERY_SPECIFIC_GLOVES, "ochen' spetsificheskiye perchatki" },
	{ WOWEE_GAUNTLETS, "vau rukavitsy" },
	{ GAUNTLETS_OF_SPEED, "rukavitsy skorosti" },
	{ CRITICAL_GAUNTLETS, "kriticheskiye rukavitsy" },
	{ MAGIC_BRACERS, "magicheskiye naruchi" },
	{ GAUNTLETS_OF_CELERITY, "rukavitsy stremitel'nosti" },
	{ TORNISTER_CLOAK, "plashch ryukzak" },
	{ CLOAK_OF_THEFT_PREVENTION, "plashch predotvrashcheniya krazhi" },
	{ SPIRIT_CLOTH, "dukh tkan'" },
	{ WAND_QUIVER_CLOAK, "plashch iz kolchana palochki" },
	{ KEVLAR_VEST, "kevlarovyy zhilet" },
	{ UTILITY_CLOAK, "praktichnyy plashch" },
	{ HELM_OF_UNLIVING_ESP, "shlem nezhivogo, osobenno" },
	{ FAIRY_HAT, "feya shlyapa" },
	{ GANGSTER_CAP, "gangsterskaya kepka" },
	{ LUCKY_MUSHROOM, "schastlivyy grib" },
	{ OMEGA_HEELS, "omega-kabluki" },
	{ BUOYANT_BOOTS, "plavuchiye botinki" },
	{ ANTI_DROWNING_BOOTS, "protivoutopayushchiye sapogi" },
	{ FLECHETTE_BOOTS, "sapogi s fleshetom" },
	{ PERMANENCE_BOOTS, "postoyannyye botinki" },
	{ FIRE_BRIGADE_HEELS, "tufli pozharnoy komandy" },
	{ BORING_BLOCK_HEELS, "skuchnyye tufli na kablukakh" },
	{ SEVEN_LEAGUE_BOOTS, "butsy semi lig" },
	{ PRINCESSEN_SHOES, "printsessen obuv'" },
	{ COMBAT_WEDGES, "boyevyye klin'ya" },
	{ CATWALK_SANDALS, "podiumnyye sandalii" },
	{ SLEEP_INDUCTION_BOOTS, "induktsionnyye botinki dlya sna" },
	{ DIDIER_SACHS_SHOES, "tufli did'ye saks" },
	{ BASIC_SHOES, "bazovaya obuv'" },
	{ CLOGS, "sabo" },
	{ BULLETPROOF_VEST, "puleneprobivayemyy zhilet" },
	{ METEORIC_STEEL_PLATE_ARMOR, "plastinchataya bronya iz meteoritnoy stali" },
	{ SHIELDBOAT, "shchitbot" },
	{ NULLIFICATION_SHIELD, "annuliruyushchiy shchit" },
	{ STORM_SHIELD, "shtormovoy shchit" },
	{ TOMAHAWK, "tomagavk" },
	{ BONE_SCYTHE, "kostyanaya kosa" },
	{ TRISHULA, "trekhzubyy stolb" },
	{ SHAKUJO, "syakudzo" },
	{ LAJATANG, "ladzhatang" },
	{ SUPERWEAPON, "superoruzhiye" },
	{ RIN_AURORA, "polyarnoye siyaniye" },
	{ RIN_SPEEDY_TRINKET, "bystraya bezdelushka" },
	{ RIN_RUIN, "razoreniye" },
	{ RIN_ALIGNMENT, "vyravnivaniye" },
	{ RIN__G, "samaya sil'naya telefonnaya svyaz'" },
	{ RIN_HONORED_SPEED, "zasluzhennaya skorost'" },
	{ AMULET_OF_FLIPPING, "amulet of perevorachivaniye" },
	{ AMULET_OF_THORNS, "amulet of shipy" },
	{ AMULET_OF_SUSTAINED_MIND, "amulet of ustoychivyy um" },
	{ AMULET_OF_SPECIAL_SHIELDING, "amulet of spetsial'naya zashchita" },
	{ AMULET_OF_VOMIT_PUMP, "amulet of rvotnyy nasos" },
	{ AMULET_OF_X, "amulet of iks" },
	{ NOPE_DRAGON_SCALE_MAIL, "net, kol'chuga iz cheshui drakona" },
	{ CRYSTALLINE_DRAGON_SCALE_MAIL, "kol'chuga iz kristallicheskoy cheshui drakona" },
	{ NOPE_DRAGON_SCALES, "net, cheshuya drakona" },
	{ CRYSTALLINE_DRAGON_SCALES, "kristallicheskaya cheshuya drakona" },
	{ NOPE_DRAGON_SCALE_SHIELD, "net, shchit iz cheshui drakona" },
	{ CRYSTALLINE_DRAGON_SCALE_SHIEL, "shchit iz kristallicheskoy cheshui drakona" },

	{ MAIDRAGON_SCALE_MAIL, "kol'chuga iz cheshui devy drakona" },
	{ MAIDRAGON_SCALES, "vesy devy drakona" },
	{ MAIDRAGON_SCALE_SHIELD, "shchit iz cheshui devy drakona" },
	{ ROBE_OF_FEMINISM, "khalat feminizma" },
	{ FEMINISM_CLOAK, "feminizm plashch" },
	{ FEMINISM_HELMET, "feminizm shlem" },
	{ FEMALE_GLOVES, "zhenskiye perchatki" },
	{ FEMININE_STILETTOS, "zhenstvennyye tufli na shpil'ke" },
	{ RIN_FEMINISM, "feminizm" },
	{ AMULET_OF_FEMINISM, "amulet of feminizm" },

	{ ORB_OF_DESTRUCTION, "sfera razrusheniya" },
	{ ORB_OF_ENCHANTMENT, "sfera volshebstva" },
	{ ORB_OF_CHARGING, "sfera zaryadki" },
	{ PAN_PIPE, "kastryulya truby" },
	{ PAN_PIPE_OF_SUMMONING, "kastryulya-truba prizyva" },
	{ PAN_PIPE_OF_THE_SEWERS, "poddon kanalizatsionnoy truby" },
	{ BRACERS_OF_DEFENSE, "naruchi zashchity" },
	{ BRACERS_OF_ABSORPTION, "naruchi pogloshcheniya" },
	{ ASBESTOS_JACKET, "asbestovaya kurtka" },
	{ BLADE_BOW, "lezviye luk" },
	{ MEADOWFOAM, "lugovaya pena" },
	{ MOTHERWORT, "pustyrnik" },
	{ WATER_HYACINTH, "vodyanoy giatsint" },
	{ SPIDDAL_STICK, "palka, vydelyayushchaya yadovityy gaz" },
	{ HARRADA, "iva dlya bit'ya" },
	{ LICHOR, "volshebnoye tsveteniye" },
	{ AMBROSIA, "pishcha bogov" },

	{ RUGGED_SACK, "prochnyy meshok" },
	{ SEATBELT_SADDLE, "sedlo s remnom bezopasnosti" },
	{ BALLPEEN_HAMMER, "molot s sharovidnym boykom" },
	{ LACQUERED_PLATE_MAIL, "lakirovannaya plastinchataya kol'chuga" },
	{ MEN_S_HIGH_HEELS, "muzhskiye tufli na kablukakh" },

	{ MULCH_STONE, "mul'chiruyushchiy kamen'" },
	{ SPELL_COOLDOWN_STONE, "kamen' vosstanovleniya zaklinaniya" },
	{ HAVE_A_PIN_STONE, "imeyte bulavochnyy kamen'" },
	{ TURBODULL_STONE, "turbotupoy kamen'" },
	{ INACCURACY_STONE, "kamen' netochnosti" },
	{ INVENTORY_SIZE_STONE, "kamen' razmera inventarya" },
	{ COSTLY_FAILURE_STONE, "dorogoy kamen' neudachi" },
	{ REDDAM_STONE, "kamen' reddama" },
	{ REDINC_STONE, "kamen' redinka" },
	{ MONSTER_MULTISHOT_STONE, "monstrovskiy mnogozaryadnyy kamen'" },
	{ MULCHER_SUIT, "kostyum mul'chera" },
	{ VANCIAN_CLOAK, "plashch vansiana" },
	{ CHOICE_O_MATE_CLOAK, "plashch vybora partnera" },
	{ DULLER_GLOVES, "boleye tupyye perchatki" },
	{ INACCURATE_GLOVES, "netochnyye perchatki" },
	{ SIZE_REDUCTION_SHIELD, "shchit umen'sheniya razmera" },
	{ COSTLY_FAILURE_HELMET, "dorogoy shlem neudachi" },
	{ RIN_REDUCE_DAMAGE, "umen'sheniye urona" },
	{ RIN_REDUCE_ACCURACY, "umen'sheniye tochnosti" },
	{ AMULET_OF_MONSTER_MULTISHOT, "amulet of monstrovskiy mnogozaryadnyy" },

	{ VERMILION_SPONGE, "alaya gubka" },
	{ BRICK_HORN, "kirpichnyy rog" },
	{ SWAMP_TENTACLE, "bolotnoye shchupal'tse" },

	{ SMALL_SWORD, "malyy mech" },
	{ BASILARD, "shveytsarskiy mech" },
	{ AWL_PIKE, "shilo-pika" },
	{ TULWAR, "tulvar" },
	{ SHAMSHIR, "vostochnaya pustynnaya sablya" },
	{ ESPANDON, "frantsuzskiy dvuruchnyy" },
	{ DIFFICULT_CROSSBOW, "slozhnyy arbalet" },
	{ FLIGHT_ARROW, "letyashchaya strela" },
	{ SEEKER_BOLT, "ishcheyka" },
	{ KITCHEN_KNIFE, "kukhonnyy nozh" },
	{ GREAT_HAMMER, "bol'shoy molot" },
	{ TRIFURCATE_SPEAR, "trifurkatnoye kop'ye" },
	{ THREE_PIECE_ROD, "trokhchastnyy zhezl" },
	{ HATCHET, "nebol'shoy toporik" },
	{ BANJO, "bandzho" },
	{ DARK_SWORD, "tomnyy mech" },
	{ BEARDED_AXE, "borodatyy topor" },
	{ MITHRIL_BOOMERANG, "mifril bumerang" },
	{ FALCATA, "fal'kata" },
	{ BATON, "dubinka" },
	{ FASCIA, "fastsiya" },
	{ KNIGHTLY_MACE, "rytsarskaya bulava" },
	{ CANYON_STAR, "zvezda kan'ona" },
	{ CROWBAR, "lom" },
	{ LONG_WHIP, "dlinnyy khlyst" },
	{ LOWER_ARM_SWORD, "mech dlya predplech'ya" },

	{ SCR_WEAPON_SPECIALIZATION, "spetsializatsiya na oruzhii" },

	{ POINTY_SHELL, "ostryy pantsir'" },
	{ HEAVY_SHELL_BALL, "tyazhelyy pantsirnyy shar" },
	{ SHELL_CHAIN, "pantsirnaya tsep'" },
	{ PHYSIO_VENOM, "fizioyad" },

	{ WEATHER_DRAGON_SCALE_MAIL, "kol'chuga iz cheshui pogodnogo drakona" },
	{ WEATHER_DRAGON_SCALES, "cheshuya pogodnogo drakona" },
	{ WEATHER_DRAGON_SCALE_SHIELD, "shchit iz cheshui pogodnogo drakona" },
	...
	{ JOHANETTA_S_JEWEL, "Johanetta dragotsennost'" },
...
STATIC_OVL struct Jitem Ancient_items[] = {
	...
	{ CATAPULT, "manjaniq" },
	{ SILVER_PISTOL_BULLET, "kumush modda belgisi" },
	...
	{ NEMEAN_LION_HIDE, "ajoyib sher yashirish" },
	...
	{ ANTIMATTER_PISTOL_BULLET, "qarshi modda o'q" },
	...
	{ LEAD_PISTOL_BULLET, "qo'rg'oshin o'qi" },
	...
	{ BONE_ARROW, "suyak o'qi" },
	{ BONE_DAGGER, "suyak xanjar" },
	{ WRAITHBLADE, "arvoh pichog'i" },
	{ TECPATL, "aztek qurboni pichog'i" },
	{ ANCUS, "ankus" },
	{ ATGEIR, "nayza kesuvchi" },
	{ KHOPESH, "o'roq shaklidagi qilich" },
	{ MACUAHUITL, "bu qanday amerika quroli bo'lishidan qat'iy nazar" },
	{ ATLATL, "tosh tasma g'ov asbobi" },
	{ ICHCAHUIPILLI, "talaffuz qilib bo'lmaydigan ismli narsa" },
	{ TINSEL_LONGSWORD, "uzun qilich" },
	{ TREESTAFF, "daraxt tayog'i" },
	{ GARBOWHIP, "axlat" },
	{ ORGANOSHIELD, "organoq" },
	{ HEAVY_TINSEL_BALL, "og'ir yaltiroq tangachalar to'pi" },
	{ AMBER_BALL, "kahrabo to'pi" },
	{ TINSEL_CHAIN, "yaltiroq tangachalar zanjiri" },
	{ AMBER_CHAIN, "kahrabo zanjiri" },
	{ GROM_AXE, "grom bolta" },
	{ HONOR_KATANA, "katanani hurmat qiling" },
	{ DIMENSIONAL_SHARD, "o'lchovli parcha" },
	{ CIRCULAR_SAW, "dumaloq arra" },
	{ AMBUSH_QATAR, "pistirma qatar" },
	{ PHEONIX_STAFF, "feniks xodimlari" },
	{ DIVINE_DART, "ilohiy irg'itiladigan o'q" },
	{ JUMPING_FLAMER, "sakrash olovi" },
	{ SECRET_SOUND_WHIP, "yashirin ovozli qamchi" },
	{ OLD_MAIL, "eski pochta" },
	{ CANDY_BRA, "konfet sutyen" },
	{ BULL_SHIELD, "buqa qalqoni" },
	{ LEAD_BOX, "qo'rg'oshin qutisi" },
	{ NANO_CHEST, "nano ko'krak qafasi" },
	{ DISPERSION_BOX, "dispersiya qutisi" },
	{ HANDYBAG, "qo'l sumkasi" },
	{ DEATH_HORN, "o'lim shoxi" },
	{ BLACK_LIGHTSABER, "qora shamchiroq" },
	{ ORANGE_LIGHTSABER, "apelsin shamchiroq" },
	{ AMBER_FRAGMENT, "kahrabo parchasi" },
	{ HEAVY_LASER_BALL, "og'ir lazer to'pi" },
	{ LASER_CHAIN, "lazer zanjiri" },
	{ SPRAY_BOX, "buzadigan amallar qutisi" },
	{ CONTROVERSY_CODE, "qarama-qarshilik kodi" },
	{ LASER_TIN_OPENER, "lazerli qalay ochuvchi" },
	{ POWERFIST, "kuchli musht" },
	{ LASERFIST, "lazer mushti" },
	{ SCR_COURSE_TRAVELING, "kurs sayohati" },
	{ CYAN_DOUBLE_LIGHTSABER, "moviy qo'shaloq shamshir" },
	{ KLIUSLING, "kliutasma g'ov" },
	{ METEOR_ARROW, "atmosfera hodisasi o'qi" },
	{ METEOR_FRAGMENT, "atmosfera hodisasi parchasi" },
	{ DARK_DRAGON_SCALE_MAIL, "qorong'u ajdaho o'lchovli pochta" },
	{ DARK_DRAGON_SCALES, "qorong'u ajdaho tarozilari" },
	{ DARK_DRAGON_SCALE_SHIELD, "qorong'u ajdaho shkalasi qalqoni" },
	{ RAINBOW_LIGHTSABER, "kamalak chirog'i" },

	{ ANNEMARIE_PLATFORM_SANDALS, "Annemarie platformali sandallar" },
	{ JIL_VELCRO_SHOES, "Jil velkro poyabzal" },
	{ JANA_SNEAKERS, "Jana krossovkalar" },
	{ KATRIN_COMBAT_BOOTS, "Katrin jangovar etiklar" },
	{ GUDRUN_WEDGE_SANDALS, "Gudrun xanjar sandallar" },
	{ ELLA_WEDGE_SANDALS, "Ella xanjar sandallar" },
	{ MANUELA_COMBAT_BOOTS, "Manuela jangovar etiklar" },
	{ JENNIFER_COMBAT_BOOTS, "Jennifer jangovar etiklar" },
	{ PATRICIA_STEEL_CAPPED_SANDALS, "Patricia po'lat qopqoqli sandallar" },
	{ ANTJE_SNEAKERS, "Antje krossovkalar" },
	{ ANTJE_COMBAT_BOOTS, "Antje jangovar etiklar" },
	{ KERSTIN_COMBAT_BOOTS, "Kerstin jangovar etiklar" },
	{ KERSTIN_WOODEN_SANDALS, "Kerstin yog'och sandallar" },
	{ KERSTIN_SNEAKERS, "Kerstin krossovkalar" },
	{ LAURA_WINTER_BOOTS, "Laura qishki etiklar" },
	{ LARISSA_PLATFORM_BOOTS, "Larissa platformali etiklar" },
	{ NORA_COMBAT_BOOTS, "Nora jangovar etiklar" },
	{ NATALIA_WEDGE_SANDALS, "Natalia xanjar sandallar" },
	{ SUSANNE_COMBAT_BOOTS, "Susanne jangovar etiklar" },
	{ LISA_COMBAT_BOOTS, "Lisa jangovar etiklar" },
	{ BRIDGHITTE_SKI_HEELS, "Bridghitte chang'i poshnalari" },
	{ JULIA_COMBAT_BOOTS, "Julia jangovar etiklar" },
	{ NICOLE_COMBAT_BOOTS, "Nicole jangovar etiklar" },
	{ RITA_STILETTOS, "Rita o'tkir poshnali poyabzal" },
	{ JANINA_LADY_PUMPS, "Janina ayol nasoslari" },
	{ ROSA_GIRL_SHOES, "Rosa qiz poyabzali" },
	{ KSENIA_PLATFORM_SANDALS, "Ksenia platformali sandallar" },
	{ LYDIA_LADY_PUMPS, "Lydia ayol nasoslari" },
	{ CONNY_COMBAT_BOOTS, "Conny jangovar etiklar" },
	{ KATIA_COMBAT_BOOTS, "Katia jangovar etiklar" },
	{ MARIYA_COMBAT_BOOTS, "Mariya jangovar etiklar" },
	{ ELISE_HIPPIE_HEELS, "Elise hippi poshnalari" },
	{ RONJA_COMBAT_BOOTS, "Ronja jangovar etiklar" },
	{ ARIANE_COMBAT_BOOTS, "Ariane jangovar etiklar" },
	{ JOHANNA_COMBAT_BOOTS, "Johanna jangovar etiklar" },
	{ INGE_COMBAT_BOOTS, "Inge jangovar etiklar" },

	{ SMG_BULLET, "qo'l quroli o'q" },
	{ MG_BULLET, "mashina injektori o'q" },
	{ RIFLE_BULLET, "miltiq o'qi" },
	{ SNIPER_BULLET, "snayper o'qi" },
	{ ASSAULT_RIFLE_BULLET, "avtomat o'qi" },
	{ ANTIMATTER_SMG_BULLET, "antimateriya qo'l quroli o'q" },
	{ ANTIMATTER_MG_BULLET, "antimater mashina injektori o'q" },
	{ ANTIMATTER_RIFLE_BULLET, "antimater miltiq o'qi" },
	{ ANTIMATTER_SNIPER_BULLET, "snayperga qarshi o'q" },
	{ ANTIMATTER_ASSAULT_RIFLE_BULLE, "antimaddali avtomat o'qi" },
	{ AUTO_SHOTGUN_SHELL, "avtomatik miltiq qobig'i" },
	{ RAYGUN_BOLT, "nurli qurol surma zulfin" },
	{ RADIO, "radioeshittirish" },
	{ LEAD_SMG_BULLET, "qo'rg'oshin qo'l quroli o'q" },
	{ LEAD_MG_BULLET, "qo'rg'oshin mashina injektori o'q" },
	{ LEAD_RIFLE_BULLET, "qo'rg'oshin miltiq o'qi" },
	{ LEAD_SNIPER_BULLET, "qo'rg'oshin snayper o'qi" },
	{ LEAD_ASSAULT_RIFLE_BULLET, "qo'rg'oshin avtomati o'qi" },
	{ AUTO_LEAD_SHOT, "avtomatik otish" },
	{ COPPER_RIFLE_BULLET, "mis miltiq o'qi" },
	{ PLATINUM_SNIPER_BULLET, "platina snayper o'qi" },
	{ CHROME_PELLET, "xrom pelleti" },
	{ GRIM_SHIELD, "dahshatli qalqon" },
	{ CLOAK_OF_PAIN_SENSE, "og'riq hissi plashi" },
	{ ONE_EATING_SIGN, "bitta ovqatlanish belgisi" },

	{ BRASS_KNUCKLES, "guruch bo'g'imlari" },
	{ SUPER_KNUCKLES, "a'lo darajadagi bo'g'inlar" },
	{ ULTRA_KNUCKLES, "haddan tashqari bo'g'imlar" },
	{ ELITE_KNUCKLES, "elita bo'g'imlari" },
	{ BUGXPLORE_HELMET, "xatolarni o'rganish dubulg'asi" },
	{ YAWNING_VISOR, "esnaydigan soyabon" },
	{ AMULET_OF_TRAP_WARPING, "amulet of tuzoqning burishishi" },
	{ AMULET_OF_HI_LEVEL_CASTING, "amulet of yuqori darajadagi kasting" },
	{ RIN_INCESSANT_FARTING, "tinimsiz sasimoq" },
	{ RIN_LAMITY, "axloqsizlik" },
	{ RIN_WALLFARTING, "devor fartingi" },
	{ ROBE_OF_DESTINY, "taqdir libosi" },
	{ TEZ_SHIELD, "aztek xudosi qalqoni" },
	{ KILLER_SPAWN_BOOTS, "qotil botinkalar" },
	{ GIANT_EXPLORER_STONE, "ulkan tadqiqotchi tosh" },
	{ TRAPWARP_STONE, "tuzoqli tosh" },
	{ YAWM_STONE, "yavm tosh" },
	{ CHAOSCRADLE_STONE, "xaos beshigi tosh" },
	{ TEZ_STONE, "aztek xudosi tosh" },
	{ BOSSGOD_STONE, "bossxudo tosh" },
	{ UBERGOD_STONE, "oliy xudo tosh" },
	{ TOO_GOOD_GO_STONE, "juda yaxshi tosh" },
	{ KILLER_ROOM_STONE, "qotil xona tosh" },
	{ FUNWALL_STONE, "qo'ziqorin tosh" },
	{ CLOAK_OF_INVERSION, "inversiya plashi" },
	{ CLOAK_OF_WINCING, "burilish plashi" },
	{ BOOTS_OF_INVERSION, "inversiya etiklari" },
	{ INVERSION_SHIELD, "inversiya qalqoni" },
	{ WINCING_GRIMACE, "jilmayish" },
	{ RIN_WINCING, "qimirlatish" },

	{ RUTH_SNEAKERS, "Ruth krossovkalar" },
	{ MAGDALENA_COMBAT_BOOTS, "Magdalena jangovar etiklar" },
	{ MARLEEN_COMBAT_BOOTS, "Marleen jangovar etiklar" },
	{ KLARA_PLATFORM_SANDALS, "Klara platformali sandallar" },
	{ FRIEDERIKE_DANCING_SHOES, "Friederike raqs poyabzali" },
	{ NAOMI_STILETTOS, "Naomi yupqa poshnalar" },
	{ UTE_PLATFORM_SANDALS, "Ute platformali sandallar" },
	{ JASIEEN_WEDGE_SANDALS, "Jasieen xanjar sandallar" },
	{ YASAMAN_LEATHER_BOOTS, "Yasaman charm etiklar" },
	{ MAY_BRITT_SANDALS, "May-Britt sandallar" },

	{ REALLY_BAD_HELM, "haqiqatan ham yomon rul" },
	{ COVID____COATED_CLOAK, "covid-19 bilan qoplangan plash" },
	{ RIN_ARTIFACT_BLASTING, "artefaktni portlatish" },
	{ REALLY_BAD_STONE, "haqiqatan ham yomon tosh" },
	{ COVID_STONE, "kovid tosh" },
	{ BLAST_STONE, "portlovchi tosh" },

	{ HONEYCOMB, "asal uyasi" },
	{ NASTYCURSE_STONE, "yomon la'nat tosh" },
	{ SPI_IMAGE_MOOSE_SHIELD, "ko'zgu tasviri mus qalqoni" },
	{ SHOVEL, "belkurak" },

	{ NADINE_STILETTO_SANDALS, "Nadine yupqa poshnalar sandallar" },
	{ LUISA_HUGGING_BOOTS, "Luisa etiklarni quchoqlash" },
	{ IRINA_WEDGE_SANDALS, "Irina xanjar sandallar" },
	{ LISELOTTE_HUGGING_BOOTS, "Liselotte etiklarni quchoqlash" },
	{ GRETA_HUGGING_BOOTS, "Greta etiklarni quchoqlash" },
	{ JANE_HUGGING_BOOTS, "Jane etiklarni quchoqlash" },
	{ SUE_LYN_WINTER_BOOTS, "Sue Lyn qishki etiklar" },
	{ CHARLOTTE_HUGGING_BOOTS, "Charlotte etiklarni quchoqlash" },
	{ HANNAH_CUDDLE_BOOTS, "Hannah quchoqlash botinkalar" },
	{ LITTLE_MARIE_HUGGING_BOOTS, "Little Marie etiklarni quchoqlash" },

	{ DEFUSING_BOX, "zararsizlantirish qutisi" },
	{ CLOAK_OF_DEFUSING, "zararsizlantirish niqobi" },
	{ GAUNTLETS_OF_DEFUSING, "zararsizlantirish qurollari" },
	{ AMULET_OF_DEFUSING, "amulet of zararsizlantirish" },

	{ PARRY_DAGGER, "bo'yin tovlamoq xanjar" },
	{ PARRY_SWORD, "bo'yin tovlamoq qilich" },
	{ PISTOL_PAIR, "to'pponcha juftligi" },
	{ FIVE_SEVEN_BULLET, "besh-etti o'q" },
	{ LEAD_FIVE_SEVEN_BULLET, "qo'rg'oshin besh-etti o'q" },
	{ SHADOW_FIVE_SEVEN_BULLET, "soya besh-etti o'q" },
	{ ANTIMATTER_FIVE_SEVEN_BULLET, "antimater besh-etti o'q" },
	{ RAPID_DART, "tez irg'itiladigan o'q" },
	{ NINJA_STAR, "yapon jangchisi yulduzi" },
	{ FLAMETHROWER, "o't o'chiruvchi" },
	{ HEAVY_SPEAR, "og'ir nayza" },
	{ SUPERHEAVY_SPEAR, "o'ta og'ir nayza" },
	{ WAN_STONE_TO_FLESH, "go'shtga tosh" },
	{ WAN_LAVA, "erigan tosh" },
	{ RIN_IMPACT, "ta'sir" },
	{ RIN_REVERSE_REGENERATION, "teskari regeneratsiya" },
	{ ROBE_OF_PUGILISM, "pugilizm libosi" },
	{ ROBE_OF_FOCUSSING, "diqqatni jamlash libosi" },
	{ SHIELD_PATE_GLASSES, "qalqon kalla ko'zoynaklari" },
	{ INFUSION, "infuzion" },
	{ BEAUTY_PACK, "go'zallik to'plami" },
	{ BLESSER, "barakali" },
	{ SCR_EXTRA_SKILL_POINT, "qo'shimcha mahorat nuqtasi" },
	{ SCR_PROOF_ACCESSORY, "isbotlovchi aksessuar" },
	{ SCR_PROOF_TOOL, "isbotlash vositasi" },
	{ SCR_NAME, "nomi" },
	{ AMULET_VERSUS_NAGGING, "amulet qichqirishga qarshi" },
	{ AMULET_OF_SYMBIOTE_SAVING, "amulet of simbiotani saqlash" },
	{ POT_CURE_AIDS, "davolovchi vositalar" },
	{ SPE_COMBAT_COMMAND, "jangovar buyruq" },
	{ SPE_DEFUSING, "zararsizlantirish" },
	{ LIGHTTORCH, "yorug'lik mash'al" },
	{ LASER_FLYAXE, "lazer chivin" },
	{ PINK_LIGHTSWORD, "pushti shamshir" },
	{ PINK_DOUBLE_LIGHTSWORD, "pushti qo'shaloq shamshir" },

	{ RAD_X, "radiatsiya shprits" },
	{ RADAWAY, "to'satdan" },
	{ SPE_RESIST_STUN, "hayratga qarshi turish" },
	{ SPE_RESIST_CONFUSION, "chalkashlikka qarshi turing" },
	{ SPE_RESIST_CONTAMINATION, "ifloslanishga qarshi turish" },

	{ STONE_OF_COMPLETE_FUCKUP, "butunlay behuda tosh" },
	{ REAL_LIE_STONE, "haqiqiy yolg'on tosh" },
	{ ESCAPE_PAST_STONE, "o'tgan toshdan qochish" },
	{ PETHATE_STONE, "uy hayvonlaridan nafratlanish tosh" },
	{ PET_LASHOUT_STONE, "uy hayvonlari qamash uchun tosh" },
	{ PETSTARVE_STONE, "uy hayvonlari ochlik uchun tosh" },
	{ PETSCREW_STONE, "vintli tosh" },
	{ TECH_LOSS_STONE, "texnologik yo'qotish tosh" },
	{ PROOFLOSS_STONE, "isbotlangan tosh" },
	{ UN_INVIS_STONE, "ko'rinmaydigan tosh" },
	{ DETECTATION_STONE, "aniqlash tosh" },
	{ ETERNAL_LIAR_BOOTS, "abadiy yolg'onchi etiklar" },
	{ UNDETECTION_GLOVES, "aniqlanmagan qo'lqoplar" },
	{ PETHATE_CLOAK, "uy hayvonlaridan nafratlanish plash" },
	{ PET_LASHOUT_CLOAK, "uy hayvonlari uchun shov-shuv plash" },
	{ PETSTARVE_CLOAK, "uy hayvonlari uchun ochlik plash" },
	{ PETSCREW_CLOAK, "vintli plash" },
	{ NON_PROOF_CLOAK, "isbotlanmagan plash" },
	{ TECH_LOSS_HELMET, "texnologik yo'qotish dubulg'asi" },
	{ AMULET_OF_ESCAPE_PROBLEM, "amulet of qochish muammosi" },
	{ RIN_VISIBLE_BECOMING, "ko'rinadigan bo'lish" },

	{ OPTION_STONE, "variant tosh" },
	{ MISCOLOR_STONE, "noto'g'ri rangdagi tosh" },
	{ ONE_RAINBOW_STONE, "bitta kamalak tosh" },
	{ COLORSHIFT_STONE, "rang o'zgaruvchan tosh" },
	{ TOP_LINE_STONE, "yuqori chiziqli tosh" },
	{ CAPS_STONE, "qopqoq tosh" },
	{ UN_KNOWLEDGE_STONE, "bilimsiz tosh" },
	{ DARKHANCE_STONE, "qorong'u tosh" },
	{ DSCHUEUEUET_STONE, "g'alati ovoz tosh" },
	{ NOPESKILL_STONE, "yo'q mahorat tosh" },
	{ DARK_HAND_GLOVES, "qora qo'lqoplar" },
	{ GAUNTLETS_OF_RAINBOW_MOUD, "kamalak mog'orlari" },
	{ THROUGH_THE_FLOOR_BOOTS, "pol etiklari orqali" },
	{ OPTIONAL_HELMET, "ixtiyoriy dubulg'a" },
	{ TOP_HELMET, "eng baland dubulg'a" },
	{ ABCDE_HELMET, "alifbo dubulg'asi" },
	{ COLOR_CHANGING_CONE, "rangni o'zgartiruvchi konus" },
	{ CLOAK_OF_NULLIFICATION, "bekor qilish niqobi" },
	{ AMULET_OF_MISCOLORATION, "amulet of noto'g'ri rang berish" },
	{ AMULET_OF_LOST_KNOWLEDGE, "amulet of yo'qolgan bilim" },
	{ AMULET_OF_SEVERE_FUCKUP, "amulet of qattiq janjal" },

	{ CASINO_CHIP, "kazino chipi" },

	{ AMULET_OF_BURDEN, "amulet of yuk" },
	{ CLOAK_OF_BURDEN, "yuk kiyimi" },
	{ CLOAK_OF_VACUUM, "vakuum plashi" },
	{ VACUUM_HELMET, "vakuumli dubulg'a" },
	{ VACUUM_STAFF, "vakuum xodimlari" },

	{ CLOAK_OF_RESISTANCE_PIERCING, "qarshilik pirsingining plashi" },
	{ GAUNTLETS_OF_ELEMENTAL_POWER, "elementar kuch qo'ltiqlari" },
	{ RIN_PIERCING, "pirsing" },
	{ ROBE_OF_MAGIC_POWER, "sehrli kuch libosi" },

	{ MYSTERY_DRAGON_SCALE_MAIL, "sirli ajdaho miqyosidagi pochta" },
	{ MYSTERY_DRAGON_SCALES, "sirli ajdaho tarozilari" },
	{ MYSTERY_DRAGON_SCALE_SHIELD, "sirli ajdaho shkalasi qalqoni" },
	{ AMULET_OF_FUCKING, "amulet of lanet" },
	{ AMULET_OF_MYSTERY_RESISTANCE, "amulet of sirli qarshilik" },
	{ CLOAK_OF_FUCKING, "jinnilik plashi" },
	{ GAUNTLETS_OF_FORTUNE, "boylik qo'ltiqlari" },
	{ GAUNTLETS_OF_MYSTERY_RESISTANC, "sirli qarshilik qo'ltiqlari" },
	{ CLOAK_OF_MAGIC_FIND, "sehrli topilma plashi" },
	{ COMBINATION_CLOAK, "kombinatsiyalangan plash" },
	{ CLOAK_OF_LOWER_MYSTERY, "pastki sirning plashi" },
	{ CLOAK_OF_MYSTERY, "sir plashi" },
	{ CLOAK_OF_ARMOR_MYSTERY, "zirh siri" },
	{ RIN_MAGIC_FIND, "sehrli topilma" },
	{ RIN_MYSTERY_RESISTANCE, "sirli qarshilik" },
	{ MYSTERIOUS_PICK, "sirli tanlov" },
	{ MAGISWORD, "sehrli so'z" },
	{ HELM_OF_MYSTERY_RES, "sirli res" },
	{ MYSTERIOUS_BOOTS, "sirli etiklar" },
	{ MYSTERY_SHIELD, "sirli qalqon" },
	{ ROBE_OF_SPELL_BOOSTING, "imloni kuchaytirish libosi" },
	{ CLOAK_OF_SPELL_BOOSTING, "afsunni kuchaytirish" },
	{ CASTSHIRT, "quyma ko'ylak" },
	{ GAUNTLETS_OF_SPELL_POWER, "afsun kuchining qo'ltiqlari" },
	{ AMULET_OF_SPELLCASTING, "amulet of imlo" },
	{ CASTER_STAFF, "kastor xodimlari" },
	{ AMULET_OF_MONSTER_SAVING, "amulet of yirtqich hayvonlarni tejash" },
	{ AMULET_OF_THIRD_CHANCE, "amulet of uchinchi imkoniyat" },
	{ FLEURE, "chayqalish" },
	{ BROKEN_BOOTS, "singan etiklar" },
	{ RIPPED_CLOAK, "yirtilgan plash" },
	{ RUSTED_MAIL, "zanglagan pochta" },
	{ RUSTED_GAUNTLETS, "zanglagan qo'lqoplar" },
	{ BROKEN_SHIELD, "singan qalqon" },
	{ BROKEN_HELMET, "singan dubulg'a" },
	{ CRUMBLED_SHIRT, "maydalangan ko'ylak" },
	{ OVER_SHOES, "poyabzal ustida" },
	{ TANJA_SNEAKERS, "Tanja krossovkalari" },
	{ SONJA_SNEAKERS, "Sonja krossovkalari" },
	{ RHEA_LADY_PUMPS, "Rhea xonim nasoslari" },
	{ LARA_COMBAT_BOOTS, "Lara jangovar etiklar" },
	{ BROKEN_SWORD, "singan qilich" },
	{ COPPER_PLATE_MAIL, "mis plastinka pochta" },
	{ GOLDEN_SHIELD, "oltin qalqon" },
	{ TANK_SADDLE, "rezervuar egar" },
	{ BARDING, "otga minish uchun asbob" },
	{ MESH_SADDLE, "to'rli egar" },
	{ ADAMANT_LEASH, "qat'iy bog'lash" },
	{ SPE_LOOT_IMPROVEMENT, "talonchilikni yaxshilash" },
	{ SPE_MYSTERY_PROTECTION, "sirli himoya" },
	{ TONFA, "buqa zarbasi tayoqchasi" },
	{ UNWIELDY_PICK, "noqulay tanlov" },
	{ FAR_EAST_ARROW, "uzoq sharq o'qi" },
	{ TOP_BOX, "yuqori quti" },
	{ TITAN_SACK, "titan sumkasi" },
	{ JUNK_METAL, "keraksiz metall" },
	{ COBALT_CHUNK, "kobalt bo'lagi" },
	{ BRONZE_NUGGET, "bronza sof holda topilgan metall" },
	{ STEEL_SLUG, "po'lat shlyuz" },
	{ SATURNITE_FIST, "saturnit musht" },
	{ JEONTU_GEOM, "koreys jangovar vositasi" },
	{ DIM_LANTERN, "xira chiroq" },
	{ JACK_KNIFE, "jak pichog'i" },
	{ REPLICA_UNICORN_HORN, "bir shoxli shoxning nusxasi" },
	{ TITANIUM_HORN, "titan shox" },
	{ HEAVY_MESH_BALL, "og'ir to'r to'pi" },
	{ HEAVY_FIRMAMENT_BALL, "og'ir osmon to'pi" },
	{ HEAVY_SINNUM_BALL, "og'ir qalay plastinka to'pi" },
	{ HEAVY_CORAL_BALL, "og'ir marjon to'pi" },
	{ HEAVY_CHITIN_BALL, "og'ir xitin to'pi" },
	{ HEAVY_BRONZE_BALL, "og'ir bronza to'p" },
	{ HEAVY_TITANIUM_BALL, "og'ir titan to'pi" },
	{ HEAVY_STEEL_BALL, "og'ir po'latdan yasalgan shar" },
	{ HEAVY_MERCURIAL_BALL, "og'ir simob to'pi" },
	{ HEAVY_BAMBOO_BALL, "og'ir bambuk to'pi" },
	{ HEAVY_ALU_BALL, "og'ir alyuminiy to'p" },
	{ HEAVY_COBALT_BALL, "og'ir kobalt to'pi" },
	{ GREEN_STEEL_BALL, "yashil po'lat to'p" },
	{ MESH_CHAIN, "to'r zanjiri" },
	{ FIRMAMENT_CHAIN, "osmon zanjiri" },
	{ SINNUM_SCOURGE, "qalay plastinka balosi" },
	{ CORAL_NUNCHIAKU, "marjon yapon bukkeri" },
	{ CHITIN_CHAIN, "xitin zanjiri" },
	{ BRONZE_CHAIN, "bronza zanjir" },
	{ TITANIUM_SCOURGE, "titan balosi" },
	{ STEEL_NUNCHIAKU, "po'lat yapon bukkeri" },
	{ MERCURIAL_CHAIN, "simob zanjiri" },
	{ BAMBOO_CHAIN, "bambuk zanjir" },
	{ ALU_SCOURGE, "alu balosi" },
	{ COBALT_NUNCHIAKU, "kobalt yapon bukkeri" },
	{ GREEN_STEEL_CHAIN, "yashil po'lat zanjir" },
	{ FATMAN, "semiz erkak" },
	{ MINI_NUKE, "mini yadro" },
	{ SHUTTER_SHIELD, "deklansoer qalqoni" },
	{ CLOAK_OF_SHUTDOWN, "yopilish niqobi" },
	{ RIN_SHUTDOWN, "o'chirish; yopish" },
	{ GAUNTLETS_OF_AUTOMATIC_SHUTDOW, "avtomatik o'chirish qo'ltiqlari" },
	{ AMULET_OF_AUTOMATIC_SHUTDOWN, "amulet of avtomatik o'chirish" },
	{ RIN_NASTINESS_RESISTANCE, "jirkanch qarshilik" },
	{ RIN_INDIGESTION, "ovqat hazm qilish buzilishi" },
	{ LIGHT_MAIL, "engil pochta" },
	{ LOOT_CHEST, "o'lja ko'kragi" },
	{ ROUND_MAIL, "dumaloq pochta" },
	{ PINCER_STAFF, "qisqich xodimlari" },
	{ UNDERWATER_TRIDENT, "suv osti tridenti" },
	{ SET_OF_CROW_TALONS, "qarg'a tirnoqlari to'plami" },
	{ BLADE_OF_PITY, "achinish pichog'i" },
	{ PARAZONIUM, "mutlaqo noaniq xanjar" },
	{ BRONZE_DAGGER, "bronza xanjar" },
	{ FANG_OF_APEP, "maymun tishlari" },
	{ STEEL_KNIFE, "po'lat pichoq" },
	{ CONSECRATED_KNIFE, "muqaddas pichoq" },
	{ DISKOS, "disklar" },
	{ QUATTUORST_AXE, "maksimal to'rtta bolta" },
	{ MIRRORBLADE, "oyna pichoq" },
	{ BLADE_OF_MERCY, "rahm-shafqat pichog'i" },
	{ BLADE_OF_GRACE, "inoyat pichog'i" },
	{ GLADIUS, "rimdan qilich" },
	{ ISAMUSEI, "yapon quroli" },
	{ KACHISEI, "yapon quroli ikki" },
	{ ZANBATO, "yaponlarning noaniq quroli" },
	{ UNNATURAL_SWORD, "g'ayritabiiy qilich" },
	{ DOUBLE_FORCE_BLADE, "ikki tomonlama kuch pichoq" },
	{ COBALT_STAFF, "kobalt xodimlari" },
	{ BAMBOO_STAFF, "bambuk xodimlari" },
	{ BREAKER_STAFF, "buzuvchi xodimlar" },
	{ FEATHER_STAFF, "tuklar xodimlari" },
	{ FORCE_WHIP, "kuch qamchi" },
	{ CHITIN_WHIP, "xitin qamchi" },
	{ FORMICAN_WHIP, "formik qamchi" },
	{ CLAWED_HAND, "tirnoqli qo'l" },
	{ BESTIAL_CLAW, "hayvon panjasi" },
	{ MEASURER_QATAR, "o'lchagich boshoq panjasi" },
	{ QUHAB, "quhob" },
	{ SUWAYYAH, "suvayya" },
	{ BREAKING_WHEEL, "g'ildirakni buzish" },
	{ CARCOSAN_STING, "karkozan chaqishi" },
	{ LEAD_UNLOADER, "qo'rg'oshin tushiruvchi" },
	{ STORM_RIFLE, "bo'ronli miltiq" },
	{ CARCOSAN_BOLT, "karkozan murvat" },
	{ BRONZE_SMG_BULLET, "bronza avtomat o'q" },
	{ HOLLOW_POINT_MG_BULLET, "ichi bo'sh nuqta mg o'q" },
	{ LOWRATE_ASSAULT_RIFLE_BULLET, "past tezlikli avtomat o'qi" },
	{ COATED_AUTO_SHELL, "qoplangan avtomatik qobiq" },
	{ LIGHT_ARROW, "engil o'q" },
	{ FALCHION, "lekin enli egri qilich" },
	{ MOUNTAIN_SWORD, "tog' qilichi" },
	{ ORCISH_SCIMITAR, "ork palasi" },
	{ STINGING_SWORD, "qichitqi qilich" },
	{ ORCISH_LONG_SWORD, "ork uzun qilichi" },
	{ FLOWING_SWORD, "oqayotgan qilich" },
	{ ULTRA_SWORD, "haddan tashqari qilich" },
	{ HEAVY_MACE, "og'ir to'qmoq" },
	{ EXECUTIONER_S_MACE, "jallodning to'zi" },
	{ TINMACE, "qalay gurzi" },
	{ ORCISH_MORNING_STAR, "ork tong yulduzi" },
	{ TURNING_STAR, "aylanuvchi yulduz" },
	{ HEAVY_WAR_HAMMER, "og'ir urush bolg'asi" },
	{ SEXY_MARY_JANE, "seksual meri jeyn" },
	{ KITTEN_HEEL_PUMP, "mushukchalar uchun poshnali nasos" },
	{ TRIPLE_HEADED_FLAIL, "uch boshli chayqalish" },
	{ SPIKED_CHAIN, "tikanli zanjir" },
	{ FOOTBOW, "oyoq kamon" },
	{ MASTER_KNUCKLES, "usta bo'g'imlari" },
	{ SHELL_CLUB, "qobiq klubi" },
	{ CUDGEL, "qo'ltiq" },
	{ LIGHT_CLUB, "yorug'lik klubi" },
	{ STEEL_CLUB, "po'lat klub" },
	{ HEAVENLY_BALL, "samoviy to'p" },
	{ DRAMA_ORB, "dramaturgiya shari" },
	{ MARKET_GRINDER, "bozor maydalagich" },
	{ GRAND_GRINDER, "katta maydalagich" },
	{ SHICKSTAKE, "tayoq silkitish" },
	{ PATINA_BAR, "rangli metall ustun" },
	{ LOCHABER_AXE, "istisno bolta" },
	{ TOP_POLE, "yuqori qutb" },
	{ SVAERDSTAV, "qilich xodimlari" },
	{ STANGOEKSE, "juda uzun bolta" },
	{ COBALT_SPEAR, "kobalt nayzasi" },
	{ CHEAP_SPEAR, "arzon nayza" },
	{ PUNCTURING_JAVELIN, "nayzani teshish" },
	{ UNDERWORLD_JAVELIN, "yer osti nayzasi" },
	{ TRANSPARENCE_THROWER, "shaffof otishchi" },
	{ AIRSTRIKE_PIKE, "havo hujumi uzun nayza" },
	{ BAGGY_SLING, "sumkali tasma g'ov" },
	{ LIGHT_CROSSBOW, "engil krossovka" },
	{ SPIKY_BOLT, "tikanli murvat" },
	{ HARDENED_BOLT, "qattiqlashtirilgan murvat" },
	{ LOWLY_DART, "past o'q" },
	{ WOOD_DART, "yog'och o'q" },
	{ LIGHT_STAR, "yorug' yulduz" },
	{ ALU_BOOMERANG, "alu bumerang" },
	{ SUNLIGHT_MAGGOT, "quyosh nuri qurtlari" },
	{ TOQUE, "tok" },
	{ HARMONIUM_HELM, "garmoniy rul" },
	{ PONTIFF_S_CROWN, "pontifik toji" },
	{ FACELESS_HELM, "yuzsiz rul" },
	{ HELM_OF_MADNESS, "jinnilik ruliga" },
	{ LANTERN_PLATE_MAIL, "fonar plitasi pochta" },
	{ HIGH_ELVEN_PLATE, "yuqori elf plastinka" },
	{ IMPERIAL_ELVEN_ARMOR, "imperator elf zirhi" },
	{ HARMONIUM_PLATE, "garmonium plitasi" },
	{ HARMONIUM_SCALE_MAIL, "garmoniy miqyosidagi pochta" },
	{ EILISTRAN_ARMOR, "eilistran zirhi" },
	{ THROWAWAY_ARMOR, "tashlandiq zirh" },
	{ MESH_ARMOR, "to'rli zirh" },
	{ CUIRASS_ARMOR, "quirass zirh" },
	{ HELLFORGED_PLATE_MAIL, "do'zax soxta plastinka pochta" },
	{ WAISTCLOTH, "bel kiyimi" },
	{ REINFORCED_SHIRT, "mustahkamlangan ko'ylak" },
	{ SMOKY_VIOLET_FACELESS_ROBE, "tutunli binafsha yuzsiz xalat" },
	{ BUCKLER, "bukuvchi" },
	{ LIGHT_SHIELD, "yorug'lik qalqoni" },
	{ RESONANT_SHIELD, "rezonans qalqoni" },
	{ CRINGE_SHIELD, "siqilish qalqoni" },
	{ BRONZE_SHIELD, "bronza qalqon" },
	{ SHELL_SHIELD, "qobiq qalqoni" },
	{ SUPER_SHIELD, "a'lo darajadagi qalqon" },
	{ TOWER_SHIELD, "minora qalqoni" },
	{ HARMONIUM_GAUNTLETS, "garmonium qo'lqoplari" },
	{ ORCISH_BOOTS, "ork etiklari" },
	{ HARMONIUM_BOOTS, "garmonium etiklari" },
	{ WIND_AND_FIRE_WHEELS, "shamol va olov g'ildiraklari" },
	{ AMULET_OF_NAUSEA, "amulet of ko'ngil aynishi" },
	{ SUPERPOWER_GAUNTLETS, "a'lo darajadagi kuch qo'ltiqlari" },
	{ GAUNTLETS_OF_PHYSICAL_SUSTENAN, "jismoniy ta'minlovchi qo'ltiqlar" },
	{ GAUNTLETS_OF_FISTFIGHTING, "mushtlashish qurollari" },
	{ HELM_OF_HOLDING, "ushlagich" },
	{ ANTIMINDFLAY_HELMET, "aqlga qarshi dubulg'asi" },
	{ GOOD_ESP_HELMET, "yaxshi dubulg'a" },
	{ SPEED_HOLDING_BOOTS, "tezlikni ushlab turuvchi etiklar" },
	{ RIN_UPPER_ADORNMENT, "yuqori bezak" },
	{ AMULET_OF_CLEAR_MIND, "amulet of toza aql" },
	...
	{ HYPERSONIC_GLOVES, "gipersonik qo'lqoplar" },
	{ HEEL_WISE_SHOES, "poshnali dono poyabzal" },
	{ EPVI_STONE, "kimyo kompaniyasi tosh" },
	{ EPVI_SLIPPERS, "kimyo kompaniyasi shippaklari" },
	{ SABRINA_PLATFORM_BOOTS, "Sabrina platforma etiklari" },
	{ AEFDE_STONE, "muqobil partiya tosh" },
	{ FISHINGHAIL_MET, "baliqchi dumba uchrashdi" },
	{ SPE_MEDIUM_HEALING, "o'rtacha shifo" },
	{ SPE_STRONG_HEALING, "kuchli shifo" },
	{ SPE_SUPER_HEALING, "juda yaxshi shifo" },
	{ SPE_HEALING_RAIN, "shifobaxsh yomg'ir" },
	{ SPE_TELEPORT_SELF, "o'zini teleport qilish" },
	{ WAN_MEDIUM_HEALING, "o'rtacha shifo" },
	{ WAN_STRONG_HEALING, "kuchli shifo" },
	{ WAN_SUPER_HEALING, "juda yaxshi shifo" },
	{ WAN_TELEPORT_SELF, "o'zini teleport qilish" },
	{ ACID_SYRINGE, "kislotali shprits" },
	{ NIGHT_VISION_GOGGLES, "tungi ko'rish ko'zoynaklari" },
	{ COMPLETE_BLOCKAGE_SHIELD, "to'liq blokirovka qalqoni" },
	{ EGGKICK_SHOES, "tuxumli poyabzal" },
	{ POT_BOOST, "oshirish" },
	{ SPE_DEFENSIVE_FIREBALL, "mudofaa olovli shar" },
	{ SPE_ULTRA_P, "eng yuqori to'pponcha" },
	{ SPE_FORCIBLE_MOVE, "majburiy harakat" },
	{ MEAN_BURDEN_STONE, "yuk toshini anglatadi" },
	{ CARRCAP_STONE, "murda tosh" },
	{ UMENG_STONE, "xabarni takrorlash tosh" },
	{ AMULET_OF_TOTAL_BURDEN, "amulet of umumiy yuk" },
	{ TOO_HEAVY_PLATE, "juda og'ir plastinka" },
	{ UMENG_CLOAK, "xabarni takrorlash plash" },
	{ GAUNTLETS_OF_TRUE_AIM, "haqiqiy maqsad qo'ltiqlari" },
	{ GAUNTLETS_OF_ARMORING, "zirhli qurollar" },
	{ BLACK_HENBANE, "qora tovuq" },
	{ DIGESTION_CAKE, "ovqat hazm qilish keki" },
	{ HELMET_OF_SAVING, "tejash dubulg'asi" },
	{ TEACHING_STAFF, "pedagogik xodimlar" },
	{ CANE, "qamish" },
	{ SATANIC_ARMOR, "shaytoniy zirh" },
	{ UPPERWEAVER_S_ROBE, "yuqori to'quvchining xalati" },
	{ SHOCK_ISOLATED_HEELS, "zarba izolyatsiya qilingan poshnalar" },
	{ FLEECLE_SHOES, "poyafzal" },
	{ POT_GREASE, "yog'" },
	{ AMULET_OF_PHYSICAL_BOOST, "amulet of jismoniy kuchayishi" },
	{ AMULET_OF_MENTAL_BOOST, "amulet of aqliy yuksalish" },
	{ AMULET_OF_THE_MATRIX, "amulet of matritsa" },
	{ DARK_LIGHTSABER, "qorong'u shamchiroq" },
	{ JEDI_ROBE, "qilich ustasi xalati" },
	{ RANDOM_JACKET, "tasodifiy ko'ylagi" },
	{ COMMANDER_HEELS, "komandir poshnalari" },
	{ GAUNTLETS_OF_PARALYSIS_ANNOUNC, "falaj qo'ltiqlari e'lon qiladi" },
	{ VERY_SPECIFIC_GLOVES, "juda o'ziga xos qo'lqoplar" },
	{ WOWEE_GAUNTLETS, "voy qo'ltiqlar" },
	{ GAUNTLETS_OF_SPEED, "tezlik qo'ltiqlari" },
	{ CRITICAL_GAUNTLETS, "tanqidiy zirhli qo'lqoplar" },
	{ MAGIC_BRACERS, "sehrli brakerlar" },
	{ GAUNTLETS_OF_CELERITY, "sekinlik qo'ltiqlari" },
	{ TORNISTER_CLOAK, "ryukzak plash" },
	{ CLOAK_OF_THEFT_PREVENTION, "o'g'irlikning oldini olish" },
	{ SPIRIT_CLOTH, "ruhiy mato" },
	{ WAND_QUIVER_CLOAK, "tayoqchali plash" },
	{ KEVLAR_VEST, "o'qga chidamli yelek" },
	{ UTILITY_CLOAK, "foydali plash" },
	{ HELM_OF_UNLIVING_ESP, "jonsizning ruliga, xususan" },
	{ FAIRY_HAT, "peri shlyapa" },
	{ GANGSTER_CAP, "bosqinchi qalpoqchasi" },
	{ LUCKY_MUSHROOM, "omadli qo'ziqorin" },
	{ OMEGA_HEELS, "omega poshnalari" },
	{ BUOYANT_BOOTS, "suzuvchi etiklar" },
	{ ANTI_DROWNING_BOOTS, "cho'kishga qarshi botinkalar" },
	{ FLECHETTE_BOOTS, "xanjar tikilgan etiklar" },
	{ PERMANENCE_BOOTS, "doimiy etiklar" },
	{ FIRE_BRIGADE_HEELS, "o't o'chiruvchilar poshnalari" },
	{ BORING_BLOCK_HEELS, "zerikarli blokli poshnalar" },
	{ SEVEN_LEAGUE_BOOTS, "yetti liga butsalari" },
	{ PRINCESSEN_SHOES, "malika poyabzali" },
	{ COMBAT_WEDGES, "jangovar to'siqlar" },
	{ CATWALK_SANDALS, "podium sandallari" },
	{ SLEEP_INDUCTION_BOOTS, "uyqu indueksiyon etiklari" },
	{ DIDIER_SACHS_SHOES, "gey kiyim dizayneri poyabzali" },
	{ BASIC_SHOES, "asosiy poyabzal" },
	{ CLOGS, "tiqilib qoladi" },
	{ BULLETPROOF_VEST, "o'q o'tkazmaydigan jilet" },
	{ METEORIC_STEEL_PLATE_ARMOR, "meteorik po'lat plastinka zirh" },
	{ SHIELDBOAT, "qalqon kemasi" },
	{ NULLIFICATION_SHIELD, "bekor qilish qalqoni" },
	{ STORM_SHIELD, "bo'ron qalqoni" },
	{ TOMAHAWK, "harbiy bolta" },
	{ BONE_SCYTHE, "suyak o'roq" },
	{ TRISHULA, "uch tishli qutb" },
	{ SHAKUJO, "axlat xodimlari" },
	{ LAJATANG, "uzoq jangovar xodimlar" },
	{ SUPERWEAPON, "ulkan qurol" },
	{ RIN_AURORA, "quyosh oqimi" },
	{ RIN_SPEEDY_TRINKET, "tez bezak" },
	{ RIN_RUIN, "xarob" },
	{ RIN_ALIGNMENT, "tekislash" },
	{ RIN__G, "maksimal telefon aloqasi" },
	{ RIN_HONORED_SPEED, "hurmatli tezlik" },
	{ AMULET_OF_FLIPPING, "amulet of ag'darish" },
	{ AMULET_OF_THORNS, "amulet of tikanlar" },
	{ AMULET_OF_SUSTAINED_MIND, "amulet of barqaror aql" },
	{ AMULET_OF_SPECIAL_SHIELDING, "amulet of maxsus himoya" },
	{ AMULET_OF_VOMIT_PUMP, "amulet of qusish pompasi" },
	{ AMULET_OF_X, "amulet of xoch shaklidagi harf" },
	{ NOPE_DRAGON_SCALE_MAIL, "yo'q ajdaho miqyosidagi pochta" },
	{ CRYSTALLINE_DRAGON_SCALE_MAIL, "kristalli ajdaho shkalasi pochta" },
	{ NOPE_DRAGON_SCALES, "yo'q ajdaho tarozi" },
	{ CRYSTALLINE_DRAGON_SCALES, "kristalli ajdaho tarozilari" },
	{ NOPE_DRAGON_SCALE_SHIELD, "yo'q ajdaho shkalasi qalqoni" },
	{ CRYSTALLINE_DRAGON_SCALE_SHIEL, "kristalli ajdaho shkalasi qalqoni" },
	{ MAIDRAGON_SCALE_MAIL, "ajdaho bo'lishi mumkin miqyosidagi pochta" },
	{ MAIDRAGON_SCALES, "ajdaho bo'lishi mumkin tarozilari" },
	{ MAIDRAGON_SCALE_SHIELD, "ajdaho bo'lishi mumkin shkalasi qalqoni" },
	{ ROBE_OF_FEMINISM, "feminizm libosi" },
	{ FEMINISM_CLOAK, "feminizm plashi" },
	{ FEMINISM_HELMET, "feminizm dubulg'asi" },
	{ FEMALE_GLOVES, "ayol qo'lqoplari" },
	{ FEMININE_STILETTOS, "ayol stilettolari" },
	{ RIN_FEMINISM, "feminizm" },
	{ AMULET_OF_FEMINISM, "amulet of feminizm" },

	{ ORB_OF_DESTRUCTION, "halokat orbi" },
	{ ORB_OF_ENCHANTMENT, "sehrli shar" },
	{ ORB_OF_CHARGING, "zaryad orbi" },
	{ PAN_PIPE, "pan trubkasi" },
	{ PAN_PIPE_OF_SUMMONING, "chaqiruvning pan trubkasi" },
	{ PAN_PIPE_OF_THE_SEWERS, "kanalizatsiya trubkasi" },
	{ BRACERS_OF_DEFENSE, "himoya kuchlari" },
	{ BRACERS_OF_ABSORPTION, "assimilyatsiya qiluvchi vositalar" },
	{ ASBESTOS_JACKET, "asbest ko'ylagi" },
	{ BLADE_BOW, "pichoqli kamon" },
	{ MEADOWFOAM, "o'tloq ko'pik" },
	{ MOTHERWORT, "ona o'ti" },
	{ WATER_HYACINTH, "suv suembuelue" },
	{ SPIDDAL_STICK, "zaharli gaz chiqaradigan tayoq" },
	{ HARRADA, "tolni qamchilash" },
	{ LICHOR, "sehrli gullash" },
	{ AMBROSIA, "yunon afsonalarida ilohlar taomi" },

	{ RUGGED_SACK, "mustahkam qop" },
	{ SEATBELT_SADDLE, "xavfsizlik kamarining egari" },
	{ BALLPEEN_HAMMER, "sharli qalam bolg'a" },
	{ LACQUERED_PLATE_MAIL, "laklangan plastinka pochta" },
	{ MEN_S_HIGH_HEELS, "erkaklar uchun baland poshnali tuflilar" },

	{ MULCH_STONE, "mulchalash tosh" },
	{ SPELL_COOLDOWN_STONE, "sovutish toshini sehrlash" },
	{ HAVE_A_PIN_STONE, "to'g'nag'ich tosh bor" },
	{ TURBODULL_STONE, "turbodul tosh" },
	{ INACCURACY_STONE, "noto'g'ri tosh" },
	{ INVENTORY_SIZE_STONE, "inventar hajmi tosh" },
	{ COSTLY_FAILURE_STONE, "qimmatbaho mag'lubiyat tosh" },
	{ REDDAM_STONE, "qizil tosh" },
	{ REDINC_STONE, "o'sishni kamaytirish tosh" },
	{ MONSTER_MULTISHOT_STONE, "mahluq bir nechta zarba tosh" },
	{ MULCHER_SUIT, "mulchalagan kishi kostyumi" },
	{ VANCIAN_CLOAK, "vans ismli yigit haqida plashi" },
	{ CHOICE_O_MATE_CLOAK, "tanlash-o-do'st plash" },
	{ DULLER_GLOVES, "xiraroq qo'lqoplar" },
	{ INACCURATE_GLOVES, "noto'g'ri qo'lqoplar" },
	{ SIZE_REDUCTION_SHIELD, "hajmini kamaytirish qalqoni" },
	{ COSTLY_FAILURE_HELMET, "qimmatbaho qobiliyatsiz dubulg'a" },
	{ RIN_REDUCE_DAMAGE, "zararni kamaytirish" },
	{ RIN_REDUCE_ACCURACY, "aniqlikni kamaytirish" },
	{ AMULET_OF_MONSTER_MULTISHOT, "amulet of mahluq bir nechta zarba" },

	{ VERMILION_SPONGE, "qizil rang shimgich" },
	{ BRICK_HORN, "g'isht shoxi" },
	{ SWAMP_TENTACLE, "botqoq chodiri" },

	{ SMALL_SWORD, "kichik qilich" },
	{ BASILARD, "rayhon" },
	{ AWL_PIKE, "awl-payke" },
	{ TULWAR, "tulvar" },
	{ SHAMSHIR, "sharqiy cho'l qilich" },
	{ ESPANDON, "frantsuz ikki qo'l" },
	{ DIFFICULT_CROSSBOW, "qiyin arbalet" },
	{ FLIGHT_ARROW, "parvoz o'qi" },
	{ SEEKER_BOLT, "qidiruvchi murvat" },
	{ KITCHEN_KNIFE, "oshxona pichog'i" },
	{ GREAT_HAMMER, "ajoyib bolg'a" },
	{ TRIFURCATE_SPEAR, "uchburchak nayza" },
	{ THREE_PIECE_ROD, "uch qismli novda" },
	{ HATCHET, "balta" },
	{ BANJO, "yomon ovoz chiqaradigan asbob" },
	{ DARK_SWORD, "qora qilich" },
	{ BEARDED_AXE, "soqolli bolta" },
	{ MITHRIL_BOOMERANG, "mitril bumerang" },
	{ FALCATA, "elita qisqa qilich" },
	{ BATON, "tayoq" },
	{ FASCIA, "fasya" },
	{ KNIGHTLY_MACE, "ritsar to'zi" },
	{ CANYON_STAR, "kanyon yulduzi" },
	{ CROWBAR, "tirgak" },
	{ LONG_WHIP, "uzun qamchi" },
	{ LOWER_ARM_SWORD, "pastki qo'l qilich" },

	{ SCR_WEAPON_SPECIALIZATION, "qurol ixtisosligi" },

	{ POINTY_SHELL, "uchli qobiq" },
	{ HEAVY_SHELL_BALL, "og'ir qobiqli to'p" },
	{ SHELL_CHAIN, "qobiq zanjiri" },
	{ PHYSIO_VENOM, "fiziologik zahar" },

	{ WEATHER_DRAGON_SCALE_MAIL, "ob-havo ajdaho shkalasi pochta" },
	{ WEATHER_DRAGON_SCALES, "ob-havo ajdaho tarozilari" },
	{ WEATHER_DRAGON_SCALE_SHIELD, "ob-havo ajdaho shkalasi qalqoni" },
	...
	{ JOHANETTA_S_JEWEL, "Johanetta marvarid" },
...
register int otyp;
{
	...
	if ( (issoviet || autismweaponcheck(ART_BARDICHE_ASSALT) || (uarmf && uarmf->oartifact == ART_NE_PROSTO_KRASIVO) || (uarmc && uarmc->oartifact == ART_GAGARIN_S_TRANSLATOR)) && Alternate_item_name(otyp,Soviet_items))
...
{	/* Hallu */
	...
	if ( (issoviet || autismweaponcheck(ART_BARDICHE_ASSALT) || (uarmf && uarmf->oartifact == ART_NE_PROSTO_KRASIVO) || (uarmc && uarmc->oartifact == ART_GAGARIN_S_TRANSLATOR)) && Alternate_item_name(typ,Soviet_items))
...
ring:
	...
	/* gray stones: show the fucking weight if you've formally ided the base item, goddammit! --Amy
	 * but don't do the CH3AT of the "vulture interface" where unidentified loadstones also have their weight displayed, because
	 * that's something the player shouldn't be able to see as long as they don't have loadstones identified */
	&& ( ((obj->otyp != LUCKSTONE) && (obj->otyp != HEALTHSTONE) && (obj->otyp != LOADSTONE) && (obj->otyp != TOUCHSTONE)
	&& (obj->otyp != WHETSTONE) && (obj->otyp != MANASTONE) && (obj->otyp != SLEEPSTONE) && (obj->otyp != LOADBOULDER)
	&& (obj->otyp != STARLIGHTSTONE) && (obj->otyp != TALC) && (obj->otyp != GRAPHITE) && (obj->otyp != BONE_FRAGMENT)
	&& (obj->otyp != METEOR_FRAGMENT) && (obj->otyp != AMBER_FRAGMENT) && (obj->otyp != LEAD_CLUMP) && (obj->otyp != JUNK_METAL)
	&& (obj->otyp != COBALT_CHUNK) && (obj->otyp != BRONZE_NUGGET) && (obj->otyp != STEEL_SLUG) && (obj->otyp != SLING_AMMO)
	&& (obj->otyp != VOLCANIC_GLASS_FRAGMENT) && (obj->otyp != STONE_OF_MAGIC_RESISTANCE) && (obj->otyp != FLINT) && (obj->otyp != SALT_CHUNK)
	&& (obj->otyp != SILVER_SLINGSTONE) && (obj->otyp != CONUNDRUM_NUGGET) && (obj->otyp != SMALL_PIECE_OF_UNREFINED_MITHR)
	&& (!is_nastygraystone(obj)) ) || (objects[obj->otyp].oc_name_known && obj->dknown) )

	&& (obj->otyp != AMULET_OF_YENDOR) && (obj->otyp != FAKE_AMULET_OF_YENDOR) 

	&& (!Hallucination && flags.invweight && !WeightDisplayIsArbitrary))
...
register const char *verb;
{
	 ...
	 */
	if( ( Role_if(PM_PIRATE) || Role_if(PM_KORSAIR) || PirateSpeakOn) && !strcmp(verb,"are")) {
		strcpy(buf,"be");
		return buf;
	}
...
STATIC_OVL NEARDATA const struct o_range o_ranges[] = {
	...
	{ "gloves",	ARMOR_CLASS,  REGULAR_GLOVES, GAUNTLETS_OF_DEXTERITY },
	{ "gauntlets",	ARMOR_CLASS,  REGULAR_GLOVES, GAUNTLETS_OF_DEXTERITY },
