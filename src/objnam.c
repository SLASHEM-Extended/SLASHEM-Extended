...
STATIC_OVL struct Jitem Soviet_items[] = {
	...
	{ SPE_ORE_MINING, "placeholder" },
	{ SPE_BOILER_KABOOM, "placeholder" },
	{ SPE_DEFOG, "placeholder" },
	{ SPE_SWAP_POSITION, "placeholder" },
	{ SPE_SHUFFLE_MONSTER, "placeholder" },
	{ SPE_PET_SYRINGE, "placeholder" },
	{ SPE_BUC_KNOWLEDGE, "placeholder" },
	{ SPE_PREACHING, "placeholder" },
	{ SPE_RESIST_PARALYSIS, "placeholder" },
	{ SPE_KEEP_SATIATION, "placeholder" },
	{ SPE_TECH_BOOST, "placeholder" },
	{ SPE_CONTINGENCY, "placeholder" },
	{ SPE_AULE_SMITHING, "placeholder" },
	{ SPE_HORSE_HOP, "placeholder" },
	{ SPE_LINE_LOSS, "placeholder" },
	{ SPE_TACTICAL_NUKE, "placeholder" },
	{ SPE_RAGNAROK, "placeholder" },
	{ SPE_ARMOR_SMASH, "placeholder" },
	{ SPE_STRANGLING, "placeholder" },
	{ SPE_PARTICLE_CANNON, "placeholder" },
	{ SPE_ONE_POINT_SHOOT, "placeholder" },
	{ SPE_BLOOD_STREAM, "placeholder" },
	{ SPE_SHINING_WAVE, "placeholder" },
	{ SPE_GROUND_STOMP, "placeholder" },
	{ SPE_DIRECTIVE, "placeholder" },
	{ SPE_NERVE_POISON, "placeholder" },
	{ SPE_POWDER_SPRAY, "placeholder" },
	{ SPE_FIREWORKS, "placeholder" },
	{ SPE_AIMBOT_LIGHTNING, "placeholder" },
	{ SPE_ENHANCE_BREATH, "placeholder" },
	{ SPE_GOUGE_DICK, "placeholder" },
	{ SPE_BODYFLUID_STRENGTHENING, "placeholder" },
	{ SPE_GEYSER, "placeholder" },
	{ SPE_BUBBLING_HOLE, "placeholder" },
	{ SPE_PURIFICATION, "placeholder" },
	{ SPE_ADD_SPELL_MEMORY, "placeholder" },
	{ SPE_NEXUSPORT, "placeholder" },
	{ SPE_GIANT_FOOT, "placeholder" },
	{ SPE_ANTI_TELEPORTATION, "placeholder" },
