...
register struct obj *obj;
{
	...
	case FOOD_CLASS:
	    ...
	    if (mon->data == &mons[PM_GHOUL] || mon->data == &mons[PM_GHAST] || mon->data == &mons[PM_DOGSHIT_SEARCHER] || mon->data == &mons[PM_STINKING_ALIEN] || mon->data == &mons[PM_GASTLY] || mon->data == &mons[PM_PHANTOM_GHOST]
