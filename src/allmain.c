...
boolean new_game;	/* false => restoring an old game */
{
    ...
    *xtrabuf = '\0';
	...
	obj_descr[SPE_CONVERGE_BREATH].oc_name = "todo";
	obj_descr[SPE_RELOCATION].oc_name = "todo";
	obj_descr[SPE_IMPACT_GUNFIRE].oc_name = "todo";
	obj_descr[SPE_COAGULATION].oc_name = "todo";
	obj_descr[SPE_CURE_PARALYSIS].oc_name = "todo";
	obj_descr[SPE_SMELL_MONSTER].oc_name = "todo";
	obj_descr[SPE_ECHOLOCATION].oc_name = "todo";
	obj_descr[SPE_RANDOM_DETECTION].oc_name = "todo";
	...
	for (i = 0; i < NUM_OBJECTS; i++) {
		...
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "heretic robe")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "contro dragonhide shield")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "celestial cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "conundrum cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "heavenly boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "shining robe")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "ornamental robe")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "cotton robe")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "star-patterned robe")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "black poleaxe")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "ornamental polearm")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "feather-etched rapier")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "latch-pommeled saber")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "fleshy boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "paper shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "bone trotteurs")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "bronze shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "glass shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "ornamental shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "conundrum boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "extraterrestrial boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "meteoric steel boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "corona boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "fluffy boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "junk shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "melded boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "golden delicately filigreed stilettos")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "ugly boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "unfashionable boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "garish boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "unsexy boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "unisex pumps")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "moon boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "cuddle cloth boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "garden slippers")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "dyke boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "ankle strap sandals")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "gentleman shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "old brogues")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "opankes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "business shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "comfortable sneakers")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "unisex sneakers")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "copper cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "plastic cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "bubble cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "meteosteel cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "antidotium cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "meat helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "order helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "very hard helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "zebes helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "meteosteel helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "flashy helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "foaming helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "scrappy helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "metal plate helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "foamcloth cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "trash cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "factory cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "mysterious gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "waxy gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "delicious gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "lithified gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "copper gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "platinum gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "vitric gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "gemmed gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "elean gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "christian gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "volcanic gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "grome gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "excavated gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "heavenly gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "conundrum gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "funny-colored gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "meteosteel gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "antidotium gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "foam gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "scrap gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "alloy gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "demonologist boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "generic high heels")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "failed shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "opera pumps")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "house slippers")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "indoor shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "wooden clogs")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "plastic sandals")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "flat-soled shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "regular sneakers")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "exceptional sneakers")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "elite sneakers")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "fur boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "cross-country boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "biker boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "throwaway sandals")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "cheap shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "golden shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "zero-drop shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "pope hat")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "corona mask")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "petsense helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "wetsuit")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "funeral shroud")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "bleached robe")) OBJ_DESCR(objects[i]) = "todo";
