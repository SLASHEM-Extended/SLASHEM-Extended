...
boolean new_game;	/* false => restoring an old game */
{
    ...
    *xtrabuf = '\0';
	...
	for (i = 0; i < NUM_OBJECTS; i++) {
		...
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "chitin gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "sinnum gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "chitin cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "sinnum cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "coral cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "cobalt cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "bamboo cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "shale cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "mystery dragonhide shield")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "chitin helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "chitin boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "woodrobe")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "greenish cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "shale gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "sling pumps")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "sister shoes")) OBJ_DESCR(objects[i]) = "todo";
		...
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "claw-ended staff")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "set of three feather-etched daggers")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "curved dagger")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "triangular dagger")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "circular-sawbladed axe")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "polished short sword")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "split-bladed short sword")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "curved short sword")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "oddly-luminous sword")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "razor-thin sword")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "curved white sword")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "double-bladed weapon")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "segmented whip")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "wagon wheel")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "heavy sword")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "crude curved sword")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "crude long sword")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "crude morning star")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "warped bow")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "swedish polearm")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "danish axe")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "parasitic insectoid")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "spined helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "filigreed helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "patina helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "top hat")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "glass-set plate mail")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "runed plate mail")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "bladed armor")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "spiked scale mail")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "clockwork plate armor")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "faceless robe")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "humming shield")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "high-grade shield")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "hooked gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "crude shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "red-lacquered boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "bladed disks")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "blue gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "corallized gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "bronze gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "mercury helmet")) OBJ_DESCR(objects[i]) = "todo";
		...
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "surefire gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "leather gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "antisuck helmet")) OBJ_DESCR(objects[i]) = "todo";
		...
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "greenish gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "mercury gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "high-value gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "light blue gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "critical gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "atlas gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "speedy gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "quicksilver cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "superior cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "bronze cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "air cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "kevlar cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "vindale cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "corallized helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "tin helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "bronze helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "23 helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "a-heels")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "low-value shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "tinsel shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "alligator pumps")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "repair-worthy boots")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "hammer shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "platform fleecies")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "retractable block heels")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "instafeminism shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "boring shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "uninspired shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "wild leather shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "very expensive shoes")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "nope dragonhide shield")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "crystalline dragonhide shield")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "maidragonhide shield")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "liquid robe")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "alu cloak")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "layered helmet")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "all-terrain gloves")) OBJ_DESCR(objects[i]) = "todo";
		if ((s = OBJ_DESCR(objects[i])) != 0 && !strcmp(s, "house shoes")) OBJ_DESCR(objects[i]) = "todo";
