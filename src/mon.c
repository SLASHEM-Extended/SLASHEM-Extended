	...
	if ((int)mdef->data->msize > MZ_TINY ||
     ...
     (obj->otyp == STATUE && mons[obj->corpsenm].msize >= mdef->data->msize) ||
		...
		/* reduce amount of musable items the player can use --Amy */
			if (is_musable(obj) && rn2(2)) delobj(obj);
