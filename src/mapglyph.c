...
#define warn_color(n) color = iflags.use_color ? ((uwep && uwep->oartifact == ART_ALASSEA_TELEMNAR) ? rnd(15) : (uwep && uwep->oartifact == ART_THRANDUIL_LOSSEHELIN) ? rnd(15) : (u.twoweap && uswapwep && uswapwep->oartifact == ART_ALASSEA_TELEMNAR) ? rnd(15) : (u.twoweap && uswapwep && uswapwep->oartifact == ART_THRANDUIL_LOSSEHELIN) ? rnd(15) : Hallucination ? rnd(15) : (BlackNgWalls || (uamul && uamul->oartifact == ART_BLACK_DARKNESS) || have_blackystone() || u.uprops[BLACK_NG_WALLS].extrinsic ) ? CLR_BLACK : (uamul && uamul->oartifact == ART_FLEECY_GREEN) ? CLR_GREEN : def_warnsyms[n].color) : NO_COLOR
#define explode_color(n) color = iflags.use_color ? ((uwep && uwep->oartifact == ART_ALASSEA_TELEMNAR) ? rnd(15) : (uwep && uwep->oartifact == ART_THRANDUIL_LOSSEHELIN) ? rnd(15) : (u.twoweap && uswapwep && uswapwep->oartifact == ART_ALASSEA_TELEMNAR) ? rnd(15) : (u.twoweap && uswapwep && uswapwep->oartifact == ART_THRANDUIL_LOSSEHELIN) ? rnd(15) : Hallucination ? rnd(15) : (BlackNgWalls || (uamul && uamul->oartifact == ART_BLACK_DARKNESS) || have_blackystone() || u.uprops[BLACK_NG_WALLS].extrinsic ) ? CLR_BLACK : (uamul && uamul->oartifact == ART_FLEECY_GREEN) ? CLR_GREEN : explcolors[n]) : NO_COLOR
