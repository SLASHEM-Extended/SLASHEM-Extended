...
pickletter:
	...
	switch (rnd(255)) {			
		...
		case 131: Sprintf(eos(string), ""); break;
		...
		case 136: Sprintf(eos(string), ""); break;
		case 137: Sprintf(eos(string), ""); break;
		case 138: Sprintf(eos(string), ""); break;
		case 139: Sprintf(eos(string), ""); break;
		case 140: Sprintf(eos(string), ""); break;
		case 141: Sprintf(eos(string), ""); break;
		case 142: Sprintf(eos(string), ""); break;
		...
		case 154: Sprintf(eos(string), ""); break;
		case 155: Sprintf(eos(string), ""); break;
		case 156: Sprintf(eos(string), ""); break;
		case 157: Sprintf(eos(string), ""); break;
		case 158: Sprintf(eos(string), ""); break;
		case 159: Sprintf(eos(string), ""); break;
