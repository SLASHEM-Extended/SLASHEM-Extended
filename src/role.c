...
{	"badstatter", "badstatter", "bad stats", "Bad",
	{0, 0},
	PM_BADSTATTER, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_ORC,
	/*    Str     Int Wis Dex Con Cha */
...
{	"de-energiser", "de-energised", "free switching", "Den",
	{0, 0},
	PM_DE_ENERGISER, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_ORC,
	/*    Str     Int Wis Dex Con Cha */
...
{	"hand", "hand", "hands", "Han",
	{0, 0},
	PM_HAND, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_ORC,
	/*    Str     Int Wis Dex Con Cha */
	...
	{ STR19(25), 125, 125, 125, 125, 125 },
	/* new limit values for the six attributes by Amy */
	{  STR18(80), 14, 15, 18, 22, 10 },
	/* Init   Lower  Higher */
	{  5, 0,  0, 6,  4, 0 },	/* Hit points */
	{  1, 0,  1, 0,  1, 0 }		/* Energy */
},
...
{	"killfiller", "killfiller", "killer room filling", "Kil",
	{0, 0},
	PM_KILLFILLER, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_ORC,
	/*    Str     Int Wis Dex Con Cha */
...
{	"mesher", "mesher", "meshing", "Mes",
	{0, 0},
	PM_MESHER, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_ORC,
	/*    Str     Int Wis Dex Con Cha */
...
{	"neanderthal", "neanderthal", "many years ago", "Nea",
	{0, 0},
	PM_PLAYABLE_NEANDERTHAL, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_ORC,
	/*    Str     Int Wis Dex Con Cha */
...
{	"samedi", "samedi", "sons of samedi", "Sam",
	{0, 0},
	PM_SAMEDI, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_ORC,
	/*    Str     Int Wis Dex Con Cha */
	...
	{ STR19(25), 125, 125, 125, 125, 125 },
	/* new limit values for the six attributes by Amy */
	{  STR19(19),  14, 18, 18, 19, 18 },
	/* Init   Lower  Higher */
	{  4, 0,  0, 2,  1, 0 },	/* Hit points */
	{  1, 0,  2, 0,  1, 0 }		/* Energy */
},
...
{	"startscummer", "startscummer", "start scumming", "Ssc",
	{0, 0},
	PM_STARTSCUMMER, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_ORC,
	/*    Str     Int Wis Dex Con Cha */
...
{	"stunned-like-a-fish", "stunned-like-a-fish", "stunning paralysis", "Stu",
	{0, 0},
	PM_STUNNED_LIKE_A_FISH, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_ORC,
	/*    Str     Int Wis Dex Con Cha */
...
{	"thrall", "thrallish", "thrall fort", "Thr",
	{0, 0},
	PM_THRALL, NON_PM, PM_DWARF_MUMMY, PM_DWARF_ZOMBIE,
	MH_DWARF | ROLE_MALE|ROLE_FEMALE | ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_DWARF, MH_DWARF, MH_HUMAN,
	/*    Str     Int Wis Dex Con Cha */
	{      3,      3,  3,  3,  3,  3 },
	{ STR19(25), 125, 125, 125, 125, 125 },
	/* new limit values for the six attributes by Amy */
...
{	"urgoth", "urgoth", "demigoth heaven", "Urg",
	{0, 0},
	PM_URGOTH, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_HUMAN,
	/*    Str     Int Wis Dex Con Cha */
	{      3,      3,  3,  3,  3,  3 },
	{ STR19(25), 125, 125, 125, 125, 125 },
	/* new limit values for the six attributes by Amy */
	{  STR19(25),  8,  8, 16, 25,  6 },
	/* Init   Lower  Higher */
	{  5, 0,  0, 8,  8, 0 },	/* Hit points */
	{  0, 0,  0, 0,  0, 0 }		/* Energy */
},
...
{	"vanillaoid", "vanillaoid", "vanilla-like", "Van",
	{0, 0},
	PM_VANILLAOID, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_ORC,
	/*    Str     Int Wis Dex Con Cha */
...
{	"wylvan", "wylvan", "wylvan forest", "Wyl",
	{0, 0},
	PM_WYLVAN, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_HUMAN,
	/*    Str     Int Wis Dex Con Cha */
...
{	"zaur", "zaur", "zauren swamp", "Zau",
	{0, 0},
	PM_ZAUR, NON_PM, PM_HUMAN_MUMMY, PM_HUMAN_ZOMBIE,
	MH_HUMAN | ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL|ROLE_NEUTRAL|ROLE_CHAOTIC,
	MH_HUMAN, 0, MH_GNOME|MH_HUMAN,
	/*    Str     Int Wis Dex Con Cha */
	...
	if (ok_race(rolenum, i, gendnum, alignnum)) {
	    if (races_ok == 0) {
			...
			switch (rnd(49)) {
				...
				case 49:
					flags.hybridvanillaoid = 1; break;
			...
			while (((rnd(7)) < 3) && (tryct < 100) ) {
				...
				switch (rnd(49)) {
					...
					case 49:
						if (!(flags.hybridvanillaoid)) {flags.hybridvanillaoid = 1; flags.hybridization++; break;
						}
	...
	if (type == 1 || (type == 0 && rn2(2) && flags.hybridization) ) {
		...
		while (tryct++ < 1000) {
			...
			case 49:
				if (flags.hybridvanillaoid) {
					tryct = 1000;
					flags.hybridvanillaoid = FALSE;
					flags.hybridization--;
					pline("You no longer have the vanillaoid hybrid race.");
				}
				break;
		...
		while (tryct++ < 1000) {
			...
			case 49:
				if (!flags.hybridvanillaoid) {
					tryct = 1000;
					flags.hybridvanillaoid = TRUE;
					flags.hybridization++;
					pline("You now have the vanillaoid hybrid race.");
				}
				break;
