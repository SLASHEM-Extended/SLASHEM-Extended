...
static const NEARDATA short hwep[] = {
	  ...
	  DIFFICULT_TRIDENT, FOURDENT, TRIDENT, CRYSTAL_SWORD, HEAVY_GRINDER,
	  ...
	  ORCISH_SHORT_SWORD, ELVEN_MACE, PLASTIC_MACE, BRONZE_MACE, HEATH_BALL,
	  ...
	  BRONZE_SPEAR, LONG_STAKE, BAMBOO_SPEAR, RANDOSPEAR, SILK_SPEAR, SPEAR, ORCISH_SPEAR, LOWER_ARM_BLADE, CAMO_QATAR,
	  ...
	  GREAT_DAGGER, JAVELIN, BLOW_AKLYS, AKLYS, POURED_CLUB, NATURAL_STICK, BONE_CLUB, CLUB, CIGARETTE,
