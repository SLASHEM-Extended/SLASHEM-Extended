...
/*	Put weapon vs. monster type "to hit" bonuses in below:	*/
	...
	if (otmp->otyp == LASER_CHAIN && thick_skinned(ptr)) tmp += 4;
	...
	if (otmp->otyp == COATED_AUTO_SHELL && ptr->mlet == S_QUADRUPED) tmp += 10;
	if (otmp->otyp == CHROME_PELLET && ptr->mlet == S_QUADRUPED) tmp += 10;
	...
	if (otmp->otyp == PINCER_STAFF && is_swimmer(ptr)) {
	   if (is_waterypool(mon->mx, mon->my)) tmp += 4;
	   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) tmp += 2;
	}
	if (otmp->otyp == UNDERWATER_TRIDENT && is_swimmer(ptr)) {
	   if (is_waterypool(mon->mx, mon->my)) tmp += 4;
	   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) tmp += 2;
	}
...
struct monst *mon;
{
	...
	if (bigmonst(ptr)) {
		...
		case LIGHTTORCH:	tmp += rnd(7); break;
		case PINK_LIGHTSWORD:	tmp += rnd(8); break;
	...
	if ((objects[otyp].oc_material <= MT_LEATHER || (objects[otyp].oc_material == MT_INKA && !hates_inka(ptr)) || (objects[otyp].oc_material == MT_SILK) || (objects[otyp].oc_material == MT_COMPOST) ) && thick_skinned(ptr) && tmp > 0)
		...
		tmp = 1;
	if ((is_shade(ptr) || mon->egotype_shader) && !(uwep && uwep->oartifact == ART_AP_) && objects[otyp].oc_material != MT_SILVER && objects[otyp].oc_material != MT_ARCANIUM)
		tmp = 0;
...
/*	Put weapon vs. monster type damage bonuses in below:	*/
	if (Is_weapon || otmp->oclass == GEM_CLASS ||
		...
		if (otmp->otyp == LASER_CHAIN && thick_skinned(ptr)) bonus += rnd(4);
		...
		if (otmp->otyp == CLAY_CHAIN && thick_skinned(ptr)) bonus += rnd(6);
		if (otmp->otyp == COMPOST_CHAIN && thick_skinned(ptr)) bonus += rnd(6);
		if (otmp->otyp == PAPER_CHAIN && thick_skinned(ptr)) bonus += rnd(6);
		...
		if (otmp->otyp == GRANITE_SCOURGE && thick_skinned(ptr)) bonus += rnd(8);
		if (otmp->otyp == DISGUSTING_CHAIN && thick_skinned(ptr)) bonus += rnd(8);
		if (otmp->otyp == CHROME_SCOURGE && thick_skinned(ptr)) bonus += rnd(8);
		if (otmp->otyp == SHADOW_SCOURGE && thick_skinned(ptr)) bonus += rnd(8);
		...
		if (otmp->otyp == CONCRETE_NUNCHIAKU && thick_skinned(ptr)) bonus += rnd(12);
		if (otmp->otyp == ELASTHAN_CHAIN && thick_skinned(ptr)) bonus += rnd(12);
		if (otmp->otyp == NANO_NUNCHIAKU && thick_skinned(ptr)) bonus += rnd(12);
		...
		if (otmp->otyp == MINERAL_HOSTAGE_CHAIN && thick_skinned(ptr)) bonus += rnd(15);
		if (otmp->otyp == ELYSIUM_HOSTAGE_CHAIN && thick_skinned(ptr)) bonus += rnd(15);
		if (otmp->otyp == NUCLEAR_HOSTAGE_CHAIN && thick_skinned(ptr)) bonus += rnd(15);
		if (otmp->otyp == SAND_HOSTAGE_CHAIN && thick_skinned(ptr)) bonus += rnd(15);
		if (otmp->otyp == ETHER_HOSTAGE_CHAIN && thick_skinned(ptr)) bonus += rnd(15);
		if (otmp->otyp == FOAM_HOSTAGE_CHAIN && thick_skinned(ptr)) bonus += rnd(15);
		if (otmp->otyp == ALLOY_HOSTAGE_CHAIN && thick_skinned(ptr)) bonus += rnd(15);
		if (otmp->otyp == OBSIDIAN_HOSTAGE_CHAIN && thick_skinned(ptr)) bonus += rnd(15);
	    ...
	    /* trident is highly effective against swimmers */
	    if (otmp->otyp == TRIDENT && is_swimmer(ptr)) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(2);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += 1;
		   if (Race_if(PM_NEMESIS)) bonus += rnd(20);
	    }
	    ...
	    if (otmp->otyp == STYGIAN_PIKE && is_swimmer(ptr)) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(4);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(2);
		   if (Race_if(PM_NEMESIS)) bonus += rnd(20);
	    }
	    ...
	    if (otmp->otyp == TWO_HANDED_TRIDENT && is_swimmer(ptr)) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(6);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(3);
		   if (Race_if(PM_NEMESIS)) bonus += rnd(20);
	    }
	    ...
	    if (otmp->otyp == COATED_AUTO_SHELL && ptr->mlet == S_QUADRUPED) bonus += (10 + rnd(10));
	    if (otmp->otyp == CHROME_PELLET && ptr->mlet == S_QUADRUPED) bonus += (10 + rnd(10));
	    ...
	    if ((otmp->otyp == WEDGED_LITTLE_GIRL_SANDAL || otmp->otyp == STURDY_PLATEAU_BOOT_FOR_GIRLS || otmp->otyp == HUGGING_BOOT || otmp->otyp == BLOCK_HEELED_COMBAT_BOOT || otmp->otyp == WOODEN_GETA || otmp->otyp == LACQUERED_DANCING_SHOE || otmp->otyp == SEXY_MARY_JANE || otmp->otyp == KITTEN_HEEL_PUMP || otmp->otyp == HIGH_HEELED_SANDAL || otmp->otyp == SEXY_LEATHER_PUMP || otmp->otyp == STICKSHOE || otmp->otyp == SPIKED_BATTLE_BOOT || otmp->otyp == INKA_BOOT || otmp->otyp == SOFT_LADY_SHOE || otmp->otyp == STEEL_CAPPED_SANDAL || otmp->otyp == BLOCK_HEELED_SANDAL || otmp->otyp == PROSTITUTE_SHOE || otmp->otyp == DOGSHIT_BOOT) && (attacktype(mon->data, AT_TENT))) {
			bonus += 2;
...
/*	Put weapon vs. monster type damage bonuses in below:	*/
	...
	if (otmp->otyp == LASER_CHAIN && thick_skinned(ptr) && (P_SKILL(P_FLAIL) == P_SKILLED) ) bonus += 1;
	if (otmp->otyp == LASER_CHAIN && thick_skinned(ptr) && (P_SKILL(P_FLAIL) == P_EXPERT) ) bonus += rnd(2);
	if (otmp->otyp == LASER_CHAIN && thick_skinned(ptr) && (P_SKILL(P_FLAIL) == P_MASTER) ) bonus += rnd(3);
	if (otmp->otyp == LASER_CHAIN && thick_skinned(ptr) && (P_SKILL(P_FLAIL) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (otmp->otyp == LASER_CHAIN && thick_skinned(ptr) && (P_SKILL(P_FLAIL) == P_SUPREME_MASTER) ) bonus += rnd(5);
	...
	if (otmp->otyp == AMBER_CHAIN && thick_skinned(ptr) && (P_SKILL(P_FLAIL) == P_SKILLED) ) bonus += rnd(2);
	if (otmp->otyp == AMBER_CHAIN && thick_skinned(ptr) && (P_SKILL(P_FLAIL) == P_EXPERT) ) bonus += rnd(5);
	if (otmp->otyp == AMBER_CHAIN && thick_skinned(ptr) && (P_SKILL(P_FLAIL) == P_MASTER) ) bonus += rnd(7);
	...
	if (otmp->otyp == FLY_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_EXPERT) ) bonus += rnd(3);
	if (otmp->otyp == FLY_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_MASTER) ) bonus += rnd(5);
	if (otmp->otyp == FLY_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_GRAND_MASTER) ) bonus += rnd(7);
	if (otmp->otyp == FLY_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_SUPREME_MASTER) ) bonus += rnd(8);
	if (otmp->otyp == VERMIN_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_SKILLED) ) bonus += rnd(2);
	if (otmp->otyp == VERMIN_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_EXPERT) ) bonus += rnd(3);
	if (otmp->otyp == VERMIN_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_MASTER) ) bonus += rnd(5);
	if (otmp->otyp == VERMIN_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_GRAND_MASTER) ) bonus += rnd(7);
	if (otmp->otyp == VERMIN_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_SUPREME_MASTER) ) bonus += rnd(8);
	if (otmp->otyp == INSECT_SQUASHER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_SKILLED) ) bonus += rnd(3);
	if (otmp->otyp == INSECT_SQUASHER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_EXPERT) ) bonus += rnd(5);
	if (otmp->otyp == INSECT_SQUASHER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_MASTER) ) bonus += rnd(7);
	if (otmp->otyp == INSECT_SQUASHER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_GRAND_MASTER) ) bonus += rnd(9);
	if (otmp->otyp == INSECT_SQUASHER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_SUPREME_MASTER) ) bonus += rnd(11);
	if (otmp->otyp == LASER_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_SKILLED) ) bonus += rnd(3);
	if (otmp->otyp == LASER_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_EXPERT) ) bonus += rnd(5);
	if (otmp->otyp == LASER_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_MASTER) ) bonus += rnd(7);
	if (otmp->otyp == LASER_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_GRAND_MASTER) ) bonus += rnd(9);
	if (otmp->otyp == LASER_SWATTER && (ptr->mlet == S_ANT || ptr->mlet == S_SPIDER || ptr->mlet == S_XAN) && (P_SKILL(P_PADDLE) == P_SUPREME_MASTER) ) bonus += rnd(11);
	    ...
	    if (otmp->otyp == PINCER_STAFF && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_SKILLED) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(2);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += 1;
	    }
	    if (otmp->otyp == UNDERWATER_TRIDENT && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_SKILLED) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(2);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += 1;
	    }
	    ...
	    if (otmp->otyp == PINCER_STAFF && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_EXPERT) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(4);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(2);
	    }
	    if (otmp->otyp == UNDERWATER_TRIDENT && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_EXPERT) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(4);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(2);
	    }
	    ...
	    if (otmp->otyp == STYGIAN_PIKE && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_EXPERT) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(8);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(4);
	    }
	    ...
	    if (otmp->otyp == TWO_HANDED_TRIDENT && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_EXPERT) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(12);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(6);
	    }
	    ...
	    if (otmp->otyp == PINCER_STAFF && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_MASTER) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(8);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(4);
	    }
	    if (otmp->otyp == UNDERWATER_TRIDENT && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_MASTER) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(8);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(4);
	    }
	    ...
	    if (otmp->otyp == STYGIAN_PIKE && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_MASTER) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(16);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(8);
	    }
	    ...
	    if (otmp->otyp == TWO_HANDED_TRIDENT && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_MASTER) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(24);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(12);
	    }
	    ...
	    if (otmp->otyp == PINCER_STAFF && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_GRAND_MASTER) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(16);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(8);
	    }
	    if (otmp->otyp == UNDERWATER_TRIDENT && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_GRAND_MASTER) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(16);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(8);
	    }
	    ...
	    if (otmp->otyp == STYGIAN_PIKE && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_GRAND_MASTER) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(20);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(10);
	    }
	    ...
	    if (otmp->otyp == PINCER_STAFF && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_SUPREME_MASTER) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(24);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(12);
	    }
	    if (otmp->otyp == UNDERWATER_TRIDENT && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_SUPREME_MASTER) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(24);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(12);
	    }
	    ...
	    if (otmp->otyp == STYGIAN_PIKE && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_SUPREME_MASTER) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(30);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(15);
	    }
	    ...
	    if (otmp->otyp == TWO_HANDED_TRIDENT && is_swimmer(ptr) && (P_SKILL(P_TRIDENT) == P_SUPREME_MASTER) ) {
		   if (is_waterypool(mon->mx, mon->my)) bonus += rnd(36);
		   else if (ptr->mlet == S_EEL || ptr->mlet == S_SNAKE) bonus += rnd(18);
	    }
	    ...
	    if (objects[otmp->otyp].oc_skill == P_QUARTERSTAFF && is_undead(ptr) && (P_SKILL(P_QUARTERSTAFF) == P_SKILLED)) bonus += 1;
	    if (objects[otmp->otyp].oc_skill == P_QUARTERSTAFF && is_undead(ptr) && (P_SKILL(P_QUARTERSTAFF) == P_EXPERT)) bonus += rnd(2);
	    if (objects[otmp->otyp].oc_skill == P_QUARTERSTAFF && is_undead(ptr) && (P_SKILL(P_QUARTERSTAFF) == P_MASTER)) bonus += rnd(3);
	    if (objects[otmp->otyp].oc_skill == P_QUARTERSTAFF && is_undead(ptr) && (P_SKILL(P_QUARTERSTAFF) == P_GRAND_MASTER)) bonus += rnd(5);
	    if (objects[otmp->otyp].oc_skill == P_QUARTERSTAFF && is_undead(ptr) && (P_SKILL(P_QUARTERSTAFF) == P_SUPREME_MASTER)) bonus += rnd(7);

	    if (otmp->otyp == TWO_HANDED_FLAIL && is_undead(ptr) && (P_SKILL(P_FLAIL) == P_SKILLED)) bonus += rnd(2);
	    if (otmp->otyp == TWO_HANDED_FLAIL && is_undead(ptr) && (P_SKILL(P_FLAIL) == P_EXPERT)) bonus += rnd(4);
	    if (otmp->otyp == TWO_HANDED_FLAIL && is_undead(ptr) && (P_SKILL(P_FLAIL) == P_MASTER)) bonus += rnd(6);
	    if (otmp->otyp == TWO_HANDED_FLAIL && is_undead(ptr) && (P_SKILL(P_FLAIL) == P_GRAND_MASTER)) bonus += rnd(8);
	    if (otmp->otyp == TWO_HANDED_FLAIL && is_undead(ptr) && (P_SKILL(P_FLAIL) == P_SUPREME_MASTER)) bonus += rnd(10);
	  ...
	  if (!(PlayerCannotUseSkills)) {
	    ...
	    if (objects[otmp->otyp].oc_skill == P_LANCE && is_animal(ptr) && (P_SKILL(P_LANCE) == P_MASTER)) bonus += rnd(3);
	    if (objects[otmp->otyp].oc_skill == P_LANCE && is_animal(ptr) && (P_SKILL(P_LANCE) == P_GRAND_MASTER)) bonus += rnd(4);
	    if (objects[otmp->otyp].oc_skill == P_LANCE && is_animal(ptr) && (P_SKILL(P_LANCE) == P_SUPREME_MASTER)) bonus += rnd(5);
	    ...
	    if (objects[otmp->otyp].oc_skill == P_POLEARMS && (ptr->mlet == S_GOLEM || ptr->mlet == S_CENTAUR || ptr->mlet == S_UNICORN) && (P_SKILL(P_POLEARMS) == P_SKILLED)) bonus += 1;
	    if (objects[otmp->otyp].oc_skill == P_POLEARMS && (ptr->mlet == S_GOLEM || ptr->mlet == S_CENTAUR || ptr->mlet == S_UNICORN) && (P_SKILL(P_POLEARMS) == P_EXPERT)) bonus += rnd(2);
	    if (objects[otmp->otyp].oc_skill == P_POLEARMS && (ptr->mlet == S_GOLEM || ptr->mlet == S_CENTAUR || ptr->mlet == S_UNICORN) && (P_SKILL(P_POLEARMS) == P_MASTER)) bonus += rnd(3);
	    if (objects[otmp->otyp].oc_skill == P_POLEARMS && (ptr->mlet == S_GOLEM || ptr->mlet == S_CENTAUR || ptr->mlet == S_UNICORN) && (P_SKILL(P_POLEARMS) == P_GRAND_MASTER)) bonus += rnd(4);
	    if (objects[otmp->otyp].oc_skill == P_POLEARMS && (ptr->mlet == S_GOLEM || ptr->mlet == S_CENTAUR || ptr->mlet == S_UNICORN) && (P_SKILL(P_POLEARMS) == P_SUPREME_MASTER)) bonus += rnd(5);
	    ...
	    if (otmp->otyp == ELECTRIC_SWORD && ptr->mlet == S_QUANTMECH && (P_SKILL(P_LONG_SWORD) == P_SKILLED)) bonus += rnd(2);
	    if (otmp->otyp == ELECTRIC_SWORD && ptr->mlet == S_QUANTMECH && (P_SKILL(P_LONG_SWORD) == P_EXPERT)) bonus += rnd(4);
	    if (otmp->otyp == ELECTRIC_SWORD && ptr->mlet == S_QUANTMECH && (P_SKILL(P_LONG_SWORD) == P_MASTER)) bonus += rnd(6);
	    if (otmp->otyp == ELECTRIC_SWORD && ptr->mlet == S_QUANTMECH && (P_SKILL(P_LONG_SWORD) == P_GRAND_MASTER)) bonus += rnd(8);
	    if (otmp->otyp == ELECTRIC_SWORD && ptr->mlet == S_QUANTMECH && (P_SKILL(P_LONG_SWORD) == P_SUPREME_MASTER)) bonus += rnd(10);
		}
	    ...
	    if (otmp->otyp == SHOTGUN_SHELL && ptr->mlet == S_QUADRUPED && (P_SKILL(P_FIREARM) == P_EXPERT)) bonus += rnd(7);
	    ...
	    if (otmp->otyp == COATED_AUTO_SHELL && ptr->mlet == S_QUADRUPED && (P_SKILL(P_FIREARM) == P_SKILLED)) bonus += rnd(4);
	    if (otmp->otyp == COATED_AUTO_SHELL && ptr->mlet == S_QUADRUPED && (P_SKILL(P_FIREARM) == P_EXPERT)) bonus += rnd(7);
	    if (otmp->otyp == COATED_AUTO_SHELL && ptr->mlet == S_QUADRUPED && (P_SKILL(P_FIREARM) == P_MASTER)) bonus += rnd(10);
	    if (otmp->otyp == COATED_AUTO_SHELL && ptr->mlet == S_QUADRUPED && (P_SKILL(P_FIREARM) == P_GRAND_MASTER)) bonus += rnd(12);
	    if (otmp->otyp == COATED_AUTO_SHELL && ptr->mlet == S_QUADRUPED && (P_SKILL(P_FIREARM) == P_SUPREME_MASTER)) bonus += rnd(15);
	    if (otmp->otyp == CHROME_PELLET && ptr->mlet == S_QUADRUPED && (P_SKILL(P_FIREARM) == P_SKILLED)) bonus += rnd(4);
	    if (otmp->otyp == CHROME_PELLET && ptr->mlet == S_QUADRUPED && (P_SKILL(P_FIREARM) == P_EXPERT)) bonus += rnd(7);
	    if (otmp->otyp == CHROME_PELLET && ptr->mlet == S_QUADRUPED && (P_SKILL(P_FIREARM) == P_MASTER)) bonus += rnd(10);
	    if (otmp->otyp == CHROME_PELLET && ptr->mlet == S_QUADRUPED && (P_SKILL(P_FIREARM) == P_GRAND_MASTER)) bonus += rnd(12);
	    if (otmp->otyp == CHROME_PELLET && ptr->mlet == S_QUADRUPED && (P_SKILL(P_FIREARM) == P_SUPREME_MASTER)) bonus += rnd(15);
		}
		...
		if (!(PlayerCannotUseSkills)) {
	    if (objects[otmp->otyp].oc_skill == P_AXE && ptr->mlet == S_UMBER && (P_SKILL(P_AXE) == P_SKILLED)) bonus += 1;
	    if (objects[otmp->otyp].oc_skill == P_AXE && ptr->mlet == S_UMBER && (P_SKILL(P_AXE) == P_EXPERT)) bonus += rnd(2);
	    if (objects[otmp->otyp].oc_skill == P_AXE && ptr->mlet == S_UMBER && (P_SKILL(P_AXE) == P_MASTER)) bonus += rnd(3);
	    if (objects[otmp->otyp].oc_skill == P_AXE && ptr->mlet == S_UMBER && (P_SKILL(P_AXE) == P_GRAND_MASTER)) bonus += rnd(4);
	    if (objects[otmp->otyp].oc_skill == P_AXE && ptr->mlet == S_UMBER && (P_SKILL(P_AXE) == P_SUPREME_MASTER)) bonus += rnd(5);
		}
	    ...
	    if (objects[otmp->otyp].oc_skill == P_WHIP && ptr->mlet == S_HUMAN && (P_SKILL(P_WHIP) == P_EXPERT)) bonus += rnd(2);
	    if (objects[otmp->otyp].oc_skill == P_WHIP && ptr->mlet == S_HUMAN && (P_SKILL(P_WHIP) == P_MASTER)) bonus += rnd(3);
	    if (objects[otmp->otyp].oc_skill == P_WHIP && ptr->mlet == S_HUMAN && (P_SKILL(P_WHIP) == P_GRAND_MASTER)) bonus += rnd(4);
	...
	if (otmp && otmp->enchantment == WEAPEGO_SHARP) {
		mon->bleedout += rnd(5);
		pline("%s gets a cut.", Monnam(mon));
	}

	if (otmp && otmp->enchantment == WEAPEGO_CANCELLING) { /* lower proc chance, since this effect is powerful --Amy */
	...
	if (otmp && otmp->enchantment == WEAPEGO_SLOWING) { /* generally procs rarely --Amy */
	...
	if (otmp && otmp->enchantment == WEAPEGO_BLINDING) {
	...
	if (otmp && otmp->enchantment == WEAPEGO_PARALYZING) { /* generally procs very rarely --Amy */
	...
	if (otmp && otmp->enchantment == WEAPEGO_STUNNING) {
	...
	if (otmp && otmp->enchantment == WEAPEGO_FRENZYING) {
		if (!mon->mfrenzied) {
			mon->mfrenzied = TRUE;
	...
	if (otmp && otmp->enchantment == WEAPEGO_CONFUSING) {
	...
	if (otmp && otmp->enchantment == WEAPEGO_HEALBLOCK) {
	...
	if (otmp && otmp->enchantment == WEAPEGO_DRAINLIFE) {
		if (!resists_drli(mon)) {
	...
	if (otmp && otmp->enchantment == WEAPEGO_VORPAL && !rn2(20)) {
...
{	
	...
	EVIL_VARIANT_STONE, COMPLETELY_BAD_PART_STONE, REALLY_BAD_STONE, COVID_STONE, BLAST_STONE,
	...
	FARLOOK_STONE, RESPAWN_STONE, CAPTCHA_STONE, METABOLIC_STONE, STONE_OF_NO_RETURN, TIME_USE_STONE,
 	NONSACRED_STONE, STARVATION_STONE, DROPLESS_STONE, LOW_EFFECT_STONE, INVISO_STONE, AEFDE_STONE,
 	GHOSTLY_STONE, DEHYDRATING_STONE, STONE_OF_HATE, DIRECTIONAL_SWAP_STONE, NONINTRINSICAL_STONE,
 	DROPCURSE_STONE, STONE_OF_NAKED_STRIPPING, ANTILEVEL_STONE, BAD_PART_STONE, NOPESKILL_STONE, EPVI_STONE,
 	STEALER_STONE, REBEL_STONE, SHIT_STONE, STONE_OF_MISFIRING, STONE_OF_PERMANENCE, STONE_OF_COMPLETE_FUCKUP,
	...
	MULCH_STONE, SPELL_COOLDOWN_STONE, HAVE_A_PIN_STONE, TURBODULL_STONE, INACCURACY_STONE, INVENTORY_SIZE_STONE,
	COSTLY_FAILURE_STONE, REDDAM_STONE, REDINC_STONE, MONSTER_MULTISHOT_STONE, ANTISWITCH_STONE,
	...
	STONE_OF_VULNERABILITY, ITEM_TELEPORTING_STONE, NASTY_STONE, BOUND_DAY_STONE,

	ANJA_S_JEWEL, CELIA_S_JEWEL, CHLOE_S_JEWEL, JOHANETTA_S_JEWEL,
	NADINE_S_JEWEL, LUISA_S_JEWEL, IRINA_S_JEWEL, LISELOTTE_S_JEWEL, GRETA_S_JEWEL, JANE_S_JEWEL, SABINE_S_JEWEL,
	SUE_LYN_S_JEWEL, CHARLOTTE_S_JEWEL, HANNAH_S_JEWEL, LITTLE_MARIE_S_JEWEL, SABRINA_S_JEWEL,
	ELIF_S_JEWEL, MADELEINE_S_JEWEL, SANDRA_S_JEWEL, NADJA_S_JEWEL, SOLVEJG_S_JEWEL, THAI_S_JEWEL, ELENA_S_JEWEL,
	WENDY_S_JEWEL, ANASTASIA_S_JEWEL, JESSICA_S_JEWEL, MARLENA_S_JEWEL, FEMMY_S_JEWEL, NATALJE_S_JEWEL, KARIN_S_JEWEL,
	JEANETTA_S_JEWEL, KATI_S_JEWEL, CLAUDIA_S_JEWEL, VICTORIA_S_JEWEL, MAURAH_S_JEWEL, JUEN_S_JEWEL, KRISTINA_S_JEWEL,
	SARAH_S_JEWEL, KATHARINA_S_JEWEL, JULIETTA_S_JEWEL, MELTEM_S_JEWEL, MELISSA_S_JEWEL, LUDGERA_S_JEWEL,
	YVONNE_S_JEWEL, EVELINE_S_JEWEL, NELLY_S_JEWEL, ARABELLA_S_JEWEL, RUEA_S_JEWEL, JETTE_S_JEWEL, VERENA_S_JEWEL,
	LOU_S_JEWEL, ANITA_S_JEWEL, MARIKE_S_JEWEL, KRISTIN_S_JEWEL, HENRIETTA_S_JEWEL, ALMUT_S_JEWEL, ANNA_S_JEWEL,
	SING_S_JEWEL, INA_S_JEWEL, DORA_S_JEWEL, ANNEMARIE_S_JEWEL, JIL_S_JEWEL, JANA_S_JEWEL, KATRIN_S_JEWEL,
 	GUDRUN_S_JEWEL, ELLA_S_JEWEL, MANUELA_S_JEWEL, JENNIFER_S_JEWEL, PATRICIA_S_JEWEL, ANTJE_S_JEWEL, JUDITH_S_JEWEL,
	ANTJE_S_SECOND_JEWEL, KERSTIN_S_JEWEL, LAURA_S_JEWEL, LARISSA_S_JEWEL, NORA_S_JEWEL, NATALIA_S_JEWEL,
	SUSANNE_S_JEWEL, LISA_S_JEWEL, BRIDGHITTE_S_JEWEL, JULIA_S_JEWEL, NICOLE_S_JEWEL, RITA_S_JEWEL, JANINA_S_JEWEL,
	ROSA_S_JEWEL, KSENIA_S_JEWEL, LYDIA_S_JEWEL, CONNY_S_JEWEL, KATIA_S_JEWEL, MARIYA_S_JEWEL, ELISE_S_JEWEL,
	RONJA_S_JEWEL, ARIANE_S_JEWEL, JOHANNA_S_JEWEL, INGE_S_JEWEL, RUTH_S_JEWEL, MAGDALENA_S_JEWEL, MARLEEN_S_JEWEL,
	KLARA_S_JEWEL, FRIEDERIKE_S_JEWEL, NAOMI_S_JEWEL, UTE_S_JEWEL, JASIEEN_S_JEWEL, YASAMAN_S_JEWEL, MAY_BRITT_S_JEWEL,
	TANJA_S_JEWEL, SONJA_S_JEWEL, RHEA_S_JEWEL, LARA_S_JEWEL, JANET_S_JEWEL,
	...
	CHROME_PELLET, COPPER_RIFLE_BULLET, PLATINUM_SNIPER_BULLET, HOLLOW_POINT_MG_BULLET,
	LEAD_MG_BULLET, LEAD_SMG_BULLET, BRONZE_SMG_BULLET, LEAD_SNIPER_BULLET, LEAD_RIFLE_BULLET, LEAD_ASSAULT_RIFLE_BULLET, 
	MG_BULLET, SMG_BULLET, SNIPER_BULLET, RIFLE_BULLET, ASSAULT_RIFLE_BULLET, TRANSPARENCE_THROWER,
	SILVER_PISTOL_BULLET, SHADOW_FIVE_SEVEN_BULLET, LEAD_PISTOL_BULLET, LEAD_FIVE_SEVEN_BULLET,
	...
	WOOD_DART, LOWLY_DART, SAND_DART, JUNK_METAL,
	/* BOOMERANG, */ CREAM_PIE
	/* note: CREAM_PIE should NOT be #ifdef KOPS */
};

static NEARDATA const int pwep[] =
{	PETRIFYIUM_BAR, DISINTEGRATION_BAR, NASTYPOLE, GREAT_POLLAX, WOODEN_BAR, TRAFFIC_LIGHT, TOP_POLE, GIANT_SCYTHE,
	CIRCULAR_SAW, THRESHER, YITH_TENTACLE, FORCE_PIKE, DROVEN_LANCE, GRAND_GRINDER, MARKET_GRINDER, 
	HEAVY_GRINDER, LASER_POLE,
	CRYPTIC_POLE, HELMET_BEARD, AIRSTRIKE_PIKE, POKER_STICK, COURSE_LANCE, HALBERD, BARDICHE, BRICKLAYER_BAR, SHICKSTAKE,
...
boolean polespecial; /* may use polearm for monster-versus-monster combat */
{
	...
	for (i = 0; i < SIZE(rwep); i++) {
	    ...
	    if ( (rwep[i] == DART || rwep[i] == SPIKE) && !likes_gems(mtmp->data) &&
		    (m_carrying(mtmp, SLING) || m_carrying(mtmp, METAL_SLING) || m_carrying(mtmp, BAGGY_SLING) || m_carrying(mtmp, SHOVEL) || m_carrying(mtmp, INKA_SLING) || m_carrying(mtmp, ATLATL) || m_carrying(mtmp, SNIPESLING) || m_carrying(mtmp, CATAPULT)) ) {		/* propellor */
		for (otmp = mtmp->minvent; otmp; otmp = otmp->nobj)
		...
		case P_BOW:
		  ...
		  if (!propellor) propellor = (oselect(mtmp, FOOTBOW));
		...
		case P_SLING:
		  ...
		  if (!propellor) propellor = (oselect(mtmp, BAGGY_SLING));
		...
		case P_CROSSBOW:
		  ...
		  if (!propellor) propellor = (oselect(mtmp, LIGHT_CROSSBOW));
		case P_FIREARM:
		  if ((objects[rwep[i]].w_ammotyp) == WP_BULLET_PISTOL) {
		  ...
		  } else if ((objects[rwep[i]].w_ammotyp) == WP_BULLET_FIVESEVEN) {
			...
			if (!propellor) propellor = (oselect(mtmp, LEAD_UNLOADER));
...
static const NEARDATA short hwep[] = {
	  ...
	  FIRE_HYDRANT, COLOSSUS_BLADE, THUNDER_HAMMER, STEEL_CAPPED_SANDAL, HONOR_KATANA, ULTRA_SWORD,
	  ...
	  MASSIVE_STAFF, FEATHER_STAFF, BATTLE_STAFF, BACKHAND_MACE, OLDEST_STAFF, PHEONIX_STAFF, RAINBOW_LIGHTSABER,
	  REINFORCED_MACE, OSBANE_KATANA, GRANITE_IMPALER, FLAME_MOUNTAIN, LEAD_FILLED_MACE, UNDERWATER_TRIDENT,
	  BRICK_HORN,
	  ...
	  DROVEN_DAGGER, TECPATL, ELVEN_BROADSWORD, BROADSWORD, SCIMITAR, SILVER_SABER, LEAD_PIPE,
	  ...
	  STAR_ROD, RUNED_ROD, SPIKED_CHAIN, WEIGHTED_FLAIL, FLAIL, TIRE_IRON, FLOGGER,
	  CHAIN_AND_SICKLE, BULLWHIP, CHITIN_WHIP,
	  ...
	  RADIOACTIVE_DAGGER, SECRETION_DAGGER, BRITTLE_SPEAR, JARED_STONE, KLIUSLING, ROLLING_PIN,
	  TELEPHONE, FUTON_SWATTER, MAGICAL_PAINTBRUSH, BREAKING_WHEEL, ORCISH_SCIMITAR, BILLARD_QUEUE,
...
register struct monst *mon;
{
	...
	switch(mon->weapon_check) {
		...
		case NEED_PICK_AXE:
			...
			if (!obj) obj = m_carrying(mon, MYSTERIOUS_PICK);
		...
		case NEED_PICK_OR_AXE:
			...
			if (!obj || which_armor(mon, W_ARMS)) {
			    ...
			    if (!obj) obj = m_carrying(mon, QUATTUORST_AXE);
			    if (!obj) obj = m_carrying(mon, GROM_AXE);
			    if (!obj) obj = m_carrying(mon, OBSIDIAN_AXE);
			    if (!obj) obj = m_carrying(mon, SPIRIT_AXE);
			    if (!obj) obj = m_carrying(mon, SHARP_AXE);
			    if (!obj) obj = m_carrying(mon, DISKOS);
...
struct monst * mon;
{
	...
	if (!obj->lamplit) {
		...
		if ((obj->otyp == RED_DOUBLE_LIGHTSABER || obj->otyp == CYAN_DOUBLE_LIGHTSABER || obj->otyp == LASERDENT || obj->otyp == LASER_FLYAXE || obj->otyp == PINK_DOUBLE_LIGHTSWORD || obj->otyp == LASERXBOW || obj->otyp == LASER_POLE || obj->otyp == SITH_STAFF || obj->otyp == WHITE_DOUBLE_LIGHTSABER) && !obj->altmode) {
...
restrpasstwo:
	  ...
	  for (pass = 0; pass < SIZE(skill_ranges); pass++)
		...
		if (want_dump) {
			...
			dump("    ",buf2);
			sprintf(buf2, "type 6: ball heels %s %d",
			    (u.ballskill >= 4320) ? "Supreme Master" : (u.ballskill >= 2500) ? "Grand Master" : (u.ballskill >= 1280) ? "Master" : (u.ballskill >= 540) ? "Expert" : (u.ballskill >= 160) ? "Skilled" : (u.ballskill >= 20) ? "Basic" : "Unskilled", u.ballskill);
			dump("    ",buf2);
			sprintf(buf2, "type 7: pyramidal heels %s %d",
			    (u.pyramidalskill >= 4320) ? "Supreme Master" : (u.pyramidalskill >= 2500) ? "Grand Master" : (u.pyramidalskill >= 1280) ? "Master" : (u.pyramidalskill >= 540) ? "Expert" : (u.pyramidalskill >= 160) ? "Skilled" : (u.pyramidalskill >= 20) ? "Basic" : "Unskilled", u.pyramidalskill);
			dump("    ",buf2);
			logged=TRUE;
			...
			any.a_int = 0;
			add_menu(win, NO_GLYPH, &any, 0, 0, ATR_NONE, buf, MENU_UNSELECTED);
			sprintf(buf, "  type 6: ball heels %s %d",
			    (u.ballskill >= 4320) ? "Supreme Master" : (u.ballskill >= 2500) ? "Grand Master" : (u.ballskill >= 1280) ? "Master" : (u.ballskill >= 540) ? "Expert" : (u.ballskill >= 160) ? "Skilled" : (u.ballskill >= 20) ? "Basic" : "Unskilled", u.ballskill);
			any.a_int = 0;
			add_menu(win, NO_GLYPH, &any, 0, 0, ATR_NONE, buf, MENU_UNSELECTED);
			sprintf(buf, "  type 7: pyramidal heels %s %d",
			    (u.pyramidalskill >= 4320) ? "Supreme Master" : (u.pyramidalskill >= 2500) ? "Grand Master" : (u.pyramidalskill >= 1280) ? "Master" : (u.pyramidalskill >= 540) ? "Expert" : (u.pyramidalskill >= 160) ? "Skilled" : (u.pyramidalskill >= 20) ? "Basic" : "Unskilled", u.pyramidalskill);
			any.a_int = 0;
			add_menu(win, NO_GLYPH, &any, 0, 0, ATR_NONE, buf, MENU_UNSELECTED);
...
/*    if (skill != P_NONE && !P_RESTRICTED(skill)) {*/
	...
	if (uarmf && uarmf->oartifact == ART_FANNY_S_ANNOYANCE && skill == P_MARTIAL_ARTS) degree *= 2;
...
screwupsdone:
	...
	if (Race_if(PM_UNALIGNMENT_THING) && !rn2(3)) return;
...
int n;	/* number of slots to lose; normally one */
{
	...
	} else /* none advanced but still going to lose some (e.g. data delete), so the total # can become negative --Amy */
		u.weapon_slots--;
    }
...
boolean bypass_martial; /* by Amy: if this is true, martial arts skill will be used even if you disabled it */
{
	...
	if (weapon && !rn2(3) && !(PlayerCannotUseSkills) && (weapon->otyp == WEDGED_LITTLE_GIRL_SANDAL || weapon->otyp == STURDY_PLATEAU_BOOT_FOR_GIRLS || weapon->otyp == BLOCK_HEELED_COMBAT_BOOT || weapon->otyp == WOODEN_GETA || weapon->otyp == LACQUERED_DANCING_SHOE || weapon->otyp == HIGH_HEELED_SANDAL || weapon->otyp == SEXY_LEATHER_PUMP || weapon->otyp == STICKSHOE || weapon->otyp == INKA_BOOT || weapon->otyp == SEXY_MARY_JANE || weapon->otyp == KITTEN_HEEL_PUMP || weapon->otyp == STEEL_CAPPED_SANDAL || weapon->otyp == BLOCK_HEELED_SANDAL || weapon->otyp == PROSTITUTE_SHOE || weapon->otyp == DOGSHIT_BOOT) ) {
	...
	if (weapon && !rn2(5) && !(PlayerCannotUseSkills) && (weapon->otyp == HUGGING_BOOT || weapon->otyp == SPIKED_BATTLE_BOOT || weapon->otyp == SOFT_LADY_SHOE || weapon->otyp == SOFT_GIRL_SNEAKER) ) {
	...
	if (RngeHighHeeling && weapon && (weapon->otyp == WEDGED_LITTLE_GIRL_SANDAL || weapon->otyp == STURDY_PLATEAU_BOOT_FOR_GIRLS || weapon->otyp == BLOCK_HEELED_COMBAT_BOOT || weapon->otyp == WOODEN_GETA || weapon->otyp == LACQUERED_DANCING_SHOE || weapon->otyp == HIGH_HEELED_SANDAL || weapon->otyp == STICKSHOE || weapon->otyp == SEXY_LEATHER_PUMP || weapon->otyp == INKA_BOOT || weapon->otyp == SEXY_MARY_JANE || weapon->otyp == KITTEN_HEEL_PUMP || weapon->otyp == STEEL_CAPPED_SANDAL || weapon->otyp == BLOCK_HEELED_SANDAL || weapon->otyp == PROSTITUTE_SHOE || weapon->otyp == DOGSHIT_BOOT) ) bonus += rnd(10);

	if (uarmf && uarmf->oartifact == ART_VERENA_S_DUELING_SANDALS && weapon && (weapon->otyp == WEDGED_LITTLE_GIRL_SANDAL || weapon->otyp == STURDY_PLATEAU_BOOT_FOR_GIRLS || weapon->otyp == BLOCK_HEELED_COMBAT_BOOT || weapon->otyp == WOODEN_GETA || weapon->otyp == LACQUERED_DANCING_SHOE || weapon->otyp == SEXY_MARY_JANE || weapon->otyp == KITTEN_HEEL_PUMP || weapon->otyp == HIGH_HEELED_SANDAL || weapon->otyp == STICKSHOE || weapon->otyp == SEXY_LEATHER_PUMP || weapon->otyp == INKA_BOOT || weapon->otyp == STEEL_CAPPED_SANDAL || weapon->otyp == BLOCK_HEELED_SANDAL || weapon->otyp == PROSTITUTE_SHOE || weapon->otyp == DOGSHIT_BOOT) ) bonus += rnd(10);

	if (uarmf && uarmf->oartifact == ART_HUGGING__GROPING_AND_STROK && weapon && (weapon->otyp == WEDGED_LITTLE_GIRL_SANDAL || weapon->otyp == STURDY_PLATEAU_BOOT_FOR_GIRLS || weapon->otyp == BLOCK_HEELED_COMBAT_BOOT || weapon->otyp == WOODEN_GETA || weapon->otyp == LACQUERED_DANCING_SHOE || weapon->otyp == SEXY_MARY_JANE || weapon->otyp == KITTEN_HEEL_PUMP || weapon->otyp == HIGH_HEELED_SANDAL || weapon->otyp == STICKSHOE || weapon->otyp == SEXY_LEATHER_PUMP || weapon->otyp == INKA_BOOT || weapon->otyp == STEEL_CAPPED_SANDAL || weapon->otyp == BLOCK_HEELED_SANDAL || weapon->otyp == PROSTITUTE_SHOE || weapon->otyp == DOGSHIT_BOOT) ) bonus += 2;
	...
	if (weapon && weapon_type(weapon) == P_BOOMERANG && (P_SKILL(P_BOOMERANG) == P_SKILLED) ) bonus += rnd(2);
	if (weapon && weapon_type(weapon) == P_BOOMERANG && (P_SKILL(P_BOOMERANG) == P_EXPERT) ) bonus += rnd(4);
	if (weapon && weapon_type(weapon) == P_BOOMERANG && (P_SKILL(P_BOOMERANG) == P_MASTER) ) bonus += rnd(6);
	if (weapon && weapon_type(weapon) == P_BOOMERANG && (P_SKILL(P_BOOMERANG) == P_GRAND_MASTER) ) bonus += rnd(8);
	if (weapon && weapon_type(weapon) == P_BOOMERANG && (P_SKILL(P_BOOMERANG) == P_SUPREME_MASTER) ) bonus += rnd(10);
	...
	if (Race_if(PM_ORC) && weapon && (weapon->otyp == ORCISH_DAGGER || weapon->otyp == ORCISH_BOW || weapon->otyp == ORCISH_ARROW || weapon->otyp == ORCISH_SPEAR || weapon->otyp == ORCISH_SCIMITAR || weapon->otyp == ORCISH_MORNING_STAR || weapon->otyp == ORCISH_SHORT_SWORD || weapon->otyp == ORCISH_LONG_SWORD ) ) bonus += 1;
	...
	if ((Race_if(PM_HOBBIT) || Role_if(PM_RINGSEEKER)) && weapon && (weapon->otyp == SLING || weapon->otyp == INKA_SLING || weapon->otyp == ATLATL || weapon->otyp == SNIPESLING || weapon->otyp == METAL_SLING || weapon->otyp == BAGGY_SLING || weapon->otyp == SHOVEL || weapon_type(weapon) == -P_SLING) ) bonus += 1;
...

{
	...
	if (Role_if(PM_GLADIATOR) && uarm && itemhasappearance(uarm, APP_ARENA_ROBE)) bonus++;
	...
	if (weapon && weapon->otyp == BATTLE_AXE && (P_SKILL(P_AXE) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == BATTLE_AXE && (P_SKILL(P_AXE) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == BATTLE_AXE && (P_SKILL(P_AXE) == P_MASTER) ) bonus += rnd(10);
	...
	if (weapon && weapon->otyp == DWARVISH_BATTLE_AXE && (P_SKILL(P_AXE) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == DWARVISH_BATTLE_AXE && (P_SKILL(P_AXE) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == CHEMISTRY_SPACE_AXE && (P_SKILL(P_AXE) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == CHEMISTRY_SPACE_AXE && (P_SKILL(P_AXE) == P_EXPERT) ) bonus += rnd(6);
	...
	if (weapon && weapon->otyp == QUATTUORST_AXE && (P_SKILL(P_AXE) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == QUATTUORST_AXE && (P_SKILL(P_AXE) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == QUATTUORST_AXE && (P_SKILL(P_AXE) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == QUATTUORST_AXE && (P_SKILL(P_AXE) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == QUATTUORST_AXE && (P_SKILL(P_AXE) == P_SUPREME_MASTER) ) bonus += rnd(15);
	...
	if (weapon && weapon->otyp == GROM_AXE && (P_SKILL(P_AXE) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == GROM_AXE && (P_SKILL(P_AXE) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == GROM_AXE && (P_SKILL(P_AXE) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == AMBUSH_QATAR && (P_SKILL(P_AXE) == P_SKILLED) ) bonus += rnd(2);
	if (weapon && weapon->otyp == AMBUSH_QATAR && (P_SKILL(P_AXE) == P_EXPERT) ) bonus += rnd(4);
	if (weapon && weapon->otyp == AMBUSH_QATAR && (P_SKILL(P_AXE) == P_MASTER) ) bonus += rnd(6);
	if (weapon && weapon->otyp == AMBUSH_QATAR && (P_SKILL(P_AXE) == P_GRAND_MASTER) ) bonus += rnd(8);
	...
	if (weapon && weapon->otyp == BROOM && (P_SKILL(P_PADDLE) == P_MASTER) ) bonus += rnd(7);
	if (weapon && weapon->otyp == BROOM && (P_SKILL(P_PADDLE) == P_GRAND_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == BROOM && (P_SKILL(P_PADDLE) == P_SUPREME_MASTER) ) bonus += rnd(12);

	if (weapon && weapon->otyp == MOP && (P_SKILL(P_PADDLE) == P_SKILLED) ) bonus += rnd(2);
	if (weapon && weapon->otyp == MOP && (P_SKILL(P_PADDLE) == P_EXPERT) ) bonus += rnd(5);
	if (weapon && weapon->otyp == MOP && (P_SKILL(P_PADDLE) == P_MASTER) ) bonus += rnd(7);
	if (weapon && weapon->otyp == MOP && (P_SKILL(P_PADDLE) == P_GRAND_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == MOP && (P_SKILL(P_PADDLE) == P_SUPREME_MASTER) ) bonus += rnd(12);

	if (weapon && weapon->otyp == SPECIAL_MOP && (P_SKILL(P_PADDLE) == P_SKILLED) ) bonus += rnd(2);
	if (weapon && weapon->otyp == SPECIAL_MOP && (P_SKILL(P_PADDLE) == P_EXPERT) ) bonus += rnd(5);
	if (weapon && weapon->otyp == SPECIAL_MOP && (P_SKILL(P_PADDLE) == P_MASTER) ) bonus += rnd(7);
	if (weapon && weapon->otyp == SPECIAL_MOP && (P_SKILL(P_PADDLE) == P_GRAND_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == SPECIAL_MOP && (P_SKILL(P_PADDLE) == P_SUPREME_MASTER) ) bonus += rnd(12);

	if (weapon && weapon->otyp == BOAT_OAR && (P_SKILL(P_PADDLE) == P_SKILLED) ) bonus += rnd(2);
	if (weapon && weapon->otyp == BOAT_OAR && (P_SKILL(P_PADDLE) == P_EXPERT) ) bonus += rnd(5);
	if (weapon && weapon->otyp == BOAT_OAR && (P_SKILL(P_PADDLE) == P_MASTER) ) bonus += rnd(7);
	if (weapon && weapon->otyp == BOAT_OAR && (P_SKILL(P_PADDLE) == P_GRAND_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == BOAT_OAR && (P_SKILL(P_PADDLE) == P_SUPREME_MASTER) ) bonus += rnd(12);

	if (weapon && weapon->otyp == MAGICAL_PAINTBRUSH && (P_SKILL(P_PADDLE) == P_SKILLED) ) bonus += rnd(2);
	if (weapon && weapon->otyp == MAGICAL_PAINTBRUSH && (P_SKILL(P_PADDLE) == P_EXPERT) ) bonus += rnd(5);
	if (weapon && weapon->otyp == MAGICAL_PAINTBRUSH && (P_SKILL(P_PADDLE) == P_MASTER) ) bonus += rnd(7);
	if (weapon && weapon->otyp == MAGICAL_PAINTBRUSH && (P_SKILL(P_PADDLE) == P_GRAND_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == MAGICAL_PAINTBRUSH && (P_SKILL(P_PADDLE) == P_SUPREME_MASTER) ) bonus += rnd(12);

	if (weapon && weapon->otyp == PICK_AXE && (P_SKILL(P_PICK_AXE) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == PICK_AXE && (P_SKILL(P_PICK_AXE) == P_EXPERT) ) bonus += rnd(2);
	if (weapon && weapon->otyp == PICK_AXE && (P_SKILL(P_PICK_AXE) == P_MASTER) ) bonus += rnd(3);
	if (weapon && weapon->otyp == PICK_AXE && (P_SKILL(P_PICK_AXE) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (weapon && weapon->otyp == PICK_AXE && (P_SKILL(P_PICK_AXE) == P_SUPREME_MASTER) ) bonus += rnd(5);

	if (weapon && weapon->otyp == CONGLOMERATE_PICK && (P_SKILL(P_PICK_AXE) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == CONGLOMERATE_PICK && (P_SKILL(P_PICK_AXE) == P_EXPERT) ) bonus += rnd(2);
	...
	if (weapon && weapon->otyp == CONUNDRUM_PICK && (P_SKILL(P_PICK_AXE) == P_MASTER) ) bonus += rnd(3);
	if (weapon && weapon->otyp == CONUNDRUM_PICK && (P_SKILL(P_PICK_AXE) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (weapon && weapon->otyp == CONUNDRUM_PICK && (P_SKILL(P_PICK_AXE) == P_SUPREME_MASTER) ) bonus += rnd(5);

	if (weapon && weapon->otyp == MYSTERY_PICK && (P_SKILL(P_PICK_AXE) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == MYSTERY_PICK && (P_SKILL(P_PICK_AXE) == P_EXPERT) ) bonus += rnd(2);
	if (weapon && weapon->otyp == MYSTERY_PICK && (P_SKILL(P_PICK_AXE) == P_MASTER) ) bonus += rnd(3);
	if (weapon && weapon->otyp == MYSTERY_PICK && (P_SKILL(P_PICK_AXE) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (weapon && weapon->otyp == MYSTERY_PICK && (P_SKILL(P_PICK_AXE) == P_SUPREME_MASTER) ) bonus += rnd(5);

	if (weapon && weapon->otyp == BRONZE_PICK && (P_SKILL(P_PICK_AXE) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == BRONZE_PICK && (P_SKILL(P_PICK_AXE) == P_EXPERT) ) bonus += rnd(2);
	if (weapon && weapon->otyp == BRONZE_PICK && (P_SKILL(P_PICK_AXE) == P_MASTER) ) bonus += rnd(3);
	if (weapon && weapon->otyp == BRONZE_PICK && (P_SKILL(P_PICK_AXE) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (weapon && weapon->otyp == BRONZE_PICK && (P_SKILL(P_PICK_AXE) == P_SUPREME_MASTER) ) bonus += rnd(5);

	if (weapon && weapon->otyp == BRICK_PICK && (P_SKILL(P_PICK_AXE) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == BRICK_PICK && (P_SKILL(P_PICK_AXE) == P_EXPERT) ) bonus += rnd(2);
	if (weapon && weapon->otyp == BRICK_PICK && (P_SKILL(P_PICK_AXE) == P_MASTER) ) bonus += rnd(3);
	if (weapon && weapon->otyp == BRICK_PICK && (P_SKILL(P_PICK_AXE) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (weapon && weapon->otyp == BRICK_PICK && (P_SKILL(P_PICK_AXE) == P_SUPREME_MASTER) ) bonus += rnd(5);

	if (weapon && weapon->otyp == NANO_PICK && (P_SKILL(P_PICK_AXE) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == NANO_PICK && (P_SKILL(P_PICK_AXE) == P_EXPERT) ) bonus += rnd(2);
	if (weapon && weapon->otyp == NANO_PICK && (P_SKILL(P_PICK_AXE) == P_MASTER) ) bonus += rnd(3);
	if (weapon && weapon->otyp == NANO_PICK && (P_SKILL(P_PICK_AXE) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (weapon && weapon->otyp == NANO_PICK && (P_SKILL(P_PICK_AXE) == P_SUPREME_MASTER) ) bonus += rnd(5);

	if (weapon && weapon->otyp == TSURUGI && (P_SKILL(P_TWO_HANDED_SWORD) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == TSURUGI && (P_SKILL(P_TWO_HANDED_SWORD) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == TSURUGI && (P_SKILL(P_TWO_HANDED_SWORD) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == TSURUGI && (P_SKILL(P_TWO_HANDED_SWORD) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == TSURUGI && (P_SKILL(P_TWO_HANDED_SWORD) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == DROVEN_GREATSWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == DROVEN_GREATSWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == DROVEN_GREATSWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == DROVEN_GREATSWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == DROVEN_GREATSWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == CHAINSWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == CHAINSWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == CHAINSWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == CHAINSWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == CHAINSWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == ZANBATO && (P_SKILL(P_TWO_HANDED_SWORD) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == ZANBATO && (P_SKILL(P_TWO_HANDED_SWORD) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == ZANBATO && (P_SKILL(P_TWO_HANDED_SWORD) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == ZANBATO && (P_SKILL(P_TWO_HANDED_SWORD) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == ZANBATO && (P_SKILL(P_TWO_HANDED_SWORD) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == UNNATURAL_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == UNNATURAL_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == UNNATURAL_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == UNNATURAL_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == UNNATURAL_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == BIDENHANDER && (P_SKILL(P_TWO_HANDED_SWORD) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == BIDENHANDER && (P_SKILL(P_TWO_HANDED_SWORD) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == BIDENHANDER && (P_SKILL(P_TWO_HANDED_SWORD) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == BIDENHANDER && (P_SKILL(P_TWO_HANDED_SWORD) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == BIDENHANDER && (P_SKILL(P_TWO_HANDED_SWORD) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == ETHER_SAW && (P_SKILL(P_TWO_HANDED_SWORD) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == ETHER_SAW && (P_SKILL(P_TWO_HANDED_SWORD) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == ETHER_SAW && (P_SKILL(P_TWO_HANDED_SWORD) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == ETHER_SAW && (P_SKILL(P_TWO_HANDED_SWORD) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == ETHER_SAW && (P_SKILL(P_TWO_HANDED_SWORD) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == SHADOWBLADE && (P_SKILL(P_TWO_HANDED_SWORD) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == SHADOWBLADE && (P_SKILL(P_TWO_HANDED_SWORD) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == SHADOWBLADE && (P_SKILL(P_TWO_HANDED_SWORD) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == SHADOWBLADE && (P_SKILL(P_TWO_HANDED_SWORD) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == SHADOWBLADE && (P_SKILL(P_TWO_HANDED_SWORD) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == ROMAN_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == ROMAN_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == ROMAN_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == ROMAN_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == ROMAN_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == ORGANOBLADE && (P_SKILL(P_TWO_HANDED_SWORD) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == ORGANOBLADE && (P_SKILL(P_TWO_HANDED_SWORD) == P_EXPERT) ) bonus += rnd(6);
	...
	if (weapon && weapon->otyp == COLOSSUS_BLADE && (P_SKILL(P_TWO_HANDED_SWORD) == P_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == COLOSSUS_BLADE && (P_SKILL(P_TWO_HANDED_SWORD) == P_GRAND_MASTER) ) bonus += rnd(16);
	if (weapon && weapon->otyp == COLOSSUS_BLADE && (P_SKILL(P_TWO_HANDED_SWORD) == P_SUPREME_MASTER) ) bonus += rnd(20);

	if (weapon && weapon->otyp == BASTERD_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == BASTERD_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == BASTERD_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == BASTERD_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == BASTERD_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == TWO_HANDED_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == TWO_HANDED_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == TWO_HANDED_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == TWO_HANDED_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == TWO_HANDED_SWORD && (P_SKILL(P_TWO_HANDED_SWORD) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == GOLDEN_SABER && (P_SKILL(P_SABER) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == GOLDEN_SABER && (P_SKILL(P_SABER) == P_EXPERT) ) bonus += rnd(2);
	if (weapon && weapon->otyp == GOLDEN_SABER && (P_SKILL(P_SABER) == P_MASTER) ) bonus += rnd(3);
	if (weapon && weapon->otyp == GOLDEN_SABER && (P_SKILL(P_SABER) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (weapon && weapon->otyp == GOLDEN_SABER && (P_SKILL(P_SABER) == P_SUPREME_MASTER) ) bonus += rnd(5);

	if (weapon && weapon->otyp == ETERNIUM_SABER && (P_SKILL(P_SABER) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == ETERNIUM_SABER && (P_SKILL(P_SABER) == P_EXPERT) ) bonus += rnd(2);
	if (weapon && weapon->otyp == ETERNIUM_SABER && (P_SKILL(P_SABER) == P_MASTER) ) bonus += rnd(3);
	if (weapon && weapon->otyp == ETERNIUM_SABER && (P_SKILL(P_SABER) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (weapon && weapon->otyp == ETERNIUM_SABER && (P_SKILL(P_SABER) == P_SUPREME_MASTER) ) bonus += rnd(5);

	if (weapon && weapon->otyp == PLATINUM_SABER && (P_SKILL(P_SABER) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == PLATINUM_SABER && (P_SKILL(P_SABER) == P_EXPERT) ) bonus += rnd(2);
	if (weapon && weapon->otyp == PLATINUM_SABER && (P_SKILL(P_SABER) == P_MASTER) ) bonus += rnd(3);
	if (weapon && weapon->otyp == PLATINUM_SABER && (P_SKILL(P_SABER) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (weapon && weapon->otyp == PLATINUM_SABER && (P_SKILL(P_SABER) == P_SUPREME_MASTER) ) bonus += rnd(5);

	if (weapon && weapon->otyp == METAL_CLUB && (P_SKILL(P_CLUB) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == METAL_CLUB && (P_SKILL(P_CLUB) == P_EXPERT) ) bonus += rnd(2);
	if (weapon && weapon->otyp == METAL_CLUB && (P_SKILL(P_CLUB) == P_MASTER) ) bonus += rnd(3);
	if (weapon && weapon->otyp == METAL_CLUB && (P_SKILL(P_CLUB) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (weapon && weapon->otyp == METAL_CLUB && (P_SKILL(P_CLUB) == P_SUPREME_MASTER) ) bonus += rnd(5);

	if (weapon && weapon->otyp == DIAMOND_SMASHER && (P_SKILL(P_CLUB) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == DIAMOND_SMASHER && (P_SKILL(P_CLUB) == P_EXPERT) ) bonus += rnd(2);
	if (weapon && weapon->otyp == DIAMOND_SMASHER && (P_SKILL(P_CLUB) == P_MASTER) ) bonus += rnd(3);
	if (weapon && weapon->otyp == DIAMOND_SMASHER && (P_SKILL(P_CLUB) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (weapon && weapon->otyp == DIAMOND_SMASHER && (P_SKILL(P_CLUB) == P_SUPREME_MASTER) ) bonus += rnd(5);

	if (weapon && weapon->otyp == LOG && (P_SKILL(P_CLUB) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == LOG && (P_SKILL(P_CLUB) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == LOG && (P_SKILL(P_CLUB) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == LOG && (P_SKILL(P_CLUB) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == LOG && (P_SKILL(P_CLUB) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == HUGE_CLUB && (P_SKILL(P_CLUB) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == HUGE_CLUB && (P_SKILL(P_CLUB) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == HUGE_CLUB && (P_SKILL(P_CLUB) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == HUGE_CLUB && (P_SKILL(P_CLUB) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == HUGE_CLUB && (P_SKILL(P_CLUB) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == BATTLE_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == BATTLE_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_EXPERT) ) bonus += rnd(3);
	if (weapon && weapon->otyp == BATTLE_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_MASTER) ) bonus += rnd(5);
	if (weapon && weapon->otyp == BATTLE_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_GRAND_MASTER) ) bonus += rnd(6);
	if (weapon && weapon->otyp == BATTLE_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SUPREME_MASTER) ) bonus += rnd(8);

	if (weapon && weapon->otyp == MASSIVE_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == MASSIVE_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_EXPERT) ) bonus += rnd(3);
	if (weapon && weapon->otyp == MASSIVE_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_MASTER) ) bonus += rnd(5);
	if (weapon && weapon->otyp == MASSIVE_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_GRAND_MASTER) ) bonus += rnd(6);
	if (weapon && weapon->otyp == MASSIVE_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SUPREME_MASTER) ) bonus += rnd(8);

	if (weapon && weapon->otyp == BAMBOO_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == BAMBOO_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_EXPERT) ) bonus += rnd(3);
	if (weapon && weapon->otyp == BAMBOO_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_MASTER) ) bonus += rnd(5);
	if (weapon && weapon->otyp == BAMBOO_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_GRAND_MASTER) ) bonus += rnd(6);
	if (weapon && weapon->otyp == BAMBOO_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SUPREME_MASTER) ) bonus += rnd(8);

	if (weapon && weapon->otyp == BREAKER_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == BREAKER_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_EXPERT) ) bonus += rnd(3);
	if (weapon && weapon->otyp == BREAKER_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_MASTER) ) bonus += rnd(5);
	if (weapon && weapon->otyp == BREAKER_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_GRAND_MASTER) ) bonus += rnd(6);
	if (weapon && weapon->otyp == BREAKER_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SUPREME_MASTER) ) bonus += rnd(8);

	if (weapon && weapon->otyp == FEATHER_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == FEATHER_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_EXPERT) ) bonus += rnd(3);
	if (weapon && weapon->otyp == FEATHER_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_MASTER) ) bonus += rnd(5);
	if (weapon && weapon->otyp == FEATHER_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_GRAND_MASTER) ) bonus += rnd(6);
	if (weapon && weapon->otyp == FEATHER_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SUPREME_MASTER) ) bonus += rnd(8);

	if (weapon && weapon->otyp == OLDEST_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == OLDEST_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_EXPERT) ) bonus += rnd(3);
	if (weapon && weapon->otyp == OLDEST_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_MASTER) ) bonus += rnd(5);
	if (weapon && weapon->otyp == OLDEST_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_GRAND_MASTER) ) bonus += rnd(6);
	if (weapon && weapon->otyp == OLDEST_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SUPREME_MASTER) ) bonus += rnd(8);

	if (weapon && weapon->otyp == IMPACT_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == IMPACT_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_EXPERT) ) bonus += rnd(3);
	if (weapon && weapon->otyp == IMPACT_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_MASTER) ) bonus += rnd(5);
	if (weapon && weapon->otyp == IMPACT_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_GRAND_MASTER) ) bonus += rnd(6);
	if (weapon && weapon->otyp == IMPACT_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SUPREME_MASTER) ) bonus += rnd(8);

	if (weapon && weapon->otyp == BO_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon->otyp == BO_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_EXPERT) ) bonus += rnd(3);
	if (weapon && weapon->otyp == BO_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_MASTER) ) bonus += rnd(5);
	if (weapon && weapon->otyp == BO_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_GRAND_MASTER) ) bonus += rnd(6);
	if (weapon && weapon->otyp == BO_STAFF && (P_SKILL(P_QUARTERSTAFF) == P_SUPREME_MASTER) ) bonus += rnd(8);

	if (weapon && weapon->otyp == SLEDGE_HAMMER && (P_SKILL(P_HAMMER) == P_SKILLED) ) bonus += rnd(2);
	if (weapon && weapon->otyp == SLEDGE_HAMMER && (P_SKILL(P_HAMMER) == P_EXPERT) ) bonus += rnd(4);
	if (weapon && weapon->otyp == SLEDGE_HAMMER && (P_SKILL(P_HAMMER) == P_MASTER) ) bonus += rnd(6);
	if (weapon && weapon->otyp == SLEDGE_HAMMER && (P_SKILL(P_HAMMER) == P_GRAND_MASTER) ) bonus += rnd(8);
	if (weapon && weapon->otyp == SLEDGE_HAMMER && (P_SKILL(P_HAMMER) == P_SUPREME_MASTER) ) bonus += rnd(10);

	if (weapon && weapon->otyp == THUNDER_HAMMER && (P_SKILL(P_HAMMER) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == THUNDER_HAMMER && (P_SKILL(P_HAMMER) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == THUNDER_HAMMER && (P_SKILL(P_HAMMER) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == THUNDER_HAMMER && (P_SKILL(P_HAMMER) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == THUNDER_HAMMER && (P_SKILL(P_HAMMER) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == FIRE_HYDRANT && (P_SKILL(P_HAMMER) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == FIRE_HYDRANT && (P_SKILL(P_HAMMER) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == FIRE_HYDRANT && (P_SKILL(P_HAMMER) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == FIRE_HYDRANT && (P_SKILL(P_HAMMER) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == FIRE_HYDRANT && (P_SKILL(P_HAMMER) == P_SUPREME_MASTER) ) bonus += rnd(15);
	...
	if (weapon && weapon_type(weapon) == P_WHIP && (P_SKILL(P_WHIP) == P_SKILLED) ) bonus += 1;
	if (weapon && weapon_type(weapon) == P_WHIP && (P_SKILL(P_WHIP) == P_EXPERT) ) bonus += rnd(2);
	if (weapon && weapon_type(weapon) == P_WHIP && (P_SKILL(P_WHIP) == P_MASTER) ) bonus += rnd(3);
	if (weapon && weapon_type(weapon) == P_WHIP && (P_SKILL(P_WHIP) == P_GRAND_MASTER) ) bonus += rnd(4);
	if (weapon && weapon_type(weapon) == P_WHIP && (P_SKILL(P_WHIP) == P_SUPREME_MASTER) ) bonus += rnd(5);
...

{
	...
	if (weapon && weapon->otyp == SPIRIT_THROWER && (P_SKILL(P_JAVELIN) == P_SKILLED) ) bonus += rnd(2);
	if (weapon && weapon->otyp == SPIRIT_THROWER && (P_SKILL(P_JAVELIN) == P_EXPERT) ) bonus += rnd(4);
	if (weapon && weapon->otyp == SPIRIT_THROWER && (P_SKILL(P_JAVELIN) == P_MASTER) ) bonus += rnd(6);
	if (weapon && weapon->otyp == SPIRIT_THROWER && (P_SKILL(P_JAVELIN) == P_GRAND_MASTER) ) bonus += rnd(8);
	if (weapon && weapon->otyp == SPIRIT_THROWER && (P_SKILL(P_JAVELIN) == P_SUPREME_MASTER) ) bonus += rnd(10);

	if (weapon && weapon->otyp == TORPEDO && (P_SKILL(P_JAVELIN) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == TORPEDO && (P_SKILL(P_JAVELIN) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == TORPEDO && (P_SKILL(P_JAVELIN) == P_MASTER) ) bonus += rnd(10);
	if (weapon && weapon->otyp == TORPEDO && (P_SKILL(P_JAVELIN) == P_GRAND_MASTER) ) bonus += rnd(12);
	if (weapon && weapon->otyp == TORPEDO && (P_SKILL(P_JAVELIN) == P_SUPREME_MASTER) ) bonus += rnd(15);

	if (weapon && weapon->otyp == HOMING_TORPEDO && (P_SKILL(P_JAVELIN) == P_SKILLED) ) bonus += rnd(3);
	if (weapon && weapon->otyp == HOMING_TORPEDO && (P_SKILL(P_JAVELIN) == P_EXPERT) ) bonus += rnd(6);
	if (weapon && weapon->otyp == HOMING_TORPEDO && (P_SKILL(P_JAVELIN) == P_MASTER) ) bonus += rnd(10);
	...
	if (weapon && weapon->otyp == LIGHT_STAR && !rn2(3) && (P_SKILL(P_SHURIKEN) == P_MASTER) ) bonus += 1;
	if (weapon && weapon->otyp == LIGHT_STAR && !rn2(3) && (P_SKILL(P_SHURIKEN) == P_GRAND_MASTER) ) bonus += rnd(2);
	if (weapon && weapon->otyp == LIGHT_STAR && !rn2(3) && (P_SKILL(P_SHURIKEN) == P_SUPREME_MASTER) ) bonus += rnd(3);
	if (weapon && weapon->otyp == NINJA_STAR && !rn2(3) && (P_SKILL(P_SHURIKEN) == P_MASTER) ) bonus += 1;
	if (weapon && weapon->otyp == NINJA_STAR && !rn2(3) && (P_SKILL(P_SHURIKEN) == P_GRAND_MASTER) ) bonus += rnd(2);
	if (weapon && weapon->otyp == NINJA_STAR && !rn2(3) && (P_SKILL(P_SHURIKEN) == P_SUPREME_MASTER) ) bonus += rnd(3);
...
struct obj *obj;
boolean extraskills; /* for artifact gifts and stuff: allow them to unlock various skills; don't use this for character's starting items --Amy */
{
	int skill;
	...
	if (obj->otyp == SEATBELT_SADDLE) skill = P_RIDING;
	if (obj->otyp == REPELLANT_SADDLE) skill = P_RIDING;
	if (obj->otyp == SOFTNESS_SADDLE) skill = P_RIDING;
	...
	if (obj->otyp == DEATH_HORN) skill = P_PETKEEPING;
	...
	if (obj->otyp == SHIELD_PATE_GLASSES) skill = P_SEARCHING;
...
releasetryagain:
	     ...
	     * mesher race can have the skills anyway */
	    if (!Role_if(PM_GENDERSTARIST) && !Race_if(PM_MESHER) && flags.female && skill == P_GUN_CONTROL) continue;
	    if (!Role_if(PM_GENDERSTARIST) && !Race_if(PM_MESHER) && !Role_if(PM_CLIMACTERIAL) && !flags.female && skill == P_SQUEAKING) continue;
	    /* orb, claw and grinder are alignment-specific at game start except if you're a diablist */
	    if (!Role_if(PM_DIABLIST) && !Race_if(PM_MESHER) && u.ualign.type != A_LAWFUL && skill == P_ORB) continue;
	    if (!Role_if(PM_DIABLIST) && !Race_if(PM_MESHER) && u.ualign.type != A_NEUTRAL && skill == P_CLAW) continue;
	    if (!Role_if(PM_DIABLIST) && !Race_if(PM_MESHER) && u.ualign.type != A_CHAOTIC && skill == P_GRINDER) continue;
	...
	if(!Role_if(PM_POLITICIAN) && !Role_if(PM_WILD_TALENT) && !Role_if(PM_SOCIAL_JUSTICE_WARRIOR) && !isamerican && !Role_if(PM_MURDERER)) for (obj = invent; obj; obj = obj->nobj) {
	    ...
	    if (skill != P_NONE && !(!Role_if(PM_GENDERSTARIST) && !Race_if(PM_MESHER) && flags.female && skill == P_GUN_CONTROL) && !(!Role_if(PM_GENDERSTARIST) && !Race_if(PM_MESHER) && !flags.female && skill == P_SQUEAKING) && !(!Role_if(PM_DIABLIST) && !Race_if(PM_MESHER) && u.ualign.type != A_LAWFUL && skill == P_ORB) && !(!Role_if(PM_DIABLIST) && !Race_if(PM_MESHER) && u.ualign.type != A_NEUTRAL && skill == P_CLAW) && !(!Role_if(PM_DIABLIST) && !Race_if(PM_MESHER) && u.ualign.type != A_CHAOTIC && skill == P_GRINDER) ) {
		...
		if (isvanillaoid) {
			if (P_MAX_SKILL(skill) < P_SKILLED) { /* if vanillaoid, really make it skilled --Amy */
				if (wizard) pline("Warning: %s should be at least skilled.  Fixing...", wpskillname(skill));
				P_MAX_SKILL(skill) = P_SKILLED;
			}
		} else {
			if (P_MAX_SKILL(skill) < P_EXPERT) { /* Amy: otherwise, let's make it expert. */
...
rerollthree:
	...
	if (Race_if(PM_BATMAN)) {
		...
		if (P_MAX_SKILL(P_BOOMERANG) < P_GRAND_MASTER) P_MAX_SKILL(P_BOOMERANG) = P_GRAND_MASTER;
	}
	...
	if (Race_if(PM_STICKER)) {
		...
		if (P_RESTRICTED(P_DEVICES)) {
			...
			if (P_MAX_SKILL(P_DEVICES) == P_BASIC) P_MAX_SKILL(P_DEVICES) = P_SKILLED;
			else if (P_MAX_SKILL(P_DEVICES) == P_SKILLED) P_MAX_SKILL(P_DEVICES) = P_EXPERT;
			else if (P_MAX_SKILL(P_DEVICES) == P_EXPERT) P_MAX_SKILL(P_DEVICES) = P_MASTER;
	...
	if (Race_if(PM_SATRE)) {
		...
		if (P_RESTRICTED(P_DEVICES)) {
			...
			P_SKILL(P_DEVICES) = P_BASIC;
			if (P_MAX_SKILL(P_DEVICES) == P_BASIC) P_MAX_SKILL(P_DEVICES) = P_EXPERT;
			else if (P_MAX_SKILL(P_DEVICES) == P_SKILLED) P_MAX_SKILL(P_DEVICES) = P_MASTER;
			else if (P_MAX_SKILL(P_DEVICES) == P_EXPERT) P_MAX_SKILL(P_DEVICES) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_DEVICES) = P_SUPREME_MASTER;
		}
	...
	if (Race_if(PM_MACTHEIST)) {
		...
		if (P_RESTRICTED(P_RIDING)) {
			...
			if (P_MAX_SKILL(P_RIDING) == P_BASIC) P_MAX_SKILL(P_RIDING) = P_SKILLED;
			else if (P_MAX_SKILL(P_RIDING) == P_SKILLED) P_MAX_SKILL(P_RIDING) = P_EXPERT;
			else if (P_MAX_SKILL(P_RIDING) == P_EXPERT) P_MAX_SKILL(P_RIDING) = P_MASTER;
		...
		if (P_RESTRICTED(P_LANCE)) {
			...
			if (P_MAX_SKILL(P_LANCE) == P_BASIC) P_MAX_SKILL(P_LANCE) = P_SKILLED;
			else if (P_MAX_SKILL(P_LANCE) == P_SKILLED) P_MAX_SKILL(P_LANCE) = P_EXPERT;
			else if (P_MAX_SKILL(P_LANCE) == P_EXPERT) P_MAX_SKILL(P_LANCE) = P_MASTER;
	...
	if (Race_if(PM_MANSTER)) {
		...
		for (skill = 0; skill < P_NUM_SKILLS; skill++) {
			if (P_MAX_SKILL(skill) == P_SKILLED) P_MAX_SKILL(skill) = P_BASIC;
			else if (P_MAX_SKILL(skill) == P_EXPERT) P_MAX_SKILL(skill) = P_BASIC;
	...
	if (Race_if(PM_MAZIN)) {
		...
		for (skill = 0; skill < P_NUM_SKILLS; skill++) {
			...
			if (P_MAX_SKILL(skill) == P_SKILLED) P_MAX_SKILL(skill) = P_BASIC;
			else if (P_MAX_SKILL(skill) == P_EXPERT) P_MAX_SKILL(skill) = P_SKILLED;
	...
	if (Race_if(PM_WOOKIE)) {
		...
		for (skill = 0; skill < P_NUM_SKILLS; skill++) {
			...
			if (skill == P_LIGHTSABER || (skill >= P_SHII_CHO && skill <= P_WEDI)) {
				...
				else if (P_MAX_SKILL(skill) == P_BASIC) P_MAX_SKILL(skill) = P_EXPERT;
				else if (P_MAX_SKILL(skill) == P_SKILLED) P_MAX_SKILL(skill) = P_EXPERT;
	...
	if (Race_if(PM_DEVELOPER)) {
		...
		for (skill = 0; skill < P_NUM_SKILLS; skill++) {
			...
			else if (P_MAX_SKILL(skill) == P_BASIC) P_MAX_SKILL(skill) = P_SKILLED;
			else if (P_MAX_SKILL(skill) == P_SKILLED) P_MAX_SKILL(skill) = P_EXPERT;
			else if (P_MAX_SKILL(skill) == P_EXPERT) P_MAX_SKILL(skill) = P_MASTER;
			else if (P_MAX_SKILL(skill) == P_MASTER) P_MAX_SKILL(skill) = P_GRAND_MASTER;
	...
	if (Race_if(PM_INKA)) {
		if (P_RESTRICTED(P_OCCULT_SPELL)) {
			...
			if (P_MAX_SKILL(P_OCCULT_SPELL) == P_BASIC) P_MAX_SKILL(P_OCCULT_SPELL) = P_EXPERT;
			else if (P_MAX_SKILL(P_OCCULT_SPELL) == P_SKILLED) P_MAX_SKILL(P_OCCULT_SPELL) = P_EXPERT;
			else if (P_MAX_SKILL(P_OCCULT_SPELL) == P_EXPERT) P_MAX_SKILL(P_OCCULT_SPELL) = P_MASTER;
	...
	if (Race_if(PM_TONBERRY)) {
		if (P_RESTRICTED(P_AXE)) {
			...
			if (P_MAX_SKILL(P_AXE) == P_BASIC) P_MAX_SKILL(P_AXE) = P_EXPERT;
			else if (P_MAX_SKILL(P_AXE) == P_SKILLED) P_MAX_SKILL(P_AXE) = P_MASTER;
			else if (P_MAX_SKILL(P_AXE) == P_EXPERT) P_MAX_SKILL(P_AXE) = P_GRAND_MASTER;
		...
		if (P_RESTRICTED(P_KNIFE)) {
			...
			if (P_MAX_SKILL(P_KNIFE) == P_BASIC) P_MAX_SKILL(P_KNIFE) = P_EXPERT;
			else if (P_MAX_SKILL(P_KNIFE) == P_SKILLED) P_MAX_SKILL(P_KNIFE) = P_MASTER;
			else if (P_MAX_SKILL(P_KNIFE) == P_EXPERT) P_MAX_SKILL(P_KNIFE) = P_GRAND_MASTER;
	...
	if (Race_if(PM_ENGCHIP)) {
		if (P_RESTRICTED(P_PETKEEPING)) {
			...
			if (P_MAX_SKILL(P_PETKEEPING) == P_BASIC) P_MAX_SKILL(P_PETKEEPING) = P_SKILLED;
			else if (P_MAX_SKILL(P_PETKEEPING) == P_SKILLED) P_MAX_SKILL(P_PETKEEPING) = P_EXPERT;
			else if (P_MAX_SKILL(P_PETKEEPING) == P_EXPERT) P_MAX_SKILL(P_PETKEEPING) = P_MASTER;
	...
	if (Race_if(PM_MAGYAR)) {
		if (P_RESTRICTED(P_BOW)) {
			...
			if (P_MAX_SKILL(P_BOW) == P_BASIC) P_MAX_SKILL(P_BOW) = P_EXPERT;
			else if (P_MAX_SKILL(P_BOW) == P_SKILLED) P_MAX_SKILL(P_BOW) = P_EXPERT;
			else if (P_MAX_SKILL(P_BOW) == P_EXPERT) P_MAX_SKILL(P_BOW) = P_MASTER;
	...
	if (Race_if(PM_TURMENE)) {
		if (P_RESTRICTED(P_FIREARM)) {
			...
			P_SKILL(P_FIREARM) = P_BASIC;
			if (P_MAX_SKILL(P_FIREARM) == P_BASIC) P_MAX_SKILL(P_FIREARM) = P_EXPERT;
			else if (P_MAX_SKILL(P_FIREARM) == P_SKILLED) P_MAX_SKILL(P_FIREARM) = P_EXPERT;
			else if (P_MAX_SKILL(P_FIREARM) == P_EXPERT) P_MAX_SKILL(P_FIREARM) = P_MASTER;
	...
	if (Race_if(PM_JAPURA)) {
		if (P_RESTRICTED(P_LONG_SWORD)) {
			...
			if (P_MAX_SKILL(P_LONG_SWORD) == P_BASIC) P_MAX_SKILL(P_LONG_SWORD) = P_SKILLED;
			else if (P_MAX_SKILL(P_LONG_SWORD) == P_SKILLED) P_MAX_SKILL(P_LONG_SWORD) = P_EXPERT;
			else if (P_MAX_SKILL(P_LONG_SWORD) == P_EXPERT) P_MAX_SKILL(P_LONG_SWORD) = P_MASTER;
	...
	if (Race_if(PM_JAVA)) {
		if (P_RESTRICTED(P_JAVELIN)) {
			...
			if (P_MAX_SKILL(P_JAVELIN) == P_BASIC) P_MAX_SKILL(P_JAVELIN) = P_EXPERT;
			else if (P_MAX_SKILL(P_JAVELIN) == P_SKILLED) P_MAX_SKILL(P_JAVELIN) = P_EXPERT;
			else if (P_MAX_SKILL(P_JAVELIN) == P_EXPERT) P_MAX_SKILL(P_JAVELIN) = P_MASTER;
	...
	if (Race_if(PM_NEMESIS)) {
		if (P_RESTRICTED(P_TRIDENT)) {
			...
			if (P_MAX_SKILL(P_TRIDENT) == P_BASIC) P_MAX_SKILL(P_TRIDENT) = P_EXPERT;
			else if (P_MAX_SKILL(P_TRIDENT) == P_SKILLED) P_MAX_SKILL(P_TRIDENT) = P_EXPERT;
			else if (P_MAX_SKILL(P_TRIDENT) == P_EXPERT) P_MAX_SKILL(P_TRIDENT) = P_MASTER;
	...
	if (Race_if(PM_KORONST)) {
		if (P_RESTRICTED(P_SLING)) {
			...
			P_SKILL(P_SLING) = P_BASIC;
			if (P_MAX_SKILL(P_SLING) == P_BASIC) P_MAX_SKILL(P_SLING) = P_MASTER;
			else if (P_MAX_SKILL(P_SLING) == P_SKILLED) P_MAX_SKILL(P_SLING) = P_MASTER;
			else if (P_MAX_SKILL(P_SLING) == P_EXPERT) P_MAX_SKILL(P_SLING) = P_GRAND_MASTER;
	...
	if (Race_if(PM_FRO)) {
		if (P_RESTRICTED(P_AXE)) {
			...
			if (P_MAX_SKILL(P_AXE) == P_BASIC) P_MAX_SKILL(P_AXE) = P_EXPERT;
			else if (P_MAX_SKILL(P_AXE) == P_SKILLED) P_MAX_SKILL(P_AXE) = P_EXPERT;
			else if (P_MAX_SKILL(P_AXE) == P_EXPERT) P_MAX_SKILL(P_AXE) = P_MASTER;
	...
	if (Race_if(PM_GERTEUT)) {
		if (P_RESTRICTED(P_VENOM)) {
			...
			if (P_MAX_SKILL(P_VENOM) == P_BASIC) P_MAX_SKILL(P_VENOM) = P_SKILLED;
			else if (P_MAX_SKILL(P_VENOM) == P_SKILLED) P_MAX_SKILL(P_VENOM) = P_EXPERT;
			else if (P_MAX_SKILL(P_VENOM) == P_EXPERT) P_MAX_SKILL(P_VENOM) = P_MASTER;
	...
	if (Race_if(PM_HUMANLIKE_NAGA)) {
		if (P_RESTRICTED(P_VENOM)) {
			...
			P_SKILL(P_VENOM) = P_BASIC;
			if (P_MAX_SKILL(P_VENOM) == P_BASIC) P_MAX_SKILL(P_VENOM) = P_EXPERT;
			else if (P_MAX_SKILL(P_VENOM) == P_SKILLED) P_MAX_SKILL(P_VENOM) = P_EXPERT;
			else if (P_MAX_SKILL(P_VENOM) == P_EXPERT) P_MAX_SKILL(P_VENOM) = P_MASTER;
			else if (P_MAX_SKILL(P_VENOM) == P_MASTER) P_MAX_SKILL(P_VENOM) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_VENOM) = P_SUPREME_MASTER;
	...
	if (Race_if(PM_IRAHA)) {
		if (P_RESTRICTED(P_VENOM)) {
			...
			P_SKILL(P_VENOM) = P_BASIC;
			if (P_MAX_SKILL(P_VENOM) == P_BASIC) P_MAX_SKILL(P_VENOM) = P_MASTER;
			else if (P_MAX_SKILL(P_VENOM) == P_SKILLED) P_MAX_SKILL(P_VENOM) = P_MASTER;
			else if (P_MAX_SKILL(P_VENOM) == P_EXPERT) P_MAX_SKILL(P_VENOM) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_VENOM) = P_SUPREME_MASTER;
		}
	}
	...
	if (Race_if(PM_TAYIIN)) {
		if (P_RESTRICTED(P_MARTIAL_ARTS)) {
			...
			if (P_MAX_SKILL(P_MARTIAL_ARTS) == P_BASIC) P_MAX_SKILL(P_MARTIAL_ARTS) = P_EXPERT;
			else if (P_MAX_SKILL(P_MARTIAL_ARTS) == P_SKILLED) P_MAX_SKILL(P_MARTIAL_ARTS) = P_EXPERT;
			else if (P_MAX_SKILL(P_MARTIAL_ARTS) == P_EXPERT) P_MAX_SKILL(P_MARTIAL_ARTS) = P_MASTER;
			else if (P_MAX_SKILL(P_MARTIAL_ARTS) == P_MASTER) P_MAX_SKILL(P_MARTIAL_ARTS) = P_GRAND_MASTER;
	...
	if (Race_if(PM_SWIKNI)) {
		if (P_RESTRICTED(P_KNIFE)) {
			...
			P_SKILL(P_KNIFE) = P_BASIC;
			if (P_MAX_SKILL(P_KNIFE) == P_BASIC) P_MAX_SKILL(P_KNIFE) = P_MASTER;
			else if (P_MAX_SKILL(P_KNIFE) == P_SKILLED) P_MAX_SKILL(P_KNIFE) = P_MASTER;
			else if (P_MAX_SKILL(P_KNIFE) == P_EXPERT) P_MAX_SKILL(P_KNIFE) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_KNIFE) = P_SUPREME_MASTER;
		}
	...
	if (Race_if(PM_WEAPONIZED_DINOSAUR)) {
		...
		if (P_RESTRICTED(P_BOULDER_THROWING)) {
			...
			if (P_MAX_SKILL(P_BOULDER_THROWING) == P_BASIC) P_MAX_SKILL(P_BOULDER_THROWING) = P_EXPERT;
			else if (P_MAX_SKILL(P_BOULDER_THROWING) == P_SKILLED) P_MAX_SKILL(P_BOULDER_THROWING) = P_EXPERT;
			else if (P_MAX_SKILL(P_BOULDER_THROWING) == P_EXPERT) P_MAX_SKILL(P_BOULDER_THROWING) = P_MASTER;
	...
	if (Race_if(PM_GIGANT)) {
		...
		if (P_RESTRICTED(P_BOULDER_THROWING)) {
			...
			P_SKILL(P_BOULDER_THROWING) = P_BASIC;
			if (P_MAX_SKILL(P_BOULDER_THROWING) == P_BASIC) P_MAX_SKILL(P_BOULDER_THROWING) = P_MASTER;
			else if (P_MAX_SKILL(P_BOULDER_THROWING) == P_SKILLED) P_MAX_SKILL(P_BOULDER_THROWING) = P_MASTER;
			else if (P_MAX_SKILL(P_BOULDER_THROWING) == P_EXPERT) P_MAX_SKILL(P_BOULDER_THROWING) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_BOULDER_THROWING) = P_SUPREME_MASTER;
		}
	...
	if (Race_if(PM_BULDOZGAR)) {
		if (P_RESTRICTED(P_BODY_ARMOR)) {
			...
			if (P_MAX_SKILL(P_BODY_ARMOR) == P_BASIC) P_MAX_SKILL(P_BODY_ARMOR) = P_EXPERT;
			else if (P_MAX_SKILL(P_BODY_ARMOR) == P_SKILLED) P_MAX_SKILL(P_BODY_ARMOR) = P_EXPERT;
			else if (P_MAX_SKILL(P_BODY_ARMOR) == P_EXPERT) P_MAX_SKILL(P_BODY_ARMOR) = P_MASTER;
	...
	if (Race_if(PM_PLAYER_ASURA)) {
		if (P_RESTRICTED(P_TWO_WEAPON_COMBAT)) {
			...
			if (P_MAX_SKILL(P_TWO_WEAPON_COMBAT) == P_BASIC) P_MAX_SKILL(P_TWO_WEAPON_COMBAT) = P_EXPERT;
			else if (P_MAX_SKILL(P_TWO_WEAPON_COMBAT) == P_SKILLED) P_MAX_SKILL(P_TWO_WEAPON_COMBAT) = P_EXPERT;
			else if (P_MAX_SKILL(P_TWO_WEAPON_COMBAT) == P_EXPERT) P_MAX_SKILL(P_TWO_WEAPON_COMBAT) = P_MASTER;
	...
	if (Race_if(PM_GREURO)) {
		...
		if (P_RESTRICTED(P_POLEARMS)) {
			...
			P_SKILL(P_POLEARMS) = P_BASIC;
			if (P_MAX_SKILL(P_POLEARMS) == P_BASIC) P_MAX_SKILL(P_POLEARMS) = P_EXPERT;
			else if (P_MAX_SKILL(P_POLEARMS) == P_SKILLED) P_MAX_SKILL(P_POLEARMS) = P_EXPERT;
			else if (P_MAX_SKILL(P_POLEARMS) == P_EXPERT) P_MAX_SKILL(P_POLEARMS) = P_MASTER;
		...
		if (P_RESTRICTED(P_LANCE)) {
			...
			P_SKILL(P_LANCE) = P_BASIC;
			if (P_MAX_SKILL(P_LANCE) == P_BASIC) P_MAX_SKILL(P_LANCE) = P_EXPERT;
			else if (P_MAX_SKILL(P_LANCE) == P_SKILLED) P_MAX_SKILL(P_LANCE) = P_EXPERT;
			else if (P_MAX_SKILL(P_LANCE) == P_EXPERT) P_MAX_SKILL(P_LANCE) = P_MASTER;
			else if (P_MAX_SKILL(P_LANCE) == P_MASTER) P_MAX_SKILL(P_LANCE) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_LANCE) = P_SUPREME_MASTER;
	...
	if (Race_if(PM_BACTERIA)) {
		if (P_RESTRICTED(P_SYMBIOSIS)) {
			...
			if (P_MAX_SKILL(P_SYMBIOSIS) == P_BASIC) P_MAX_SKILL(P_SYMBIOSIS) = P_EXPERT;
			else if (P_MAX_SKILL(P_SYMBIOSIS) == P_SKILLED) P_MAX_SKILL(P_SYMBIOSIS) = P_EXPERT;
			else if (P_MAX_SKILL(P_SYMBIOSIS) == P_EXPERT) P_MAX_SKILL(P_SYMBIOSIS) = P_MASTER;
	...
	if (Race_if(PM_GOAULD)) {
		if (P_RESTRICTED(P_SYMBIOSIS)) {
			...
			P_SKILL(P_SYMBIOSIS) = P_BASIC;
			if (P_MAX_SKILL(P_SYMBIOSIS) == P_BASIC) P_MAX_SKILL(P_SYMBIOSIS) = P_MASTER;
			else if (P_MAX_SKILL(P_SYMBIOSIS) == P_SKILLED) P_MAX_SKILL(P_SYMBIOSIS) = P_MASTER;
			else if (P_MAX_SKILL(P_SYMBIOSIS) == P_EXPERT) P_MAX_SKILL(P_SYMBIOSIS) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_SYMBIOSIS) = P_SUPREME_MASTER;
		}
	...
	if (Race_if(PM_ELONA_SNAIL)) {
		...
		if (P_RESTRICTED(P_MARTIAL_ARTS)) {
			...
			P_SKILL(P_MARTIAL_ARTS) = P_BASIC;
			if (P_MAX_SKILL(P_MARTIAL_ARTS) == P_BASIC) P_MAX_SKILL(P_MARTIAL_ARTS) = P_EXPERT;
			else if (P_MAX_SKILL(P_MARTIAL_ARTS) == P_SKILLED) P_MAX_SKILL(P_MARTIAL_ARTS) = P_MASTER;
			else if (P_MAX_SKILL(P_MARTIAL_ARTS) == P_EXPERT) P_MAX_SKILL(P_MARTIAL_ARTS) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_MARTIAL_ARTS) = P_SUPREME_MASTER;
		}
		if (P_RESTRICTED(P_BOW)) {
			P_SKILL(P_BOW) = P_BASIC;
			...
			P_SKILL(P_BOW) = P_BASIC;
			if (P_MAX_SKILL(P_BOW) == P_BASIC) P_MAX_SKILL(P_BOW) = P_EXPERT;
			else if (P_MAX_SKILL(P_BOW) == P_SKILLED) P_MAX_SKILL(P_BOW) = P_MASTER;
			else if (P_MAX_SKILL(P_BOW) == P_EXPERT) P_MAX_SKILL(P_BOW) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_BOW) = P_SUPREME_MASTER;
		}
		if (P_RESTRICTED(P_CROSSBOW)) {
			...
			P_SKILL(P_CROSSBOW) = P_BASIC;
			if (P_MAX_SKILL(P_CROSSBOW) == P_BASIC) P_MAX_SKILL(P_CROSSBOW) = P_EXPERT;
			else if (P_MAX_SKILL(P_CROSSBOW) == P_SKILLED) P_MAX_SKILL(P_CROSSBOW) = P_MASTER;
			else if (P_MAX_SKILL(P_CROSSBOW) == P_EXPERT) P_MAX_SKILL(P_CROSSBOW) = P_GRAND_MASTER;
		...
		if (P_RESTRICTED(P_SLING)) {
			...
			P_SKILL(P_SLING) = P_BASIC;
			if (P_MAX_SKILL(P_SLING) == P_BASIC) P_MAX_SKILL(P_SLING) = P_EXPERT;
			else if (P_MAX_SKILL(P_SLING) == P_SKILLED) P_MAX_SKILL(P_SLING) = P_MASTER;
			else if (P_MAX_SKILL(P_SLING) == P_EXPERT) P_MAX_SKILL(P_SLING) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_SLING) = P_SUPREME_MASTER;
		}
		if (P_RESTRICTED(P_FIREARM)) {
			...
			P_SKILL(P_FIREARM) = P_BASIC;
			if (P_MAX_SKILL(P_FIREARM) == P_BASIC) P_MAX_SKILL(P_FIREARM) = P_EXPERT;
			else if (P_MAX_SKILL(P_FIREARM) == P_SKILLED) P_MAX_SKILL(P_FIREARM) = P_MASTER;
			else if (P_MAX_SKILL(P_FIREARM) == P_EXPERT) P_MAX_SKILL(P_FIREARM) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_FIREARM) = P_SUPREME_MASTER;
		}
		if (P_RESTRICTED(P_DART)) {
			...
			P_SKILL(P_DART) = P_BASIC;
			if (P_MAX_SKILL(P_DART) == P_BASIC) P_MAX_SKILL(P_DART) = P_EXPERT;
			else if (P_MAX_SKILL(P_DART) == P_SKILLED) P_MAX_SKILL(P_DART) = P_MASTER;
			else if (P_MAX_SKILL(P_DART) == P_EXPERT) P_MAX_SKILL(P_DART) = P_GRAND_MASTER;
		...
		if (P_RESTRICTED(P_SHURIKEN)) {
			...
			P_SKILL(P_SHURIKEN) = P_BASIC;
			if (P_MAX_SKILL(P_SHURIKEN) == P_BASIC) P_MAX_SKILL(P_SHURIKEN) = P_EXPERT;
			else if (P_MAX_SKILL(P_SHURIKEN) == P_SKILLED) P_MAX_SKILL(P_SHURIKEN) = P_MASTER;
			else if (P_MAX_SKILL(P_SHURIKEN) == P_EXPERT) P_MAX_SKILL(P_SHURIKEN) = P_GRAND_MASTER;
		...
		if (P_RESTRICTED(P_PETKEEPING)) {
			...
			P_SKILL(P_PETKEEPING) = P_BASIC;
			if (P_MAX_SKILL(P_PETKEEPING) == P_BASIC) P_MAX_SKILL(P_PETKEEPING) = P_EXPERT;
			else if (P_MAX_SKILL(P_PETKEEPING) == P_SKILLED) P_MAX_SKILL(P_PETKEEPING) = P_MASTER;
			else if (P_MAX_SKILL(P_PETKEEPING) == P_EXPERT) P_MAX_SKILL(P_PETKEEPING) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_PETKEEPING) = P_SUPREME_MASTER;
		}
		if (P_RESTRICTED(P_SYMBIOSIS)) {
			P_SKILL(P_SYMBIOSIS) = P_BASIC;
		...
		if (P_RESTRICTED(P_MEMORIZATION)) {
			...
			P_SKILL(P_MEMORIZATION) = P_BASIC;
			if (P_MAX_SKILL(P_MEMORIZATION) == P_BASIC) P_MAX_SKILL(P_MEMORIZATION) = P_EXPERT;
			else if (P_MAX_SKILL(P_MEMORIZATION) == P_SKILLED) P_MAX_SKILL(P_MEMORIZATION) = P_MASTER;
		...
		if (flags.female || Role_if(PM_GENDERSTARIST)) {
			if (P_RESTRICTED(P_SQUEAKING)) {
				...
				P_SKILL(P_SQUEAKING) = P_BASIC;
				if (P_MAX_SKILL(P_SQUEAKING) == P_BASIC) P_MAX_SKILL(P_SQUEAKING) = P_EXPERT;
				else if (P_MAX_SKILL(P_SQUEAKING) == P_SKILLED) P_MAX_SKILL(P_SQUEAKING) = P_MASTER;
				else if (P_MAX_SKILL(P_SQUEAKING) == P_EXPERT) P_MAX_SKILL(P_SQUEAKING) = P_GRAND_MASTER;
		...
		if (!flags.female || Role_if(PM_GENDERSTARIST)) {
			if (P_RESTRICTED(P_GUN_CONTROL)) {
				...
				P_SKILL(P_GUN_CONTROL) = P_BASIC;
				if (P_MAX_SKILL(P_GUN_CONTROL) == P_BASIC) P_MAX_SKILL(P_GUN_CONTROL) = P_EXPERT;
				else if (P_MAX_SKILL(P_GUN_CONTROL) == P_SKILLED) P_MAX_SKILL(P_GUN_CONTROL) = P_MASTER;
				else if (P_MAX_SKILL(P_GUN_CONTROL) == P_EXPERT) P_MAX_SKILL(P_GUN_CONTROL) = P_GRAND_MASTER;
		...
		if (P_RESTRICTED(P_MISSILE_WEAPONS)) {
			...
			P_SKILL(P_MISSILE_WEAPONS) = P_BASIC;
			if (P_MAX_SKILL(P_MISSILE_WEAPONS) == P_BASIC) P_MAX_SKILL(P_MISSILE_WEAPONS) = P_EXPERT;
			else if (P_MAX_SKILL(P_MISSILE_WEAPONS) == P_SKILLED) P_MAX_SKILL(P_MISSILE_WEAPONS) = P_MASTER;
			else if (P_MAX_SKILL(P_MISSILE_WEAPONS) == P_EXPERT) P_MAX_SKILL(P_MISSILE_WEAPONS) = P_GRAND_MASTER;
		...
		if (P_RESTRICTED(P_TECHNIQUES)) {
			...
			P_SKILL(P_TECHNIQUES) = P_BASIC;
			if (P_MAX_SKILL(P_TECHNIQUES) == P_BASIC) P_MAX_SKILL(P_TECHNIQUES) = P_EXPERT;
			else if (P_MAX_SKILL(P_TECHNIQUES) == P_SKILLED) P_MAX_SKILL(P_TECHNIQUES) = P_MASTER;
			else if (P_MAX_SKILL(P_TECHNIQUES) == P_EXPERT) P_MAX_SKILL(P_TECHNIQUES) = P_GRAND_MASTER;
		...
		if (P_RESTRICTED(P_SEARCHING)) {
			...
			if (P_MAX_SKILL(P_SEARCHING) == P_BASIC) P_MAX_SKILL(P_SEARCHING) = P_SKILLED;
			else if (P_MAX_SKILL(P_SEARCHING) == P_SKILLED) P_MAX_SKILL(P_SEARCHING) = P_EXPERT;
			else if (P_MAX_SKILL(P_SEARCHING) == P_EXPERT) P_MAX_SKILL(P_SEARCHING) = P_MASTER;
		...
		if (P_RESTRICTED(P_POLYMORPHING)) {
			...
			if (P_MAX_SKILL(P_POLYMORPHING) == P_BASIC) P_MAX_SKILL(P_POLYMORPHING) = P_SKILLED;
			else if (P_MAX_SKILL(P_POLYMORPHING) == P_SKILLED) P_MAX_SKILL(P_POLYMORPHING) = P_EXPERT;
			else if (P_MAX_SKILL(P_POLYMORPHING) == P_EXPERT) P_MAX_SKILL(P_POLYMORPHING) = P_MASTER;
		...
		if (P_RESTRICTED(P_SPIRITUALITY)) {
			...
			if (P_MAX_SKILL(P_SPIRITUALITY) == P_BASIC) P_MAX_SKILL(P_SPIRITUALITY) = P_SKILLED;
			else if (P_MAX_SKILL(P_SPIRITUALITY) == P_SKILLED) P_MAX_SKILL(P_SPIRITUALITY) = P_EXPERT;
			else if (P_MAX_SKILL(P_SPIRITUALITY) == P_EXPERT) P_MAX_SKILL(P_SPIRITUALITY) = P_MASTER;
		...
		if (P_RESTRICTED(P_ATTACK_SPELL)) {
			...
			if (P_MAX_SKILL(P_ATTACK_SPELL) == P_BASIC) P_MAX_SKILL(P_ATTACK_SPELL) = P_SKILLED;
			else if (P_MAX_SKILL(P_ATTACK_SPELL) == P_SKILLED) P_MAX_SKILL(P_ATTACK_SPELL) = P_EXPERT;
			else if (P_MAX_SKILL(P_ATTACK_SPELL) == P_EXPERT) P_MAX_SKILL(P_ATTACK_SPELL) = P_MASTER;
		...
		if (P_RESTRICTED(P_HEALING_SPELL)) {
			...
			if (P_MAX_SKILL(P_HEALING_SPELL) == P_BASIC) P_MAX_SKILL(P_HEALING_SPELL) = P_SKILLED;
			else if (P_MAX_SKILL(P_HEALING_SPELL) == P_SKILLED) P_MAX_SKILL(P_HEALING_SPELL) = P_EXPERT;
			else if (P_MAX_SKILL(P_HEALING_SPELL) == P_EXPERT) P_MAX_SKILL(P_HEALING_SPELL) = P_MASTER;
		...
		if (P_RESTRICTED(P_DIVINATION_SPELL)) {
			...
			if (P_MAX_SKILL(P_DIVINATION_SPELL) == P_BASIC) P_MAX_SKILL(P_DIVINATION_SPELL) = P_SKILLED;
			else if (P_MAX_SKILL(P_DIVINATION_SPELL) == P_SKILLED) P_MAX_SKILL(P_DIVINATION_SPELL) = P_EXPERT;
			else if (P_MAX_SKILL(P_DIVINATION_SPELL) == P_EXPERT) P_MAX_SKILL(P_DIVINATION_SPELL) = P_MASTER;
		...
		if (P_RESTRICTED(P_ENCHANTMENT_SPELL)) {
			...
			if (P_MAX_SKILL(P_ENCHANTMENT_SPELL) == P_BASIC) P_MAX_SKILL(P_ENCHANTMENT_SPELL) = P_SKILLED;
			else if (P_MAX_SKILL(P_ENCHANTMENT_SPELL) == P_SKILLED) P_MAX_SKILL(P_ENCHANTMENT_SPELL) = P_EXPERT;
			else if (P_MAX_SKILL(P_ENCHANTMENT_SPELL) == P_EXPERT) P_MAX_SKILL(P_ENCHANTMENT_SPELL) = P_MASTER;
		...
		if (P_RESTRICTED(P_PROTECTION_SPELL)) {
			...
			if (P_MAX_SKILL(P_PROTECTION_SPELL) == P_BASIC) P_MAX_SKILL(P_PROTECTION_SPELL) = P_SKILLED;
			else if (P_MAX_SKILL(P_PROTECTION_SPELL) == P_SKILLED) P_MAX_SKILL(P_PROTECTION_SPELL) = P_EXPERT;
			else if (P_MAX_SKILL(P_PROTECTION_SPELL) == P_EXPERT) P_MAX_SKILL(P_PROTECTION_SPELL) = P_MASTER;
		...
		if (P_RESTRICTED(P_BODY_SPELL)) {
			...
			if (P_MAX_SKILL(P_BODY_SPELL) == P_BASIC) P_MAX_SKILL(P_BODY_SPELL) = P_SKILLED;
			else if (P_MAX_SKILL(P_BODY_SPELL) == P_SKILLED) P_MAX_SKILL(P_BODY_SPELL) = P_EXPERT;
			else if (P_MAX_SKILL(P_BODY_SPELL) == P_EXPERT) P_MAX_SKILL(P_BODY_SPELL) = P_MASTER;
		...
		if (P_RESTRICTED(P_MATTER_SPELL)) {
			...
			if (P_MAX_SKILL(P_MATTER_SPELL) == P_BASIC) P_MAX_SKILL(P_MATTER_SPELL) = P_SKILLED;
			else if (P_MAX_SKILL(P_MATTER_SPELL) == P_SKILLED) P_MAX_SKILL(P_MATTER_SPELL) = P_EXPERT;
			else if (P_MAX_SKILL(P_MATTER_SPELL) == P_EXPERT) P_MAX_SKILL(P_MATTER_SPELL) = P_MASTER;
		...
		if (P_RESTRICTED(P_OCCULT_SPELL)) {
			...
			if (P_MAX_SKILL(P_OCCULT_SPELL) == P_BASIC) P_MAX_SKILL(P_OCCULT_SPELL) = P_SKILLED;
			else if (P_MAX_SKILL(P_OCCULT_SPELL) == P_SKILLED) P_MAX_SKILL(P_OCCULT_SPELL) = P_EXPERT;
			else if (P_MAX_SKILL(P_OCCULT_SPELL) == P_EXPERT) P_MAX_SKILL(P_OCCULT_SPELL) = P_MASTER;
			else if (P_MAX_SKILL(P_OCCULT_SPELL) == P_MASTER) P_MAX_SKILL(P_OCCULT_SPELL) = P_GRAND_MASTER;
			else P_MAX_SKILL(P_OCCULT_SPELL) = P_SUPREME_MASTER;
		...
		if (P_RESTRICTED(P_ELEMENTAL_SPELL)) {
			...
			if (P_MAX_SKILL(P_ELEMENTAL_SPELL) == P_BASIC) P_MAX_SKILL(P_ELEMENTAL_SPELL) = P_SKILLED;
			else if (P_MAX_SKILL(P_ELEMENTAL_SPELL) == P_SKILLED) P_MAX_SKILL(P_ELEMENTAL_SPELL) = P_EXPERT;
			else if (P_MAX_SKILL(P_ELEMENTAL_SPELL) == P_EXPERT) P_MAX_SKILL(P_ELEMENTAL_SPELL) = P_MASTER;
		...
		if (P_RESTRICTED(P_CHAOS_SPELL)) {
			...
			if (P_MAX_SKILL(P_CHAOS_SPELL) == P_BASIC) P_MAX_SKILL(P_CHAOS_SPELL) = P_SKILLED;
			else if (P_MAX_SKILL(P_CHAOS_SPELL) == P_SKILLED) P_MAX_SKILL(P_CHAOS_SPELL) = P_EXPERT;
			else if (P_MAX_SKILL(P_CHAOS_SPELL) == P_EXPERT) P_MAX_SKILL(P_CHAOS_SPELL) = P_MASTER;
	...
	if (!Role_if(PM_GENDERSTARIST) && !Race_if(PM_MESHER) && flags.female && P_MAX_SKILL(P_GUN_CONTROL) >= P_BASIC) {
		P_MAX_SKILL(P_GUN_CONTROL) = P_ISRESTRICTED;
		P_SKILL(P_GUN_CONTROL) = P_ISRESTRICTED;
		P_ADVANCE(P_GUN_CONTROL) = 0;
	}
	if (!Role_if(PM_GENDERSTARIST) && !Race_if(PM_MESHER) && !Role_if(PM_CLIMACTERIAL) && !flags.female && P_MAX_SKILL(P_SQUEAKING) >= P_BASIC) {
	...
	if (!Role_if(PM_DIABLIST) && !Race_if(PM_MESHER) && u.ualign.type != A_CHAOTIC && P_MAX_SKILL(P_GRINDER) >= P_BASIC) {
		P_MAX_SKILL(P_GRINDER) = P_ISRESTRICTED;
		P_SKILL(P_GRINDER) = P_ISRESTRICTED;
		P_ADVANCE(P_GRINDER) = 0;
	}
	if (!Role_if(PM_DIABLIST) && !Race_if(PM_MESHER) && u.ualign.type != A_NEUTRAL && P_MAX_SKILL(P_CLAW) >= P_BASIC) {
		P_MAX_SKILL(P_CLAW) = P_ISRESTRICTED;
		P_SKILL(P_CLAW) = P_ISRESTRICTED;
		P_ADVANCE(P_CLAW) = 0;
	}
	if (!Role_if(PM_DIABLIST) && !Race_if(PM_MESHER) && u.ualign.type != A_LAWFUL && P_MAX_SKILL(P_ORB) >= P_BASIC) {
...
xtraskillinit()
{
	...
	if (!Role_if(PM_POLITICIAN) && !Role_if(PM_WILD_TALENT) && !Role_if(PM_SOCIAL_JUSTICE_WARRIOR) && !isamerican && !Role_if(PM_ANACHRONOUNBINDER) && !Role_if(PM_MURDERER) ) for (obj = invent; obj; obj = obj->nobj) {
		...
		if (isvanillaoid) {
			if (P_MAX_SKILL(skill) < P_SKILLED) { /* well, if you're playing vanillaoid mode... */
				P_MAX_SKILL(skill) = P_SKILLED;
			}
		} else {
			if (P_MAX_SKILL(skill) < P_EXPERT) { /* Amy: otherwise, let's make it expert. */
...
doubleskilltraining()
{
	...
	if (P_ADVANCE(P_DAGGER) && !(P_RESTRICTED(P_DAGGER)) && yn("Do you want to train the dagger skill?")=='y') {
		...
		P_ADVANCE(P_DIVINATION_SPELL) += min(P_ADVANCE(P_DIVINATION_SPELL), 5000);
		acquiredskill = 1; }
		...
		P_ADVANCE(P_ENCHANTMENT_SPELL) += min(P_ADVANCE(P_ENCHANTMENT_SPELL), 5000);
		acquiredskill = 1; }
		...
		P_ADVANCE(P_TWO_HANDED_WEAPON) += min(P_ADVANCE(P_TWO_HANDED_WEAPON), 5000);
		acquiredskill = 1; }
		...
		P_ADVANCE(P_BARE_HANDED_COMBAT) += min(P_ADVANCE(P_BARE_HANDED_COMBAT), 5000);
		acquiredskill = 1; }
	else if (P_ADVANCE(P_MARTIAL_ARTS) && !(P_RESTRICTED(P_MARTIAL_ARTS)) && yn("Do you want to train the martial arts skill?")=='y') {
		P_ADVANCE(P_MARTIAL_ARTS) += min(P_ADVANCE(P_MARTIAL_ARTS), 5000);
		acquiredskill = 1; }
...
int lossamount;
{
	...
	if (!rn2(500)) {
		u.ballskill -= lossamount;
		if (u.ballskill < 0) u.ballskill = 0;
		Your("type 6: ball heels skill deteriorates.");
	}
	if (!rn2(500)) {
		u.pyramidalskill -= lossamount;
		if (u.pyramidalskill < 0) u.pyramidalskill = 0;
		Your("type 7: pyramidal heels skill deteriorates.");
	}
