...
{	
	...
	LOADSTONE, STONE_OF_MAGIC_RESISTANCE, LOADBOULDER, SLEEPSTONE, MANASTONE,
...
static const NEARDATA short hwep[] = {
	...
	IMPOSSIBLY_HEAVY_IRON_BALL, EXTREMELY_HEAVY_IRON_BALL, REALLY_HEAVY_IRON_BALL, HEAVY_ELYSIUM_BALL, QUITE_HEAVY_IRON_BALL, HEAVY_GOLD_BALL, HEAVY_IRON_BALL, HEAVY_GLASS_BALL, HEAVY_STONE_BALL,
