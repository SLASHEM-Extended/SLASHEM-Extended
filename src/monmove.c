...
postmov:
	if(mmoved == 1 || mmoved == 3) {
		...
		if (ptr == &mons[PM_GELATINOUS_CUBE] || ptr == &mons[PM_FLYING_GELATINOUS_CUBE] || ptr == &mons[PM_STOUT_GELATINOUS_CUBE] || ptr == &mons[PM_GELATINOUS_GLOB] || ptr == &mons[PM_OOZE_ELEMENTAL] || ptr == &mons[PM_AMUSING_TYPE] || ptr == &mons[PM_MINOCUBE] || ptr == &mons[PM_ROOMBA] || ptr == &mons[PM_THEME_TERMITE] || ptr == &mons[PM_GELATINOUS_DICE] || ptr == &mons[PM_WEAPON_CUBE] || ptr == &mons[PM_TASMANIAN_ZOMBIE]
