...
postmov:
	if(mmoved == 1 || mmoved == 3) {
		...
		if (ptr == &mons[PM_GHOUL] || ptr == &mons[PM_GHAST] || ptr == &mons[PM_STINKING_ALIEN] || ptr == &mons[PM_GASTLY] || ptr == &mons[PM_PHANTOM_GHOST]
