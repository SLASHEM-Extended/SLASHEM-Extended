...
const char * const random_insult[] = {
	...
	"simpleton",
	"sissy",
	"social justice warrior who finds the word 'poofy' insulting",
	"startscummer",
	"stinker",
	"sucker",
	"traitor",
...
const char * const random_malediction[] = {
	...
	"Nethack 4's low difficulty would match thine nonexistant skill level,",
	"Prepare to die, thou",
	...
	"Thou art doomed,",
	"Thou cannot even ascend Nethack Fourk, let alone SLEX! Begone",
