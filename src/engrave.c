...
"monsters should not spawn with wands of disintegration before level 20 because i noob and i forgot that items not have levels in this game",
	...
	"Here lies Princess Rosella. That rickety old shovel (which is a picture of hate and spite for King's Quest 4) broke after she had dug up five graves, but she had failed to realize that he had to dig up five SPECIFIC graves, and without the shovel she found herself unable to dig up some plot-critical grave so her game was no longer winnable.",
