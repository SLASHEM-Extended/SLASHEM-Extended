...
"monsters should not spawn with wands of disintegration before level 20 because i noob and i forgot that items not have levels in this game",
	...
	"Here lies Jack Hammer. He tried to attack the woman who was controlling him, but she pushed hin down a set of stairs causing him to get impaled by a fence spike. Whoever decided to build fences with such razor-sharp spikes must have been out of their mind, considering a different actor had already died to the same spike before when Hammer had accidentally pushed him into it...",
