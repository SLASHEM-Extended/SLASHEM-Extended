...
"monsters should not spawn with wands of disintegration before level 20 because i noob and i forgot that items not have levels in this game",
	...
	"Here lies Phoenix Wright. Even though it was obvious he didn't murder Mia Fey, he was unable to disprove Redd White's blatant lies and therefore the judge pronounced him guilty. In the end, Phoenix was executed on the electric chair.",
	"Here lies Mia Fey. She was a very good defense attorney, but that scumbag Redd White killed her with a blunt object in cold blood.",
	"Here lies Larry Butz. He was accused of having killed his girlfriend and his defense attorney (Phoenix Wright) was unable to cope with a murder case as his very first trial, so Larry was pronounced guilty and got the electric chair.",
	"Here lies Cindy Stone, a model who lived in an apartment by herself. Frank Didit (who referred to himself as Frank Sahwit) broke into her house and wanted to steal things when Cindy suddenly came back home, causing Frank to strike her over the head with a heavy object.",
	"Here lies Maya Fey. Even though everyone should have realized she didn't kill her sister, the judge used the 'in dubio contra reo' principle and therefore decided that unless the defense can prove she's not guilty, the verdict defaults to 'guilty' and so she was put on the electric chair.",
	"Here lies Miles Edgeworth. He was accused of having murdered someone, and Phoenix (Miles' defense attorney) fell for the prosecutor Manfred Von Karma's guilt trap, causing Miles to be pronounced guilty immediately. And a guilty verdict in a murder case means the chair.",
	"Here lies Redd White. The bastard murdered a woman in cold blood, and for a petty reason no less, but thankfully Phoenix Wright managed to prove that White had done it. So White rightfully got executed on the electric chair.",
	"Here lies Will Powers. Despite being the 'Steel Samurai', and despite the lack of decisive evidence, he lost the trial and was declared guilty of having murdered his colleague Jack Hammer, and got executed for it.",
	"Here lies Jack Hammer. He tried to attack the woman who was controlling him, but she pushed him down a set of stairs causing him to get impaled by a fence spike. Whoever decided to build fences with such razor-sharp spikes must have been out of their mind, considering a different actor had already died to the same spike before when Hammer had accidentally pushed him into it...",
	"Here lies Dee Vasquez. She knew that she'd get the chair if someone found out that she had pushed Jack Hammer into a deadly spike, so she did her best to cover it up but Phoenix Wright, also known as the Ace Attorney, uncovered her devious schemes, so the diva was found guilty.",
	"Here lies Robert Hammond. He was shot by Yanni Yogi, but everyone believed Miles Edgeworth had done it.",
	"Here lies Gregory Edgeworth. He was the only defense attorney who ever managed to get 'king of prosecutors' Manfred von Karma penalized in court, but the latter decided to shoot Gregory over such a minor setback.",
	"Here lies Manfred von Karma. He was the best prosecutor there ever was but he was so incredibly stupid to murder someone, thinking nobody would ever find out he did it. Well, Phoenix Wright did, and so, one day before the statute of limitations ran out, Karma was found guilty and died on the electric chair.",
	"Here lies Yanni Yogi. He tried to play dumb and pretend he had lost his memory, but Phoenix Wright couldn't be fooled and discovered that the old caretaker had shot an innocent man in his shack. Needless to say, the electric chair snuffed out Yogi's life.",
	"Here lies Lana Skye. She decided to plead guilty in a murder case despite knowing she wasn't the one who did it, and got sent to the afterworld on the electric chair.",
	"Here lies Bruce Goodman. He was a good man, but he had to die because power-hungry corrupt police chief Damon Gant felt that Goodman knew too much.",
	"Here lies Damon Gant. He should've kept just being a police chief, but noooooo, he had to commit murder and thought his power would prevent anyone from finding out about it! In the end, Phoenix Wright uncovered the web of lies Gant had been spinning, causing the latter to be executed and the entire police department to suffer a huge loss of credibility.",
	"Here lies Joe Darke. He was the serial killer responsible for the SL-9 incident, and given the death penalty.",
	"Here lies Neil Marshall. He was a prosecutor, murdered by Damon Gant in cold blood.",
	"Here lie the ears of an Ace Attorney player. They got blown to bits in Episode 5 when Officer Meekins made an extremely loud, ear-splitting 'WEEEEEEEEEEEEEEEEEEEEEEN' sound every couple of seconds.",
	"Here lies Prince Alexander. He had just arrived on the island and decided to walk back into the ocean. Against his best efforts, he was dragged out to sea! The currents around the island pulled Alexander under! As Alexander struggled to the surface for the third and last time, he found himself wishing he'd paid more attention to the warning signs of an undertow! Nothing like getting swept off your feet...",
	"Here lies Prince Alexander. He fell for the totally legit swimboy with the golden glinting eyes (who was really Shamir Schlamassel). The powerful currents grabbed Alexander. Struggle as he might, he felt himself being pulled out to sea. As his head submerged for the third time, Alexander found himself pondering the wisdom of going out on a limb for a stranger.",
	"Here lies the willful suspension of disbelief, killed by King's Quest 6 when the player could see Shamir Schlamassel reporting to his superior in his castle because that is something Alexander very definitely could NOT have witnessed. His subsequent actions were influenced by what the player saw, despite Alexander having no way of listening in to Shamir and Abdul's conversation.",
	"Here lies Shamir Schlamassel's ability to speak normally, killed by a mint drop. Which caused Shamir to talk about 'Prince Salamander of Pagentry' who had just obtained a 'magic smap'.",
	"Here lies Prince Alexander. He used an item on himself and rendered King's Quest 6 unwinnable, the genius.",
	"Here lies Prince Alexander. He decided to brave the boiling pond... and soon realized a deep sympathy for soup vegetables as he learned the true meaning of 'being in a stew'.",
	"Here lies the oyster with a toothache on the Isle of Wonder. Prince Alexander decided not to take the pearl out of the oyster's mouth and instead read from a book: 'Two dulcimas raised to the degree of forty halfdulcimas, divided into equal parts by the third of a cackle of grouse geese, put over the result of ten finemackels (albeit small finemackels), stretched over the total of fifty-three and an eighth bottles of wildebeast lard...' Eventually the oyster fell into an uneasy sleep, but still wasn't resting easy and eventually succumbed to the pain.",
	"Here lies Prince Alexander. He waded deeper into the sea to get the strange object in the water. The underwater tow was amazingly strong here. It pulled ferociously at Alexander's legs. Before Alexander could retreat, the currents grabbed his legs! The shifting sand vanished from beneath his feet! Against his best efforts, he was dragged out to sea! The currents around the island pulled Alexander under!",
	"Here lies Prince Alexander. He didn't have the odoriferous flower, so the smell sense gnome found out that Alexander was a man, and they threw him out to sea because like any King's Quest protagonist, he can't fight back. Not even against a gnome.",
	"Here lies Prince Alexander. He didn't have the mechanical nightingale, so the hearing sense gnome found out that Alexander was a man, and they threw him out to sea because like any King's Quest protagonist, he can't fight back. Not even against a gnome.",
	"Here lies Prince Alexander. He didn't have... uhh whatever pixelated thing he was supposed to use (maybe the rabbit's tail?), so the tasting sense gnome licked him, thereby finding out that Alexander was a man. And then the gnomes threw Alexander out to sea because like any King's Quest protagonist, he can't fight back. Not even against a gnome.",
	"Here lies Prince Alexander. He didn't have the rabbit's tail (but he did have some sweet pixelated thing for the tasting sense gnome), so the feeling sense gnome found out that Alexander was a man, and they threw him out to sea because like any King's Quest protagonist, he can't fight back. Not even against a gnome.",
	"Here lies Prince Alexander. He didn't have the invisible ink to fool the vision gnome, and so the gnomes punished him for the fact that he existed. They threw him out to sea, because like any King's Quest protagonist, he can't fight back. Not even against a gnome.",
	"Here lies Prince Alexander. There was a very lovely, fleecy spider in a web, so he reached out... causing him to feel the tiny pin prick of the spider's bite and the slow burning of her poison. Now he knew why Valanice was called a black widow.",
	"Here lies Prince Alexander. He walked up to the clinging vines, which just wanted to be loved by him, but they would never let him go and eventually hugged him to death.",
	"Here lies Prince Alexander. He fell for the gardener who was really Shamir Schlamassel, and got shot by a statue. That move was slightly arrow-neous!",
	"Here lies Prince Alexander's heart. It broke when he realized that Princess Nervkopfcassima wouldn't answer the things he sent to her via her bird Sing-Sing. And all just because he mixed up the order of those items, which made the bitch of a princess think the stuff was coming from Abdul Alhazred, the evil author of the Necronomicon.",
	"Here lies Prince Alexander's heart. It broke when Princess Nervkopfcassima friendzoned him. He had her bird Sing-Sing take all those sweet gifts to her and all he got in return was a letter calling him 'friend'. He would've had plenty of reason to just get off the island and leave her there to rot with that evil author of the Necronomicon (Abdul Alhazred) because if she doesn't love Alex, then she doesn't deserve him.",
	"Here lies Prince Alexander. The swampy bog sunk beneath Alexander's weight. He felt himself being sucked slowly but firmly down into the muck! As the marshy water filled Alexander's mouth, he thought that, although he'd always wanted to try a mud bath, this is hardly what he had in mind.",
	"Here lies Prince Alexander. He threw the rotten tomato into the swamp, and since he didn't have Belle's clothes anymore, he was a dead man walking now. Because he couldn't get swamp muck for casting a spell necessary for the long ending path now.",
	"Here lies the fourth wall. Prince Alexander broke it when the player misclicked enough times on the Cliffs of CoPy Protection, addressing the player directly for making him fall down.",
	"Here lies Prince Alexander. He didn't have the handbook, so he couldn't solve the Cliffs of CoPy Protection and ended up falling to his death. The game said 'That wasn't a very logical step!'",
	"Here lies Prince Alexander. He had brute forced his way through the first two screens of the Cliffs of CoPy Protection, but the third one would instantly kill him for clicking on the wrong button. The game said 'What a riddle! Stones of stealth! Find a Guide, to keep your health!', and maybe after reloading from his last save, Alexander actually decided to go to GameFAQs to figure out the solution.",
	"Here lies Prince Alexander. He had beaten the Cliffs of CoPy protection and then didn't realize the 'old lady' was actually Shamir Schlamassel again, trying to kill him. So Alexander foolishly ate from the nightshade bush, the 'Duedeldue-duedeldue-duedueueueue!' sound effect played, and he was dead. I mean, it was *nightshade*. What did he think would happen?",
	"Here lies Prince Alexander. He went to the city of the winged ones without having everything he needed to beat the minotaur maze, returned back to the ground, but then went back to the angels while still not having all the necessary items, so he got thrown into the maze with no way of completing it and died.",
	"Here lies Prince Alexander. As he walked through the doorway, Alexander got a VERY bad feeling about this room. There was no floor... so he just fell to his death even though he could plainly see the bottomless pit without having to step into it. And the game then mocked him further by saying 'Don't just wander, Alexander! Let your conscience be your Guide.', as if that would protect him from accidentally entering a 'lol yore dead now' room.",
	"Here lies Prince Alexander. He encountered the last CoPy protection in King's Quest 6, a room with tiles that had engravings on them, and he didn't have the guide so he had to brute force the one correct path. What he didn't know is that by holding Alt while walking over the trap, it'd never activate and allow him to just bypass the room.",
	"Here lies Prince Alexander. He found Shamir Schlamassel in the minotaur maze, who looked like Lady Celeste and somehow had managed to prevent his eyes from sparkling. He beckoned Alexander to come closer... and Alexander didn't notice that the room had no floor, so he fell to his death again.",
	"Here lies Prince Alexander. He encountered a trap! The doors had sealed Alexander inside! And the ceiling was coming down! With a sudden lurch, the ceiling completed its descent. And pressed Alexander into the floor like a bug under a heel!",
	"Here lies Prince Alexander. He made it through the first level of the minotaur maze and found himself in a pitch-black room. Since he didn't have the tinderbox from the 'Pawn, Shoppe', he got eaten by a grue, err, the resident minotaur.",
	"Here lies Prince Alexander. He walked into a dead end in the minotaur maze, and then the minotaur just randomly appeared behind him and killed Alex.",
	"Here lies Prince Alexander. He had forgotten to pick the hole-in-the-wall back up, so when he was in the minotaur maze, he couldn't spy on the titular minotaur and that caused the script to go 'well then, let's just randomly kill Alexander now'. Even though he used the exact same path through the maze as the one he'd have used if he had the hole with him.",
	"Here lies Prince Alexander. He didn't know what to do when he actually encountered the minotaur in the maze (or he didn't have the right item with him, which is more likely), so the minotaur charged and pushed Alex into the lava with his horns. Hand-to-hand combat with a minotaur is, apparently, not a great idea.",
	"Here lies the minotaur of the maze. Prince Alexander held a red scarf in front of the bull's face, causing him to come a-charging, and then quickly stepped aside causing the minotaur to run right into the lava. The minotaur screamed 'OHOHO-HO-HO!' and burned to ashes.",
	"Here lies Prince Alexander. He returned to the winged ones after having saved their princess Celeste, and thanks to the evil Abdul Alhazred (author of the Necronomicon), they then killed their hero and savior Alex even though they should have been GRATEFUL.",
	"Here lies Prince Alexander. The druids put him in a cage and suspended it over a fire. The bottom of the cage was getting uncomfortably hot. Mercifully, Alexander passed out from the heat before the first tongues of flame ignited the wicker. That was a bit too hot to handle! Alexander should have been better prepared.",
	"Here lies Prince Alexander. He had entered Beast's garden, and was supposed to find a beauty for him to marry within three and a half minutes but failed. As a result, Beast's curse afflicted Alex too, turning him into a beast as well.",
	"Here lies Prince Alexander. He fucked up, filling his lamp to the brim with fountain water before adding salt water and he couldn't just pour out a little bit to add the salt water for some reason, so he ended up being unable to complete the rain spell and thereby had no way to survive the druids' cage.",
	"Here lies Prince Alexander's heart. It definitely broke in two when he sent the white rose to Princess Nervkopfcassima after she had friendzoned him, because he hoped she'd reconsider and realize he was meant for her. The bitch of a princess never replied, thereby confirming Alex's worst fears: she actually loved Abdul Alhazred, and wanted to marry him even though he's the author of the Necronomicon and thereby evil by definition.",
	"Here lies Prince Alexander. He had mixed up the order of things in King's Quest 6 and therefore missed the only opportunity for meeting Jollo to set up the act of stealing the magic lamp used to control Shamir Schlamassel. So he couldn't get the best ending, just because he wasn't at the right place at the right time. Hooray! And they call King's Quest *5* unforgiving!",
	"Here lies Prince Alexander's inability to see things in places where he isn't. After he had feigned death, the game showed Abdul Alhazred with the magic lamp to control the genie, Shamir Schlamassel, and thereby Alex somehow knew what that lamp looked like even though realistically he had no way of knowing. It makes absolutely no fucking sense that Alex could then specifically pick out the correct lamp out of the collection he was presented later!",
	"Here lies Belle's clothes. Prince Alexander used them to put out the flames of the wicker cage he was put into by the evil druids... except that of course the bonfire kept burning, so it was only a matter of time until the cage would catch fire anyway, meaning the sacrifice of those innocent clothes was in vain. :(",
	"Here lies Prince Alexander. He had just appeared in the underworld... uh, oh! One of the wandering ghouls brushed up against Alexander! The touch of the putrid flesh dissolved the living matter like acid!",
	"Here lies King Caliphim. He was brutally murdered by Abdul Alhazred, because the author of the Necronomicon is EVIL.",
	"Here lies Queen Allaria. The evil author of the Necronomicon, Abdul Alhazred, wanted Allaria's daughter, Allaria said no, and so the evil Abdul was so evil and killed Allaria to get what he wants by force.",
	"Here lies Prince Alexander. He came to the underworld gate, but his player thought he had done something wrong and gotten a game over, so he reloaded even though Alex was still wearing his flesh. All just because it's the same screen that King's Quest 6 shows every time you die.",
	"Here lies Prince Alexander. He slipped off the path and plunged into the River Styx. As soon as the water touched his skin, Alexander's mind and body went numb. He sank like a lifeless stone.",
	"Here lies Prince Alexander. He had forgotten to get some River Styx water before paying Charon for the ride, and therefore couldn't beat the game since he lacked the final ingredient for his last magic spell.",
	"Here lies Prince Alexander. He didn't have the silver coins from the minotaur maze, so when he got to the underworld he couldn't pay Charon's boat fare and got killed with an especially bad pun.",
	"Here lies Prince Alexander. He had already opened the hungry gate, but then clicked on the gate instead of the path behind and got killed anyway, which is really silly but that's King's Quest 6 for you.",
	"Here lies Prince Alexander. He couldn't get past the hungry gate even though it was so obvious that the answer to the riddle was 'love'. As a result, the gate simply ate Alex.",
	"Here lies Prince Alexander. As though sensing Alexander's desire to touch him, the Lord of the Dead reached out his hand. As the Lord of the Dead's hand touched his shoulder, Alexander's mind faded to blackness.",
	"Here lies Death's contenance. Prince Alexander showed him a magic mirror, displaying Death's past life in front of him. Things long forgotten were once more uncovered: his enslavement to this throne while still a man; the years of watching misery and horror and growing ever more numb to it; the seep of his own humanity; the slow growth of a new thing altogether which became that which he is now. His is an existence that has no possibility of redemption, no end. The mirror of truth cracked from the strain.... And Death shed a single, gray tear.",
	"Here lies Prince Alexander. He had forgotten to get the handkerchief from the underworld, and therefore found himself unable to console the child's ghost back in the mortal world. And that meant the child ghost never told Alex of the secret door behind the suit of armor. Because King's Quest 6 works like it does, trying to open the secret door without having been told about it didn't work, so the game was unwinnable.",
	"Here lies Prince Alexander. He didn't charm the skeletons at the underworld gate, so he didn't get the skeleton key which he'd then have to use back in the mortal world to open Abdul Alhazred's chest. And without the documents from the Necronomicon author's chest, he couldn't prove that the latter was actually evil and planning to kill the princess, so the game was unwinnable but it took more than an hour of playing to actually reach the part where Alex died.",
	"Here lies Prince Alexander. He rushed in to stop the wedding, but was intercepted by Saladin who gave Alex five seconds to convince him. Since Alex didn't have the documents of Abdul Alhazred the evil author of the necronomicon, Saladin just killed him.",
	"Here lies Prince Alexander. He had convinced Saladin that something was amiss, so the two of them went to stop the wedding... only for Saladin to be so stupid to fall for Shamir Schlamassel's lies (who was disguised as Princess Nervkopfcassima) and believe that the princess really loved the author of the Necronomicon. And therefore, Saladin suddenly turned on Alex and cut him down instantly.",
	"Here lies Prince Alexander. He waited around too long at the wedding ceremony, allowing Shamir Schlamassel to fire balls of dazzling light at everyone. And eventually Alex got hit by one and died. Genie, meenie, minie, moe... Alexander can't be slow!",
	...
	"Here lies Phoenix Wright. He committed suicide after the outcome of Matt Engarde's case: because Matt was found guilty, Shelly de Killer killed Maya. And living in a world without Maya is unbearable, so Phoenix requested that Shelly kill him too, which he did with his gun. Blam.",
	"Here lies Maggey Byrde. Even though the lies spun by that idiot Wellington made absolutely no sense, the judge found her guilty, but that was only because Phoenix had amnesia and therefore couldn't defend Maggey as well as he'd normally have been able to.",
	"Here lies Dustin Prince. He was at the wrong place, at the wrong time. Richard Wellington met him and, not expecting to see a cop, freaked out and threw Dustin off a ledge, causing him to snap his neck and die instantly.",
	"Here lies Maya Fey. She was the victim of her aunt Morgan Fey's evil plot, because Morgan is eeeeeeeeevil (go figure) and therefore set up the killing of a doctor in order to frame Maya. And even though Phoenix Wright did his best to get Maya found not guilty, Ini Miney's 'eeny-miney-mimey-moe' game confused him too much, so he ate too many penalties and the judge decided to give Maya the chair. :-(",
	"Here lies Richard Wellington. The self-proclaimed 'drifter virtuoso' can now drift around the underworld until the end of all time, because the ace attorney (Phoenix) easily unraveled his lies and therefore proved that Wellington was the real murderer of Dustin Prince.",
	"Here lies Dr. Turner Grey. He got killed by Mimi Miney, who was disguised as her dead sister Ini Miney and acted on behalf of the evil Morgan Fey (who is very eeeeeeeevil) in an attempt to frame Maya.",
	"Here lies Ini Miney. She died in a car accident, but then her sister Mimi Miney underwent facial surgery in order to look like Ini, which meant that it was really Mimi who no longer existed. Yeah, try to twist your head around that.",
	"Here lies Mimi Miney. She killed Dr. Turner Grey while disguised as her dead sister Ini Miney. Thankfully, Phoenix Wright is just an ace as an attorney and therefore figured out Mimi's convoluted plot, exposing her for the evil person she really was all along, and so the electric chair zapped her out of existence.",
	"Here lies Maximillion Galactica. Even though he wears absolutely gorgeous purple combat boots with incredibly beautiful, thick block heels, he was falsely framed for the death of ringmaster Russell Berry and executed. :-( (insert a sea of tears here :-( If only Phoenix Wright had managed to find the real killer!)",
	"Here lies Regina Berry's belief that the world was full of fluffy rainbows. After watching the trial of Maximillion Galactica and seeing that Acro was the real killer, her world shattered into a thousand fragments, forcing Regina to realize that reality can be a cold, cruel place.",
	"Here lies Russell Berry. He got killed by Acro (the brother of Bat), who actually wanted to kill Regina but didn't know who the victim was that had walked into his trap, and therefore Acro simply triggered the trap, murdering an innocent man in the process.",
	"Here lies Acro (real name: Ken Dingling). He had wanted to avenge the 'death' of his brother Bat (Sean Dingling), actually killed the wrong person, and had the misfortune of the defense attorney being an absolute ace who actually managed to beat Franziska von Karma's dirty tricks, so Acro was found guilty and killed with the electric chair even though he was already sitting in a wheelchair.",
	"Here lies Bat (real name: Sean Dingling). After his brother Acro (Ken Dingling) had been executed for his evil murder of the circus ringmaster, Bat didn't want to go on living anymore either, so he kys'ed himself.",
	"Here lies the original version of Wendy Oldbag. When she became part of the security personnel of Gatewater Hotel, she somehow transformed into an alien with a hideous helmet and a ray gun.",
	"Here lies Juan Corrida. He got killed by Adrian Andrews... well, not really, Shelly de Killer was the one who actually did the deed, but Andrews had ordered it and is therefore the killer by association.",
	"Here lies Matt Engarde. He was falsely framed for the murder of his rival Juan Corrida, even though it was really Shelly de Killer who performed the deed, and even though Phoenix Wright had realistically proven Matt not guilty ten times over, he slipped up at the very last witness testimony and so Matt was found guilty anyway. So Matt got executed, and Shelly de Killer, agitated by the fact that Phoenix hadn't fulfilled his demand, strangled Maya to death. :-(",
	"Here lies Adrian Andrews. She hadn't really killed Juan Corrida, but she had hired an assassin to do so, and she tried to act as the super frigid, unbreakable ice queen bitch but Phoenix Wright wouldn't have any of that. Phoenix knew that Matt Engarde was innocent, and so he proved Adrian the androgynous bitch of a woman guilty, causing her to be executed. Shelly de Killer was satisfied and released Maya... but she had somehow wanted Engarde to be convicted, so she left without a word of goodbye and left Phoenix to despair. :-(",
	"Here lies Celeste Inpax. That bastard Juan Corrida had proposed to her, and the wedding had already been planned but three days later Juan suddenly cancelled it, and Celeste... she just didn't want to keep on living. So she hanged herself. :-(",
	...
	"Here lies the DOOM 2 engine. It blew up on the 'Icon of Sin' level, when the titular icon had done a certain amount of 'Pitschaeff!' sound effects accompanied by it shooting cubes that transform into monsters, because the genius programming hadn't accounted for the size of the monsters array, eventually causing an overflow that resulted in the game crashing.",
	...
	"Here lies Phoenix Wright. His not-girlfriend Dahlia Hawthorne had tried to murder him with poison, but Phoenix survived by dumb luck, only to be framed for the murder of Doug Swallow and his attorney (Mia Fey) unfortunately failed to prove to that blind judge Udgey that Dahlia was the real murderer, so Phoenix got the chair. :-(",
	"Here lies Dahlia Hawthorne. She had murdered two men, and then tried twice to murder Phoenix Wright (one direct attempt with poison, one frame job for the murder of Doug Swallow which counts as a murder attempt because Phoenix would've gotten the chair despite being innocent), but Mia Fey took Dahlia's reeking-of-perjury testimonies apart. As a result, that Dahlia monster was found guilty and got the chair, which she definitely deserved.",
	"Here lies Mia Fey's career as an attorney. She was just doing her fucking job (namely, proving that Dahlia Hawthorne had committed murder twice and perjury about half a dozen times), but that blind idiot Udgey who calls himself a 'judge' decided to penalize Mia by forcing her to turn in her attorney badge forever even though she had every right to cross-examine the witness! How the hell is a defense attorney even supposed to work with such a corrupt judge???",
	"Here lies the opportunity to give funny names to Glen Elg's coworkers. Sure, they had Lisa Basil, but there could have been a Mark Ram and a Tobias AI-Bot too! Why did they leave those other guys unnamed? And when they added a new character in the epilogue, they named him 'Adam Mada', which sounds kinda lame by comparison!",
	"Here lies Maya Fey's sanity, it got blown to bits when she was left to sit on an ice block and commanded to chant 'Hare Krishna' 30 000 times in a row. That was the special course she had volunteered to do at Hazakura Temple to 'boost her spirit powers'. And since the bridge had been burned down, there was no way for Maya to come back when she started to freeze, either.",
	"Here lies Ron DeLite. He was found not guilty of theft... which opened up the window for Luke Atmey to frame Ron for murder instead, which he was found guilty of. So he got the chair; had Ron been found guilty of theft instead, the murder charge would've just been ignored for some reason. Maybe because the theft case gave him an alibi?",
	"Here lies Luke Atmey. He was about to be declared guilty of theft even though the prosecutor was just Winston Payne, but then Phoenix Wright barged in, dragged Atmey into a much more serious trial where the accusation was 'murder', and being the Ace Attorney, Nick managed to prove that Atmey had actually done the deed. So Atmey got the chair.",
	"Here lies the hope that we'd never have to see Adrian Andrews again after the end of the second Ace Attorney game. She reappeared in the MaskStarDeMasque case, uglier than ever, and with an incredibly repulsive new haircut to boot. Urrrrrrgggghh.",
	"Here lies Kane Bullard. Originally, the MaskStarDeMasque case was about theft, unlike all other Ace Attorney cases, but then a murder did happen after all because all those cases have to involve murder. And Luke Atmey the self-appointed 'ace detective' was the culprit, but he had created an elaborate scheme to pin the whole thing on Ron DeLite.",
	"Here lies Maggey Byrde. Her defense attorney, Xin Eohp aka Furio Tigre, posed as Phoenix Wright and intentionally lost to Winston Payne because he wanted Maggey to be found guilty; after all, Tigre was the actual murderer of Glen Elg and tried to frame it on Maggey.",
	"Here lies Maggey Byrde. She was accused of having poisoned Glen Elg, and even though she got a retrial with a real Phoenix Wright as her attorney, the latter tripped over the stupid penalty system where just pressing Furio Tigre's statements sometimes resulted in a penalty. In the end, Nick's health ran out and the judge declared Maggey guilty. Again.",
	"Here lies Furio Tigre. He had somehow poisoned Glen Elg to death, a method of murder that is normally performed only by women, and then even made it so that Godot and the judge could randomly penalize Phoenix Wright just for pressing Tigre's statements, but Nick is such an ace attorney that he won the trial anyway, meaning Tigre got the chair in the end.",
	"Here lies Glen Elg. He had been poisoned to death, and then Furio Tigre as well as his accomplice Viola Cadaverini staged an almost exact rendition of that murder because they wanted Victor Kudo to witness everything. That way, they could pin the murder on Maggey even though Tigre was the actual culprit.",
	"Here lies Terry Fawles. He was accused of having murdered a policewoman, and given the death penalty because Mia Fey was the defense attorney, fresh out of law school, and immediately had to face off against Miles Edgeworth. Of course Mia didn't have a chance because Edgeworth used every underhanded trick in the book to win, and not even Godot (Mia's sidekick) could turn things around because Edgey just can't be defeated.",
	"Here lies Terry Fawles. He was staging a kidnapping together with Valerie and Dahlia Hawthorne, but then the latter just jumped off the bridge and Fawles was framed for having pushed her. He had no way of disproving the accusations and therefore was found guilty, and given the death penalty.",
	"Here lies Terry Fawles. All he really had to do was tell the world that Dahlia Hawthorne set him up, but instead of doing that, he committed suicide right in the middle of the courtroom despite being one single step away from freedom.",
	"Here lies Valerie Hawthorne. She was killed, not by Terry Fawles (even though it certainly looked like he was the culprit) but probably by her sister Dahlia. Although that never really gets established in Ace Attorney 3; we just have to assume it was Dahlia because there's no one else who could conceivably have done it.",
	"Here lies Misty Fey. She was the master of the Kurain Channeling Technique and posed as an inexperienced occult woman (Elise Deauxnim) as part of an elaborate plan, but the plan went wrong at some point and so Godot had no choice but to kill Misty when she was channeling Dahlia Hawthorne. Because Dahlia, in Misty's body, would've killed Maya were it not for Godot's brave actions.",
	"Here lies Iris... Fey, I guess? Or Hawthorne? She was the sister of Dahlia and Pearly, but got set up to take the fall in case Godot had to kill Misty. And even though Phoenix Wright had done everything correctly, the very last question in the trial had Godot impose an instant death penalty in case Nick presents the wrong evidence. Well, Nick slipped, and therefore Iris was found guilty even though Nick had full health left.",
	"Here lies Godot's original life. When Dahlia poisoned him, he lost five years that he had to spend in a coma, his eyesight faded for the rest of his life, and his natural hair color vanished forever! The latter was particularly heartbreaking; now Godot has to spend his remaining life with snow-white hair, instead of the auburn color that his hair had originally!",
	...
	"Guuuuuuuuuuuh... I had found matching power armor and helmet artifacts, and just couldn't make use of them because despite wishing for the Anchorage Battlecoat artifact five times, it failed every time! So I was unable to receive power armor training and eventually died to something that I'd have survived had I been able to wear the armors.",
	"Amy just added way too many turbocursed ass artifacts to the game and you get forced to wear one at the most inopportune time! Fucking game, you always die to something that you couldn't control, which is no fun I tell you!",
	"Yeah sure, Amy made a game where you can play normally for 30 dungeon levels and then suddenly the next level spawns some super bad artifact that gives you nasty trap effects *just from having generated*, and what's more, it gives those effects *permanently* so you can't even wait them out. Her game is completely fucked up and I'll never play again, I don't care about all the nice stuff in SLEX because the bad stuff makes it unplayable either way.",
	"Why did I suddenly have that nasty trap effect and why didn't it time out even after 20000 turns? That's bullshit, nasty traps should time out after a couple thousand turns! If they don't, you just get an unplayable game! Screw that, I'll play Evilhack from now on, long live K2, he's the best NetHack variant developer ever and his variant will always be worlds better than SLEX!",
	"Of course it's totally fair if you can suddenly encounter a monster that dishes out over a hundred damage per turn, with its attack being ranged and capable of hitting you through walls. SLEX is such a fucking pile of shit and I'm now gonna play one of the variants created by ais523 instead. *He* is a capable developer, one who understands the concept of game balance and that's why his variants are thoroughly enjoyable! Amy, you suck ass!",
	"What, you're complaining that if you combine the sokosolver, mazewalker and specialist hybrid races, the dungeon levels are revealed less often? You're saying they should once again be all but guaranteed to start out revealed? Dude you totally didn't get what hybrid races are actually for, namely, they're meant to provide additional challenges, NOT be an easymode switch that makes the game trivial to play through!", /* yeah sorry amateurhour, but it was definitely a bug that combining them would result in lots of mazes and other special levels that start out fully explored. also spirit was too strong :P but that's beside the point, the fact that it was possible to gain benefits from picking specific hybrid races was a bug because by definition none of them should have big benefits without a downside! they're meant for experienced players who want a challenge, so if any of them results in the game becoming easier, it's a bug that needs fixing! otherwise, everyone would be that hybrid race, with every single character! */
	"bleh, what is that, I failed to cast particle cannon and still got paralyzed for five turns! that's gotta be a bug!!!", /* it was, but got fixed now --Amy */
	"I encountered a level 60 monster on dungeon level 5 and because I'm not a very good player, I just plugged away at it in melee like a doofus. I also didn't read a phase door or healing scroll when my health got low, nor was I smart enough to run away at the very least. Nope, I just geronimo'ed it and then rolled a new character.", /* happens sooooooooo often, players tend to not be able to tell that an unexpectedly high-level monster cannot be beaten by a low-level char! there are so many ways to avoid such monsters, one would just have to use one of them... */
	"I accidentally killed Moldoux and had a great wyrm of power spawn next to me, so I read a phase door scroll and then decided to be very intelligent: since there was still a chance of finding good items, I kept exploring the level. My motto was 'maybe the wyrm will catch me or maybe it won't'. Even though the downstair was right nearby where I landed, I ignored it. After a while, something breathed at me from a dark corridor and I died instantly, oh well.", /* not sure why one would ever play like that, but I've seen that happen too... --Amy */
	"Huh, what, I killed some fungus that was called the sweet defenceless mold or something and then there was a dragon and I punched it but died immediately! Why did I die there? That's so unfair!", /* nope, you should've immediately phase doored away and gotten the hell OFF the level! you shouldn't just punch everything that moves or looks like it could move! The GWOP *will* kill you if it gets a turn, unless you have at least a full ascension kit! */
	"So I was quaffing from that fountain like the very smart and skilled player I am, and then a purple ampersand appeared next to me. Obviously, I started attacking it. A while later, there were three purple ampersands around me and then I died. What, you're saying I should have immediately phase doored away when the first such ampersand appeared? How do you phase door, wasdat?????", /* yeah 9 out of 10 slex newbies don't familiarize themselves with their starting inventory and therefore fail to realize that they can do short-range teleports with those scrolls! */
	"That monster just outdamaged and killed me, what the hell could I have done? Oh what's that you say, I started with healing scrolls??????? Wait, so I could've saved myself by just reading one of those to heal up?!", /* should be *really* the *very first thing* you do with *every* character in *every* RPG you play that you *check your starting inventory*, but noooooooo, some players are even too impatient for that... */
	"The hippie femmy and her sexy red overknees with extra thick block heels used the most devastating attack in the game, namely the segfault attack, which allowed her to blow up my game from the grave. So, even though I had killed her, I then had to recover my game to a point from before she had died, and failed to defeat her the second time around.",
	"i tried to offer a cockatrice corpse off the ground and got turned to stone because i had no gloves, thats so unfair!!!!!!!!!!!111111 it makes no sense that you would be touching a corpse on the ground!!!!! i will never shut up about this, instead i will now create thread after thread on usenet to complain about this obvious design error and shout at the devteam IN ALL CAPS BECAUSE THAT WILL CERTAINLY MAKE PEOPLE MORE LIKELY TO AGREE WITH ME!!!!!!!!!!11111111111", /* actually happened... */
	"My last SLASHTHEM character was killed by a heap of shit. At least a fitting death, summarizes my feelings about that game.", /* IIRC by a player named coffeebeetle, I'm fully aware that the heap of shit is actually a SLEX feature but since we all know what I think about the variant-that-started-as-a-SLEX-variant-without-really-being-one, I'll say that the line fits very well :D --Amy */
	"Those new monsters that Amy added to the 42 rooms are sooooooo unbalanced! I died with no chance!!!",
	"Man, you can't handle doomed barracks! They always spawn all those zombiemans and former sergeants, and they fucking kill you from far away and their guns seem to ignore your armor completely!!",
	"Amy added yet another monster that completely ignores difficulty ratings, spawning way too early and killing promising characters through no fault of the player! This game fucking sucks!",
	"Why did that high-level monster spawn here, the monster difficulty should have been quite a bit too low for it to be generated. SLEX is completely out of whack.",
	"Whyyyyy are there so many item-stealing monsters. SLEX is no fun, they were incredibly annoying in vanilla already but now Amy added a clone of basically every monster with an added stealing attack, so they spawn everywhere, all the time. Unplayable game.",
	"I played for 15k turns and accomplished *nothing*. Sokoban had no prize. Mines end didn't generate. And I couldn't find the quest in the level range where it would appear in vanilla.",
	"Oh no, WHERE is the sokoban branch entrance!!!!!!! I spend 5k turns on the level below the oracle and did NOT find it, instead I ran out of food and when I tried to pray my god was angry for no reason!!!!!",
	"holy fuck she made it so that you can be turned to slime by rotten food. that's waaaaaaaaaaay too evil, i had no way of curing the sliming so i just slowly died!",
	"what the hell, why did i permanently turn into a green slime when my sliming timer ran out, now my char is unplayable, i cannot equip anything, cannot open doors, cannot even SEE, and my melee attack seems to do no damage! how am i even supposed to play this game now! man this sucks, i don't want to have to quit 40k turns into the game but i see no other way! fucking bullshit!",
	"what, playing the sheep race means you have no hands? and every time i try to open a door i get blinded, trying to wear armor stuns me and everything else also sucks? #quit, gonna roll a new char", /* sooooooo many players do that... I guess 99 out of 100 players (maybe even more than that) are just too impatient to play a challenging race; having fucking ascended a sheep prostitute, I look down on all of those noobs with disdain :P --Amy */
	"Amy your game sucks. I didn't listen to your advice to save frequently, was almost done with the dungeon level when it crashed, and got reset to when I entered the level. When I tried to annoyedly play through it again, I died.",
	"Amy I died! Fix your game plz!",
	"Amy that thing killed me, that's unbalanced! Fix plz!",
	...
	"Monsters who trigger nasty traps by walking over them are just evil, Amy. It's bad enough if I get afflicted with those shit traps when *I* step on one, you really didn't need to make monsters who can trigger them for you. #quit",
	"Stupid monsters who can trigger feminism traps and make it behave as if you had triggered them, man. Whose idea was that, anyway??? Why not make it so that the monsters are affected by the traps instead?",
	"That silly item-stealing monster suddenly just banished itself while it was holding half my inventory including the box with all the damn goodies, and I couldn't find that monster before something killed me. Had I still had my equipment, I'd not have died there, either.",
	"omg amy is so fucked up and her game is soooooo offensive! why did she insist on having gender monsters who make fun of the various genders, she should be burned at the stake!",
	"What, an anorexia-themed monster?! That is unacceptable, I haven't read the content warning at the start of the game and got really badly triggered, so I'll now stop playing this game forever.",
	"Uaaaaaaaargh, Amy actually made a bunch of bulimic monsters who vomit up any food they eat??????? Like that's so turbo gross, I knew that this game supposedly had disturbing content but that's just too much! Sorry but I'll not play again!",
	"What the hell is up with those weird glyphs appearing on some levels, and why are some of them monsters that I can't even see and therefore not check up on their stats? Dammit!",
	"Ugghh Amy you sick freak, I thought this game was fun but then I encountered a molester monster, and it did so many evil, icky things to my female character that I felt really uncomfortable. I can't go on playing, yet I don't want to kill off my character either, so I'll just declare that she lived and will now play Nethack Fourk instead where such triggering monsters do not exist.",
	"What, a monster that can give you random nasty trap effects just by having moved??? Amy what the hell is WRONG with you?!",
	"That weird-ass armorer monster seemed easy enough at first, he barely got any turns but as I kept fighting him, he got faster and faster and eventually just owned me!",
	"Why did I get random bad effects every once in a while on that dungeon level? What, you're saying there was an 'omen' monster that can give you a random bad effect randomly just by moving around??? Amy, get help, quickly, before it's too late!",
	...
	"Here lies another character who permanently retired after getting to the castle wand. The player knew that the game was effectively won at that point due to having a full ascension kit and everything, so there was no chance of finding interesting loot anymore and the monsters and demon lairs in Gehennom generally don't pose much of a challenge either. So the player opted to restart instead and experience the most interesting part of the game again, which is the early game when every newfound item can be a significant boon.",
	"I fully understand why many vanilla players stop playing once they reach the castle or valley. The game just gets very repetitive and boring at that point because you're merely going through the motions and try not to doze off while playing through maze after boring maze for hours on end.",
	"It seems that all the non-SLEX dev teams just got bored when they had to design the late game. That's why the various demon lairs, the sanctum and other special levels all have only a single version, so they are always the same boring grind in every single playthrough, making that part of the game even more dull than it already is.",
	"Most development time of the various non-SLEX variants (including vanilla nethack) went into the early and mid-game. That's why the late game is dull and repetitive: because there weren't enough resources to make as many different versions of the later special levels as there are versions of minetown and mines end. Roguelikes live and die with variety, and in the late game you get the same boring special level layouts every. single. time. you play through the game, making it an incredibly monotonous and sleep-inducing grind.",
	"The late game of vanilla nethack is not very interesting. You already know exactly what to expect: endless mazes as filler levels (yawn) with very little loot (double yawn) and monsters which are mostly just speed bumps (triple yawn), and the special levels all have fixed layouts that are the same in every single game so they don't do much to make the game more interesting. B-o-r-i-n-g.",
	"unbalanced, I don't think that word means what you think it does... Just because you don't like a particular game feature doesn't mean it's unbalanced, as that allegation is based on your personal opinion. And no, even if the entire community of SLEX players share it, it's still a personal opinion and not a proof of the supposed 'lack of balance' you're claiming to see.",
	"Here lies the allegation of various SLEX players (and people who didn't even bother playing it) that it was supposedly 'unbalanced'. Since none of them have any valid arguments with which to prove their point, their claims are all invalid by definition and SLEX therefore has to be viewed as balanced until someone brings some proof to the contrary (which will never happen anyway).",
	"Players tend to only look at things from the player's perspective. A kickass artifact two-handed sword with triple damage and a suite of useful resistances would never be viewed as overpowered by them, they'd merely call it 'good'. But if something even slightly works against the player, they immediately scream 'unbalanced'. Ridiculous. Game balance goes both ways, not every game is about sending the player on a power trip where their character can easily become unstoppable!",
	...
	"Here lies a player who was so ultra wierd and decided to no longer play the spirit race 'because of the lack of paranoid phasing'. He seems to grossly overestimate the fluidators, thinking (despite being told that he's wrong) that a single misstep into a wall would instantly summon them.",
	"omg walls are harmful tiles!!! i will refuse to play any phasing race forever because there is no way to activate paranoid phasing! lalalalala you cant convince me, i will forever treat walls just like water or lava now even though you have to spend dozens of turns in a wall to even have a chance of fluidators spawning!", /* such an idiotic reason to not play a given race... as if it was sooooooo hard to not step on a wall constantly... also, I literally told him that a single misstep does nothing and fluidators come only if you wallwalk a lot but if he doesn't want to believe me... */
	"Here lies a player who actually thought that a 'single misstep' into a wall tile would instantly summon the fluidator squads. Even after being told that the fluidators don't appear unless the fluidator wantedness reaches 50, and one turn spent in a wall only gives a wantedness of 5 while every turn spent not inside a wall reduces it by one again, he still insisted that walls were somehow on the same danger level as lava or peaceful Izchaks.",
	"I can't stand it if my early-game characters get killed by some unavoidable bullshit. Or by 'avoidable but only if you play very OCD and decide on every keypress 200%% perfectly' kinds of bullshit. If one wrong keypress ends the game regardless of your char's stats or anything, the game sucks and is in need of fixing!",
	"lol why would anyone seriously play TSX now, they completely warped the game by not only making it so that sokoban has rolling boulder traps but they also no longer disappear even if there's no more boulder *AND* to top it off, you can't displace your pets onto the traps anymore. So essentially, the strategy of bringing a pet or two to the zoo at the end has been taken off the table unless you have a magic whistle, and for no good reason to boot, which is just so incredibly dumb.",
	"Here lies Phoenix Wright's ability to sound forceful in the German version of the Ace Attorney trilogy. When pressing a witness, he normally shouts 'HOLD IT!', but in the German translation that was somehow changed into 'Moment mal!', which is something you'd say in a nice friendly discussion about the weather, politics or something, not in a murder trial where the client's life is on the line. Nick really should shout 'HALT!' in German, which would sound a lot more powerful.",
	"Here lies the magatama. It got seized by the American government and turned into a MAGA-tama, and became the symbol that was supposed to make America great again, with dubious success.",
	"Here lies an Ace Attorney player who got stuck in an investigation segment not knowing how to proceed, because he didn't play the game the way you're supposed to. If you don't click on everything that looks like it can be clicked and don't use every item on every NPC that's available, then what are you even doing playing adventure games???",
	"Here lie a bunch of optional funny interactions that Phoenix Wright can have with the various characters in investigation segments. The player was so incredibly impatient and didn't play the game like you're supposed to play an adventure game, i.e. never presented the attorney badge to anyone, or any other evidence for that matter, and therefore didn't see most of the lines that the developers had put in. :-(",
	"Here lie the various responses that you can get in Ace Attorney 2 and 3 for presenting profiles to different characters. The player wanted to just rush-rush through that segment and get to trial already, which is kinda understandable because the trials are the most interesting part of the games by far, but really, come on. First rule of adventure games is that you try out every possible interaction, you don't just 'forget' that you can also present profiles! If you skip past that, you're playing it wrong!",
	"Here lies the sanity of someone who was watching the investigation segments of an Ace Attorney Let's Play video series. Whenever there was an examine prompt, the player would move the cursor around and somehow not notice the very obvious effect of the blue cursor becoming yellow when it was on something clickable, and the watcher was internally chanting 'CLI CK! CLI CK! CLI CK!' but the player just moved the cursor back and forth, talked about something not game-related while doing so, and then closed the examination prompt without actually clicking on the VERY OBVIOUS CLICKABLE THING. GNNNNNNNNNNNN.",
	"It is sooooo dumb that in OSEhack, using enchant weapon scrolls to fooproof things is arbitrarily limited to only 'most' item types and one or two that one would really want to have proofed are exempt for no reason! Why the hell would one design the game in such a half-assed way?!",
	"lol osehack is such a great variant, you can wield an artifact sword that disintegrates enemy swords with no way for you to stop that and monsters exist who can snatch your secondary weapon right out of your hand, allowing them to instantly wield said weapon and then unless you play VERY carefully, your primary weapon will just disintegrate the weapon that was really yours, 10/10 great game design would play again :-P",
	"omg why do all those newfangled nethack variants have to add new artifact weapons or change existing ones such that they deal area damage, that's literally unworkable because it doesn't care about friendly monsters caught in the blasts so you have to always switch to a different weapon when any shopkeepers, quest guardians or whatever are around, why would a game be designed in such a dumb way :(",
	"The success or lack thereof of a NetHack character should not depend on whether you've found an altar on a deep enough level. As there's no way in vanilla to create a new altar, it means that if none spawn at all in the main dungeon, you're just hosed.",
	"The success or lack thereof of a NetHack character should not depend on whether a general store did generate. In fact, price identification is bad and shouldn't be a thing that exists, because it's so cumbersome to do yet you have to do it with every new character unless you want to deliberately face lower odds of success. Can't we just ditch that mechanic and make it easier to identify items via other means, e.g. by increasing the average amount of stuff IDed by an ID scroll?",
	"Here lies a spirit assassin. The player was constantly wallwalking everywhere for hundreds of turns straight despite knowing that doing so would attract the fluidators, and then complained that there was no 'paranoid wallwalking confirmation'. Since the player was obviously inclined to wallwalk all the damn time anyway, no amount of paranoid wallwalking would've helped him and his claim that the lack of that option made him quit is invalid, really he quit because the fluidators are a thing at all because he was obviously too used to earlier SLEX versions that didn't have them.",
	"Here lies the players' interest in playing wallwalking races. Amy added the fluidators as a way to balance the OPness of wallwalking chars because in early SLEX versions those were kinda very popular due to their awesome power; while none of the players in question ever really met a lot of fluidators, and none had been killed by fluidators, their mere existence was somehow enough to get all those players to quit playing. So the nerf 'worked', even if it wasn't in the way it was originally intended. Guess video game players in the current modern times really are spoiled and want to play only instant-gratification games where you can easily no-brainer your way to victory without any challenge whatsoever.",
