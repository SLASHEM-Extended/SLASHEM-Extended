...
"monsters should not spawn with wands of disintegration before level 20 because i noob and i forgot that items not have levels in this game",
	...
	"The monsters on FIQhack's Astral Plane spammed 200 charges of their create monster wands and then the things that got created also had wands of create monster and then I got cornered by a couple Archons and died.",
	"Well that FIQhack monster was just regenerating health way too quickly and therefore I couldn't kill it.",
	"Some player monster in FIQhack spawned with a wand of death and was skilled at wands of course, and someone decided that that causes the wand to create a death field that cannot be reflected, so I died despite having a shield of reflection.",
	"I found out the hard way that if I'm polymorphed into a foocubus in FIQhack, I cannot seduce monsters despite that variant claiming to be fully monster-player symmetrical. Not wanting to live in a world ruled by prudery, I then zapped my wand of death (the one between my legs, you know, I was an incubus after all) in . direction and now I'll play SLEX instead.",
	...
	"Some FIQhack monster zapped a wand of cancellation at my wizard and that was some A-grade bullshit, I tell you. I had a goddamn cloak of magic resistance, and in SLEX that would protect against cancellation because SLEX is well-designed!",
	"Some FIQhack monster zapped a wand of slow monster at me and since there is no defense against that, the air elementals and angels and mastodons and whatnot then proceeded to kick the crap out of me. Next time I'll play SLEX instead, where wands of inertia are rare enough to be balanced.",
	...
	"Got some bullshit stack bashing segfault core dump desktop panic, and on the prompt that asks if the game can be recovered automatically, I annoyedly hit 'y' to say 'yes, recover it'. But some MOTHER FUCKER made it so that 'y' means 'yes, delete it' AND DID NOT ADD A FAILSAFE TO ASK WHETHER YOU REALLY WANT TO DELETE IT!!! RAAAAAAAAAAAAARGH",
	"I had almost finished playing that level and then the game segfaulted, and when I tried to play through it again because someone made it so that the game never autosaves unless you switch levels, I died. Bullshit.",
	...
	"Fuck fourk's alignment system. I have a fucking cursed ring of levitation stuck on me. I pray and god decides that my polymorph form is bigger problem than that shitty ring. After a while I start having serious issues with hunger, so I pray again and this time I get fucking punished! Dude...", /* by Winsalot */
	...
	"Forgot that I was playing Splicehack, and died to a Nethack 3.6.x change. Next time I'm playing a variant of vanilla again.",
	"Man, why couldn't the xnethack author base its variant on vanilla??? Now I died because of something the 3.6.x devteam had committed! This is stupid! If I play a variant, I want to lose the game for reasons unique to the variant in question!",
	"Okay this variant is stupid, in vanilla I would have lived. Curse the devs that made the variant that calls itself 3.6.x, which is very obviously not vanilla anymore!",
	"Died to something retarded.",
	"I realized that the variant I was playing got invaded by SJWisms, and decided to not play it anymore. My next character will be a SLEX one, that's for sure.",
	"RIP diversity, killed by the SJWs.",
	"RIP freedom of speech, killed by the SJW thought police.",
	"RIP poofy coffee, killed by the ubersjws that would even butcher Izchak's original lines for bullshit 'political correctness' reasons.",
	...
	"Here lies a sporkhack valkyrie whose savegame got mangled into an unrecoverable chunk because the genius variant developer somehow butchered the game's ability to keep a .0 file in the playground.",
	...
	"Here lies dnethack, killed by the SJWs. No, 'poofy' is not an insult. If it is, it definitely isn't one in the NetHack context. Heck, actual gay men said they didn't consider it insulting.",
	"Here lies your memory, put in this grave after your brain was sucked by a mind flayer.",
	"RIP permablind conduct, killed by the stuuuuupid devs making it so that the Eyes of the Overworld ignore the birth option instead of simply not allowing you to see.",
	...
	"RIP user-friendliness, killed by the devs' insistence on not allowing us to target the scroll of enchant armor when we're wearing many armor pieces.",
	"RIP playability, killed by FIQhack. Now you live or die on a crapshoot, because if a monster gets the wrong musable item it will fuck you up and there's no way to counter that.",
	"RIP full player-monster symmetry, killed by FIQ's prudery. Give us foocubus seduction messages dammit!",
	...
	"Another victim of the torture machine that is called FIQhack.",
	"DCSS autoexplore caused me to autoexplore into a dead end, and when I wanted to walk back out the way I came, there were 200 yaks and basilisks and Sigmunds and whatnot so I died with zero chance. How do I genocide the autoexplore hotkey?",
	...
	"We buried some fool here who tried to pull down a muslim woman's headcloth in public. She hired a bunch of measurer men who stabbed him.",
