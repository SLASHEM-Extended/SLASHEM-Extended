...
"monsters should not spawn with wands of disintegration before level 20 because i noob and i forgot that items not have levels in this game",
	...
	"Most development time of the various non-SLEX variants (including vanilla nethack) went into the early and mid-game. That's why the late game is dull and repetitive: because there weren't enough resources to make as many different versions of the later special levels as there are versions of minetown and mines end. Roguelikes live and die with variety, and in the late game you get the same boring special level levels every. single. time. you play through the game, making it an incredibly monotonous and sleep-inducing grind.",
