 ...
 */
	...
	if (u.legscratching > 1 && !Role_if(PM_BLEEDER) && !BloodLossProblem && !u.uprops[BLOOD_LOSS].extrinsic && moves % 1000 == 0) u.legscratching--; /* always time out once per 1000 turns --Amy */
