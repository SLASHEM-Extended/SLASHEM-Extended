 ...
 make_bones:
	...
	for (mtmp = fmon; mtmp; mtmp = mtmp->nmon) {
	    ...
	    if (mtmp->iswiz || mptr == &mons[PM_MEDUSA] ||
		    (mptr->msound == MS_NEMESIS &&  mptr->mlet != S_NEMESE && mptr != &mons[PM_STARLIT_SKY] && mptr != &mons[PM_DARK_STARLIT_SKY] && mptr != &mons[PM_BLACK_STARLIT_SKY] && mptr != &mons[PM_RED_STARLIT_SKY] && mptr != &mons[PM_BROWN_STARLIT_SKY] && mptr != &mons[PM_GREEN_STARLIT_SKY] && mptr != &mons[PM_PURPLE_STARLIT_SKY] && mptr != &mons[PM_YELLOW_STARLIT_SKY] && mptr != &mons[PM_ORANGE_STARLIT_SKY] && mptr != &mons[PM_CYAN_STARLIT_SKY] && mptr != &mons[PM_VIOLET_STARLIT_SKY] && mptr != &mons[PM_TRUE_MISSINGNO] && mptr != &mons[PM_ETHEREAL_MISSINGNO]) || mptr->msound == MS_LEADER ||
