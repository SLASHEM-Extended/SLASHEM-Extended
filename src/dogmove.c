...
register struct monst *mtmp;
{
	...
	if (u.arti_carry_barksters) return FALSE;
...
#define GDIST(x,y) (dist2(x,y,gx,gy))
	...
	/* extra check for priests, because roamers might not have ispriest set */
			 ((mtmp2->data == &mons[PM_ALIGNED_PRIEST] || mtmp2->data == &mons[PM_MASTER_PRIEST] || mtmp2->data == &mons[PM_EXPERIENCED_PRIEST] || mtmp2->data == &mons[PM_EXCEPTIONAL_PRIEST] || mtmp2->data == &mons[PM_ELITE_PRIEST] || mtmp2->data == &mons[PM_DNETHACK_ELDER_PRIEST_TM_] || mtmp2->data == &mons[PM_HIGH_PRIEST]) && !issoviet && mtmp2->malign <= 0 && (int)EPRI(mtmp2)->shralign != A_NONE ) ||
