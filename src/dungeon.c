...
struct level_map {
	...
	{ "medus",	&medusa_level },
	{ "jfmai",	&jefferson1_level },
	{ "jfmid",	&jefferson2_level },
	{ "jfsub",	&jefferson3_level },
	{ "jftfa",	&jefferson4_level },
	{ "jftfb",	&jefferson5_level },
...
level_difficulty()
{
	...
	if (DifficultyIncreased || u.uprops[DIFFICULTY_INCREASED].extrinsic || have_difficultystone() || (uimplant && uimplant->oartifact == ART_LAURENA_S_ALTERNATIVE) || (uarmc && uarmc->oartifact == ART_VINTO_MOBILE) || Race_if(PM_PLAYER_DYNAMO) || autismweaponcheck(ART_ARABELLA_S_BLACK_PRONG) || autismweaponcheck(ART_HOL_ON_MAN) || autismweaponcheck(ART_PWNHAMMER_DUECE) || (uarm && uarm->oartifact == ART_ASTRA_MAIL) || autismweaponcheck(ART_CUDGEL_OF_CUTHBERT) || autismweaponcheck(ART_ONE_THROUGH_FOUR_SCEPTER) ) retvalue += 10;
	if (DifficultyIncrXtra) retvalue += 10;
