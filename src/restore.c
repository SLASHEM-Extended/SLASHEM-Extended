...
unsigned int *stuckid, *steedid;	/* STEED */
{
	...
	if (!uwep || uwep->otyp == PICK_AXE || uwep->otyp == CONGLOMERATE_PICK || uwep->otyp == CONUNDRUM_PICK || uwep->otyp == SHOVEL || uwep->otyp == MYSTERY_PICK || uwep->otyp == BRONZE_PICK || uwep->otyp == BRICK_PICK || uwep->otyp == NANO_PICK || uwep->otyp == GRAPPLING_HOOK ||
