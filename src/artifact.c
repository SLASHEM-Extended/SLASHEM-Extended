...
init_randarts()
{
	...
	artilist[ART_PLAY_FIGUT_EIGHT].otyp = randartmeleeweapon();
	...
	artilist[ART_ADELISA_S_HIDING_GAME].otyp = randartring();
	artilist[ART_LAISHA_DEAL].otyp = randartring();
	...
	artilist[ART_LIGNES_ENZYMES].otyp = randartcloak();
	...
	artilist[ART_GLENNIS_DOWNS].otyp = randartgloves();
	...
	artilist[ART_JABINE_S_ORTHOGRAPHY].otyp = randartboots();
	...
	artilist[ART_ROSINE_S_RAISE].otyp = randartamulet();
	artilist[ART_RAYVON_S_BEAM].otyp = randartamulet();
	...
	artilist[ART_SHARDS_BRING_LUCK].otyp = randartpolearm();
	...
	artilist[ART_FIRSTACKE].otyp = randartknife();
	...
	artilist[ART_WHILEHOLD].otyp = randartlightsaber();
	...
	artilist[ART_BLACK_MAW].otyp = randarttwohandedsword();
	artilist[ART_EXTREME_ENCHANTMENT].otyp = randarttwohandedsword();
	...
	artilist[ART_STOP_THE_SCRIPT_NONSENSE].otyp = randartclaw();
	...
	artilist[ART_MARIKE_S_WALL_BUTT].otyp = randartsaddle();
	artilist[ART_VANCE_S_TAX].otyp = randartsaddle();
	artilist[ART_YET_ANOTHER__JUST_WATCH].otyp = randartsaddle();
	artilist[ART_AUTORA].otyp = randartsaddle();
	...
	artilist[ART_ROWALLAN_S_BALLING].otyp = randartbootsX();
	...
	artilist[ART_BALL_SHOT_].otyp = randartmeleeweaponX();
	artilist[ART_ALL_IN_ALL_IS_THE_BEST_BAC].otyp = randartmeleeweaponX();
	...
	artilist[ART_SHOTTE_RAIGHT].otyp = randartbowX();
	...
	artilist[ART_ADELAIDE_S_RACING].otyp = randartamuletX();
	...
	artilist[ART_STOCKTON_BRAND].otyp = randartshirtX();
	artilist[ART_DAMAGO_KLARA].otyp = randartshirtX();
	...
	artilist[ART_ALCHEM_LOAD].otyp = randartpotionX();
	artilist[ART_JOHN_CALEB_S_INGENIOSITY].otyp = randartpotionX();
	artilist[ART_WONDER_WATERING_PLACE].otyp = randartpotionX();
	artilist[ART_ULTRALASER].otyp = randartscrollX();
	artilist[ART_SCRIBBELN].otyp = randartscrollX();
	...
	artilist[ART_P_U_E_U_U_U].otyp = randartcrossbowX();
	...
	artilist[ART_WARBOEMMEN].otyp = randartmaceX();
	...
	artilist[ART_ANIMO_EATER].otyp = randarttridentX();
	...
	artilist[ART_FEEBILITY].otyp = randartflailX();
	...
	artilist[ART_BANGSPRANG].otyp = randartclubX();
	...
	artilist[ART_WEE_HOUR_EFFECT].otyp = randartmorningstarX();
	...
	artilist[ART_MOST_IS_NOT_A_GOOD_TERM].otyp = randartlongswordX();
	...
	artilist[ART_FLIUFLIUFLIUFLIUFLIUUUUU_].otyp = randartdartX();
	...
	artilist[ART_BROADWPN_HEAD].otyp = randartbroadswordX();
	artilist[ART_MCCAULEY_S_INTELLIGENCE].otyp = randartbroadswordX();
	artilist[ART_NARROWNESSCAPE].otyp = randartshortswordX();
	...
	artilist[ART_DEATH_MAW].otyp = randarttwohandedswordX();
	...
	artilist[ART_KERSIE_PERSIE].otyp = randartsaddleX();
	artilist[ART_MILAGROS_CURVE].otyp = randartsaddleX();
	artilist[ART_WI_O_WI_O_WACKIWE_].otyp = randartsaddleX();
...
init_appearance_randarts()
{
	...
	artilist[ART_HIGHEST_FEELING].otyp = find_appearance_armor(APP_FETISH_HEELS);
	artilist[ART_VORPAL_HEELS].otyp = find_appearance_armor(APP_FETISH_HEELS);
	artilist[ART_LORSKEL_S_INTEGRITY].otyp = find_appearance_armor(APP_LOLITA_BOOTS);

	artilist[ART_TANGO_HEELS].otyp = find_appearance_armor(APP_SEXY_HEELS);
	artilist[ART_BRAVO_HELMET].otyp = find_appearance_armor(APP_MUSICAL_HELMET);
	artilist[ART_PHANTOM_OF_THE_OPERA].otyp = find_appearance_armor(APP_OPERA_CLOAK);
	artilist[ART_HIGH_DESIRE_OF_FATALITY].otyp = find_appearance_armor(APP_EXPLOSIVE_BOOTS);
	artilist[ART_CHOICE_OF_MATTER].otyp = find_appearance_armor(APP_IRREGULAR_BOOTS);
	artilist[ART_MELISSA_S_BEAUTY].otyp = find_appearance_armor(APP_WEDGE_BOOTS);
	artilist[ART_CORINA_S_SNOWY_TREAD].otyp = find_appearance_armor(APP_WINTER_STILETTOS);
	artilist[ART_NUMBER___].otyp = find_appearance_armor(APP_ALUMINIUM_HELMET);
	artilist[ART_HAUNTNIGHT].otyp = find_appearance_armor(APP_GHOSTLY_CLOAK);
	artilist[ART_LORSKEL_S_SPECIAL_PROTECTI].otyp = find_appearance_armor(APP_POLNISH_GLOVES);
	artilist[ART_VULTUREHANDLER].otyp = find_appearance_armor(APP_FALCONRY_GLOVES);
	artilist[ART_MOUNTAIN_FISTS].otyp = find_appearance_armor(APP_FENCING_GLOVES);

	artilist[ART_OFFZEEH_BRUN].otyp = find_appearance_armor(APP_ENARMORING_BOOTS);
	artilist[ART_PORYSTONE].otyp = find_appearance_armor(APP_GEOMETRY_HEELS);
	artilist[ART_MARC_S_SOMEWHAT_EQUIP].otyp = find_appearance_armor(APP_RUSTPRONE_BOOTS);
	artilist[ART_WINGELWINGELWINGEL].otyp = find_appearance_armor(APP_GIRL_BOOTS);
	artilist[ART_ADHS_DIAGNOSIS].otyp = find_appearance_armor(APP_BOY_BOOTS);
	artilist[ART_DON_T_RUN_IN_FEAR].otyp = find_appearance_armor(APP_SUPER_BOOTS);
	artilist[ART_VERY_WARM_TYPE].otyp = find_appearance_armor(APP_WARM_WERDING_BOOTS);
	...
	artilist[ART_FUNGUS_ERADICATION].otyp = find_appearance_armor(APP_COPPER_STILETTOS);
	artilist[ART_POI_SEN_SUX].otyp = find_appearance_armor(APP_FAILUNCAP_SHOES);
	artilist[ART_DO_NOT_FEAR_DEATH].otyp = find_appearance_armor(APP_SPOOKY_BOOTS);
	artilist[ART_BACKPLAYSHILD].otyp = find_appearance_armor(APP_GENTLE_SNEAKERS);
	artilist[ART_COLDCLINK].otyp = find_appearance_armor(APP_PORCELAIN_SANDALS);
	artilist[ART_WANNA_BE_THE_BEST].otyp = find_appearance_armor(APP_RAINBOW_BOOTS);
	artilist[ART_RIDE_CONTROL].otyp = find_appearance_armor(APP_RIDING_BOOTS);
	artilist[ART_TURBOSHRINE].otyp = find_appearance_armor(APP_GENTLE_BOOTS);
	artilist[ART_TOAD_S_CONTROL_BUTTON].otyp = find_appearance_armor(APP_BUCKLED_BOOTS);
	artilist[ART_SPRUNGUNG_GAME].otyp = find_appearance_armor(APP_SPIDER_BOOTS);
	artilist[ART_WOOT_WOOT].otyp = find_appearance_armor(APP_BATTLE_BOOTS);
	artilist[ART_TANK_SOLE_PAIR].otyp = find_appearance_armor(APP_PLATFORM_BOOTS);
	artilist[ART_RINGFIGHTER_S_GUARD].otyp = find_appearance_armor(APP_COMBAT_BOOTS);
	artilist[ART_STRONGEST_STOMP].otyp = find_appearance_armor(APP_JUNGLE_BOOTS);
	artilist[ART_NOSE_FINDER].otyp = find_appearance_armor(APP_BRAND_NEW_GLOVES);
	artilist[ART_POWERORB_BOOSTING].otyp = find_appearance_armor(APP_SILK_FINGERLINGS);
	artilist[ART_FAILMASTER_S_BOREDOM].otyp = find_appearance_armor(APP_FAILUNCAP_GLOVES);
	artilist[ART_FILLGERS_OF_ARCANE].otyp = find_appearance_armor(APP_OCCULTISM_GLOVES);
	artilist[ART_NOTHAL_SMILEY].otyp = find_appearance_armor(APP_TECHNICAL_HELMET);
	artilist[ART_EKOLOT_L].otyp = find_appearance_armor(APP_FREQUENT_HELMET);
	artilist[ART_LIGHTSPYGEL].otyp = find_appearance_armor(APP_MIRRORED_GLOVES);
	artilist[ART_GAMBLEGAMBLEGAMBLEGAMBLE_D].otyp = find_appearance_armor(APP_GAMBLING_GLOVES);
	artilist[ART_JUSTKIT_PART].otyp = find_appearance_armor(APP_SELF_TYPE_HELMET);
	artilist[ART_LADDERSORRY_TEARS].otyp = find_appearance_armor(APP_WEEPING_HELMET);
	artilist[ART_GAME_IS_NOW_FULL_OF_BUGS].otyp = find_appearance_armor(APP_BLUY_HELMET);
	artilist[ART_ENWAHSTER].otyp = find_appearance_armor(APP_FAILUNCAP_HELMET);
	artilist[ART_DEEPERBREATH].otyp = find_appearance_armor(APP_NARROW_HELMET);
	artilist[ART_SEENBC].otyp = find_appearance_armor(APP_KNOWLEDGEABLE_HELMET);
	artilist[ART_MORE_RESISTANT_TO_DRAIN_LI].otyp = find_appearance_armor(APP_RNG_HELMET);
	artilist[ART_GHOSTER_VISOR].otyp = find_appearance_armor(APP_VISORED_HELMET);
	artilist[ART_SAMIRA_S_EXPRESSION].otyp = find_appearance_armor(APP_MASKED_HELMET);
	artilist[ART_CONTROGLARE].otyp = find_appearance_armor(APP_ORANGE_VISORED_HELMET);
	artilist[ART_SONG_REMEMBERANCE].otyp = find_appearance_armor(APP_RADIO_HELMET);
	artilist[ART_NATALIA_S_PROTECTOR_POWER].otyp = find_appearance_armor(APP_RIFLING_POWER_CLOAK);
	artilist[ART_KLAUUNG].otyp = find_appearance_armor(APP_FAILUNCAP_CLOAK);
	artilist[ART_X__TOKEN].otyp = find_appearance_armor(APP_ENCHANTMENT_CLOAK);
	artilist[ART_HANNAH_S_INNOCENCE].otyp = find_appearance_armor(APP_CUDDLE_BOOTS);
	artilist[ART_PANZER_MANTLE].otyp = find_appearance_armor(APP_KEVLAR_CLOAK);
	artilist[ART_HUNTING_TIME_HINT].otyp = find_appearance_armor(APP_HUNGRY_CLOAK);
	artilist[ART_LIFEHOLD_VALUE].otyp = find_appearance_armor(APP_SCIENCE_CLOAK);
	artilist[ART_SEE_THE_MONO_WORLD].otyp = find_appearance_armor(APP_COLORFADE_CLOAK);
	artilist[ART_SVEN_S_LAUGHING].otyp = find_appearance_armor(APP_SLOWING_GOWN);
	artilist[ART_PIERCELIGHT].otyp = find_appearance_armor(APP_HEARING_CLOAK);
	artilist[ART_WINDER_WANDER].otyp = find_appearance_armor(APP_ROADMAP_CLOAK);
	artilist[ART_CURIE_S_WHOLE_LIFE].otyp = find_appearance_armor(APP_CYANISM_CLOAK);
	artilist[ART_IS_THE_NOT_SO_VERY_MYSTERI].otyp = find_appearance_armor(APP_SHROUDED_CLOAK);
	artilist[ART_ADRIA_S_MIMICKING].otyp = find_appearance_armor(APP_SHROUDED_CLOAK);
	artilist[ART_INVISOGOWN].otyp = find_appearance_armor(APP_MYSTERIOUS_CLOAK);
	artilist[ART_GRAY_DOESN_T_CHANGE_ANYMOR].otyp = find_appearance_armor(APP_STRAITJACKET_CLOAK);
	artilist[ART_HARD_CHEST_GRIN].otyp = find_appearance_armor(APP_ANGELIC_CLOAK);
	artilist[ART_EARRING_STOLEN].otyp = find_appearance_armor(APP_CHANGING_CLOAK);
	artilist[ART_CHARGEUP_CELL].otyp = find_appearance_armor(APP_ENERGIZER_CLOAK);
	artilist[ART_BLOND_ANTICLICHE].otyp = find_appearance_armor(APP_ELECTROSTATIC_CLOAK);
	artilist[ART_ANTIBLACK_AURA].otyp = find_appearance_armor(APP_PINK_CLOAK);
	artilist[ART_DISS_PLACE].otyp = find_appearance_armor(APP_GRASS_CLOAK);
	artilist[ART_STEAD_FAST].otyp = find_appearance_armor(APP_GRAVITY_CLOAK);
	artilist[ART_MARC_S_MANAFILL].otyp = find_appearance_armor(APP_GEEK_CLOAK);
	artilist[ART_SOMEDAY_S_USENESS].otyp = find_appearance_armor(APP_WITHERED_CLOAK);
	artilist[ART_MERRY_S_HELP].otyp = find_appearance_armor(APP_IGNORANT_CLOAK);
	artilist[ART_ARABELLA_S_SAFETY_EQUIPMEN].otyp = find_appearance_armor(APP_FLEECY_COLORED_CLOAK);
	artilist[ART_EXTRASHOCK].otyp = find_appearance_armor(APP_FLASH_CLOAK);
	...
	artilist[ART_ASTER_IX_BOOKLET].otyp = find_appearance_armor(APP_ROMAN_SANDALS);
	artilist[ART_MARIA_S_FLEECLE_FLOPS].otyp = find_appearance_armor(APP_FLIPFLOPS);
	artilist[ART_ANASTASIA_S_PLAYTIME].otyp = find_appearance_armor(APP_HEAP_OF_SHIT_BOOTS);
	artilist[ART_LE_MOUVEMENT_DE_LA_BOUCHE_].otyp = find_appearance_armor(APP_BISE_GLOVES);
	artilist[ART_NIA_S_NEAR_MISS].otyp = find_appearance_armor(APP_SUREFIRE_GLOVES);
	artilist[ART_NINA_S_NONCOOPERATION].otyp = find_appearance_armor(APP_CLUNKY_HEELS);
	artilist[ART_UP_UP_UP_AD_NAUSEAM].otyp = find_appearance_armor(APP_INVERSE_GLOVES);
	artilist[ART_COUNT_DOWN_FROM___].otyp = find_appearance_armor(APP_LESS_HELMET);
	artilist[ART_LEHOBAUM].otyp = find_appearance_armor(APP_THINKING_HELMET);
	artilist[ART_ALEJANDRA_S_EDUCATION].otyp = find_appearance_armor(APP_STRIP_BANDANA);
	artilist[ART_SHIT_].otyp = find_appearance_armor(APP_FILTERED_HELMET);
	artilist[ART_ORNA_S_DOUBLE].otyp = find_appearance_armor(APP_DIFFERENT_CLOAK);
	artilist[ART_DRIVECHAIR_OF_ETERNITY].otyp = find_appearance_armor(APP_UP_DOWN_CLOAK);
	artilist[ART_TOLLEGAL_WRIGHT].otyp = find_appearance_armor(APP_RUNIC_GLOVES);
	artilist[ART_ENA_WUSELEY].otyp = find_appearance_armor(APP_FUR_BOOTS);
	artilist[ART_GERMAN_CHANCELLOR_SAYS_].otyp = find_appearance_armor(APP_POLITICIAN_CLOAK);
	artilist[ART_TECH_OF_X].otyp = find_appearance_armor(APP_LATEX_GLOVES);
	artilist[ART_ROBBERY_GONE_RIGHT].otyp = find_appearance_armor(APP_POLNISH_GLOVES);
	artilist[ART_JOSEFINE_S_EVILNESS].otyp = find_appearance_armor(APP_VELCRO_BOOTS);
	artilist[ART_WHINY_MARY].otyp = find_appearance_armor(APP_CLUMSY_GLOVES);
	artilist[ART_WARP_SPEED].otyp = find_appearance_armor(APP_FIN_BOOTS);
	artilist[ART_LOIS_S_CHILL].otyp = find_appearance_armor(APP_WINTER_BOOTS);
	artilist[ART_ISHITA_S_OVERWHELMING].otyp = find_appearance_armor(APP_PETRIFIED_CLOAK);
	artilist[ART_PECTORAL_HEEL].otyp = find_appearance_armor(APP_FIN_BOOTS);
	artilist[ART_GRENEUVENIA_S_HUG].otyp = find_appearance_armor(APP_PROFILED_BOOTS);
	artilist[ART_SHELLY].otyp = find_appearance_armor(APP_VOID_CLOAK);
	artilist[ART_SPREAD_YOUR_LEGS_WIDE].otyp = find_appearance_armor(APP_GREY_SHADED_GLOVES);
	artilist[ART_GREEB].otyp = find_appearance_armor(APP_WEEB_CLOAK);
	...
	artilist[ART_PERCENTIOEOEPSPERCENTD_THI].otyp = find_appearance_armor(APP_MANTLE_OF_COAT);
	artilist[ART_PEEPING_GROOVE].otyp = find_appearance_armor(APP_FATAL_GLOVES);
	artilist[ART_TURN_INTO_THE_NORM].otyp = find_appearance_armor(APP_LEATHER_GLOVES);
	artilist[ART_RARE_ASIAN_LADY].otyp = find_appearance_armor(APP_BEAUTIFUL_HEELS);
	artilist[ART_JANA_S_FAIRNESS_CUP].otyp = find_appearance_armor(APP_HOMICIDAL_CLOAK);
	artilist[ART_OUT_OF_TIME].otyp = find_appearance_armor(APP_CASTLEVANIA_BOOTS);
	artilist[ART_DISINT_BEAM].otyp = find_appearance_armor(APP_LEAD_HELMET);
	artilist[ART_COMMANDER_S_RECIPIENT].otyp = find_appearance_armor(APP_RUMBLE_BOOTS);
	artilist[ART_TEAM_BRIDE].otyp = find_appearance_armor(APP_PURE_CLOAK);
	artilist[ART_KATHERINE_S_BEACHWEAR].otyp = find_appearance_armor(APP_TANKINI);
	artilist[ART_PALEOLITHIC_ELBOW_CONTRACT].otyp = find_appearance_armor(APP_GREEK_CLOAK);
	artilist[ART_FEATHER_LIGHT].otyp = find_appearance_armor(APP_FLIER_CLOAK);
	artilist[ART_NUCLEAR_BOMB].otyp = find_appearance_armor(APP_CELTIC_HELMET);
	artilist[ART_BABY_JOYN_ME_IN_THERE].otyp = find_appearance_armor(APP_NETRADIATION_HELMET);
	artilist[ART_DOUBLE_ARROW_NOSE].otyp = find_appearance_armor(APP_JARRING_CLOAK);
	artilist[ART_MESSEN_PLES].otyp = find_appearance_armor(APP_DEEP_CLOAK);
	artilist[ART_DOGGERSEE].otyp = find_appearance_armor(APP_DOGBONE_HELMET);
	artilist[ART_HABIBA_S_MATRONAGE].otyp = find_appearance_armor(APP_HARDCORE_CLOTH);
	artilist[ART_BEEEEEEEANPOLE].otyp = find_appearance_armor(APP_ENGLISH_GLOVES);
	artilist[ART_LEGMA].otyp = find_appearance_armor(APP_KOREAN_SANDALS);
	artilist[ART_BRITTA_S_MURDER_STORY].otyp = find_appearance_armor(APP_SLING_PUMPS);
	artilist[ART_TERRY_PRATCHETT_S_INGENUIT].otyp = find_appearance_armor(APP_OCTARINE_ROBE);
	artilist[ART_HARDUP].otyp = find_appearance_armor(APP_METAL_FOCUS_ROBE);
	artilist[ART_ANTOCONT].otyp = find_appearance_armor(APP_SUPER_HEAVY_ROBE);
	artilist[ART_SMALLIST].otyp = find_appearance_armor(APP_GROMY_ROBE);
	artilist[ART_MYSTIOSITY].otyp = find_appearance_armor(APP_MAGICPROT_ROBE);
	artilist[ART_TANKSTA_S_SUIT].otyp = find_appearance_armor(APP_ARMORED_ROBE);
	artilist[ART_SATAN_S_REVERENCE].otyp = find_appearance_armor(APP_VANILLIC_ROBE);
	artilist[ART_MOTA_ROLA].otyp = find_appearance_armor(APP_FOCUSED_ROBE);
	artilist[ART_WOOHOO_AMATEURHOUR_].otyp = find_appearance_armor(APP_SUPERFOCUSED_ROBE);
	artilist[ART_IDENTIFYING].otyp = find_appearance_armor(APP_EASY_ID_ROBE);
	artilist[ART_DERANDERGRAAA].otyp = find_appearance_armor(APP_FACELESS_ROBE);
	artilist[ART_ARABELLA_S_SEXY_GIRL_BUTT].otyp = find_appearance_armor(APP_CHINESE_CLOAK);
	artilist[ART_LONG_LASTING_JOY].otyp = find_appearance_armor(APP_POLYFORM_CLOAK);
	artilist[ART_LIGHT_ABSORPTION].otyp = find_appearance_armor(APP_ABSORBING_CLOAK);
	artilist[ART_CATHERINE_S_SEXUALITY].otyp = find_appearance_armor(APP_BIRTHCLOTH);
	artilist[ART_POKEWALKER].otyp = find_appearance_armor(APP_POKE_MONGO_CLOAK);
	artilist[ART_WINDS_OF_CHANGE].otyp = find_appearance_armor(APP_LEVUNTATION_CLOAK);
	artilist[ART_LIGHTSPEED_TRAVEL].otyp = find_appearance_armor(APP_QUICKTRAVEL_CLOAK);
	artilist[ART_T_O_M_E].otyp = find_appearance_armor(APP_ANGBAND_CLOAK);
	artilist[ART_FEMMY_FATALE].otyp = find_appearance_armor(APP_ANOREXIA_CLOAK);
	artilist[ART_ARTIFICIAL_FAKE_DIFFICULTY].otyp = find_appearance_armor(APP_DNETHACK_CLOAK);
	artilist[ART_JUNETHACK______WINNER].otyp = find_appearance_armor(APP_TEAM_SPLAT_CLOAK);
	artilist[ART_YOG_SOTHOTH_HELP_ME].otyp = find_appearance_armor(APP_ELDRITCH_CLOAK);
	artilist[ART_TOMORROW_WENDY_S_CHOICENA].otyp = find_appearance_armor(APP_DEADLY_CLOAK);
	artilist[ART_LUISA_S_IRRESISTIBLE_CHARM].otyp = find_appearance_armor(APP_EROTIC_BOOTS);
	artilist[ART_JANA_S_DECEPTIVE_MASK].otyp = find_appearance_armor(APP_SECRET_HELMET);
	artilist[ART_NOW_IT_BECOMES_DIFFERENT].otyp = find_appearance_armor(APP_DIFFICULT_CLOAK);
	artilist[ART_NATASCHA_S_STROKING_UNITS].otyp = find_appearance_armor(APP_VELVET_GLOVES);
	artilist[ART_SPEAK_TO_OJ].otyp = find_appearance_armor(APP_SPUTA_BOOTS);
	artilist[ART_SUNA_S_CONTROVERSY_MATTER].otyp = find_appearance_armor(APP_STROKING_BOOTS);
	artilist[ART_INGRID_S_SECRETARY_OFFICE].otyp = find_appearance_armor(APP_BONE_HEELS);
	artilist[ART_FOLLOWBSSSSS].otyp = find_appearance_armor(APP_SENSOR_GLOVES);
	artilist[ART_CURVATURE_OF_THE_SET].otyp = find_appearance_armor(APP_POWERSAVE_ROBE);
	artilist[ART_DUE_DUE_DUE_DUE_BRMMMMMMM].otyp = find_appearance_armor(APP_FORMULA_ONE_HELMET);
	artilist[ART_TOILET_NOISES].otyp = find_appearance_armor(APP_EXCREMENT_CLOAK);
	artilist[ART_LINE_CAN_PLAY_BY_YOURSELF].otyp = find_appearance_armor(APP_RACER_GLOVES);
	artilist[ART_TOO_FAST__TOO_FURIOUS].otyp = find_appearance_armor(APP_TURBO_BOOTS);
	artilist[ART_NOUROFIBROMA].otyp = find_appearance_armor(APP_GUILD_CLOAK);
	artilist[ART_MADELINE_S_STUPID_GIRL].otyp = find_appearance_armor(APP_SHITTY_GLOVES);
	artilist[ART_ELARA_S_AGILITY].otyp = find_appearance_armor(APP_DEXTROUS_GLOVES);
	artilist[ART_GET_THE_BUC_K_].otyp = find_appearance_armor(APP_BUCKLOAK);
	artilist[ART_ARVOGENIA_S_BIKER_HEELS].otyp = find_appearance_armor(APP_STONE_CARVED_HEELS);
	artilist[ART_EI_KEN_WOOK_WIF_DIS].otyp = find_appearance_armor(APP_STUPID_STILETTOS);
	artilist[ART_PRECURSOR_TO_THE___].otyp = find_appearance_armor(APP_HOMO_SHOES);
	artilist[ART_HEELMARJI].otyp = find_appearance_armor(APP_DEVIL_LETTUCE_SHOES);
	artilist[ART_SHE_S_STILL_AN_ANASTASIA].otyp = find_appearance_armor(APP_LOAFERS);
	artilist[ART_SING_AND_JULIETTA_S_JOINT_].otyp = find_appearance_armor(APP_ANTISUCK_HELMET);
	artilist[ART_DARKFLECT].otyp = find_appearance_armor(APP_CHESS_BOOTS);
	artilist[ART_ELIZAH_S_SINKER].otyp = find_appearance_armor(APP_OTTING_BOOTS);
	artilist[ART_HANH_S_UNEXPECTED_POWER].otyp = find_appearance_armor(APP_BALLERINAS);
	artilist[ART_MY_DEAR_SLAVE].otyp = find_appearance_armor(APP_PLATEAU_BOOTS);
	artilist[ART_JONACE_S_TALLNESS].otyp = find_appearance_armor(APP_PLATINUM_STILETTOS);
	artilist[ART_ABRASIVE_RUPIKA].otyp = find_appearance_armor(APP_HIGH_IRON_BOOTS);
	artilist[ART_NUDE_PUNAM].otyp = find_appearance_armor(APP_SLEXUAL_CLOAK);
	artilist[ART_EDNA_S_CALM].otyp = find_appearance_armor(APP_GENTLE_CLOAK);
	artilist[ART_DORIKA_S_COLORBLOCK].otyp = find_appearance_armor(APP_SUPER_COMFY_HEELS);
	artilist[ART_ZUNI_S_IRIDESCENCE].otyp = find_appearance_armor(APP_WISHFUL_CLOAK);
	artilist[ART_HOBART_THE_GOLDEN].otyp = find_appearance_armor(APP_DIGGER_GLOVES);
	artilist[ART_KILLCAP].otyp = find_appearance_armor(APP_SWEATY_SHOES);
	artilist[ART_KATHARINA_S_SIGH].otyp = find_appearance_armor(APP_WHITE_BUFFALO_BOOTS);
	artilist[ART_THICK_PLATFORM_CRAZE].otyp = find_appearance_armor(APP_WHITE_BUFFALO_BOOTS);
	artilist[ART_SASSY_JULIA].otyp = find_appearance_armor(APP_SISTER_SHOES);
	artilist[ART_POCAHONTAS_HOME].otyp = find_appearance_armor(APP_SISTER_SHOES);
	artilist[ART_SOFT_ON_THE_CLOUD].otyp = find_appearance_armor(APP_SISTER_SHOES);
	artilist[ART_WIDEFORCE_GRIP].otyp = find_appearance_armor(APP_HOOKED_GLOVES);
	artilist[ART_HEME_FLOW].otyp = find_appearance_armor(APP_BLADED_DISKS);
	artilist[ART_CRUSH_THE_OPPOSITION].otyp = find_appearance_armor(APP_ATLAS_GLOVES);
	artilist[ART_JURE_DE_LO].otyp = find_appearance_armor(APP_SPEEDY_GLOVES);
	artilist[ART_CHEATER_S_PROSPERING].otyp = find_appearance_armor(APP_AIR_CLOAK);
	artilist[ART_EREA_S_HERITAGE].otyp = find_appearance_armor(APP_VINDALE_CLOAK);
	artilist[ART_ALIEN_MINDWAVE].otyp = find_appearance_armor(APP_TT_HELMET);
	artilist[ART_WHO_CAN_DRIVE_BEST_].otyp = find_appearance_armor(APP_BIKER_HELMET);
	artilist[ART_REVELATION____VERSE__].otyp = find_appearance_armor(APP_A_HEELS);
	artilist[ART_GLENCHECK_EATING].otyp = find_appearance_armor(APP_ALLIGATOR_PUMPS);
	artilist[ART_KLOCKING_NOISE].otyp = find_appearance_armor(APP_HAMMER_SHOES);
	artilist[ART_SABRINA_S_FREEDOM].otyp = find_appearance_armor(APP_PLATFORM_FLEECIES);
	artilist[ART_EVIL_HAIRTEAR].otyp = find_appearance_armor(APP_PLATFORM_FLEECIES);
	...
	artilist[ART_IRIS_S_FAVORED_MATERIAL].otyp = find_appearance_armor(APP_SPIKY_GLOVES);

	artilist[ART_IRMA_S_CHOICE].otyp = find_appearance_armor(APP_COPPER_STILETTOS);
	artilist[ART_EVERLASTING_HEELS].otyp = find_appearance_armor(APP_DIAMOND_STILETTOS);
	artilist[ART_HEIKE_S_BIGOTRY].otyp = find_appearance_armor(APP_HEELED_HUGGING_BOOTS);
	artilist[ART_ADORNING_BUNDLE].otyp = find_appearance_armor(APP_COSMETIC_HELMET);
	artilist[ART_GO_ON_A_SURVEY_RECREATION].otyp = find_appearance_armor(APP_WARNING_COAT);
	artilist[ART_GIVE_US_TODAY_OUR_DAILY_GA].otyp = find_appearance_armor(APP_BAMBOO_CLOAK);
	artilist[ART_JANA_S_ROULETTE_OF_LIFE].otyp = find_appearance_armor(APP_FOUNDRY_CLOAK);
	artilist[ART_MAGIC_JUGGULATE].otyp = find_appearance_armor(APP_SPELLSUCKING_CLOAK);
	artilist[ART_HIGH_KING_OF_SKIRIM].otyp = find_appearance_armor(APP_STORM_COAT);
	artilist[ART_ALLCOLOR_PRISM].otyp = find_appearance_armor(APP_FLEECELING_CLOAK);
	artilist[ART_MARY_INSCRIPTION].otyp = find_appearance_armor(APP_PRINCESS_GLOVES);
	artilist[ART_FATHIEN_ELDER_S_SECRET_POW].otyp = find_appearance_armor(APP_UNCANNY_GLOVES);
	artilist[ART_SI_OH_WEE].otyp = find_appearance_armor(APP_SLAYING_GLOVES);
	artilist[ART_JOHANETTA_S_ROUGH_GENTLENE].otyp = find_appearance_armor(APP_BLUE_SNEAKERS);
	artilist[ART_JANA_S_VAGINAL_FUN].otyp = find_appearance_armor(APP_BLUE_SNEAKERS);
	artilist[ART_VERY_NICE_PERSON].otyp = find_appearance_armor(APP_FEMMY_BOOTS);
	artilist[ART_JULIA_S_REAL_LOVE].otyp = find_appearance_armor(APP_RED_SNEAKERS);
	artilist[ART_ELIANE_S_COMBAT_SNEAKERS].otyp = find_appearance_armor(APP_YELLOW_SNEAKERS);
	artilist[ART_MAILIE_S_CHALLENGE].otyp = find_appearance_armor(APP_PINK_SNEAKERS);
	artilist[ART_MERLOT_FUTURE].otyp = find_appearance_armor(APP_SKI_HEELS);
	artilist[ART_MADELEINE_S_GIRL_FOOTSTEPS].otyp = find_appearance_armor(APP_CALF_LEATHER_SANDALS);
	artilist[ART_RUTH_S_MORTAL_ENEMY].otyp = find_appearance_armor(APP_VELCRO_SANDALS);
	artilist[ART_LARISSA_S_ANGER].otyp = find_appearance_armor(APP_BUFFALO_BOOTS);
	artilist[ART_PRETTY_ROOMMAID].otyp = find_appearance_armor(APP_HEROINE_MOCASSINS);
	artilist[ART_ALISEH_S_RED_COLOR].otyp = find_appearance_armor(APP_LOLITA_BOOTS);
	artilist[ART_KATIE_MELUA_S_FLEECINESS].otyp = find_appearance_armor(APP_WEAPON_LIGHT_BOOTS);
	artilist[ART_SHARP_EDGED_AND_DANGEROUS].otyp = find_appearance_armor(APP_WEAPON_LIGHT_BOOTS);
	artilist[ART_ELONA_S_SNAIL_TRAIL].otyp = find_appearance_armor(APP_RUBYNUS_HELMET);
	artilist[ART_LORENZI_S_CLEANING_RESIDUE].otyp = find_appearance_armor(APP_EVERLASTING_BOOTS);

	artilist[ART_ARABELLA_S_WEAPON_STORAGE].otyp = find_appearance_armor(APP_CURSED_CALLED_CLOAK);
	artilist[ART_KYS_YOURSELF].otyp = find_appearance_armor(APP_FOURCHAN_CLOAK);
	artilist[ART_INA_S_SORROW].otyp = find_appearance_armor(APP_INALISH_CLOAK);
	artilist[ART_WHY_NOT_DO_THE_REAL_THING].otyp = find_appearance_armor(APP_GRUNTER_HELMET);
	artilist[ART_CLAUDIA_S_SEXY_SCENT].otyp = find_appearance_armor(APP_CLOUDY_HELMET);
	artilist[ART_VACUUM_CLEANER_DEATH].otyp = find_appearance_armor(APP_BREATH_CONTROL_HELMET);
	artilist[ART_NYPHERISBANE].otyp = find_appearance_armor(APP_GAS_MASK);
	artilist[ART_CHRISTMAS_MEDAL].otyp = find_appearance_armor(APP_SAGES_HELMET);
	artilist[ART_LONGEST_RAY].otyp = find_appearance_armor(APP_RAYDUCTNAY_GLOVES);
	artilist[ART_ENDORPHIC_SCRATCHING].otyp = find_appearance_armor(APP_ORGASM_PUMPS);
	artilist[ART_SONJA_S_TORN_SOUL].otyp = find_appearance_armor(APP_WORN_OUT_SNEAKERS);
	artilist[ART_RUEA_S_FAILED_CONVERSION].otyp = find_appearance_armor(APP_NOBLE_SANDALS);
	artilist[ART_HAWAIIAN_KAMEHAMEHA].otyp = find_appearance_armor(APP_DOCTOR_CLAW_BOOTS);
	artilist[ART_LARISSA_S_GENTLE_SLEEP].otyp = find_appearance_armor(APP_FEELGOOD_HEELS);
	artilist[ART_STEFANJE_S_PROBLEM].otyp = find_appearance_armor(APP_PLOF_HEELS);
	artilist[ART_MALENA_S_LADYNESS].otyp = find_appearance_armor(APP_PRINCESS_PUMPS);
	artilist[ART_ELEVECULT].otyp = find_appearance_armor(APP_BALLET_HEELS);
	artilist[ART_SHIT_KICKERS].otyp = find_appearance_armor(APP_STEEL_TOED_BOOTS);
	artilist[ART_SARAH_S_GRANNY_WEAR].otyp = find_appearance_armor(APP_MARJI_SHOES);
	artilist[ART_CLICHE_WEAR].otyp = find_appearance_armor(APP_MARY_JANES);
	artilist[ART_YVONNE_S_MODEL_AMBITION].otyp = find_appearance_armor(APP_VELVET_PUMPS);
	artilist[ART_BRIGHT_AURORA].otyp = find_appearance_armor(APP_NOT_SLOWING_DOWN_BOOTS);

	artilist[ART_BOWSER_S_FUN_ARENA].otyp = find_appearance_armor(APP_VOLCANIC_CLOAK);
	artilist[ART_BILLS_PAID].otyp = find_appearance_armor(APP_FUEL_CLOAK);
	artilist[ART_FINDING_THYSELF].otyp = find_appearance_armor(APP_CLOISTER_CLOAK);
	artilist[ART_GUNNEM_DOWN].otyp = find_appearance_armor(APP_QUANTITY_CLOAK);
	artilist[ART_GOODFOOD].otyp = find_appearance_armor(APP_QUANTITY_CLOAK);
	artilist[ART_SALADIN_S_DESERT_FOX].otyp = find_appearance_armor(APP_SHEMAGH);
	artilist[ART_JAMILA_S_BELIEF].otyp = find_appearance_armor(APP_SHEMAGH);
	artilist[ART_SLIPPING_SUCKING].otyp = find_appearance_armor(APP_SERRATED_HELMET);
	artilist[ART_INERT_GREAVES].otyp = find_appearance_armor(APP_THICK_BOOTS);
	artilist[ART_DESERT_MEDITATION].otyp = find_appearance_armor(APP_SAND_ALS);
	artilist[ART_GORGEOUS_VEIL_MODEL].otyp = find_appearance_armor(APP_SHADOWY_HEELS);
	artilist[ART_SUBLEVEL_FLOODING].otyp = find_appearance_armor(APP_WEIGHT_ATTACHMENT_BOOTS);
	artilist[ART_USE_THE_NORMALNESS_TURNS].otyp = find_appearance_armor(APP_FUNGAL_SANDALS);
	artilist[ART_UNFELLABLE_TREE].otyp = find_appearance_armor(APP_STANDING_FOOTWEAR);

	artilist[ART_CARMARK].otyp = find_appearance_armor(APP_BUSINESS_SHOES);
	artilist[ART_ANITA_S_RASHLUST].otyp = find_appearance_armor(APP_FILIGREE_STILETTOS);
	...
	artilist[ART_MARJI_JANA].otyp = find_appearance_armor(APP_ANKLE_BOOTS);

	artilist[ART_AMPERSAND_HAREM].otyp = find_appearance_armor(APP_DEMONOLOGIST_BOOTS);
	artilist[ART_DIP_DIVE].otyp = find_appearance_armor(APP_MUD_BOOTS);
	artilist[ART_MANDY_S_RAIDWEAR].otyp = find_appearance_armor(APP_FAILED_SHOES);
	artilist[ART_PHANTO_S_RETARDEDNESS].otyp = find_appearance_armor(APP_OPERA_PUMPS);
	...
	artilist[ART_THERE_ARE_SEVERAL_OF_THEM].otyp = find_appearance_armor(APP_POPE_HAT);
	artilist[ART_FOOTBALL_MASK].otyp = find_appearance_armor(APP_CORONA_MASK);
	artilist[ART_FFP___MASK].otyp = find_appearance_armor(APP_CORONA_MASK);
	artilist[ART_ACU_BECOME_HAVE].otyp = find_appearance_armor(APP_ANACHRO_HELMET);
	artilist[ART_PRIESTEST_BLESS].otyp = find_appearance_armor(APP_ORNAMENTAL_COPE);
	artilist[ART_SATAN_S_SUGGESTION].otyp = find_appearance_armor(APP_WETSUIT);
	artilist[ART_EGASSO_S_GIBBERISH].otyp = find_appearance_armor(APP_MULTILINGUITIS_GLOVES);
	artilist[ART_SANDALS_OF_JESUS_CHRIST].otyp = find_appearance_armor(APP_THROWAWAY_SANDALS);
	artilist[ART_ARTHUR_S_HIGH_HEELED_PLATF].otyp = find_appearance_armor(APP_SHARP_EDGED_SANDALS);
	artilist[ART_GREEN_THUMB].otyp = find_appearance_armor(APP_NONDESCRIPT_GLOVES);
	artilist[ART_GEAVY_GREAVES].otyp = find_appearance_armor(APP_LEAD_BOOTS);
	artilist[ART_PERMINANT_INCREASE].otyp = find_appearance_armor(APP_MACHINERY_BOOTS);
	artilist[ART_WHINY_TEACHER_INSIDE_WOMAN].otyp = find_appearance_armor(APP_CHRISTMAS_CHILD_MODE_BOOTS);
	artilist[ART_NOW_YOU_LOOK_LIKE_A_BEGGAR].otyp = find_appearance_armor(APP_SANDALS_WITH_SOCKS);
	artilist[ART_ANJA_S_WIDE_FIELD].otyp = find_appearance_armor(APP_WEDGE_SNEAKERS);
	artilist[ART_U_BE_CURRY].otyp = find_appearance_armor(APP_BAREFOOT_SHOES);
	...
	artilist[ART_SHARPSPIKE].otyp = find_appearance_armor(APP_PARAGRAPH_SANDALS);
	artilist[ART_WEDDING_CHALLENGE].otyp = find_appearance_armor(APP_BRIDAL_SHOES);
	artilist[ART_ANACONDA_HEELS].otyp = find_appearance_armor(APP_PISTOL_BOOTS);
	artilist[ART_JANA_S_DEVIOUSNESS].otyp = find_appearance_armor(APP_NG_SHOES);
	artilist[ART_PLAYING_ANASTASIA].otyp = find_appearance_armor(APP_CHELSEA_BOOTS);
	artilist[ART_JASIEEN_S_FEAR].otyp = find_appearance_armor(APP_WEDGE_ESPADRILLES);
	artilist[ART_SHE_REALLY_LIKES_IT].otyp = find_appearance_armor(APP_TREADED_HEELS);
	artilist[ART_SOARUP].otyp = find_appearance_armor(APP_HIGHER_HELMET);
	artilist[ART_GODLY_POSTMAN].otyp = find_appearance_armor(APP_WINGED_SANDALS);
	artilist[ART_SUCH_A_LOVELY_SHARK].otyp = find_appearance_armor(APP_REMORA_HEELS);
	artilist[ART_SPFLOTCH__HAHAHAHAHA_].otyp = find_appearance_armor(APP_HEELED_CHELSEA_BOOTS);
	...
	artilist[ART_SAFARI_ROCKZ].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_SMILE_Z].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_SECRET_RAINBOW].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_YELLY].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_DEATHHEAD].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_MASK_OFF].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_SPARKLING_GOLD].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_PURPLE_SANDSTORM].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_SQUARE_ZONE].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_CUTE_JEANS].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_LOVELY_CORNFLOWER].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_GHETTO_ROCKZ].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_LAST_UNICORN].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_JUNGLE_LOVE].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_FRESH_PINK].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_BLUE_BLOSSOM].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_SIXX_PAXX].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_NEXT_LEVEL].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_PATCHWORK].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_MAGIC_BUTTERFLY].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_TOXIC_PINK].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_SPACE_SHUTTLE].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_ART_ROCKZ].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_COVER_UP].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_SPIRIT_ROCKZ].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_PURPLE_JUNGLE].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_EAZY_GOING].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_SIMPLY_WHITE].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_SIMPLY_BLACK].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_WOOD_FEELING].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_COLLEGE_ROCKZ].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_WELCOME_ON_BOARD].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_WONDERFUL_LOTUS].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_UNDERWATER_LOVE].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_SWEET_CHERRY].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_TIRE_ROCKZ].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_HAPPY_CLOUD].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_DELFI_ROCKZ].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_ALL_TIME_FAVZ].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_ROCKZ_ARMY].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_SKETCH_IT].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_POKERFACE].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_WHITE_KARMA].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_STREET_ROCKZ].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_BLACK_MANDALA].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_MY_LOVE].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_YES_I_ROCKZ].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_BUNNY_ROCKZ].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_CAT_ROCKZ].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_SCAN_ME].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_BACTERIA].otyp = find_appearance_armor(APP_MISSYS);
	artilist[ART_JULIA_S_SLIPPERS].otyp = find_appearance_armor(APP_HOUSE_SLIPPERS);
...
register boolean mod;
{
	...
	if (otmp && *name)
		...
		if (artimatch && !strcmp(a->name, name)) {
		    ...
		    if (otmp && otmp->oartifact == ART_W_W_W_W_W_W_W_W_W_W_W_) {
...
skillswapredo:
		    ...
		    if (otmp && otmp->oartifact == ART_PERPLEX_PERSPECTIVE) {
				int tempswapvalue;
				int tempswapvalue2;
				int tryct, tryct2, i;
				int swapskill1, swapskill2;
...
skillswapredoX:
				swapskill2 = randomgoodskill();
				if (swapskill1 == swapskill2) goto skillswapredoX;
			...
			if (specialangel) {
				...
				platformfleeceboots = mksobj(find_appearance_armor(APP_WHITE_BUFFALO_BOOTS), FALSE, FALSE, FALSE);
		    ...
		    if (otmp && otmp->oartifact == ART_SAM_S_LUCKLESS_STREAK) {
			int downskill = randomgoodskill();

			if (P_MAX_SKILL(downskill) == P_BASIC) {
				P_MAX_SKILL(downskill) = P_ISRESTRICTED;
				P_ADVANCE(downskill) = 0;
				pline("You lose all knowledge of the %s skill!", wpskillname(downskill));
			} else if (P_MAX_SKILL(downskill) == P_SKILLED) {
				P_MAX_SKILL(downskill) = !rn2(3) ? P_BASIC : P_ISRESTRICTED;
				if (P_MAX_SKILL(downskill) == P_ISRESTRICTED) {
					P_ADVANCE(downskill) = 0;
					pline("You lose all knowledge of the %s skill!", wpskillname(downskill));
				} else {
					pline("You lose some knowledge of the %s skill!", wpskillname(downskill));
				}
			} else if (P_MAX_SKILL(downskill) == P_EXPERT) {
				P_MAX_SKILL(downskill) = !rn2(3) ? P_ISRESTRICTED : !rn2(2) ? P_BASIC : P_SKILLED;
				if (P_MAX_SKILL(downskill) == P_ISRESTRICTED) {
					P_ADVANCE(downskill) = 0;
					pline("You lose all knowledge of the %s skill!", wpskillname(downskill));
				} else {
			...
			} else if (P_MAX_SKILL(downskill) == P_MASTER) {
				P_MAX_SKILL(downskill) = !rn2(3) ? P_EXPERT : !rn2(2) ? P_BASIC : P_SKILLED;
				pline("You lose some knowledge of the %s skill!", wpskillname(downskill));
			} else if (P_MAX_SKILL(downskill) == P_GRAND_MASTER) {
				P_MAX_SKILL(downskill) = !rn2(3) ? P_EXPERT : !rn2(2) ? P_MASTER : P_SKILLED;
				pline("You lose some knowledge of the %s skill!", wpskillname(downskill));
			} else if (P_MAX_SKILL(downskill) == P_SUPREME_MASTER) {
				P_MAX_SKILL(downskill) = !rn2(3) ? P_EXPERT : !rn2(2) ? P_MASTER : P_GRAND_MASTER;
				pline("You lose some knowledge of the %s skill!", wpskillname(downskill));
			}

			skill_sanity_check(downskill);

		    }

		    if (otmp && otmp->oartifact == ART_NO__THEY_MAY_NOT_DO_THIS_) {
			int downskill = randomgoodskill();
			int compensationskills = 0;
			if (P_MAX_SKILL(downskill) == P_BASIC) compensationskills = 1;
			if (P_MAX_SKILL(downskill) == P_SKILLED) compensationskills = 2;
			if (P_MAX_SKILL(downskill) == P_EXPERT) compensationskills = 3;
			if (P_MAX_SKILL(downskill) == P_MASTER) compensationskills = 4;
			if (P_MAX_SKILL(downskill) == P_GRAND_MASTER) compensationskills = 5;
			if (P_MAX_SKILL(downskill) == P_SUPREME_MASTER) compensationskills = 6;

			P_MAX_SKILL(downskill) = P_ISRESTRICTED;
			P_ADVANCE(downskill) = 0; /* even if it was already restricted, this is on purpose --Amy */
			pline("You lose all knowledge of the %s skill!", wpskillname(downskill));

			skill_sanity_check(downskill);

			if (compensationskills > 0) {
				u.weapon_slots += compensationskills;
			}
		    }

		    if (otmp && otmp->oartifact == ART_LUCK_WITH_THE_MONEY__PITCH) {
			int downskill = randomgoodskill();
			int compensationdollars = P_ADVANCE(downskill) * 10;

			P_ADVANCE(downskill) = 0;
			skill_sanity_check(downskill);

			You("have to relearn how to use the %s skill!", wpskillname(downskill));

			if (compensationdollars > 0) {
				u.ugold += compensationdollars;
				You("gain %d dollars as a compensation.", compensationdollars);
				flags.botl = TRUE;
			}

		    }

		    if (otmp && otmp->oartifact == ART_VANCE_S_TAX) {
			if (P_MAX_SKILL(P_RIDING) == P_ISRESTRICTED) {
				unrestrict_weapon_skill(P_RIDING);
				pline("You can now learn the riding skill!");
			} else if (P_MAX_SKILL(P_RIDING) == P_UNSKILLED) {
				unrestrict_weapon_skill(P_RIDING);
				pline("You can now learn the riding skill!");
				P_MAX_SKILL(P_RIDING) = P_BASIC;
			} else if (P_MAX_SKILL(P_RIDING) == P_SKILLED) {
				P_MAX_SKILL(P_RIDING) = P_BASIC;
				skill_sanity_check(P_RIDING);
				pline("You lose some knowledge of the riding skill!");
			} else if (P_MAX_SKILL(P_RIDING) == P_EXPERT) {
				P_MAX_SKILL(P_RIDING) = P_SKILLED;
				skill_sanity_check(P_RIDING);
				pline("You lose some knowledge of the riding skill!");
			} else if (P_MAX_SKILL(P_RIDING) == P_MASTER) {
				P_MAX_SKILL(P_RIDING) = P_EXPERT;
				skill_sanity_check(P_RIDING);
				pline("You lose some knowledge of the riding skill!");
			} else if (P_MAX_SKILL(P_RIDING) == P_GRAND_MASTER) {
				P_MAX_SKILL(P_RIDING) = P_MASTER;
				skill_sanity_check(P_RIDING);
				pline("You lose some knowledge of the riding skill!");
			} else if (P_MAX_SKILL(P_RIDING) == P_SUPREME_MASTER) {
		    ...
		    if (otmp && otmp->oartifact == ART_POWLBOWL) {
			You_feel("like poking things with a pole...");
			...
			if (P_MAX_SKILL(P_POLEARMS) == P_ISRESTRICTED) {
				...
				pline("You can now become expert with polearms!");
				...
				P_MAX_SKILL(P_POLEARMS) = P_GRAND_MASTER;
				pline("You can now become grand master with polearms!");
			...
			} else pline("Sadly your knowledge of the polearm skill is already maxed.");

		    }

		    if (otmp && otmp->oartifact == ART_P_U_E_U_U_U) {
			You("suddenly gain the ability to shoot more effectively!");

			if (P_MAX_SKILL(P_CROSSBOW) == P_ISRESTRICTED) {
				unrestrict_weapon_skill(P_CROSSBOW);
				pline("You can now learn the crossbow skill!");
			} else if (P_MAX_SKILL(P_CROSSBOW) == P_UNSKILLED) {
				unrestrict_weapon_skill(P_CROSSBOW);
				pline("You can now learn the crossbow skill!");
				P_MAX_SKILL(P_CROSSBOW) = P_BASIC;
			} else if (P_MAX_SKILL(P_CROSSBOW) == P_BASIC) {
				P_MAX_SKILL(P_CROSSBOW) = P_SKILLED;
				pline("You can now become skilled with crossbows!");
			} else if (P_MAX_SKILL(P_CROSSBOW) == P_SKILLED) {
				P_MAX_SKILL(P_CROSSBOW) = P_EXPERT;
				pline("You can now become expert with crossbows!");
			} else if (P_MAX_SKILL(P_CROSSBOW) == P_EXPERT) {
				P_MAX_SKILL(P_CROSSBOW) = P_MASTER;
				pline("You can now become master with crossbows!");
			} else if (P_MAX_SKILL(P_CROSSBOW) == P_MASTER) {
				P_MAX_SKILL(P_CROSSBOW) = P_GRAND_MASTER;
				pline("You can now become grand master with crossbows!");
			} else if (P_MAX_SKILL(P_CROSSBOW) == P_GRAND_MASTER) {
				P_MAX_SKILL(P_CROSSBOW) = P_SUPREME_MASTER;
				pline("You can now become supreme master with crossbows!");
			} else pline("Sadly your knowledge of the crossbow skill is already maxed.");

			if (P_MAX_SKILL(P_MISSILE_WEAPONS) == P_ISRESTRICTED) {
				unrestrict_weapon_skill(P_MISSILE_WEAPONS);
				pline("You can now learn the missile weapon skill!");
			} else if (P_MAX_SKILL(P_MISSILE_WEAPONS) == P_UNSKILLED) {
				unrestrict_weapon_skill(P_MISSILE_WEAPONS);
				pline("You can now learn the missile weapon skill!");
				P_MAX_SKILL(P_MISSILE_WEAPONS) = P_BASIC;
			} else if (P_MAX_SKILL(P_MISSILE_WEAPONS) == P_BASIC) {
				P_MAX_SKILL(P_MISSILE_WEAPONS) = P_SKILLED;
				pline("You can now become skilled with missile weapons!");
			} else if (P_MAX_SKILL(P_MISSILE_WEAPONS) == P_SKILLED) {
				P_MAX_SKILL(P_MISSILE_WEAPONS) = P_EXPERT;
				pline("You can now become expert with missile weapons!");
			} else if (P_MAX_SKILL(P_MISSILE_WEAPONS) == P_EXPERT) {
				P_MAX_SKILL(P_MISSILE_WEAPONS) = P_MASTER;
				pline("You can now become master with missile weapons!");
			} else if (P_MAX_SKILL(P_MISSILE_WEAPONS) == P_MASTER) {
				P_MAX_SKILL(P_MISSILE_WEAPONS) = P_GRAND_MASTER;
				pline("You can now become grand master with missile weapons!");
			} else if (P_MAX_SKILL(P_MISSILE_WEAPONS) == P_GRAND_MASTER) {
				P_MAX_SKILL(P_MISSILE_WEAPONS) = P_SUPREME_MASTER;
				pline("You can now become supreme master with missile weapons!");
			} else pline("Sadly your knowledge of the missile weapon skill is already maxed.");

		    }

		    if (otmp && otmp->oartifact == ART_SHOTTE_RAIGHT) {
			You_feel("more capable of firing a bow...");

			if (P_MAX_SKILL(P_BOW) == P_ISRESTRICTED) {
				unrestrict_weapon_skill(P_BOW);
				pline("You can now learn the bow skill!");
				P_MAX_SKILL(P_BOW) = P_SKILLED;
			} else if (P_MAX_SKILL(P_BOW) == P_UNSKILLED) {
				unrestrict_weapon_skill(P_BOW);
				pline("You can now learn the bow skill!");
				P_MAX_SKILL(P_BOW) = P_SKILLED;
			} else if (P_MAX_SKILL(P_BOW) == P_BASIC) {
				P_MAX_SKILL(P_BOW) = P_EXPERT;
				pline("You can now become expert with bows!");
			} else if (P_MAX_SKILL(P_BOW) == P_SKILLED) {
				P_MAX_SKILL(P_BOW) = P_MASTER;
				pline("You can now become master with bows!");
			} else if (P_MAX_SKILL(P_BOW) == P_EXPERT) {
				P_MAX_SKILL(P_BOW) = P_GRAND_MASTER;
				pline("You can now become grand master with bows!");
			} else if (P_MAX_SKILL(P_BOW) == P_MASTER) {
				P_MAX_SKILL(P_BOW) = P_SUPREME_MASTER;
				pline("You can now become supreme master with bows!");
			} else if (P_MAX_SKILL(P_BOW) == P_GRAND_MASTER) {
				P_MAX_SKILL(P_BOW) = P_SUPREME_MASTER;
				pline("You can now become supreme master with bows!");
			} else pline("Sadly your knowledge of the bow skill is already maxed.");

		    }

		    if (otmp && otmp->oartifact == ART_HEIDENEI) {
			pline("Something seems to improve your ability to use a sling...");
			pline("Check out the #enhance menu to see what's changed!");

			if (P_MAX_SKILL(P_SLING) == P_ISRESTRICTED) {
				unrestrict_weapon_skill(P_SLING);
				P_MAX_SKILL(P_SLING) = rn2(2) ? P_SKILLED : P_EXPERT;
			} else if (P_MAX_SKILL(P_SLING) == P_UNSKILLED) {
				unrestrict_weapon_skill(P_SLING);
				P_MAX_SKILL(P_SLING) = rn2(2) ? P_SKILLED : P_EXPERT;
			} else if (P_MAX_SKILL(P_SLING) == P_BASIC) {
				P_MAX_SKILL(P_SLING) = rn2(2) ? P_MASTER : P_EXPERT;
			} else if (P_MAX_SKILL(P_SLING) == P_SKILLED) {
				P_MAX_SKILL(P_SLING) = rn2(2) ? P_MASTER : P_GRAND_MASTER;
			} else if (P_MAX_SKILL(P_SLING) == P_EXPERT) {
				P_MAX_SKILL(P_SLING) = rn2(2) ? P_SUPREME_MASTER : P_GRAND_MASTER;
			} else if (P_MAX_SKILL(P_SLING) == P_MASTER) {
				P_MAX_SKILL(P_SLING) = P_SUPREME_MASTER;
			} else if (P_MAX_SKILL(P_SLING) == P_GRAND_MASTER) {
				P_MAX_SKILL(P_SLING) = P_SUPREME_MASTER;
		    ...
		    if (otmp && otmp->oartifact == ART_FIRSTACKE) {
			otmp->quan += 15;
			otmp->owt = weight(otmp);
		    }
		    ...
		    if (otmp && otmp->oartifact == ART_WHILEHOLD) {
			otmp->age *= 3;
		    }
		    if (otmp && otmp->oartifact == ART_SUCKSTRIKE) {
			otmp->age *= 5;
		    }
...
int tmp;
{
	...
	if (spec_dbon_applies) {
	    ...
	    if (otmp && otmp->oartifact == ART_LERYN_S_HAMMER) {
			return rnd(max(tmp,1)) + rnd((int)weap->attk.damd); /* doubles the damage first, then adds the random damage bonus from artilist.h */
	    }
	...
	case SPECIAL_INVOKE:
		...
		*/
		...
		if (obj->oartifact == ART_PARASITIC_GROWTH) {
			useupall(obj);
			FastMetabolismEffect += rnz(50000);

			if (P_MAX_SKILL(P_SYMBIOSIS) == P_ISRESTRICTED) {
				unrestrict_weapon_skill(P_SYMBIOSIS);
				pline("You can now learn the symbiosis skill!");
			} else if (P_MAX_SKILL(P_SYMBIOSIS) == P_UNSKILLED) {
				unrestrict_weapon_skill(P_SYMBIOSIS);
				pline("You can now learn the symbiosis skill!");
				P_MAX_SKILL(P_SYMBIOSIS) = P_BASIC;
			} else if (P_MAX_SKILL(P_SYMBIOSIS) == P_BASIC) {
				P_MAX_SKILL(P_SYMBIOSIS) = P_SKILLED;
				pline("You can now become skilled in symbiosis!");
			} else if (P_MAX_SKILL(P_SYMBIOSIS) == P_SKILLED) {
				P_MAX_SKILL(P_SYMBIOSIS) = P_EXPERT;
				pline("You can now become expert in symbiosis!");
			} else if (P_MAX_SKILL(P_SYMBIOSIS) == P_EXPERT) {
				P_MAX_SKILL(P_SYMBIOSIS) = P_MASTER;
				pline("You can now become master in symbiosis!");
			} else if (P_MAX_SKILL(P_SYMBIOSIS) == P_MASTER) {
				P_MAX_SKILL(P_SYMBIOSIS) = P_GRAND_MASTER;
				pline("You can now become grand master in symbiosis!");
			} else if (P_MAX_SKILL(P_SYMBIOSIS) == P_GRAND_MASTER) {
				P_MAX_SKILL(P_SYMBIOSIS) = P_SUPREME_MASTER;
				pline("You can now become supreme master in symbiosis!");
			} else pline("Sadly your knowledge of the symbiosis skill is already maxed.");

			break;
		}

		if (obj->oartifact == ART_CURVEDRATCH) {
			register struct obj *radcig;
			radcig = mksobj(rnd_class(SCIMITAR, HIGH_ELVEN_WARSWORD), TRUE, FALSE, FALSE);
			if (radcig) {
				...
				pline("You're suddenly wielding a scimitar!");
			}

			break;
		}

		if (obj->oartifact == ART_JAN_S_GRUMBLEBUMBLE) {
			if (uwep && (uwep == obj)) {
				setnotworn(uwep);
				pline("You're not wielding the stone anymore.");
			} else {
				pline("%s", nothing_happens);
				if (FailureEffects || u.uprops[FAILURE_EFFECTS].extrinsic || have_failurestone()) {
					pline("Oh wait, actually something bad happens...");
		...
		if (obj->oartifact == ART_LENNY_S_MUSIC_MAKER) {
			objects[obj->otyp].oc_material = rn2(LASTMATERIAL + 1); /* allow every material, including 0 (mysterious) */
			pline_The("guitar's material has changed.");
			break;
		}
...
findmorestonesX:
		...
		if (obj->oartifact == ART_EARRING_STOLEN) {
			u.uprops[DEAC_POLYMORPH_CONTROL].intrinsic += 10000;
...
tunguskaagain:
		...
		if (obj->oartifact == ART_TURN_INTO_LEATHER) {
			...
			if (find_appearance_armor(APP_LEATHER_GLOVES) == -1) {
			...
			obj->otyp = find_appearance_armor(APP_LEATHER_GLOVES);
			obj->owt = weight(obj);
...
tscheinschroll:
		...
		if (obj->oartifact == ART_ALL_THE_FRAGRANT_GIRLS) {
			...
			if (uchocitem) {
				...
				uchocitem->known = uchocitem->dknown = uchocitem->bknown = uchocitem->rknown = 1;
				uchocitem->owt = weight(uchocitem);
				uncurse_completely(uchocitem, TRUE);
