 ...
 */
	...
	case OBJ_DETECTION:
		...
		break;
	case CREATE_PORTAL: 
		if (flags.lostsoul || flags.uberlostsoul || u.uprops[STORM_HELM].extrinsic) break;
				{
	    ...
	    if(u.uhave.amulet || In_endgame(&u.uz) || (u.usteed && mon_has_amulet(u.usteed)) || In_endgame(&newlev) ||
