...
/* sobj is null if crystal ball, *scroll if gold detection scroll */
{
    ...
    for (obj = fobj; obj; obj = obj->nobj) {
	if ((obj->otyp==LARGE_BOX || obj->otyp==LEAD_BOX || obj->otyp==TREASURE_CHEST || obj->otyp==CHEST || obj->otyp==NANO_CHEST || obj->otyp==LARGE_BOX_OF_DIGESTION || obj->otyp==CHEST_OF_HOLDING) && obj->otrapped) {
...
/* sobj is null if crystal ball, *scroll if gold detection scroll */
{
    ...
    for (obj = fobj; obj; obj = obj->nobj) {
	if ((obj->otyp==LARGE_BOX || obj->otyp==LEAD_BOX || obj->otyp==CHEST || obj->otyp==NANO_CHEST || obj->otyp==TREASURE_CHEST || obj->otyp==LARGE_BOX_OF_DIGESTION || obj->otyp==CHEST_OF_HOLDING) && obj->otrapped) {
	    if (obj->ox != u.ux || obj->oy != u.uy)
		goto outtrapmap;
	    else found = TRUE;
	}
