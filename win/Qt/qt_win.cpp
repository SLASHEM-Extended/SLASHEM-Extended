...
aboutMsg()
{
    QString msg;
    msg.sprintf(
    "Qt " DEF_GAME_NAME " is a version of " DEF_GAME_NAME " built using\n"
#ifdef KDE
    ...
    keysource(ks)
{
    ...
    */
    ...
    QLabel* logo = new QLabel("<big>Qt Slash'EM</big>"
	"<br><i>by Warwick Allison<br>, the NetHack DevTeam and Warren Cheung",
	this);
    ...
    keysink(ks)
{
	...
	{ magic,	"Poly self\tAlt-Y",     "\371" },
	{ magic,	"Technique\tAlt-T",     "\364" },
	{ magic,	"Turn undead\t#tu",     "#tu" },
...
char NetHackQtBind::qt_yn_function(const char *question, const char *choices, CHAR_P def)
{
	...
	if (strcmp (choices,"ynq") == 0) {
	    switch (QMessageBox::information (0,DEF_GAME_NAME,question,
	      "&Yes","&No","&Quit",0,2))
	    {
	      case 0: return 'y'; 
	      case 1: return 'n'; 
