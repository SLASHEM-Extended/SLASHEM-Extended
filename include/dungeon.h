...
#define Is_jefferson_maint(x)	(on_level(x, &jefferson1_level))
#define Is_jefferson_mid(x)	(on_level(x, &jefferson2_level))
#define Is_jefferson_sub(x)	(on_level(x, &jefferson3_level))
#define Is_jefferson_taf1(x)	(on_level(x, &jefferson4_level))
#define Is_jefferson_taf2(x)	(on_level(x, &jefferson5_level))
