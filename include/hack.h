...
#define isevilvariant (Race_if(PM_EVILVARIANT) || flags.hybridevilvariant || (uwep && uwep->oartifact == ART_FUURKER)  || (uswapwep && uswapwep->oartifact == ART_FUURKER) )
