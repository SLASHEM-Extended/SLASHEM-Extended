...
#define issoviet (Race_if(PM_SOVIET) || flags.hybridsoviet || (!u.dungeongrowthhack && uimplant && uimplant->oartifact == ART_GELMER_KELANA_TWIN && !powerfulimplants() ) )
