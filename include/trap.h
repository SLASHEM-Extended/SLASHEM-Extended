...
#define POTION_DISPENSER
#define SPACEWARS_SPAWN_TRAP
#define TV_TROPES_TRAP
#define SYMBIOTE_TRAP
#define KILL_SYMBIOTE_TRAP
#define SYMBIOTE_REPLACEMENT_TRAP
#define SHUTDOWN_TRAP
#define CORONA_TRAP
#define UNPROOFING_TRAP
#define VISIBILITY_TRAP
#define FEMINISM_STONE_TRAP
#define BRANCH_TELEPORTER
#define BRANCH_BEAMER
#define POISON_ARROW_TRAP
#define POISON_BOLT_TRAP
#define MACE_TRAP
#define SHUEFT_TRAP
#define MOTH_LARVAE_TRAP
#define WORTHINESS_TRAP
#define CONDUCT_TRAP
#define STRIKETHROUGH_TRAP
#define MULTIPLE_GATHER_TRAP
#define VIVISECTION_TRAP
#define INSTAFEMINISM_TRAP
#define INSTANASTY_TRAP
#define SKILL_POINT_LOSS_TRAP
#define PERFECT_MATCH_TRAP
#define DUMBIE_LIGHTSABER_TRAP
#define WRONG_STAIRS
#define TECHSTOP_TRAP
#define AMNESIA_SWITCH_TRAP
#define SKILL_SWAP_TRAP
#define SKILL_UPORDOWN_TRAP
#define SKILL_RANDOMIZE_TRAP
