...
#define mhe(mtmp)	( (Role_if(PM_GENDERSTARIST) || (monstersoundtype(mtmp) == MS_GENDER) || (BoundDayActive && (mtmp->data->mcolor == CLR_RED)) || (!powerfulimplants() && uimplant && uimplant->oartifact == ART_I_LL_GIVE_YOU_A_GENDER_STA) || autismweaponcheck(ART_DAEMEL)) ? "he/she/it" : genders[pronoun_gender(mtmp)].he)
#define mhim(mtmp)	( (Role_if(PM_GENDERSTARIST) || (monstersoundtype(mtmp) == MS_GENDER) || (BoundDayActive && (mtmp->data->mcolor == CLR_RED)) || (!powerfulimplants() && uimplant && uimplant->oartifact == ART_I_LL_GIVE_YOU_A_GENDER_STA) || autismweaponcheck(ART_DAEMEL)) ? "him/her/it" : genders[pronoun_gender(mtmp)].him)
#define mhis(mtmp)	( (Role_if(PM_GENDERSTARIST) || (monstersoundtype(mtmp) == MS_GENDER) || (BoundDayActive && (mtmp->data->mcolor == CLR_RED)) || (!powerfulimplants() && uimplant && uimplant->oartifact == ART_I_LL_GIVE_YOU_A_GENDER_STA) || autismweaponcheck(ART_DAEMEL)) ? "his/her/its" : genders[pronoun_gender(mtmp)].his)
...
#define MARTIALSTYLE_BUHURT 17
	...
	boolean nastinator276;
	boolean nastinator277;
	boolean nastinator278;
	boolean nastinator279;
	boolean nastinator280;
	boolean nastinator281;
	boolean nastinator282;
	...
	boolean arti_carry_dissolvotek;
	boolean arti_carry_arcticerwinter;
	boolean arti_carry_roysmanliness;
	boolean arti_carry_marlenasforest;
	boolean arti_carry_mourndressing;
	boolean arti_carry_nogleamshine;
	boolean arti_carry_darkcellarhousing;
	boolean arti_carry_colorofsexuality;
	boolean arti_carry_inasbrightness;
	boolean arti_carry_katrinsthrill;
	boolean arti_carry_buttoutput;
	boolean arti_carry_beholdenname;
	boolean arti_carry_irisflaxsharp;
	boolean arti_carry_muxxerhead;
	boolean arti_carry_fortunefeet;
	boolean arti_carry_madeofstone;

	boolean arti_carry_howdeepcan;
	boolean arti_carry_feelsgoodenough;
	boolean arti_carry_marioand;
	boolean arti_carry_quewuewue;
	boolean arti_carry_nonasianwoman;
	boolean arti_carry_onioncake;
	boolean arti_carry_airtightwar;
	boolean arti_carry_onthewaterfront;
	boolean arti_carry_disgustinghighly;
	boolean arti_carry_greetlets;
	boolean arti_carry_lamademoiselle;
	boolean arti_carry_moddedthedungeon;
	boolean arti_carry_littleflask;
	boolean arti_carry_islama;
	boolean arti_carry_fuckingbirds;
	boolean arti_carry_littlegirlamber;
	boolean arti_carry_bonuscleaning;
	boolean arti_carry_russiankarate;
	boolean arti_carry_sillyfree;
	boolean arti_carry_odorantsocks;
	boolean arti_carry_wonteverfind;
	boolean arti_carry_shouldsmashyou;
	boolean arti_carry_darknessstorm;
	boolean arti_carry_gluttonyis;
	boolean arti_carry_liveontheland;
	boolean arti_carry_whatifthecushion;
	boolean arti_carry_cleanputter;
	boolean arti_carry_prettybut;
	boolean arti_carry_skiersbridge;
	boolean arti_carry_absorbhole;
	boolean arti_carry_searchanek;
	boolean arti_carry_pamelarosan;
	boolean arti_carry_onaneberet;
	boolean arti_carry_incrediblysexy;
	boolean arti_carry_prrooo;
	boolean arti_carry_greencolorfem;
	boolean arti_carry_wherehasshegone;
	boolean arti_carry_spacesare;
	boolean arti_carry_howcouldshefall;
	boolean arti_carry_klackklack;
	boolean arti_carry_facedisappears;
	boolean arti_carry_protectherblue;
	boolean arti_carry_inhalepersian;
	boolean arti_carry_iceblocksister;
	boolean arti_carry_swoonelnadine;
	boolean arti_carry_sassysmall;
	boolean arti_carry_cutefacial;
	boolean arti_carry_nuaerdudoed;
	boolean arti_carry_sendinthehorde;
	boolean arti_carry_youwontstop;
	boolean arti_carry_fleecywithe;
	boolean arti_carry_pretendthatsome;
	boolean arti_carry_endanwissing;
	boolean arti_carry_eventheblock;
	boolean arti_carry_namesaysit;
	boolean arti_carry_horriblescratch;
	boolean arti_carry_stayawayfrom;
	boolean arti_carry_delallesbkk;
	boolean arti_carry_bedrock;
	boolean arti_carry_extrahighdiff;
	boolean arti_carry_quaffspark;
	boolean arti_carry_donotwork;
	boolean arti_carry_loudclap;
	boolean arti_carry_navigatemess;
	boolean arti_carry_severeuninf;
	boolean arti_carry_gremlinsrev;
	boolean arti_carry_keepstumb;
	boolean arti_carry_pureaids;
	boolean arti_carry_whoneedsitems;
	boolean arti_carry_infernalarea;
	boolean arti_carry_livefast;
	boolean arti_carry_thatsderp;
	boolean arti_carry_wallifyup;
	boolean arti_carry_tryitout;
	boolean arti_carry_sofunny;
	boolean arti_carry_goodluckneed;
	boolean arti_carry_unplayablegame;
	boolean arti_carry_notsosecret;
	boolean arti_carry_robbieswear;
	boolean arti_carry_tinyvisi;
	boolean arti_carry_biggershroud;
	boolean arti_carry_seeevenless;
	boolean arti_carry_hohoiate;
	boolean arti_carry_arrghhecomes;
	boolean arti_carry_waitinggodot;
	boolean arti_carry_betterputit;
	boolean arti_carry_itexplodes;
	boolean arti_carry_needfairness;
	boolean arti_carry_lastforeva;
	boolean arti_carry_nuclearwar;
	boolean arti_carry_screenglitch;
	boolean arti_carry_quasiperma;
	boolean arti_carry_trashit;
	boolean arti_carry_flucker;
	boolean arti_carry_grrmdaddy;
	boolean arti_carry_womanler;
	boolean arti_carry_doorningday;
	boolean arti_carry_blabberblabber;
	boolean arti_carry_leikiquest;
	boolean arti_carry_loseallspells;
	boolean arti_carry_manlush;
	boolean arti_carry_toutdaau;
	boolean arti_carry_wastewither;
	boolean arti_carry_morkmore;
	boolean arti_carry_fffffqp;
	boolean arti_carry_gasweapon;
	boolean arti_carry_beyondhelp;
	boolean arti_carry_clapaway;
	boolean arti_carry_iseeyou;
	boolean arti_carry_fredopt;
	boolean arti_carry_fullyid;
	boolean arti_carry_deepdesc;
	boolean arti_carry_halfcuthaha;
	boolean arti_carry_fuckwithu;
	boolean arti_carry_umengflyer;
	boolean arti_carry_dndnoone;
	boolean arti_carry_albieswhite;
	boolean arti_carry_everythingshot;
	boolean arti_carry_satanspecial;
	boolean arti_carry_anainsurance;
	boolean arti_carry_breakpilot;

	boolean item_carry_femjewel1; /* these are for checking whether you have specific feminism gems in your inventory, keyword "marlena" */
	boolean item_carry_femjewel2;
	boolean item_carry_femjewel3;
	boolean item_carry_femjewel4;
	boolean item_carry_femjewel5;
	boolean item_carry_femjewel6;
	boolean item_carry_femjewel7;
	boolean item_carry_femjewel8;
	boolean item_carry_femjewel9;
	boolean item_carry_femjewel10;
	boolean item_carry_femjewel11;
	boolean item_carry_femjewel12;
	boolean item_carry_femjewel13;
	boolean item_carry_femjewel14;
	boolean item_carry_femjewel15;
	boolean item_carry_femjewel16;
	boolean item_carry_femjewel17;
	boolean item_carry_femjewel18;
	boolean item_carry_femjewel19;
	boolean item_carry_femjewel20;
	boolean item_carry_femjewel21;
	boolean item_carry_femjewel22;
	boolean item_carry_femjewel23;
	boolean item_carry_femjewel24;
	boolean item_carry_femjewel25;
	boolean item_carry_femjewel26;
	boolean item_carry_femjewel27;
	boolean item_carry_femjewel28;
	boolean item_carry_femjewel29;
	boolean item_carry_femjewel30;
	boolean item_carry_femjewel31;
	boolean item_carry_femjewel32;
	boolean item_carry_femjewel33;
	boolean item_carry_femjewel34;
	boolean item_carry_femjewel35;
	boolean item_carry_femjewel36;
	boolean item_carry_femjewel37;
	boolean item_carry_femjewel38;
	boolean item_carry_femjewel39;
	boolean item_carry_femjewel40;
	boolean item_carry_femjewel41;
	boolean item_carry_femjewel42;
	boolean item_carry_femjewel43;
	boolean item_carry_femjewel44;
	boolean item_carry_femjewel45;
	boolean item_carry_femjewel46;
	boolean item_carry_femjewel47;
	boolean item_carry_femjewel48;
	boolean item_carry_femjewel49;
	boolean item_carry_femjewel50;
	boolean item_carry_femjewel51;
	boolean item_carry_femjewel52;
	boolean item_carry_femjewel53;
	boolean item_carry_femjewel54;
	boolean item_carry_femjewel55;
	boolean item_carry_femjewel56;
	boolean item_carry_femjewel57;
	boolean item_carry_femjewel58;
	boolean item_carry_femjewel59;
	boolean item_carry_femjewel60;
	boolean item_carry_femjewel61;
	boolean item_carry_femjewel62;
	boolean item_carry_femjewel63;
	boolean item_carry_femjewel64;
	boolean item_carry_femjewel65;
	boolean item_carry_femjewel66;
	boolean item_carry_femjewel67;
	boolean item_carry_femjewel68;
	boolean item_carry_femjewel69;
	boolean item_carry_femjewel70;
	boolean item_carry_femjewel71;
	boolean item_carry_femjewel72;
	boolean item_carry_femjewel73;
	boolean item_carry_femjewel74;
	boolean item_carry_femjewel75;
	boolean item_carry_femjewel76;
	boolean item_carry_femjewel77;
	boolean item_carry_femjewel78;
	boolean item_carry_femjewel79;
	boolean item_carry_femjewel80;
	boolean item_carry_femjewel81;
	boolean item_carry_femjewel82;
	boolean item_carry_femjewel83;
	boolean item_carry_femjewel84;
	boolean item_carry_femjewel85;
	boolean item_carry_femjewel86;
	boolean item_carry_femjewel87;
	boolean item_carry_femjewel88;
	boolean item_carry_femjewel89;
	boolean item_carry_femjewel90;
	boolean item_carry_femjewel91;
	boolean item_carry_femjewel92;
	boolean item_carry_femjewel93;
	boolean item_carry_femjewel94;
	boolean item_carry_femjewel95;
	boolean item_carry_femjewel96;
	boolean item_carry_femjewel97;
	boolean item_carry_femjewel98;
	boolean item_carry_femjewel99;
	boolean item_carry_femjewel100;
	boolean item_carry_femjewel101;
	boolean item_carry_femjewel102;
	boolean item_carry_femjewel103;
	boolean item_carry_femjewel104;
	boolean item_carry_femjewel105;
	boolean item_carry_femjewel106;
	boolean item_carry_femjewel107;
	boolean item_carry_femjewel108;
	boolean item_carry_femjewel109;
	boolean item_carry_femjewel110;

	boolean item_carry_nastystone1; /* these are for checking whether you have specific nastystones in your inventory, keyword "timerun" */
	boolean item_carry_nastystone2;
	boolean item_carry_nastystone3;
	boolean item_carry_nastystone4;
	boolean item_carry_nastystone5;
	boolean item_carry_nastystone6;
	boolean item_carry_nastystone7;
	boolean item_carry_nastystone8;
	boolean item_carry_nastystone9;
	boolean item_carry_nastystone10;
	boolean item_carry_nastystone11;
	boolean item_carry_nastystone12;
	boolean item_carry_nastystone13;
	boolean item_carry_nastystone14;
	boolean item_carry_nastystone15;
	boolean item_carry_nastystone16;
	boolean item_carry_nastystone17;
	boolean item_carry_nastystone18;
	boolean item_carry_nastystone19;
	boolean item_carry_nastystone20;
	boolean item_carry_nastystone21;
	boolean item_carry_nastystone22;
	boolean item_carry_nastystone23;
	boolean item_carry_nastystone24;
	boolean item_carry_nastystone25;
	boolean item_carry_nastystone26;
	boolean item_carry_nastystone27;
	boolean item_carry_nastystone28;
	boolean item_carry_nastystone29;
	boolean item_carry_nastystone30;
	boolean item_carry_nastystone31;
	boolean item_carry_nastystone32;
	boolean item_carry_nastystone33;
	boolean item_carry_nastystone34;
	boolean item_carry_nastystone35;
	boolean item_carry_nastystone36;
	boolean item_carry_nastystone37;
	boolean item_carry_nastystone38;
	boolean item_carry_nastystone39;
	boolean item_carry_nastystone40;
	boolean item_carry_nastystone41;
	boolean item_carry_nastystone42;
	boolean item_carry_nastystone43;
	boolean item_carry_nastystone44;
	boolean item_carry_nastystone45;
	boolean item_carry_nastystone46;
	boolean item_carry_nastystone47;
	boolean item_carry_nastystone48;
	boolean item_carry_nastystone49;
	boolean item_carry_nastystone50;
	boolean item_carry_nastystone51;
	boolean item_carry_nastystone52;
	boolean item_carry_nastystone53;
	boolean item_carry_nastystone54;
	boolean item_carry_nastystone55;
	boolean item_carry_nastystone56;
	boolean item_carry_nastystone57;
	boolean item_carry_nastystone58;
	boolean item_carry_nastystone59;
	boolean item_carry_nastystone60;
	boolean item_carry_nastystone61;
	boolean item_carry_nastystone62;
	boolean item_carry_nastystone63;
	boolean item_carry_nastystone64;
	boolean item_carry_nastystone65;
	boolean item_carry_nastystone66;
	boolean item_carry_nastystone67;
	boolean item_carry_nastystone68;
	boolean item_carry_nastystone69;
	boolean item_carry_nastystone70;
	boolean item_carry_nastystone71;
	boolean item_carry_nastystone72;
	boolean item_carry_nastystone73;
	boolean item_carry_nastystone74;
	boolean item_carry_nastystone75;
	boolean item_carry_nastystone76;
	boolean item_carry_nastystone77;
	boolean item_carry_nastystone78;
	boolean item_carry_nastystone79;
	boolean item_carry_nastystone80;
	boolean item_carry_nastystone81;
	boolean item_carry_nastystone82;
	boolean item_carry_nastystone83;
	boolean item_carry_nastystone84;
	boolean item_carry_nastystone85;
	boolean item_carry_nastystone86;
	boolean item_carry_nastystone87;
	boolean item_carry_nastystone88;
	boolean item_carry_nastystone89;
	boolean item_carry_nastystone90;
	boolean item_carry_nastystone91;
	boolean item_carry_nastystone92;
	boolean item_carry_nastystone93;
	boolean item_carry_nastystone94;
	boolean item_carry_nastystone95;
	boolean item_carry_nastystone96;
	boolean item_carry_nastystone97;
	boolean item_carry_nastystone98;
	boolean item_carry_nastystone99;
	boolean item_carry_nastystone100;
	boolean item_carry_nastystone101;
	boolean item_carry_nastystone102;
	boolean item_carry_nastystone103;
	boolean item_carry_nastystone104;
	boolean item_carry_nastystone105;
	boolean item_carry_nastystone106;
	boolean item_carry_nastystone107;
	boolean item_carry_nastystone108;
	boolean item_carry_nastystone109;
	boolean item_carry_nastystone110;
	boolean item_carry_nastystone111;
	boolean item_carry_nastystone112;
	boolean item_carry_nastystone113;
	boolean item_carry_nastystone114;
	boolean item_carry_nastystone115;
	boolean item_carry_nastystone116;
	boolean item_carry_nastystone117;
	boolean item_carry_nastystone118;
	boolean item_carry_nastystone119;
	boolean item_carry_nastystone120;
	boolean item_carry_nastystone121;
	boolean item_carry_nastystone122;
	boolean item_carry_nastystone123;
	boolean item_carry_nastystone124;
	boolean item_carry_nastystone125;
	boolean item_carry_nastystone126;
	boolean item_carry_nastystone127;
	boolean item_carry_nastystone128;
	boolean item_carry_nastystone129;
	boolean item_carry_nastystone130;
	boolean item_carry_nastystone131;
	boolean item_carry_nastystone132;
	boolean item_carry_nastystone133;
	boolean item_carry_nastystone134;
	boolean item_carry_nastystone135;
	boolean item_carry_nastystone136;
	boolean item_carry_nastystone137;
	boolean item_carry_nastystone138;
	boolean item_carry_nastystone139;
	boolean item_carry_nastystone140;
	boolean item_carry_nastystone141;
	boolean item_carry_nastystone142;
	boolean item_carry_nastystone143;
	boolean item_carry_nastystone144;
	boolean item_carry_nastystone145;
	boolean item_carry_nastystone146;
	boolean item_carry_nastystone147;
	boolean item_carry_nastystone148;
	boolean item_carry_nastystone149;
	boolean item_carry_nastystone150;
	boolean item_carry_nastystone151;
	boolean item_carry_nastystone152;
	boolean item_carry_nastystone153;
	boolean item_carry_nastystone154;
	boolean item_carry_nastystone155;
	boolean item_carry_nastystone156;
	boolean item_carry_nastystone157;
	boolean item_carry_nastystone158;
	boolean item_carry_nastystone159;
	boolean item_carry_nastystone160;
	boolean item_carry_nastystone161;
	boolean item_carry_nastystone162;
	boolean item_carry_nastystone163;
	boolean item_carry_nastystone164;
	boolean item_carry_nastystone165;
	boolean item_carry_nastystone166;
	boolean item_carry_nastystone167;
	boolean item_carry_nastystone168;
	boolean item_carry_nastystone169;
	boolean item_carry_nastystone170;
	boolean item_carry_nastystone171;
	boolean item_carry_nastystone172;
	boolean item_carry_nastystone173;
	boolean item_carry_nastystone174;
	boolean item_carry_nastystone175;
	boolean item_carry_nastystone176;
	boolean item_carry_nastystone177;
	boolean item_carry_nastystone178;
	boolean item_carry_nastystone179;
	boolean item_carry_nastystone180;
	boolean item_carry_nastystone181;
	boolean item_carry_nastystone182;
	boolean item_carry_nastystone183;
	boolean item_carry_nastystone184;
	boolean item_carry_nastystone185;
	boolean item_carry_nastystone186;
	boolean item_carry_nastystone187;
	boolean item_carry_nastystone188;
	boolean item_carry_nastystone189;
	boolean item_carry_nastystone190;
	boolean item_carry_nastystone191;
	boolean item_carry_nastystone192;
	boolean item_carry_nastystone193;
	boolean item_carry_nastystone194;
	boolean item_carry_nastystone195;
	boolean item_carry_nastystone196;
	boolean item_carry_nastystone197;
	boolean item_carry_nastystone198;
	boolean item_carry_nastystone199;
	boolean item_carry_nastystone200;
	boolean item_carry_nastystone201;
	boolean item_carry_nastystone202;
	boolean item_carry_nastystone203;
	boolean item_carry_nastystone204;
	boolean item_carry_nastystone205;
	boolean item_carry_nastystone206;
	boolean item_carry_nastystone207;
	boolean item_carry_nastystone208;
	boolean item_carry_nastystone209;
	boolean item_carry_nastystone210;
	boolean item_carry_nastystone211;
	boolean item_carry_nastystone212;
	boolean item_carry_nastystone213;
	boolean item_carry_nastystone214;
	boolean item_carry_nastystone215;
	boolean item_carry_nastystone216;
	boolean item_carry_nastystone217;
	boolean item_carry_nastystone218;
	boolean item_carry_nastystone219;
	boolean item_carry_nastystone220;
	boolean item_carry_nastystone221;
	boolean item_carry_nastystone222;
	boolean item_carry_nastystone223;
	boolean item_carry_nastystone224;
	boolean item_carry_nastystone225;
	boolean item_carry_nastystone226;
	boolean item_carry_nastystone227;
	boolean item_carry_nastystone228;
	boolean item_carry_nastystone229;
	boolean item_carry_nastystone230;
	boolean item_carry_nastystone231;
	boolean item_carry_nastystone232;
	boolean item_carry_nastystone233;
	boolean item_carry_nastystone234;
	boolean item_carry_nastystone235;
	boolean item_carry_nastystone236;
	boolean item_carry_nastystone237;
	boolean item_carry_nastystone238;
	boolean item_carry_nastystone239;
	boolean item_carry_nastystone240;
	boolean item_carry_nastystone241;
	boolean item_carry_nastystone242;
	boolean item_carry_nastystone243;
	boolean item_carry_nastystone244;
	boolean item_carry_nastystone245;
	boolean item_carry_nastystone246;
	boolean item_carry_nastystone247;
	boolean item_carry_nastystone248;
	boolean item_carry_nastystone249;
	boolean item_carry_nastystone250;
	boolean item_carry_nastystone251;
	boolean item_carry_nastystone252;
	boolean item_carry_nastystone253;
	boolean item_carry_nastystone254;
	boolean item_carry_nastystone255;
	boolean item_carry_nastystone256;
	boolean item_carry_nastystone257;
	boolean item_carry_nastystone258;
	boolean item_carry_nastystone259;
	boolean item_carry_nastystone260;
	boolean item_carry_nastystone261;
	boolean item_carry_nastystone262;
	boolean item_carry_nastystone263;
	boolean item_carry_nastystone264;
	boolean item_carry_nastystone265;
	boolean item_carry_nastystone266;
	boolean item_carry_nastystone267;
	boolean item_carry_nastystone268;
	boolean item_carry_nastystone269;
	boolean item_carry_nastystone270;
	boolean item_carry_nastystone271;
	boolean item_carry_nastystone272;
	boolean item_carry_nastystone273;
	boolean item_carry_nastystone274;
	boolean item_carry_nastystone275;
	boolean item_carry_nastystone276;
	boolean item_carry_nastystone277;
	boolean item_carry_nastystone278;
	boolean item_carry_nastystone279;
	boolean item_carry_nastystone280;
	boolean item_carry_nastystone281;
	boolean item_carry_nastystone282;
	boolean item_carry_nastystone283;
	boolean item_carry_nastystone284;
	boolean item_carry_nastystone285;
	boolean item_carry_nastystone286;
	boolean item_carry_nastystone287;
	boolean item_carry_nastystone288;
