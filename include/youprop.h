...
#define ExtResistancePiercing	(EResistancePiercing || (uwep && uwep->oartifact == ART_USELESS_TALK) || (uarmu && uarmu->oartifact == ART_HA_HA_HA_HA___) || (uarm && uarm->oartifact == ART_ALTADOON_HERMA_MORA) || (uwep && uwep->oartifact == ART_MR__OF_HIGH_HEELS) || (uwep && uwep->oartifact == ART_ETHER_DAGGER) || (uwep && uwep->oartifact == ART_DAGGER_SURROUNDED_BY_WIND) || (uarmh && uarmh->oartifact == ART_DAN_THE_MAGE) || (uarmg && uarmg->oartifact == ART_SPELLSNIPE) || (uwep && uwep->oartifact == ART_MARC_S_WRONG_SPELL) || (uarmf && uarmf->oartifact == ART_SMILE_Z) || (uarmh && uarmh->oartifact == ART_DREHTURN) || (uarmg && uarmg->oartifact == ART_DATLEST_KRANN) || (uarms && uarms->oartifact == ART_TARTSCH) || (powerfulimplants() && uimplant && (goodimplanteffect(uimplant) == RESISTANCE_PIERCING) ) )
