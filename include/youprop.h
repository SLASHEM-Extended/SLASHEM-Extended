...
#define ExtDefusing	(EDefusing || (uarmf && uarmf->oartifact == ART_GHETTO_ROCKZ) || (uarm && uarm->oartifact == ART_ARMS_OVERSIGHT) || (uwep && uwep->oartifact == ART_GO_FULLY_OFF) || (uarm && uarm->oartifact == ART_ENCHANTED__OF_DEFUSING) || (uarm && uarm->oartifact == ART_BEEPA_DEVICE) || (uwep && uwep->oartifact == ART_HALF_SUPER_ENCHANTMENT) || (uamul && uamul->oartifact == ART_______SCORE) || (uamul && uamul->oartifact == ART_ARVIAT_S_LOAD) || (ublindf && ublindf->otyp == DEFUSING_BOX) || (powerfulimplants() && uimplant && (goodimplanteffect(uimplant) == DEFUSING) ) )
...
#define ExtResistancePiercing	(EResistancePiercing || (uwep && uwep->oartifact == ART_USELESS_TALK) || (uarmu && uarmu->oartifact == ART_HA_HA_HA_HA___) || (uarm && uarm->oartifact == ART_ALTADOON_HERMA_MORA) || (uwep && uwep->oartifact == ART_MR__OF_HIGH_HEELS) || (uwep && uwep->oartifact == ART_ETHER_DAGGER) || (uwep && uwep->oartifact == ART_DAGGER_SURROUNDED_BY_WIND) || (uarm && uarm->oartifact == ART_SPAMRESIST) || (uarm && uarm->oartifact == ART_FIRE_AWAY) || (uarmh && uarmh->oartifact == ART_DAN_THE_MAGE) || (uarmh && uarmh->oartifact == ART_JOLENE_S_ZEAL) || (uarmg && uarmg->oartifact == ART_SPELLSNIPE) || (uwep && uwep->oartifact == ART_MARC_S_WRONG_SPELL) || (uarmf && uarmf->oartifact == ART_SMILE_Z) || (uarmh && uarmh->oartifact == ART_DREHTURN) || (uarmg && uarmg->oartifact == ART_DATLEST_KRANN) || (uarms && uarms->oartifact == ART_TARTSCH) || (powerfulimplants() && uimplant && (goodimplanteffect(uimplant) == RESISTANCE_PIERCING) ) )
