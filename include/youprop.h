...
#define Sleep_resistance	( !( (Thirst || (uwep && uwep->oartifact == ART_LUISA_S_CHARMING_BEAUTY) || (u.twoweap && uswapwep && uswapwep->oartifact == ART_LUISA_S_CHARMING_BEAUTY) || u.uprops[THIRST].extrinsic || have_thirststone()) && (u.uhunger > 2000 ) ) && !Race_if(PM_KOBOLT) && !Race_if(PM_DEEP_ELF) && !have_sleepstone() && !NoSleep_resistance && ( (HSleep_resistance && !(u.nonintrinsicproperty == SLEEP_RES)) || ESleep_resistance || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == SLEEP_RES) ) || (uwep && uwep->oartifact == ART_SLEEPLESS_NIGHTS) || (uarmh && uarmh->oartifact == ART_JESTES_TAKA_KURWA) || (uarmf && uarmf->oartifact == ART_NASTIST) || (uarmf && uarmf->oartifact == ART_BLUEDE) || (uarmh && uarmh->oartifact == ART_UNIMPORTANT_ELEMENTS) || (uarmu && uarmu->oartifact == ART_PRISMATIC_SHIRT) || FemaleTrapNatalje || (uarmf && uarmf->oartifact == ART_JESSICA_S_TENDERNESS) || (uarmh && uarmh->oartifact == ART_HAVE_ALL_YOU_NEED) || (uamul && uamul->oartifact == ART_SNOREFEST && (moves % 10 != 0) ) || \
...
#define See_invisible		(((HSee_invisible && !(u.nonintrinsicproperty == SEE_INVIS)) || ESee_invisible || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == SEE_INVIS) ) || (uarmc && uarmc->oartifact == ART_VISIBLE_INVISIBILITITY) || (uimplant && uimplant->oartifact == ART_POTATOROK) || (uarmc && uarmc->oartifact == ART_CAN_T_KILL_WHAT_YOU_CAN_T_) || (uwep && uwep->oartifact == ART_SECRETS_OF_INVISIBLE_PLEAS) || \
...
#define Clairvoyant		(((HClairvoyant && !(u.nonintrinsicproperty == CLAIRVOYANT)) || EClairvoyant || (uwep && uwep->oartifact == ART_TOOTH_OF_SHAI_HULUD) || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == CLAIRVOYANT) ) || (uamul && uamul->oartifact == ART_WOUUU) || (uarmh && uarmh->otyp == ART_WSCHIIIIIE_) ) &&\
...
#define Half_physical_damage	(((HHalf_physical_damage && !(u.nonintrinsicproperty == HALF_PHDAM)) || EHalf_physical_damage || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == HALF_PHDAM) ) || (uwep && uwep->otyp == SECRET_WHIP) || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && uimplant->oartifact == ART_POTATOROK) || (uarmh && OBJ_DESCR(objects[uarmh->otyp]) && (!strcmp(OBJ_DESCR(objects[uarmh->otyp]), "cloudy helmet") || !strcmp(OBJ_DESCR(objects[uarmh->otyp]), "oblachnyy shlem") || !strcmp(OBJ_DESCR(objects[uarmh->otyp]), "bulutli dubulg'a")) && isok(u.ux, u.uy) && IS_CLOUD(levl[u.ux][u.uy].typ) ) || (uarmc && (moves % 10 == 0) && OBJ_DESCR(objects[uarmc->otyp]) && ( !strcmp(OBJ_DESCR(objects[uarmc->otyp]), "soft cloak") || !strcmp(OBJ_DESCR(objects[uarmc->otyp]), "myagkiy plashch") || !strcmp(OBJ_DESCR(objects[uarmc->otyp]), "yumshoq plash") ) ) || (ublindf && ublindf->otyp == SOFT_CHASTITY_BELT) ) && !NoHalf_physical_damage)
...
#define Conf_resist		(((HConf_resist && !(u.nonintrinsicproperty == CONF_RES)) || Race_if(PM_EROSATOR) || EConf_resist || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == CONF_RES) ) || tech_inuse(T_STAT_RESIST) || (uarmf && uarmf->oartifact == ART_BOOTS_OF_THE_MACHINE) || (uwep && uwep->oartifact == ART_OGRESMASHER____) || (uarmh && uarmh->oartifact == ART_CLAUDIA_S_DIRECTION_FINDER) || (uarmf && uarmf->oartifact == ART_SANDRA_S_BEAUTIFUL_FOOTWEA) || (uarms && uarms->oartifact == ART_FIVE_STAR_PARTY) || (uarmu && uarmu->oartifact == ART_TOTAL_CONTROL) || (uarmc && uarmc->oartifact == ART_FREQUENT_BUT_WEAK_STATUS) ) && !NoConf_resist)
...
#define Cont_resist		(((HCont_resist && !(u.nonintrinsicproperty == CONT_RES)) || ECont_resist || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && uimplant->oartifact == ART_ARABELLA_S_SEXY_CHARM) || (uimplant && uimplant->oartifact == ART_POTATOROK) || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == CONT_RES) )) && !NoCont_resist)
...
#define Discount_action		(((HDiscount_action && !(u.nonintrinsicproperty == DISCOUNT_ACTION)) || EDiscount_action ||  (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && uimplant->oartifact == ART_CAN_T_BRING_US_DOWN) || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == DISCOUNT_ACTION) )) && !NoDiscount_action)
