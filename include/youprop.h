...
#define IntTeleportation	(HTeleportation || autismringcheck(ART_TO_JUDITHBIS) || can_teleport(youmonst.data) || Race_if(PM_MAIA) || Race_if(PM_HUMANOID_LEPRECHAUN))
...
#define ExtPainSense	(EPainSense || (uarmf && uarmf->oartifact == ART_CUTE_JEANS) || have_feeldasag() || (uwep && uwep->oartifact == ART_TANKFRIEND) || (uamul && objects[uamul->otyp].oc_color == CLR_BLUE) || (uleft && objects[uleft->otyp].oc_color == CLR_BLUE) || (uright && objects[uright->otyp].oc_color == CLR_BLUE) || (uimplant && objects[uimplant->otyp].oc_color == CLR_BLUE) || (ublindf && objects[ublindf->otyp].oc_color == CLR_BLUE) || (uarmf && objects[uarmf->otyp].oc_color == CLR_BLUE) || (uarmh && objects[uarmh->otyp].oc_color == CLR_BLUE) || (uarmu && uarmu->oartifact == ART_DAMAGO_KLARA) || (uamul && uamul->oartifact == ART_______SCORE) || (uarmg && objects[uarmg->otyp].oc_color == CLR_BLUE) || (uarmc && objects[uarmc->otyp].oc_color == CLR_BLUE) || (uarmu && objects[uarmu->otyp].oc_color == CLR_BLUE) || autismringcheck(ART_PAYN_HU) || (uarms && objects[uarms->otyp].oc_color == CLR_BLUE) || (uarm && objects[uarm->otyp].oc_color == CLR_BLUE) || autismringcheck(ART_SENSELBLUE) || (uwep && objects[uwep->otyp].oc_color == CLR_BLUE) )
