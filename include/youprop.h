...
#define IntFire_resistance	(HFire_resistance || FireImmunity || (uarm && uarm->oartifact == ART_DUEUEUEUET) || (uarm && uarm->oartifact == ART_COAL_PEER) || resists_fire(&youmonst) || (uarm && uarm->oartifact == ART_COMPLETE_ARMORING) || is_fire_resistant(youmonst.data) || (uarms && uarms->oartifact == ART_HEATEM_UP) || (uarms && uarms->oartifact == ART_THATS_ENOUGH_RIGHT_THERE) || (powerfulsymbiosis() && is_fire_resistant(&mons[u.usymbiote.mnum])) )
...
#define FireImmunity		((uarm && uarm->oartifact == ART_COAL_PEER) || (uarms && uarms->oartifact == ART_THATS_ENOUGH_RIGHT_THERE) || Race_if(PM_HYPOTHERMIC))

#define HCold_resistance	u.uprops[COLD_RES].intrinsic
#define ECold_resistance	u.uprops[COLD_RES].extrinsic
#define IntCold_resistance	(HCold_resistance || ColdImmunity || (uwep && uwep->oartifact == ART_CUTRELEASE) || resists_cold(&youmonst) || (uwep && uwep->oartifact == ART_WINTERHOLD_S_KEEP) || is_cold_resistant(youmonst.data) || (powerfulsymbiosis() && is_cold_resistant(&mons[u.usymbiote.mnum])))
...
#define ColdImmunity		((uwep && uwep->oartifact == ART_CUTRELEASE) || (uwep && uwep->oartifact == ART_WINTERHOLD_S_KEEP))
...
#define AcidImmunity		((uarm && uarm->oartifact == ART_NULARMOR) || (uarmf && uarmf->oartifact == ART_POCAHONTAS_HOME))
...
#define FemtrapActiveJane	(FemaleTrapJane || u.uprops[FEMTRAP_JANE].extrinsic || have_femtrapjane() || (uarm && uarm->oartifact == ART_SUIT_OF_JANE_MAIL) )
...
#define ExtFreezopathy	(EFreezopathy || (uarmf && uarmf->oartifact == ART_LITTLE_ICE_BLOCK_WITH_THE_) || (uarmh && uarmh->oartifact == ART_INCREDIBLE_VIEW) || (uarms && uarms->oartifact == ART_IT_IS_COMPLETE_NOW) || (uarmc && uarmc->oartifact == ART_SIECHELALUER) )
...
#define ExtExtra_wpn_practice	(EExtra_wpn_practice || have_superjonadabstone() || (powerfulimplants() && uimplant && uimplant->oartifact == ART_FASTPLANT) || (uwep && uwep->oartifact == ART_ARABELLA_S_BLACK_PRONG) || (powerfulimplants() && uimplant && (goodimplanteffect(uimplant) == EXTRA_WEAPON_PRACTICE) ) || (uarm && uarm->oartifact == ART_EVERYTHING_COMES_WITH_A_CO) || (uarmu && uarmu->oartifact == ART_CAPITAL_RAP) || (uarmc && uarmc->oartifact == ART_SKILLS_BEAT_STATS) || (uarm && uarm->oartifact == ART_MOTHERFUCKER_TROPHY) )
...
#define ExtJumping	(EJumping || (uwep && uwep->oartifact == ART_DIZZY_METAL_STORM) || (uarmc && uarmc->oartifact == ART_ROKKO_CHAN_S_SUIT) || (uarmf && uarmf->oartifact == ART_AIRSHIP_DANCING) || (uarmf && uarmf->oartifact == ART_SEVEN_LEAGUE_BOOTS) || (uwep && uwep->oartifact == ART_JUMP_HURRIES) || (uarmf && uarmf->oartifact == ART_JUMP_KICK_ACTION) || (uarmf && uarmf->oartifact == ART_ARVOGENIA_S_BIKER_HEELS && u.usteed) || (uarm && uarm->oartifact == ART_LUKE_S_JEDI_POWER) || (uarmf && uarmf->oartifact == ART_PRINCE_OF_PERSIA) || (uwep && uwep->oartifact == ART_SUPERGIRL_S_JUMP_AND_RUN_F) || (uwep && uwep->oartifact == ART_STRINGFELLOW_HOUKI) || (uamul && uamul->oartifact == ART_ONLY_ONE_ESCAPE) || u.uprops[MULTISHOES].extrinsic)
...
#define ExtUseTheForce	(EUseTheForce || (uarm && uarm->oartifact == ART_SUSA_MAIL) || (uwep && uwep->oartifact == ART_THAIFORCE) || (uwep && uwep->oartifact == ART_HENRIETTENFORCE) || (powerfulimplants() && uimplant && (goodimplanteffect(uimplant) == THE_FORCE) ) || (uarm && uarm->oartifact == ART_LUKE_S_JEDI_POWER))
...
#define ExtScentView	(EScentView || (uarm && uarm->oartifact == ART_FARTHER_INTO_THE_JUNGLE) || (uarmf && uarmf->oartifact == ART_CAMELIC_SCENT) || (uarmh && uarmh->oartifact == ART_HEARING_EAR) || (uarmh && uarmh->oartifact == ART_COMPLETE_SIGHT) || (powerfulimplants() && uimplant && uimplant->oartifact == ART_THEY_RE_REALLY_AFTER_ME) || (uwep && uwep->oartifact == ART_HELIOPOLIS_MISTAKE) || (uarm && uarm->oartifact == ART_CRYPT_SMELL && in_rooms(u.ux, u.uy, CRYPTROOM)) || (uarmf && uarmf->oartifact == ART_SAFARI_ROCKZ) || (ublindf && ublindf->oartifact == ART_SCENTFOLD) )
...
#define ExtMagicFindBonus	(EMagicFindBonus || (uarmu && uarmu->oartifact == ART_ALL_IN_ONE_EFF) || (uarmh && uarmh->oartifact == ART_DLANGOUT) || (uarms && uarms->oartifact == ART_UNUSUAL_ENCH) || (uarm && uarm->oartifact == ART_OUTMINE_OF_METAL) || (uarm && uarm->oartifact == ART_FORTUTIOUSNESS_SIC_) || (uarmc && uarmc->oartifact == ART_DEEPFOUND) || autismringcheck(ART_LOOKIE_LOOKIE) || (uarmc && uarmc->oartifact == ART_FINDEET) || (uarms && uarms->oartifact == ART_GIT_ALL_DE_ARTS_NO) || (uwep && uwep->oartifact == ART_MR__OF_HIGH_HEELS) || (powerfulimplants() && uimplant && (goodimplanteffect(uimplant) == MAGIC_FIND) ) )
