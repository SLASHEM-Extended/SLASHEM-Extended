...
#define ExtWildWeatherEffect	(EWildWeatherEffect || autismweaponcheck(ART_THUNDERDOME_BAR) || autismweaponcheck(ART_FOREST_FIRE) || autismweaponcheck(ART_MAGIHEX) || (uarmh && uarmh->oartifact == ART_SPRING_BREEZE) || (uarmc && uarmc->oartifact == ART_OUT_OF_THE_RAIN) || (uarmu && uarmu->oartifact == ART_EVERY_EVENTUALITY) || (uamul && uamul->oartifact == ART_______SCORE) )
