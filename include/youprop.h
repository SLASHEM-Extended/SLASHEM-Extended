...
#define FemtrapActiveClaudia	(FemaleTrapClaudia || u.uprops[FEMTRAP_CLAUDIA].extrinsic || have_femtrapclaudia() || (uarmu && uarmu->oartifact == ART_CLOUDYBAND) || (ublindf && ublindf->oartifact == ART_MONIQUE_S_NONSENSE) )
