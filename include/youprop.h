...
#define FemtrapActiveAnastasia	(FemaleTrapAnastasia || u.uprops[FEMTRAP_ANASTASIA].extrinsic || have_femtrapanastasia() || (uarmf && uarmf->oartifact == ART_THAT_S_SUPER_UNFAIR) || (uarmf && uarmf->oartifact == ART_PLAYING_ANASTASIA) || (uwep && uwep->oartifact == ART_REAL_WALKING) || (uarmf && uarmf->oartifact == ART_SHE_S_STILL_AN_ANASTASIA) || (u.twoweap && uswapwep && uswapwep->oartifact == ART_REAL_WALKING) || (uwep && uwep->oartifact == ART_DAMN_SKI_WEDGE && !uarmf) || (u.twoweap && uswapwep && uswapwep->oartifact == ART_DAMN_SKI_WEDGE && !uarmf) || (uarmf && uarmf->oartifact == ART_FASTER_THAN_ALL_OTHERS_INT))
