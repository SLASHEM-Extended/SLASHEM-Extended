...
#define FemtrapActiveAnastasia	(FemaleTrapAnastasia || u.uprops[FEMTRAP_ANASTASIA].extrinsic || have_femtrapanastasia() || (uarmf && uarmf->oartifact == ART_THAT_S_SUPER_UNFAIR) || (uwep && uwep->oartifact == ART_REAL_WALKING) || (u.twoweap && uswapwep && uswapwep->oartifact == ART_REAL_WALKING) || (uarmf && uarmf->oartifact == ART_FASTER_THAN_ALL_OTHERS_INT))
