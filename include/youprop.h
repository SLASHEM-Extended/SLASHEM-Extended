...
#define See_invisible		(((HSee_invisible && !(u.nonintrinsicproperty == SEE_INVIS)) || ESee_invisible || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == SEE_INVIS) ) || (uarmc && uarmc->oartifact == ART_VISIBLE_INVISIBILITITY) || (uarmc && uarmc->oartifact == ART_CAN_T_KILL_WHAT_YOU_CAN_T_) || (uwep && uwep->oartifact == ART_SECRETS_OF_INVISIBLE_PLEAS) || \
...
#define Teleport_control	(((HTeleport_control && !(u.nonintrinsicproperty == TELEPORT_CONTROL)) || ETeleport_control || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == TELEPORT_CONTROL) ) || \
...
#define Half_spell_damage	(((HHalf_spell_damage && !(u.nonintrinsicproperty == HALF_SPDAM)) || EHalf_spell_damage || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == HALF_SPDAM) )) && !NoHalf_spell_damage)
...
#define Regeneration		(((HRegeneration && !(u.nonintrinsicproperty == REGENERATION)) || ERegeneration || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == REGENERATION) ) || (uarmf && uarmf->oartifact == ART_ERROR_IN_PLAY_ENCHANTMENT) || \
...
#define Cont_resist		(((HCont_resist && !(u.nonintrinsicproperty == CONT_RES)) || ECont_resist || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == CONT_RES) )) && !NoCont_resist)
...
#define Discount_action		(((HDiscount_action && !(u.nonintrinsicproperty == DISCOUNT_ACTION)) || EDiscount_action || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == DISCOUNT_ACTION) )) && !NoDiscount_action)
#define NoDiscount_action	(!Race_if(PM_IMMUNIZER) && (u.uprops[DEAC_DISCOUNT_ACTION].intrinsic || (isevilvariant && Free_action) || RngeAids || (u.nonextrinsicproperty == DISCOUNT_ACTION && !HDiscount_action) || (u.impossibleproperty == DISCOUNT_ACTION) || (Race_if(PM_HUMANOID_ANGEL) && u.ualign.record < 0)))

#define HFull_nutrient		u.uprops[FULL_NUTRIENT].intrinsic
#define EFull_nutrient		u.uprops[FULL_NUTRIENT].extrinsic
#define Full_nutrient		(((HFull_nutrient && !(u.nonintrinsicproperty == FULL_NUTRIENT)) || EFull_nutrient || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == FULL_NUTRIENT) )) && !NoFull_nutrient)
...
#define Technicality		(((HTechnicality && !(u.nonintrinsicproperty == TECHNICALITY)) || ETechnicality || (nohands(youmonst.data) && !Race_if(PM_TRANSFORMER) && uimplant && (goodimplanteffect(uimplant) == TECHNICALITY) )) && !NoTechnicality)
