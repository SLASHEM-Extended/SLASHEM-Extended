...
#define ExtWildWeatherEffect	(EWildWeatherEffect || (uarmc && uarmc->oartifact == ART_OUT_OF_THE_RAIN) || (uarmu && uarmu->oartifact == ART_EVERY_EVENTUALITY) || (uamul && uamul->oartifact == ART_______SCORE) )
