...
#define isvanillaarmor(number) (number == HAWAIIAN_SHIRT || number == T_SHIRT || number == STRIPED_SHIRT || number == PLATE_MAIL || number == RIBBED_PLATE_MAIL || number == PARTIAL_PLATE_MAIL || number == FULL_PLATE_MAIL || number == PLASTEEL_ARMOR || number == CRYSTAL_PLATE_MAIL || number == BRONZE_PLATE_MAIL || number == SPLINT_MAIL || number == METAL_LAMELLAR_ARMOR || number == BANDED_MAIL || number == DWARVISH_MITHRIL_COAT || number == DARK_ELVEN_MITHRIL_COAT || number == ELVEN_MITHRIL_COAT || number == GNOMISH_SUIT || number == CHAIN_MAIL || number == BAR_CHAIN_MAIL || number == BAMBOO_MAIL || number == SILK_MAIL || number == ORCISH_CHAIN_MAIL || number == SCALE_MAIL || number == STUDDED_LEATHER_ARMOR || number == RING_MAIL || number == HEAVY_MAIL || number == LIGHT_MAIL || number == ORCISH_RING_MAIL || number == LEATHER_ARMOR || number == LEATHER_JACKET || number == ROBE || number == MUMMY_WRAPPING || number == ORCISH_CLOAK || number == DWARVISH_CLOAK || number == ELVEN_CLOAK || number == LEATHER_CLOAK || number == PLASTEEL_CLOAK || number == ELVEN_LEATHER_HELM || number == GNOMISH_HELM || number == ORCISH_HELM || number == DWARVISH_IRON_HELM || number == FEDORA || number == DENTED_POT || number == STANDARD_HELMET || number == PLASTEEL_GLOVES || number == REGULAR_GLOVES || number == SMALL_SHIELD || number == HEAVY_SHIELD || number == ELVEN_SHIELD || number == URUK_HAI_SHIELD || number == ORCISH_SHIELD || number == LARGE_SHIELD || number == PAPER_SHIELD || number == DWARVISH_ROUNDSHIELD || number == SHIELD || number == LOW_BOOTS || number == IRON_SHOES || number == GNOMISH_BOOTS || number == HIGH_BOOTS)
