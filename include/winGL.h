...
E int sdlgl_test_tile_visible(int, int, int, int, int);
E void sdlgl_set_start_depth(int);

E void sdlgl_store_char(struct TileWindow *, int, int, char, rgbcol_t);
E int sdlgl_store_str(struct TileWindow *, int, int, const char *, int, rgbcol_t);
E void sdlgl_store_tile(struct TileWindow *, int, int, tileidx_t, tileidx_t, tileidx_t, tileflags_t);
E void sdlgl_blank_area(struct TileWindow *, int, int, int, int);
E void sdlgl_copy_area(struct TileWindow *, int, int, int, int, int, int);
E void sdlgl_transfer_area(struct TileWindow *, int, int, int, int, struct TileWindow *, int, int);
E void sdlgl_transfer_line(struct TileWindow *, int, int, int, struct TilePair *, int);
E void sdlgl_set_scale(struct TileWindow *, int);
E void sdlgl_set_cursor(struct TileWindow *, int, int, int);
...
E int sdlgl_save_ppm_file(const char *, const unsigned char *, int, int);
...
#ifdef GL_GRAPHICS
E GLuint sdlgl_send_graphic_RGBA(unsigned char *, int, int);
#endif
...
E void sdlgl_set_surface_colors(SDL_Surface *);
E SDL_Surface *sdlgl_RGBA_to_truecolor(unsigned char *, int, int);
E SDL_Surface *sdlgl_RGBA_to_palettised(unsigned char *, int, int);
E SDL_Surface *sdlgl_shrink_surface(SDL_Surface *);
E void sdlgl_sw_create_has_alpha(struct TileSet *);

E void sdlgl_create_font_cache(struct TileSet *);
E void sdlgl_free_font_cache(struct TileSet *);
E void sdlgl_font_cache_lookup(struct TileSet *, tileidx_t, tilecol_t, int *, int *);

E struct DirtyMatrix *sdlgl_create_dirty_matrix(int, int);
E void sdlgl_free_dirty_matrix(struct DirtyMatrix *);
E void sdlgl_dirty_matrix_clear(struct DirtyMatrix *);
E void sdlgl_dirty_matrix_add(struct DirtyMatrix *, int, int, int, int, int);
E int sdlgl_dirty_matrix_test(struct DirtyMatrix *, int, int, int, int, int);
E int sdlgl_dirty_matrix_to_updaters(struct DirtyMatrix *);
E void sdlgl_dirty_matrix_blit(struct DirtyMatrix *, SDL_Surface *, SDL_Rect *, SDL_Rect *, Uint32, int);
...
E winid Sdlgl_create_nhwindow(int);
E void Sdlgl_clear_nhwindow(winid);
E void Sdlgl_display_nhwindow(winid, BOOLEAN_P);
E void Sdlgl_dismiss_nhwindow(winid);
E void Sdlgl_destroy_nhwindow(winid);
...
E int sdlgl_internal_key_handler(SDL_keysym *, int);
E int sdlgl_internal_button_handler(SDL_MouseButtonEvent *);
E void sdlgl_internal_motion_handler(SDL_MouseMotionEvent *);
...
E void Sdlgl_start_menu(winid);
E void Sdlgl_add_menu(winid,int,const ANY_P *, CHAR_P,CHAR_P,int,const char *, BOOLEAN_P);
E void Sdlgl_end_menu(winid, const char *);
E int Sdlgl_select_menu(winid, int, MENU_ITEM_P **);
E char Sdlgl_message_menu(CHAR_P,int,const char *);
E char Sdlgl_yn_function(const char *, const char *, CHAR_P);

E void sdlgl_clear_menu_items(struct TextWindow *);
E int sdlgl_process_menu_window(int, struct TextWindow *, int);
...
E void Sdlgl_display_file(const char *, BOOLEAN_P);

E void sdlgl_clear_text_items(struct TextWindow *);
E void sdlgl_insert_text_item(struct TextWindow *, struct TextItem *, int, int, const char *);
E void sdlgl_process_text_window(int, struct TextWindow *);
...
E void Sdlgl_cliparound(int, int);
E void Sdlgl_update_positionbar(char *);
E void Sdlgl_print_glyph(winid,XCHAR_P,XCHAR_P,int);
...
E void sdlgl_putc(struct TextWindow *, int);
E void sdlgl_puts(struct TextWindow *, const char *);
E void sdlgl_puts_nolf(struct TextWindow *, const char *);
E void sdlgl_gotoxy(struct TextWindow *, int, int);
E void sdlgl_home(struct TextWindow *);
E void sdlgl_backsp(struct TextWindow *);
E void sdlgl_clear(struct TextWindow *);
E void sdlgl_clear_end(struct TextWindow *);
E void sdlgl_clear_eos(struct TextWindow *);
E void sdlgl_enable_cursor(struct TextWindow *, int);


/*
 * GL_STAT
 */
E void sdlgl_write_status(struct TextWindow *win);
E void sdlgl_update_status(int);
