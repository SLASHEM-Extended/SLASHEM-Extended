...
#define tp_sensemon(mon) (	/* The hero can always sense a monster IF:  */\
	...
	(!mindless((mon)->data) && (!mon->egotype_undead) ) &&	/* 1. the monster has a brain to sense AND  */\
      (( (Blind || (uarm && uarm->oartifact == ART_COLONEL_BASTARD_S_HIDDEN_A && uarmh && uarmh->oartifact == ART_COLONEL_BASTARD_S_BALLISTI) ) && Blind_telepat &&				/* 2a. hero is blind and telepathic     */\
