...
#define touch_petrifies(ptr)	(ptr == &mons[PM_COCKATRICE] || \
				 ...
				 ptr == &mons[PM_HIDDEN_ENGULFITRICE] || \
				 ptr == &mons[PM_BASILISK] || \
				 ptr == &mons[PM_DRACOLISK] || \
				 ptr == &mons[PM_STONE_BUG] || \
				 ptr == &mons[PM_STONING_SPHERE] || \
				 ...
				 ptr == &mons[PM_PETRO_SPORE] || \
				 ptr == &mons[PM_PETRO_STALK] || \
				 ptr == &mons[PM_PETRO_GROWTH] || \
				 ptr == &mons[PM_PETRO_MUSHROOM] || \
				 ptr == &mons[PM_PETRO_COLONY] || \
