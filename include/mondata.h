...
#define is_reviver(ptr)		(is_rider(ptr) || is_deadlysin(ptr) || ((ptr)->mlet == S_FUNGUS && !nocorpsedecay(ptr) ) || \
				 (ptr)->mlet == S_TROLL || (ptr) == &mons[PM_ROT_WALKER] || (ptr) == &mons[PM_ROT_CONVERTER] || (ptr) == &mons[PM_RED_DEATH] || (ptr) == &mons[PM_LITCH_DEMON] || (ptr) == &mons[PM_UNDEAD_BALROG] || (ptr) == &mons[PM_BONE_DEMON] || (ptr) == &mons[PM_RUST_CONVERTER] || (ptr) == &mons[PM_GRETA_S_HUGGING_BOOT] || (ptr) == &mons[PM_VANESSA_S_THICK_LADY_SHOE] || (ptr) == &mons[PM_SARAH_S_HUGGING_BOOT] || (ptr) == &mons[PM_CONNY_S_COMBAT_BOOT] || (ptr) == &mons[PM_SUE_LYN_S_THICK_WINTER_BOOT] || (ptr) == &mons[PM_VERENA_S_WORN_OUT_COMBAT_BOOT] || (ptr) == &mons[PM_VERENA_S_STILETTO_SANDAL] || (ptr) == &mons[PM_REANIMATED_HORDE] || (ptr) == &mons[PM_PROWLING_DEAD_POTATO] || (ptr) == &mons[PM_UNHOLY_CORPSE] || (ptr) == &mons[PM_VAMPIRE_TROLL] || (ptr) == &mons[PM_DEFILED_WARRIOR]  )
