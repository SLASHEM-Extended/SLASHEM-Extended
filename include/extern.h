...
E int have_femtrapjohanetta(void);
E int have_femtrapchloe(void);
E int have_femtrapanja(void);
E int have_femtrapcelia(void);
...
E int find_appearance_armor(int);
E int find_appearance_potion(int);
...
E const char *generate_crythroat_string(void);
E const char *generate_crythroat_char(void);
...
E void genitalhealth(BOOLEAN_P);
...
E int maybepyramidalheels(void);
E int maybeballheels(void);
...
E int randartcontainerplustricks(void);
E int randartcontainerplustricksX(void);
E int randartcontainernotricks(void);
E int randartcontainernotricksX(void);
E int randartunlocking(void);
E int randartunlockingX(void);
E int randartlightsource(void);
E int randartlightsourceX(void);
E int randartblindfold(void);
E int randartblindfoldX(void);
...
E void monster_kill_taunt(struct monst *, int, BOOLEAN_P);
...
E int weapon_type_alwaysmartial(struct obj *);
E int uwep_skill_type(void);
E int weapon_hit_bonus(struct obj *);
E int weapon_dam_bonus(struct obj *, BOOLEAN_P);
