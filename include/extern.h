...
E boolean FDECL(arti_is_evil, (struct obj *));
...
E void FDECL(zap_dig, (BOOLEAN_P) );
...
E boolean FDECL(doorlockX, (int,int,BOOLEAN_P));
E int NDECL(doopen);
E int NDECL(doclose);
...
E boolean FDECL(really_bad_location, (XCHAR_P,XCHAR_P,XCHAR_P,XCHAR_P,XCHAR_P,XCHAR_P));
...
E void FDECL(tele_trapX, (struct trap *));
E void FDECL(level_tele_trap, (struct trap *));
E void FDECL(level_tele_trapX, (struct trap *));
...
E void FDECL(doshittrap, (struct obj *));
