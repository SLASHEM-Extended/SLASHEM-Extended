...
E void newgame(void);
E boolean contaminationcheck(int);
...
E void do_vicinity_map_huge(void);
...
E int have_rmbstone(void);
E int have_displaystone(void);
E int have_yellowspellstone(void);
E int have_spelllossstone(void);
E int have_autodestructstone(void);
E int have_memorylossstone(void);
E int have_inventorylossstone(void);
E int have_blackystone(void);
E int have_menubugstone(void);
E int have_speedbugstone(void);
E int have_superscrollerstone(void);
E int have_freehandbugstone(void);
E int have_unidentifystone(void);
E int have_thirststone(void);
E int have_unluckystone(void);
E int have_shadesofgreystone(void);
E int have_faintingstone(void);
E int have_cursingstone(void);
E int have_difficultystone(void);
E int have_deafnessstone(void);
E int have_weaknessstone(void);
E int have_antimagicstone(void);
E int have_rotthirteenstone(void);
E int have_bishopstone(void);
E int have_confusionstone(void);
E int have_dropbugstone(void);
E int have_dstwstone(void);
E int have_statusstone(void);
E int have_alignmentstone(void);
E int have_stairstrapstone(void);
E int have_uninformationstone(void);

E int have_amnesiastone(void);
E int have_bigscriptstone(void);
E int have_bankstone(void);
E int have_mapstone(void);
E int have_techniquestone(void);
E int have_disenchantmentstone(void);
E int have_verisiertstone(void);
E int have_chaosterrainstone(void);
E int have_mutenessstone(void);
E int have_engravingstone(void);
E int have_magicdevicestone(void);
E int have_bookstone(void);
E int have_levelstone(void);
E int have_quizstone(void);

E int have_intrinsiclossstone(void);
E int have_bloodlossstone(void);
E int have_badeffectstone(void);
E int have_trapcreationstone(void);
E int have_vulnerabilitystone(void);
E int have_itemportstone(void);
E int have_nastystone(void);

E int have_respawnstone(void);
E int have_captchastone(void);
E int have_farlookstone(void);

E int have_nonsacredstone(void);
E int have_starvationstone(void);
E int have_droplessstone(void);
E int have_loweffectstone(void);
E int have_invisostone(void);
E int have_ghostlystone(void);
E int have_dehydratingstone(void);
E int have_hatestone(void);
E int have_directionswapstone(void);
E int have_nonintrinsicstone(void);
E int have_dropcursestone(void);
E int have_nakedstone(void);
E int have_antilevelstone(void);
E int have_stealerstone(void);
E int have_rebelstone(void);
E int have_shitstone(void);
E int have_misfirestone(void);
E int have_wallstone(void);

E int have_metabolicstone(void);
E int have_noreturnstone(void);
E int have_egostone(void);
E int have_fastforwardstone(void);
E int have_rottenstone(void);
E int have_unskilledstone(void);
E int have_lowstatstone(void);
E int have_trainingstone(void);
E int have_exercisestone(void);

E int have_limitationstone(void);
E int have_weaksightstone(void);
E int have_messagestone(void);

E int have_disconnectstone(void);
E int have_interfacescrewstone(void);
E int have_bossfightstone(void);
E int have_entirelevelstone(void);
E int have_bonestone(void);
E int have_autocursestone(void);
...
E int have_umengstone(void);
E int have_aefdestone(void);
...
E int have_colorshiftstone(void);
E int have_toplinestone(void);
E int have_capsstone(void);
E int have_unknowledgestone(void);
E int have_darkhancestone(void);
E int have_dschueueuetstone(void);
E int have_nopeskillstone(void);

E int have_realliestone(void);
E int have_escapepaststone(void);
E int have_pethatestone(void);
E int have_petlashoutstone(void);
E int have_petstarvestone(void);
E int have_petscrewstone(void);
E int have_techlossstone(void);
E int have_prooflossstone(void);
E int have_uninvisstone(void);
E int have_detectationstone(void);

E int have_giantexplorerstone(void);
E int have_trapwarpstone(void);
E int have_yawmstone(void);
E int have_chaoscradlestone(void);
E int have_tezstone(void);
E int have_bossgodstone(void);
E int have_ubergodstone(void);
E int have_toogoodgostone(void);
E int have_killerroomstone(void);
E int have_funwallstone(void);

E int have_sanitytreblestone(void);
E int have_statdecreasestone(void);
E int have_simeoutstone(void);

E int have_orangespellstone(void);
E int have_violetspellstone(void);
E int have_longingstone(void);
E int have_cursedpartstone(void);
E int have_quaversalstone(void);
E int have_appearanceshufflingstone(void);
E int have_brownspellstone(void);
E int have_choicelessstone(void);
E int have_goldspellstone(void);
E int have_deprovementstone(void);
E int have_initializationstone(void);
E int have_gushlushstone(void);
E int have_soiltypestone(void);
E int have_dangerousterrainstone(void);
E int have_falloutstone(void);
E int have_mojibakestone(void);
E int have_gravationstone(void);
E int have_uncalledstone(void);
E int have_explodingdicestone(void);
E int have_permacursestone(void);
E int have_shroudedidentitystone(void);
E int have_feelergaugesstone(void);
E int have_longscrewupstone(void);
E int have_wingyellowstone(void);
E int have_lifesavingstone(void);
E int have_curseusestone(void);
E int have_cutnutritionstone(void);
E int have_skilllossstone(void);
E int have_autopilotstone(void);
E int have_forcestone(void);
E int have_monsterglyphstone(void);
E int have_changingdirectivestone(void);
E int have_containerkaboomstone(void);
E int have_stealdegradestone(void);
E int have_leftinventorystone(void);
E int have_fluctuatingspeedstone(void);
E int have_tarmustrokingnorastone(void);
E int have_failurestone(void);
E int have_brightcyanspellstone(void);
E int have_frequentationspawnstone(void);
E int have_petaistone(void);
E int have_satanstone(void);
E int have_rememberancestone(void);
E int have_pokeliestone(void);
E int have_autopickupstone(void);
E int have_dywypistone(void);
E int have_silverspellstone(void);
E int have_metalspellstone(void);
E int have_platinumspellstone(void);
E int have_manlerstone(void);
E int have_doorningstone(void);
E int have_nownsiblestone(void);
E int have_elmstreetstone(void);
E int have_monnoisestone(void);
E int have_rangcallstone(void);
E int have_recurringspelllossstone(void);
E int have_antitrainingstone(void);
E int have_techoutstone(void);
E int have_statdecaystone(void);
E int have_movemorkstone(void);

E int have_lootcutstone(void);
E int have_monsterspeedstone(void);
E int have_scalingstone(void);
E int have_inimicalstone(void);
E int have_whitespellstone(void);
E int have_greyoutstone(void);
E int have_quasarstone(void);
E int have_mommystone(void);
E int have_horrorstone(void);
E int have_artificialstone(void);
E int have_wereformstone(void);
E int have_antiprayerstone(void);
E int have_evilpatchstone(void);
E int have_hardmodestone(void);
E int have_secretattackstone(void);
E int have_eaterstone(void);
E int have_covetousstone(void);
E int have_nonseeingstone(void);
E int have_darkmodestone(void);
E int have_unfindablestone(void);
E int have_homicidestone(void);
E int have_multitrappingstone(void);
E int have_wakeupcallstone(void);
E int have_grayoutstone(void);
E int have_graycenterstone(void);
E int have_checkerboardstone(void);
E int have_clockwisestone(void);
E int have_counterclockwisestone(void);
E int have_lagstone(void);
E int have_blesscursestone(void);
E int have_delightstone(void);
E int have_dischargestone(void);
E int have_trashstone(void);
E int have_filteringstone(void);
E int have_deformattingstone(void);
E int have_flickerstripstone(void);
E int have_undressingstone(void);
E int have_hyperbluestone(void);
E int have_nolightstone(void);
E int have_paranoiastone(void);
E int have_fleecestone(void);
E int have_interruptionstone(void);
E int have_dustbinstone(void);
E int have_batterystone(void);
E int have_butterfingerstone(void);
E int have_miscastingstone(void);
E int have_messagesuppressionstone(void);
E int have_stuckannouncementstone(void);
E int have_stormstone(void);
E int have_maximumdamagestone(void);
E int have_latencystone(void);
E int have_starlitskystone(void);
E int have_trapknowledgestone(void);
E int have_highscorestone(void);
E int have_pinkspellstone(void);
E int have_greenspellstone(void);
E int have_evcstone(void);
E int have_underlaidstone(void);
E int have_damagemeterstone(void);
E int have_weightstone(void);
E int have_infofuckstone(void);
E int have_blackspellstone(void);
E int have_cyanspellstone(void);
E int have_heapstone(void);
E int have_bluespellstone(void);
E int have_tronstone(void);
E int have_redspellstone(void);
E int have_tooheavystone(void);
E int have_elongatedstone(void);
E int have_wrapoverstone(void);
E int have_destructionstone(void);
E int have_meleeprefixstone(void);
E int have_automorestone(void);
E int have_unfairattackstone(void);

E int have_badpartstone(void);
E int have_completelybadpartstone(void);
E int have_evilvariantstone(void);
E int have_reallybadstone(void);
E int have_blaststone(void);
E int have_covidstone(void);
...
E int have_femtraplara(void);
E int have_femtrapnadine(void);
E int have_femtrapluisa(void);
E int have_femtrapirina(void);
E int have_femtrapliselotte(void);
E int have_femtrapgreta(void);
E int have_femtrapjane(void);
E int have_femtrapsuelyn(void);
E int have_femtrapcharlotte(void);
E int have_femtraphannah(void);
E int have_femtraplittlemarie(void);
E int have_femtrapanastasia(void);
E int have_femtrapjessica(void);
E int have_femtrapsolvejg(void);
E int have_femtrapwendy(void);
E int have_femtrapkatharina(void);
E int have_femtrapelena(void);
E int have_femtrapthai(void);
E int have_femtrapelif(void);
E int have_femtrapnadja(void);
E int have_femtrapsandra(void);
E int have_femtrapnatalje(void);
E int have_femtrapjeanetta(void);
E int have_femtrapyvonne(void);
E int have_femtrapmaurah(void);
E int have_femtrapmeltem(void);
E int have_femtrapsarah(void);
E int have_femtrapclaudia(void);
E int have_femtrapludgera(void);
E int have_femtrapkati(void);
E int have_femtrapnelly(void);
E int have_femtrapeveline(void);
E int have_femtrapkarin(void);
E int have_femtrapjuen(void);
E int have_femtrapkristina(void);
E int have_femtraplou(void);
E int have_femtrapalmut(void);
E int have_femtrapjulietta(void);
E int have_femtraparabella(void);
E int have_femtrapkristin(void);
E int have_femtrapanna(void);
E int have_femtrapruea(void);
E int have_femtrapdora(void);
E int have_femtrapmarike(void);
E int have_femtrapjette(void);
E int have_femtrapina(void);
E int have_femtrapsing(void);
E int have_femtrapvictoria(void);
E int have_femtrapmelissa(void);
E int have_femtrapanita(void);
E int have_femtraphenrietta(void);
E int have_femtrapverena(void);
E int have_femtrapannemarie(void);
E int have_femtrapjil(void);
E int have_femtrapjana(void);
E int have_femtrapkatrin(void);
E int have_femtrapgudrun(void);
E int have_femtrapella(void);
E int have_femtrapmanuela(void);
E int have_femtrapjennifer(void);
E int have_femtrappatricia(void);
E int have_femtrapantje(void);
E int have_femtrapantjex(void);
E int have_femtrapkerstin(void);
E int have_femtraplaura(void);
E int have_femtraplarissa(void);
E int have_femtrapnora(void);
E int have_femtrapnatalia(void);
E int have_femtrapsusanne(void);
E int have_femtraplisa(void);
E int have_femtrapbridghitte(void);
E int have_femtrapjulia(void);
E int have_femtrapnicole(void);
E int have_femtraprita(void);
E int have_femtrapjanina(void);
E int have_femtraprosa(void);
E int have_femtrapksenia(void);
E int have_femtraplydia(void);
E int have_femtrapconny(void);
E int have_femtrapkatia(void);
E int have_femtrapmariya(void);
E int have_femtrapelise(void);
E int have_femtrapronja(void);
E int have_femtrapariane(void);
E int have_femtrapjohanna(void);
E int have_femtrapinge(void);
E int have_femtrapruth(void);
E int have_femtrapmagdalena(void);
E int have_femtrapmarleen(void);
E int have_femtrapklara(void);
E int have_femtrapfriederike(void);
E int have_femtrapnaomi(void);
E int have_femtrapute(void);
...
E struct obj *add_to_container(struct obj *, struct obj *, BOOLEAN_P);
...
E boolean isillusorymonster(struct monst *);
...
E int rnd_offensive_wand(struct monst *);
...
E int find_echo_helmet(void);
E int find_demonic_cloak(void);
...
E int find_fencing_gloves(void);
E int find_critical_gloves(void);
...
E int find_petrified_cloak(void);
E int find_profiled_boots(void);
E int find_void_cloak(void);
E int find_bamboo_cloak(void);
...
E int find_heeled_hugging_boots(void);
E int find_plateau_boots(void);
E int find_fleecy_boots(void);
E int find_terrible_boots(void);
...
E int find_lead_helmet(void);
E int find_rumble_boots(void);
E int find_pure_cloak(void);
...
E int find_metal_focus_robe(void);
E int find_super_heavy_robe(void);
E int find_gromy_robe(void);
E int find_magicprot_robe(void);
E int find_armored_robe(void);
E int find_vanillic_robe(void);
E int find_focused_robe(void);
E int find_superfocused_robe(void);
E int find_easy_id_robe(void);
...
E int find_remora_heels(void);
E int find_heeled_chelsea_boots(void);
...
E int find_white_buffalo_boots(void);
...
E int find_named_boots(void);
E int find_roller_boots(void);
E int find_roman_sandals(void);
E int find_flipflops(void);
E int find_heap_of_shit_boots(void);
E int find_bise_gloves(void);
E int find_surefire_gloves(void);
E int find_clunky_heels(void);
E int find_inverse_gloves(void);
E int find_less_helmet(void);
E int find_thinking_helmet(void);
E int find_filtered_helmet(void);
E int find_different_cloak(void);
E int find_up_down_cloak(void);
E int find_runic_gloves(void);
E int find_fur_boots(void);
E int find_politician_cloak(void);
...
E int find_sweaty_shoes(void);
E int find_sister_shoes(void);
...
E int find_silver_stilettos(void);
E int find_copper_stilettos(void);
E int find_diamond_stilettos(void);
...
E int find_quantity_cloak(void);
...
E int find_blockchoc_boots(void);
E int find_platform_sneakers(void);
E int find_iceblock_heels(void);
E int find_paragraph_shoes(void);
E int find_paragraph_sandals(void);
E int find_bridal_shoes(void);
...
E void mstatuslinestats(struct monst *);
...
E boolean resistdarknesseffect(void);
E boolean readableshirt(int);
E boolean trophylevel(void);
E boolean bucreclevel(void);
E boolean enchantreclevel(void);
...
E void percentheal(int);
E void percentheal_mon(struct monst *, int);
E void percentrestoremana(int);
...
E boolean playerextrinsicdrainres(void);
E boolean playerextrinsicsickres(void);
E boolean playerextrinsicacidres(void);
E boolean playerextrinsicfearres(void);
E boolean playerextrinsicpsires(void);
...
E const char *tshirt_text(struct obj *);
...
E int randartpolearmX(void);
E int randartdagger(void);
E int randartdaggerX(void);
E int randartquarterstaff(void);
E int randartquarterstaffX(void);
E int randartbow(void);
E int randartbowX(void);
...
E int randartbroadswordX(void);
E int randartshortsword(void);
...
E int randartflailX(void);
E int randartlance(void);
E int randartlanceX(void);
E int randartcrossbow(void);
E int randartcrossbowX(void);
E int randarthammer(void);
E int randarthammerX(void);
E int randartmorningstar(void);
E int randartmorningstarX(void);
E int randartclub(void);
E int randartclubX(void);
E int randartaxe(void);
E int randartaxeX(void);
E int randartboomerang(void);
E int randartboomerangX(void);
E int randartsling(void);
E int randartslingX(void);
E int randartspear(void);
E int randartspearX(void);
E int randarttwohandedsword(void);
E int randarttwohandedswordX(void);
E int randartpickaxe(void);
E int randartpickaxeX(void);
E int randartmace(void);
...
E int steal(struct monst *, char *,BOOLEAN_P,BOOLEAN_P,BOOLEAN_P);
