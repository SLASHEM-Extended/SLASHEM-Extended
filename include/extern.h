...
E boolean have_femtrapsonja(void);
E boolean have_femtraprhea(void);
E boolean have_femtraptanja(void);
E boolean have_femtraplara(void);
E boolean have_femtrapnadine(void);
E boolean have_femtrapluisa(void);
E boolean have_femtrapirina(void);
E boolean have_femtrapliselotte(void);
E boolean have_femtrapgreta(void);
E boolean have_femtrapjane(void);
E boolean have_femtrapsuelyn(void);
E boolean have_femtrapcharlotte(void);
E boolean have_femtraphannah(void);
E boolean have_femtraplittlemarie(void);
...
E boolean have_femtrapruth(void);
E boolean have_femtrapmagdalena(void);
E boolean have_femtrapmarleen(void);
E boolean have_femtrapklara(void);
E boolean have_femtrapfriederike(void);
E boolean have_femtrapnaomi(void);
E boolean have_femtrapute(void);
E boolean have_femtrapjasieen(void);
E boolean have_femtrapyasaman(void);
E boolean have_femtrapmaybritt(void);
