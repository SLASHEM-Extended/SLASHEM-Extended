...
/* ### dialogs.c ### */
E Widget CreateDialog(Widget, String, XtCallbackProc, XtCallbackProc);
E void SetDialogPrompt(Widget, String);
E String GetDialogResponse(Widget);
E void SetDialogResponse(Widget, String);
E void positionpopup(Widget,BOOLEAN_P);
...
E void create_message_window(struct xwindow*, BOOLEAN_P, Widget);
...
E void create_map_window(struct xwindow*, BOOLEAN_P, Widget);
...
/* ### winmisc.c ### */
E void ps_key(Widget, XEvent*, String*, Cardinal*); /* player selection action */
E void race_key(Widget, XEvent*, String*, Cardinal*); /* race selection action */
...
E void ec_key(Widget, XEvent*, String*, Cardinal*); /* extended command action */

/* ### winstatus.c ### */
E void create_status_window(struct xwindow*, BOOLEAN_P, Widget);
...
E void display_text_window(struct xwindow*, BOOLEAN_P);
E void create_text_window(struct xwindow*);
E void destroy_text_window(struct xwindow*);
E void clear_text_window(struct xwindow*);
E void append_text_buffer(struct text_buffer*, const char*, BOOLEAN_P); /* text buffer routines */
...
#ifdef GRAPHIC_TOMBSTONE
E void calculate_rip_text(int);
#endif


/* ### winval.c ### */
E Widget create_value(Widget, const char*);
E void	 set_name(Widget, char*);
...
E void X11_display_nhwindow(winid, BOOLEAN_P);
E void X11_destroy_nhwindow(winid);
E void X11_curs(winid,int,int);
E void X11_putstr(winid, int, const char *);
#ifdef FILE_AREAS
E void X11_display_file(const char *, const char *, BOOLEAN_P);
#else
E void X11_display_file(const char *, BOOLEAN_P);
#endif
E void X11_start_menu(winid);
E void X11_add_menu(winid,int,const ANY_P *,
...
#endif
E void X11_print_glyph(winid,XCHAR_P,XCHAR_P,int);
...
E char X11_yn_function(const char *, const char *, CHAR_P);
