...
#define ABIL_BREATHE_LIGHT	49
#define ABIL_CAMERA_CLICK	50
#define ABIL_SOCKS_ODOR	51
#define ABIL_PANTS_ODOR	52
#define ABIL_TRUMPET	53
#define ABIL_SELFHARM	54
#define ABIL_ANTI_TELEPORT	55
