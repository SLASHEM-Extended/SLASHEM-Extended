This is the binary distribution of Slash'EM 0.0.7E6F3 for Mac OS Classic. This is a Power PC binary, so it will run only on a Macintosh with a Power PC processor.
